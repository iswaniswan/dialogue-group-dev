...
class Mmaster extends CI_Model {
    ...
    public function closingsaldo($ibagian,$periodeclosing,$periodenext) 
    {
        ...
        $this->db->query("
            DELETE FROM
                tm_mutasi_saldoawal_base_wip
                WHERE id_company = $this->company AND i_bagian = '$ibagian' AND e_mutasi_periode = '$periodenext';
            INSERT INTO 
                tm_mutasi_saldoawal_base_wip
                (id_company, i_bagian, e_mutasi_periode, i_product_wip, i_color, n_saldo_awal)
                SELECT 
                    id_company, 
                    '$ibagian', 
                    '$periodenext', 
                    ...
                    i_color,
                    saldo_akhir 
                FROM f_mutasi_saldoawal_unitjahit ($this->company,'$periodeclosing','9999-12-01','9999-12-31','$awal','$akhir','$ibagian')
        ", FALSE);
