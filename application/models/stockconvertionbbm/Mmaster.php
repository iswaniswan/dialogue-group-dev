...
class Mmaster extends CI_Model {
    ...
    public function getbbm($cari){
        ...
        return $this->db->query("
            SELECT
                ...
                e_area_name,
                i_bbm,
                to_char(d_bbm, 'dd-mm-yyyy') AS dbbm 
            FROM
                tm_bbm a,
                tr_area b
            WHERE
                ...
                FROM
                    tm_ic_convertion
                WHERE
                    a.i_bbm = tm_ic_convertion.i_refference)
                AND a.f_bbm_convertion = 'f'
                AND a.i_bbm LIKE '%-$tahun%'
                AND a.i_bbm LIKE 'BBM-$tahun%'
                AND UPPER(a.i_bbm) LIKE '%$cari%'
            ORDER BY
                a.d_bbm DESC,
                a.i_area ASC", 
        FALSE);
    ...
    public function bacadetail($irefference){
        $this->db->select("
            ...
            FROM
                tm_bbm_item b
            LEFT JOIN tm_bbm e ON
                ( e.i_bbm = b.i_bbm
                AND e.i_bbm_type = b.i_bbm_type )
            LEFT JOIN tr_product_motif a ON
                ( b.i_product_motif = a.i_product_motif
                AND b.i_product = a.i_product )
            LEFT JOIN tr_product c ON
    ...
    public function insertheader($iicconvertion,$dicconvertion,$iproduct,$iproductgrade,$eproductname,$iproductmotif,$ficconvertion,$nicconvertion,$irefference,$drefference){
    ...
    public function insertbbkdetail($iproduct,$iproductgrade,$eproductname,$iproductmotif,$nicconvertion,$vunitprice,$iicconvertion,$ibbk,$eremark,$ibbktype){
        $this->db->set(
            array(
                'i_bbk'                => $ibbk,
                'i_bbk_type'           => $ibbktype,
    ...
    public function insertbbmdetail($iproduct,$iproductgrade,$eproductname,$iproductmotif,$nicconvertion,$vunitprice,$iicconvertion,$ibbm,$eremark,$ibbmtype){
        $this->db->set(
            array(
                'i_bbm'                 => $ibbm,
                'i_bbm_type'            => $ibbmtype,
