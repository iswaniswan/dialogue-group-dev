...
class Mmaster extends CI_Model {
	...
	function data($dfrom, $dto, $area, $i_menu){
        ...
        $datatables->query("Select a.i_nota, a.d_nota, a.i_sj, a.d_sj, a.i_faktur_komersial, a.i_seri_pajak, a.d_pajak, b.e_customer_name, c.e_area_name, a.i_spb, d.i_spb_old, a.i_area, '$dfrom' as dfrom, '$dto' as dto, '$i_menu' as i_menu
                            from tm_nota a, tr_customer b, tr_area c, tm_spb d
                            where a.i_customer=b.i_customer and a.i_area=c.i_area and a.i_approve_pajak isnull
                            and a.i_spb=d.i_spb and a.i_area=d.i_area
                            and not a.i_nota isnull and not a.i_sj isnull and a.f_nota_cancel = 'f' 
                            and not a.i_dkb isnull and not a.i_seri_pajak isnull and a.i_area='$area'
                            and (a.d_nota >= to_date('$dfrom', 'yyyy-mm-dd') 
                            and a.d_nota <= to_date('$dto', 'yyyy-mm-dd'))
                            order by a.d_nota, a.i_nota ",false);
		$datatables->add('action', function ($data) {
            ...
            if(check_role($i_menu, 3)){
                $data .= "<a href=\"#\" onclick='show(\"notaapprovepajak/cform/edit/$i_sj/$i_area/$dfrom/$dto/$d_sj/\",\"#main\"); return false;'><i class='fa fa-pencil'></i></a>";
            }
			return $data;
        });
