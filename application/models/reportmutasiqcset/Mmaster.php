...
class Mmaster extends CI_Model {
  ...
  public function getjenis($ikelompok, $ibagian){
    ...
    $this->db->select("
      a.i_type_code, a.e_type_name from tr_item_type a where a.id_company = '$id_company' and a.i_kode_group_barang in ('GRB0001','GRB0004','GRB0005') $where
  ...
  function cek_datadet($id_company, $i_periode, $d_jangka_awal, $d_jangka_akhir, $dfrom, $dto, $ibagian, $ikelompok, $jnsbarang){   
    ...
    $this->db->select("
                        x.*, a.e_material_name, b.e_satuan_name from f_mutasi_saldoawal_qcset('$id_company', '$i_periode', '$d_jangka_awal', '$d_jangka_akhir', '$dfrom', '$dto', '$ibagian') x
