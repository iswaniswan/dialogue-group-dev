...
class Mmaster extends CI_Model {
  ...
  public function cek_kode($kode,$ibagian){
        ...
        $this->db->from('tm_keluar_produksibp');
  ...
  public function changestatus($id,$istatus){
        ...
        if ($istatus=='6') {
            $query = $this->db->query("
                ...
                FROM tm_keluar_produksibp_item
        ...
        $this->db->update('tm_keluar_produksibp', $data);
  }
  ...
  public function insertheader($id, $ibagian, $ikeluar, $datekeluar, $imemo, $partner, $eremark){
        ...
        $this->db->insert('tm_keluar_produksibp', $data);
  }
  ...
  public function insertdetail($id, $imaterial, $nquantitymemo, $nsisa, $nquantity, $edesc, $imemo){               
        ...
        $this->db->insert('tm_keluar_produksibp_item', $data);
  }
  ...
  public function deletedetail($id){
        ...
        $this->db->where('id_company', $idcompany);
        $this->db->delete('tm_keluar_produksibp_item');
  }
}
