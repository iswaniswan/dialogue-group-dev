...
class Mmaster extends CI_Model
{
    ...
    function data($i_menu,$folder,$dfrom,$dto)
    {
        ...
        $datatables->query("
            ...
            INNER JOIN tm_konversi_pinjaman_bp_item b ON
                (b.id_document = a.id)
            INNER JOIN tm_keluar_pinjamanbp c ON
    ...
    public function partner($cari)
    {
        return $this->db->query("
            ...
            LEFT JOIN tm_keluar_pinjamanbp_item c ON
                (a.id = c.id_document
    ...
    public function cek_kode($kode,$ibagian)
    {
        ...
        $this->db->from('tm_konversi_pinjaman_bp');
    ...
    public function datareferensi($cari,$idpartner,$grouppartner)
    {
        return $this->db->query("
            ...
            FROM
                tm_keluar_pinjamanbp a
            INNER JOIN tm_keluar_pinjamanbp_item b ON
                (a.id = b.id_document
                AND a.id_company = b.id_company)
            WHERE
                a.id_company = $this->company
    ...
    public function simpan($id,$idocument,$ddocument,$ibagian,$ipartner,$etypepartner,$ireff,$eremark)
    {
        ...
        $this->db->insert('tm_konversi_pinjaman_bp', $data);
    }
    ...
    public function simpandetail($id,$iddocument,$idmaterial,$nquantity,$eremark)
    {
        ...
        $this->db->insert('tm_konversi_pinjaman_bp_item', $data);
    }
    ...
    public function dataeditreferensi($id)
    {
        return $this->db->query("
            SELECT
                ...
                to_char(d_document, 'dd-mm-yyyy') AS d_document
            FROM
                tm_konversi_pinjaman_bp_item a
            INNER JOIN tm_keluar_pinjamanbp b ON
    ...
    public function dataeditdetail($id)
    {
        return $this->db->query("
            ...
            INNER JOIN tr_material b ON
                (b.id = a.id_material)
            INNER JOIN tm_keluar_pinjamanbp_item c ON
                (c.id_document = a.id_document_reff
                AND a.id_material = c.id_material)
            INNER JOIN tm_keluar_pinjamanbp d ON
                (d.id = c.id_document)
    ...
    public function update($id,$idocument,$ddocument,$ibagian,$ipartner,$etypepartner,$ireff,$eremark)
    {
        ...
        $this->db->where('id',$id);
        $this->db->update('tm_konversi_pinjaman_bp', $data);
    }
    ...
    public function delete($id)
    {
        ...
        $this->db->delete('tm_konversi_pinjaman_bp_item');
    }
