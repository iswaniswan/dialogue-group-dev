...
class Mmaster extends CI_Model
{
    ...
    public function cek_kode($kode,$ibagian)
    {
        ...
        $this->db->from('tm_masuk_retur_packing');
    ...
    public function insertheader($id, $ibonm, $datebonm, $ikodemaster, $iasal, $ireff, $eremark)
    {
        ...
        $this->db->insert('tm_masuk_retur_packing', $data);
    }
    ...
    public function insertdetail($id, $ireff, $ibonm, $idproduct, $idcolor, $nquantity, $nquantitymasuk, $edesc)
    {
        if($nquantitymasuk>0){
            ...
            $this->db->insert('tm_masuk_retur_packing_item', $data);
        }
    }
    ...
    public function updateheader($id, $ikodemaster, $ibonm, $datebonm, $eremark, $iasal, $ireff)
    {
        ...
        $this->db->update('tm_masuk_retur_packing', $data);
    }

    public function deletedetail($id){
        $this->db->where('id_document', $id);
        $this->db->delete('tm_masuk_retur_packing_item');
    }
            ...
            if ($istatus == '3') {
            	...
            	if ($awal->i_approve_urutan + 1 > $awal->n_urut ) {
                    /* $query = $this->db->query("SELECT id_document, id_product, n_quantity, id_reff
                        FROM tm_masuk_retur_packing_item
            	...
            	$this->db->query("INSERT INTO tm_menu_approve (i_menu,i_level,i_document,e_approve,d_approve,e_database) VALUES
					('$this->i_menu','$this->i_level','$id','$this->username','$now','tm_masuk_retur_packing');", FALSE);
                }
        }else{
            $data = array(
                'i_status'  => $istatus,
