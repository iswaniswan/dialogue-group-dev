...
class Mmaster extends CI_Model {
    ...
    public function bacasupplier(){
        return $this->db->query("SELECT * FROM tr_supplier", FALSE)->result();
    }
    ...
    function bacaperiode($dfrom,$dto,$iarea,$interval,$isupplier)
    {
      if($dfrom!=''){
				$tmp=explode("-",$dfrom);
        $th=$tmp[2];				
      ...
      if($iarea=='NA'){
        ...
        $sql="a.nama, a.kode, a.alamat, a.kota, a.sales, a.area, a.supplier, a.jenis, a.iarea, a.icity, a.product, a.productname, a.unitprice, ";
        switch ($bl){
        case '01' :
...
isi[5] as area, isi[6] as jenis, isi[7] as iarea, isi[8] as icity, isi[13] as supplier, isi[11] as productname, isi[12] as unitprice, ";
        switch ($bl){
        case '01' :
        ...
        $sql.=" from crosstab
              ('SELECT Array [b.e_customer_name::text, b.e_customer_address::text, c.e_city_name::text, a.i_salesman::text, 
                ...
                f.e_product_name, f.v_unit_price::text, h.e_supplier_name::text, g.i_supplier::text] as isi, to_number(to_char(a.d_nota, ''mm''),''99'') as bln, 
                ...
                AND a.i_sj=f.i_sj AND a.i_area=f.i_area AND g.i_supplier=''$isupplier'' AND f.i_product=g.i_product AND g.i_supplier=h.i_supplier
        ...
        $sql.=" ) as a
                group by a.iarea, a.icity, a.nama, a.kode, a.alamat, a.kota, a.sales, a.area, a.supplier, a.jenis, a.product, a.productname, a.unitprice
                order by a.iarea, a.icity, a.kode, a.nama, a.alamat, a.kota, a.sales, a.area, a.supplier, a.jenis, a.product, a.productname, a.unitprice";
...
isi[5] as area, isi[6] as jenis, isi[7] as iarea, isi[8] as icity, isi[13] as supplier, isi[11] as productname, isi[12] as unitprice, ";
        ...
        $sql.=" from crosstab
              ('SELECT Array [b.e_customer_name::text, b.e_customer_address::text, c.e_city_name::text, a.i_salesman::text, 
                ...
                AND (a.d_nota >= to_date(''$dfrom'',''dd-mm-yyyy'') AND a.d_nota <= to_date(''$dto'',''dd-mm-yyyy''))
                GROUP BY b.e_customer_name, a.i_customer, b.e_customer_address, c.e_city_name, a.i_salesman, d.e_area_name, 
                e.e_customer_classname, a.i_area, b.i_city, f.i_product, f.e_product_name, f.v_unit_price, g.i_supplier, h.e_supplier_name,
                to_char(a.d_nota, ''mm'')
                order by a.i_customer, b.e_customer_name, to_char(a.d_nota, ''mm'')','select (SELECT EXTRACT(MONTH FROM 
                date_trunc(''month'', 
                ''$tgl''::date)::date + s.a * ''1 month''::interval))
