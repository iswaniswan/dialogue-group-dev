...
class Mmaster extends CI_Model {
    ...
    public function bacaperiode($dfrom,$dto,$interval){
      ...
      $sql=" a.kode, a.nama, a.alamat, a.kota, a.area, a.iarea, a.icity, ";
        switch ($bl){
          case '01' :
        ...
        $sql.=" from ( select kode, nama, alamat, kota, area, iarea, icity, ";
        switch ($bl){
          case '01' :
        ...
        $sql.=" FROM CROSSTAB
              ...
              AS
                (kode text, nama text, alamat text, kota text, area text, iarea text, icity text,";
        switch ($bl){
        case '01' :
