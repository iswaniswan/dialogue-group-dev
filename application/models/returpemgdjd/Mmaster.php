...
/*(a.d_faktur_date_from ||' s/d '||a.d_faktur_date_to) as periode, */
  ...
  public function data($i_menu,$folder,$dfrom,$dto){
    ...
    $datatables->query("
                        ...
                        FROM 
                          tm_retur_beligdjd a
                          LEFT JOIN 
                            tm_retur_beligdjd_item b ON (a.id = b.id_retur_beli AND a.id_company = b.id_company)
                          LEFT JOIN 
  ...
  public function cek_kode($kode,$ibagian){
    ...
    $this->db->from('tm_retur_beligdjd');
  ...
  public function bacagudang(){
    ...
    return $this->db->query("
                            SELECT	
                            	a.id, a.i_bagian, e_bagian_name
                            FROM
                            	tr_bagian a
                            INNER JOIN tr_departement_cover b on (b.i_bagian = a.i_bagian)
                            WHERE 
                              a.id_company = '$id_company' and b.id_company = '$id_company' and i_departement = '$idepartement' and username = '$username' and e_bagian_name ilike '%$cari%'
                            ORDER BY 
                              a.e_bagian_name
                            ", FALSE);
  }
  ...
  public function insertheader($id, $iretur, $dateretur, $ibagian, $isupplier, $esupplier, $vtot, $eremark){
    ...
    $this->db->insert('tm_retur_beligdjd', $data);
  }
  ...
  public function insertdetail($id, $idbtb, $isj, $imaterial, $isatuan, $nquantity, $vunitprice, $edesc){
    ...
    $this->db->insert('tm_retur_beligdjd_item', $data);
  }
  ...
  public function updatedetail($id, $idretur, $imaterial, $isatuan, $nquantity, $edesc){
    ...
    $this->db->where('id_company', $this->idcompany);
    $this->db->update('tm_retur_beligdjd_item', $data);
  }
