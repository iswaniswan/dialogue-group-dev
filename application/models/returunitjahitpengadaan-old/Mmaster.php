...
class Mmaster extends CI_Model {
    ...
    public function product($cari, $ipartner, $ireferensi) {
        $idcompany = $this->session->userdata('id_company');
        $where = '';
        if($ireferensi == '' || $ireferensi == NULL){
            $where .= '';
        }else{
            $where .= "AND a.id_document = '$ireferensi' AND b.i_bagian_pengirim = '$ipartner'";
        }
        return $this->db->query("
                                    SELECT DISTINCT
                                    	a.id_product_wip,
                                    ...
                                    FROM
                                    	...
                                    	LEFT JOIN
                                    		tm_masuk_unitjahit b
                                    		ON (a.id_document = b.id AND a.id_company = b.id_company)
                                    	INNER JOIN 
                                    		tr_product_wip c
                                    		ON (a.id_product_wip = c.id AND a.id_company = c.id_company)
                                    	INNER JOIN tr_product_wip_item d 
                                            ON (c.id = d.id_product_wip AND c.id_company = d.id_company AND a.id_company = d.id_company)
                                        INNER JOIN tr_material e 
                                            ON (d.id_material = e.id AND d.id_company = e.id_company AND a.id_company
                                             = e.id_company)
                                        INNER JOIN tr_color f 
                                            ON (c.i_color = f.i_color AND c.id_company = f.id_company AND a.id_company = f.id_company)
                                    WHERE
        ...
        return $this->db->query("
                                    ...
                                    FROM
                                        ...
                                        INNER JOIN 
                                            ...
                                            ON (a.id_product_wip = c.id AND a.id_company = c.id_company)
                                        INNER JOIN tr_material e 
                                            ON (a.id_material = e.id AND a.id_company = e.id_company AND a.id_company = e.id_company)
                                        INNER JOIN tr_color f 
                                            ON (c.i_color = f.i_color AND c.id_company = f.id_company AND a.id_company = f.id_company)
                                    WHERE 
                                    	a.id_company = '$this->idcompany'
    ...
    public function deletedetail($id){
        $this->db->query("DELETE FROM tm_retur_jahit_topengadaan_item WHERE id_document='$id'", false);
    }
