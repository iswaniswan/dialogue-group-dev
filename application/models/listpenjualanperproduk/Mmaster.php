        ...
        $query = $this->db->query("
            ...
            FROM
                ...
                SELECT
                    *
                FROM
                    crosstab ('SELECT (a.i_product||e.i_product_group) as kode, a.i_product, d.i_supplier, i.e_supplier_name, e.i_product_group, 
                    ...
                    'select i_area from tr_area where f_area_real=''t'' order by i_area') AS (kode TEXT,
                    i_product TEXT,
                    i_supplier TEXT,
                    e_supplier_name TEXT,
                    i_product_group TEXT,
                    e_product_name TEXT,
                    e_area_name TEXT,
