...
class Mmaster extends CI_Model {
    ...
    public function data($dfrom,$dto,$gudang,$folder,$i_menu){
        ...
        $datatables->add('action', function ($data) {
            ...
            if(check_role($i_menu, 2)){
                $data .= "<a href=\"#\" onclick='show(\"$folder/cform/detail/$id/$dfrom/$dto/$gudang\",\"#main\"); return false;'><i class='fa fa-eye'></i></a>&nbsp;&nbsp;";
                #$data .= "<a href=\"#\" onclick='show(\"$folder/cform/detail/$id/$dfrom/$dto\",\"#main\"); return false;'><i class='fa fa-eye'></i></a>&nbsp;&nbsp;";
            }
            return $data;
        });
    ...
    public function baca_detail($ipp){
