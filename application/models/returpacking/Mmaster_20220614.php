...
class Mmaster extends CI_Model {
    ...
    public function changestatus_20211218($id, $istatus) {
        ...
        $this->db->where('id', $id);
        $this->db->update('tm_retur_packing_keluar', $data);
    }
    public function changestatus($id, $istatus) {
        if ($istatus == '3' || $istatus == '6') {
            $awal = $this->db->query("SELECT b.i_menu, 
				...
				FROM tm_retur_packing_keluar a
            ...
            if ($istatus == '3') {
                ...
                $this->db->query("INSERT INTO tm_menu_approve (i_menu,i_level,i_document,e_approve,d_approve,e_database) VALUES
					('$this->i_menu','$this->i_level','$id','$this->username','$now','tm_retur_packing_keluar');", FALSE);
            }
        } else {
            $data = array('i_status' => $istatus,);
        }
    ...
    public function cek_kode($kode, $ibagian) {
        ...
        $this->db->from('tm_retur_packing_keluar');
    ...
    function insertheader($id, $iretur, $ibagian, $dateretur, $itujuan, $eremarkh) {
        ...
        $this->db->insert('tm_retur_packing_keluar');
    }
    function insertdetail($id, $iproduct, $icolor, $nqtyproduct, $edesc) {
        ...
        $this->db->insert('tm_retur_packing_keluar_item');
    }
    ...
    public function dataeditdetail($id) {
        ...
        return $this->db->query("
                                  SELECT
                                       ...
                                       a.e_remark 
                                    FROM
                                       tm_retur_packing_keluar_item a 
                                       JOIN
                                          tm_retur_packing_keluar d 
    ...
    function updateheader($id, $iretur, $dateretur, $ibagian, $itujuan, $eremarkh) {
        ...
        $this->db->update('tm_retur_packing_keluar');
    }
    function deletedetail($id) {
        $idcompany = $this->session->userdata('id_company');
        $this->db->query("DELETE FROM tm_retur_packing_keluar_item WHERE id_document='$id' AND id_company = '$idcompany'");
    }
}
