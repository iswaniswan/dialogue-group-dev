...
class Mmaster extends CI_Model {
    ...
    function data($i_menu, $folder, $dfrom, $dto){
        ...
        $datatables->query("   
                            ...
                            FROM
                                ...
                                LEFT JOIN
                                    tm_kas_masuklain_hutangdagang h 
    ...
    public function cek_kode($kode,$ibagian){
        ...
        $this->db->from('tm_kas_konversi_masuk');
    ...
    public function partner($cari){
        ...
        return $this->db->query("
                                  ...
                                  FROM
                                     ...
                                     JOIN
                                        tm_kas_masuklain_hutangdagang c 
    ...
    function insertheader($id, $idocument, $datedocument, $ibagian, $ikasbank, $idpartner, $epartnertype, $idreferensi, $vnilaisisa, $vnilai, $vnilaiold, $eremark){
      ...
      $this->db->insert('tm_kas_konversi_masuk', $data);
    }
    ...
    function insertdetail($id, $idcustomer, $vvalue, $edesc){
      ...
      $this->db->insert('tm_kas_konversi_masuk_item', $data);
    }
    ...
    public function changestatus($id, $istatus, $epartnertype){
            ...
            $query = $this->db->query("                
                                        ...
                                        FROM
                                           ...
                                           JOIN
                                              ...
                                              AND a.id_company = b.id_company 
                                           JOIN
                                              tm_kas_masuklain_hutangdagang_item c 
        ...
        $this->db->update('tm_kas_konversi_masuk', $data);
    }
      ...
      return $this->db->query("                              
                                ...
                                FROM
                                    ...
                                    INNER JOIN
                                        ...
                                        AND a.id_company = c.id_company)
                                    INNER JOIN 
                                        tm_kas_masuklain_hutangdagang d
                                        ON a.id_document_reff = d.id
                                        AND a.id_company = d.id_company
                                    INNER JOIN 
                                        tm_kas_masuklain_hutangdagang_item e
    ...
    function deletedetail($id){
        $idcompany    = $this->session->userdata('id_company'); 
        return $this->db->query("DELETE FROM tm_kas_konversi_masuk_item WHERE id_document = '$id' AND id_company = '$idcompany'", FALSE);
    } 
}
