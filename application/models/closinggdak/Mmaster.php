        ...
        $this->db->query("
            ...
            INSERT INTO 
                ...
                SELECT 
                    ...
                    i_material, 
                    saldo_akhir 
                FROM f_mutasi_saldoawal_aks ($this->company,'$periodeclosing','9999-12-01','9999-12-31','$awal','$akhir','$ibagian')
        ", FALSE);
        $this->db->query("
            DELETE FROM
            ...
            INSERT INTO 
                ...
                SELECT 
                    ...
                    type_partner,
                    saldo_akhir 
                FROM f_mutasi_saldoawal_akspinjaman ($this->company,'$periodeclosing','9999-12-01','9999-12-31','$awal','$akhir','$ibagian')
        ", FALSE);
    }
}
