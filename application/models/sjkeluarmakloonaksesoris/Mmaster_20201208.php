...
class Mmaster extends CI_Model {
    ...
    $datatables = new Datatables(new CodeigniterAdapter);
        $datatables->query("select x.i_sj, x.d_sj, x.d_back, x.i_supplier, x.e_supplier_name, x.i_referensi, 
          ...
          (
            ...
            from tm_sjkeluarmakloonaksesoris sj 
          ...
          left join (
            select distinct(i_referensi), i_kode_master from tm_sjkeluarmakloonaksesoris where f_cancel = 'f'
        ...
        $datatables->add('action', function ($data) {
            ...
            if(check_role($i_menu, 2)){
               $data .= "<a href=\"#\" onclick='show(\"sjkeluarmakloonaksesoris/cform/view/$sj/$isupplier/\",\"#main\"); return false;'><i class='fa fa-eye'></i></a>&nbsp;&nbsp;";
            }
            if(check_role($i_menu, 3) && $f_cancel == 'f' && $i_status !='6' && $i_status != '4'){
                $data .= "<a href=\"#\" onclick='show(\"sjkeluarmakloonaksesoris/cform/edit/$sj/$isupplier/\",\"#main\"); return false;'><i class='fa fa-pencil'></i></a>&nbsp;&nbsp;";
            }   
            if(check_role($i_menu, 1)&& $f_cancel!='t' && $i_status !='1' && $i_status!='6' && $i_status=='2'){
               $data .= "<a href=\"#\" onclick='show(\"sjkeluarmakloonaksesoris/cform/approve/$sj/$isupplier/\",\"#main\"); return false;'><i class='fa fa-check-square'></i></a>&nbsp;&nbsp;";
            }
            if($f_cancel !='t'){
    ...
    $cari = strtoupper($this->input->get('q'));
        $this->db->select("c.i_partner, c.e_partner 
                      from(
                        ...
                        join tm_permintaanpengeluaranaks b on c.i_partner= b.pic
                        where b.i_status='6'
  ...
  public function gettypemakloon($ipartner){
        ...
        $this->db->select("distinct x.i_type_makloon, x.i_supplier, x.e_type_makloon
                          ...
                          join tm_permintaanpengeluaranaks b on x.i_supplier= b.pic
                          where b.pic= '$ipartner'", false);
        return $this->db->get();
  }
  ...
  public function reff($ipartner){
        ...
        return $this->db->query("
            ...
            FROM
                tm_permintaanpengeluaranaks
            WHERE
                i_status = '6' and jenis_pengeluaran = 'JK00002' and i_permintaan 
            NOT IN 
                  (select i_referensi from tm_sjkeluarmakloonaksesoris where i_status = '6')
            AND pic = '$ipartner'
  ...
  public function getreff($reff){
      return $this->db->query("
                          select x.d_pp, x.i_permintaan, x.partner, x.f_pkp
                            from(
                                select to_char(a.d_pp, 'dd-mm-yyyy') as d_pp, a.i_permintaan, a.pic as partner, su.f_supplier_pkp as f_pkp
                              from tm_permintaanpengeluaranaks a
                              join tr_supplier su on a.pic = su.i_supplier

                              UNION ALL
                              select to_char(a.d_pp, 'dd-mm-yyyy') as d_pp, a.i_permintaan, a.pic as partner, cu.f_customer_pkp as f_pkp 
                              from tm_permintaanpengeluaranaks a
                              join tr_customer cu on a.pic = cu.i_customer
  ...
  public function getreff_detail($reff, $ipartner, $itypemakloon){
      ...
      select x.i_permintaan, x.i_material, x.e_material_name, x.e_satuan, x.n_qty, x.n_qty_sisa, x.i_satuan_code,
          ...
          from (
                  ...
                  join tm_permintaanpengeluaranaks sa on sj.i_permintaan = sa.i_permintaan
                  ...
                  join tr_satuan s2 on (s2.i_satuan_code = m2.i_satuan_code)
                   join tm_price_makloon_supplier_cutting pi on (sj.i_material = pi.i_material and sa.pic = pi.i_supplier)
                 ...
                 group by sj.i_permintaan, sj.i_material, m.e_material_name, s.e_satuan, sj.n_qty, sj.n_qty_sisa, sj.i_satuan_code,
                  ...
                  join tr_material m2 on (sj.i_material2 = m2.i_material)
                  join tr_satuan s2 on (s2.i_satuan_code = m2.i_satuan_code)
                  join tm_price_makloon_supplier_bordir pi on (sj.i_material = pi.i_material and sa.pic = pi.i_supplier)
                   where sj.i_permintaan = '$reff'
                  and sa.pic = '$ipartner' 
                  and sa.i_status = '6'
                  and pi.i_type_makloon = '$itypemakloon'
           ...
           group by sj.i_permintaan, sj.i_material, m.e_material_name, s.e_satuan, sj.n_qty, sj.n_qty_sisa, sj.i_satuan_code,
                  ...
                  join tr_material m2 on (sj.i_material2 = m2.i_material)
                  join tr_satuan s2 on (s2.i_satuan_code = m2.i_satuan_code)
                  join tm_price_makloon_supplier_embosh pi on (sj.i_material = pi.i_material and sa.pic = pi.i_supplier)
                  where sj.i_permintaan = '$reff'
                  and sa.pic = '$ipartner' 
                  and sa.i_status = '6'
                  and pi.i_type_makloon = '$itypemakloon'
                  ...
                  join tr_material m2 on (sj.i_material2 = m2.i_material)
                  join tr_satuan s2 on (s2.i_satuan_code = m2.i_satuan_code)
                  join tm_price_makloon_supplier_packing pi on (sj.i_material = pi.i_material and sa.pic = pi.i_supplier)
                   where sj.i_permintaan = '$reff'
                  and sa.pic = '$ipartner' 
                  and sa.i_status = '6'
                  and pi.i_type_makloon = '$itypemakloon'
                  ...
                  join tr_material m2 on (sj.i_material2 = m2.i_material)
                  join tr_satuan s2 on (s2.i_satuan_code = m2.i_satuan_code)
                  join tm_price_makloon_supplier_print pi on (sj.i_material = pi.i_material and sa.pic = pi.i_supplier)
                   where sj.i_permintaan = '$reff'
                  and sa.pic = '$ipartner' 
                  and sa.i_status = '6'
                  and pi.i_type_makloon = '$itypemakloon'
                  ...
                  join tr_material m2 on (sj.i_material2 = m2.i_material)
                  join tr_satuan s2 on (s2.i_satuan_code = m2.i_satuan_code)
                  join tm_price_makloon_supplier_qwilting pi on (sj.i_material = pi.i_material and sa.pic = pi.i_supplier)
                   where sj.i_permintaan = '$reff'
                  and sa.pic = '$ipartner' 
                  and sa.i_status = '6'
                  and pi.i_type_makloon = '$itypemakloon'
                  ...
                  join tr_material m2 on (sj.i_material2 = m2.i_material)
                  join tr_satuan s2 on (s2.i_satuan_code = m2.i_satuan_code)
                  join tm_price_makloon_supplier_unitjahit pi on (sj.i_material = pi.i_material and sa.pic = pi.i_supplier)
                   where sj.i_permintaan = '$reff'
                  and sa.pic = '$ipartner' 
                  and sa.i_status = '6'
                  and pi.i_type_makloon = '$itypemakloon'
  ...
  public function insertheader($nosjkeluar, $datesjk, $ibagian, $partner, $remark, $dateback, $reff, $datereff, $itypemakloon, $fpkp){
    ...
    $this->db->insert('tm_sjkeluarmakloonaksesoris', $data);
    }
    ...
    $this->db->insert('tm_sjkeluarmakloonaksesoris_detail', $data);
    }
    ...
    $this->db->update('tm_permintaanpengeluaranaks_detail', $data);
    ...
    $this->db->update('tm_sjkeluarmakloonaksesoris', $data);
    }
    ...
    public function baca_header($sj){
      return $this->db->query(" select a.i_sj, to_char(a.d_sj, 'dd-mm-yyyy') as d_sj, to_char(a.d_back, 'dd-mm-yyyy') as d_kembali, a.i_kode_master, a.i_supplier as partner, b.e_supplier_name, a.i_referensi as i_reff, to_char(a.d_referensi, 'dd-mm-yyyy') as d_referensi, a.e_remark, a.i_type_makloon, a.i_status 
                            from tm_sjkeluarmakloonaksesoris a
    ...
    public function deletedetail($nosjkeluar){
        $this->db->query("DELETE FROM tm_sjkeluarmakloonaksesoris_detail WHERE i_sj='$nosjkeluar'");
    }
