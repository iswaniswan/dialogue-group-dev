    ...
    public function data($dfrom,$dto,$iarea,$folder,$imenu){
        ...
        $datatables->add('action', function ($data) {
            ...
            if(check_role($i_menu, 2)||check_role($i_menu, 3)){
                $data .= "<a href=\"#\" onclick='show(\"$folder/cform/edit/$i_sj/$i_area/$i_spb/$dfrom/$dto/$areax/\",\"#main\"); return false;'><i class='fa fa-pencil'></i></a>&nbsp;&nbsp;";
            }
            return $data;
        });
