...
class Mmaster extends CI_Model {
  ...
  function data($folder, $i_menu, $dfrom, $dto){
    ...
    $datatables = new Datatables(new CodeigniterAdapter);
        $datatables->query("   
          ...
          from tm_adjustment_bahanpembantu a
  ...
  public function runningnumber($thbl,$tahun,$ibagian) {
        ...
        $cek = $this->db->query("
            ...
            FROM tm_adjustment_bahanpembantu
            WHERE i_status <> '5'
  ...
  public function cek_kode($kode,$ibagian) {
      ...
      $this->db->from('tm_adjustment_bahanpembantu');
  ...
  function bacagudang($ilevel, $idepart, $lokasi, $username, $idcompany){
    ...
    public function simpan($id,$idocument,$ddocument,$ibagian,$eremarkh)
    {
        ...
        $this->db->insert('tm_adjustment_bahanpembantu', $data);
    }
    ...
    public function simpandetail($id,$imaterial,$nquantity,$eremark)
    {
        ...
        $this->db->insert('tm_adjustment_bahanpembantu_item', $data);
    }
    ...
    public function dataeditdetail($id) {
        return $this->db->query("
            SELECT
              ...
              a.e_remark
            FROM tm_adjustment_bahanpembantu_item a
    ...
    public function updateheader($id,$idocument,$ddocument,$ibagian,$eremarkh)
    {
        ...
        $this->db->where('id', $id);
        $this->db->update('tm_adjustment_bahanpembantu', $data);
    }

    public function deletedetail($id){
        $this->db->query("DELETE FROM tm_adjustment_bahanpembantu_item WHERE id_adjustment='$id'", false);
    }
