...
class Mmaster extends CI_Model {
	...
	function data($i_menu){
        ...
        $datatables->query("
                        Select 
                            a.i_product, 
                            a.e_product_name, 
                            b.e_product_statusname, 
                            '$i_menu' as i_menu 
                        from 
                            tr_product a 
                        left join 
                            tr_product_status b on (a.i_product_status=b.i_product_status)");
		$datatables->add('action', function ($data) {
            $i_product = trim($data['i_product']);
            $i_menu = $data['i_menu'];
            $data = '';
            if(check_role($i_menu, 2)){
                $data .= "<a href=\"#\" onclick='show(\"productbase/cform/view/$i_product/\",\"#main\"); return false;'><i class='fa fa-eye'></i></a>&nbsp;&nbsp;";
            }
            if(check_role($i_menu, 3)){
                $data .= "<a href=\"#\" onclick='show(\"productbase/cform/edit/$i_product/\",\"#main\"); return false;'><i class='fa fa-pencil'></i></a>";
            }
			return $data;
        });
	...
	public function insert($iproduct, $iproductsupplier, $isupplier, $iproductstatus, 
    ...
    $dproductstopproduction, $dproductregister, $iproductseri){
    ...
    $this->db->insert('tr_product', $data);
    }
    ...
    public function update($iproduct, $iproductsupplier, $isupplier, $iproductstatus, 
                            $iproducttype, $iproductcategory, $iproductclass, $iproductgroup,$eproductname,
                            $eproductsuppliername, $vproductretail, $vproductmill, $fproductpricelist,
