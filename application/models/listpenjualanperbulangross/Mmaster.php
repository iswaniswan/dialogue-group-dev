...
class Mmaster extends CI_Model {
    ...
    public function bacaperiode($dfrom,$dto,$iarea,$interval){
        ...
        if($iarea=='NA'){
            ...
            switch ($bl){
                case '01' :
                $sql.=" sum(b.notajan) as notajangross, sum(b.notafeb) as notafebgross, sum(b.notamar) as notamargross, sum(b.notaapr) as notaaprgross, sum(b.notamay) as notamaygross, sum(b.notajun) as notajungross, sum(b.notajul) as notajulgross, sum(b.notaaug) as notaauggross, sum(b.notasep) as notasepgross, sum(b.notaoct) as notaoctgross, sum(b.notanov) as notanovgross, sum(b.notades) as notadesgross ";
                break;
                case '02' :
                $sql.=" sum(b.notajan) as notajangross, sum(b.notafeb) as notafebgross, sum(b.notamar) as notamargross, sum(b.notaapr) as notaaprgross, sum(b.notamay) as notamaygross, sum(b.notajun) as notajungross, sum(b.notajul) as notajulgross, sum(b.notaaug) as notaauggross, sum(b.notasep) as notasepgross, sum(b.notaoct) as notaoctgross, sum(b.notanov) as notanovgross, sum(b.notades) as notadesgross ";
                break;
            ...
            switch ($bl){
                case '01' :
                $sql.=" sum(b.notajan) as notajangross, sum(b.notafeb) as notafebgross, sum(b.notamar) as notamargross, 
                sum(b.notaapr) as notaaprgross, sum(b.notamay) as notamaygross, sum(b.notajun) as notajungross, 
                sum(b.notajul) as notajulgross, sum(b.notaaug) as notaauggross, sum(b.notasep) as notasepgross, 
                sum(b.notaoct) as notaoctgross, sum(b.notanov) as notanovgross, sum(b.notades) as notadesgross";
                break;
                case '02' :
                $sql.=" sum(b.notajan) as notajangross, sum(b.notafeb) as notafebgross, sum(b.notamar) as notamargross, 
                sum(b.notaapr) as notaaprgross, sum(b.notamay) as notamaygross, sum(b.notajun) as notajungross, 
