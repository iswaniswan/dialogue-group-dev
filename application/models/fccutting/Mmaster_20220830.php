    ...
    */
    ...
    public function datareferensi($folder, $i_menu, $dfrom, $dto)
    {
        ...
        $datatables->query("WITH CTE AS (SELECT
                ...
                c.e_bagian_name, e_remark, a.i_bagian, '$i_menu' AS i_menu, '$folder' AS folder,
            ...
            SELECT id, i, i_document, d_document, i_periode, tahun, bulan, e_bagian_name, e_remark, i_bagian, 
    ...
    public function insert_detail($id_forecast, $id_product_wip, $n_sisa_schedule_berjalan, $n_schedule_jahit, $n_stb_pengadaan, $n_stock_pengadaan, $n_stock_pengesetan, $n_sisa_permintaan_cutting, $n_kondisi_stock, $n_fc_produksi_perhitungan, $n_up_cutting, $n_fc_cutting, $e_remark)
    {
        $data = array(
            'id_company' => $this->id_company,
            'id_forecast' => $id_forecast,
    ...
    public function update_detail($id_forecast, $id_product_wip, $n_sisa_schedule_berjalan, $n_schedule_jahit, $n_stb_pengadaan, $n_stock_pengadaan, $n_stock_pengesetan, $n_sisa_permintaan_cutting, $n_kondisi_stock, $n_fc_produksi_perhitungan, $n_up_cutting, $n_fc_cutting, $e_remark)
    {
        $data = array(
            'n_sisa_schedule_berjalan' => $n_sisa_schedule_berjalan,
            'n_schedule_jahit' => $n_schedule_jahit,
