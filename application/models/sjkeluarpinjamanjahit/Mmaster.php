...
class Mmaster extends CI_Model {
  ...
  public function cek_kode($kode,$ibagian) {
      ...
      $this->db->from('tm_keluar_pinjamanjahit');
  ...
  public function insertheader($id, $idocument, $datedocument, $ibagian, $dateback, $idpartner, $epartner, $ireff, $eremarkh){
      ...
      $this->db->insert('tm_keluar_pinjamanjahit', $data);
  }
  ...
  public function insertdetail($id, $idproduct, $nquantity, $edesc){
      ...
      $this->db->insert('tm_keluar_pinjamanjahit_item', $data);
  }
  ...
  public function dataeditdetail($id) {
      return $this->db->query("
                                  SELECT
                                     a.id_product,
                                     c.i_product_wip as i_product,
                                     c.e_product_wipname as e_product,
                                     d.id as id_color,
                                     c.i_color,
                                     d.e_color_name,
                                     a.n_quantity, 
  ...
  public function updateheader($id, $idocument, $datedocument, $ibagian, $dateback, $idpartner, $epartner, $ireff, $eremarkh){
      ...
      $this->db->update('tm_keluar_pinjamanjahit', $data);
  }

  public function deletedetail($id){
      $idcompany = $this->session->userdata('id_company');
      $this->db->query("DELETE FROM tm_keluar_pinjamanjahit_item WHERE id_document='$id' AND id_company = '$idcompany'", false);
  }
