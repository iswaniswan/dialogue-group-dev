...
class Mmaster extends CI_Model {
  ...
  public function cek_kode($kode,$ibagian){
        ...
        $this->db->from('tm_keluar_pinjamanbp');
  ...
  public function partner($cari){
      return $this->db->query("    
                                ...
                                FROM
                                  tr_supplier a   
                                JOIN tm_memo_bp b ON a.id = b.id_partner AND a.id_company = b.id_company            
                                WHERE
                                    a.f_status = 't'
                                    AND b.id_jenis = '3'
  ...
  public function changestatus($id,$istatus){
        ...
        if ($istatus=='6') {
            $query = $this->db->query("
                ...
                FROM tm_keluar_pinjamanbp_item
        ...
        $this->db->update('tm_keluar_pinjamanbp', $data);
  }
  ...
  public function insertheader($id, $ibagian, $ikeluar, $datekeluar, $dateback, $imemo, $idpartner, $ipartner, $idpic, $epic, $eremark){
        ...
        $this->db->insert('tm_keluar_pinjamanbp', $data);
  }
  ...
  public function insertdetail($id, $imaterial, $nquantitymemo, $nsisa, $nquantity, $edesc, $imemo){               
        ...
        $this->db->insert('tm_keluar_pinjamanbp_item', $data);
  }
  ...
  public function baca_detail($id){
      return $this->db->query("
                                SELECT DISTINCT
                                   ...
                                   a.e_remark 
                                FROM
                                   tm_keluar_pinjamanbp_item a 
                                   JOIN
                                      tm_keluar_pinjamanbp b 
  ...
  public function updatedetail($id, $imaterial, $nquantitymemo, $nsisa, $nquantity, $edesc, $imemo){     
        ...
        $this->db->update('tm_keluar_pinjamanbp_item', $data);
  }
}
