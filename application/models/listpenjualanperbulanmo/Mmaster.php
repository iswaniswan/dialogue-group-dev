...
class Mmaster extends CI_Model {
    ...
    public function bacaperiode($dfrom,$dto,$iarea,$interval){
        ...
        if($iarea=='NA'){
            ...
            a.i_area, b.i_city, to_number(to_char(a.d_nota, ''mm''), ''99'') as bln, sum(a.v_nota_gross) AS jumlah
            FROM tm_nota a, tr_customer b, tr_city c, tr_area d, tr_customer_class e,tm_spb i
            ...
            and a.i_spb=i.i_spb and a.i_area=i.i_area and i.f_spb_consigment=''t''
