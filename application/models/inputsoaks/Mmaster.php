...
class Mmaster extends CI_Model {
    ...
    public function runningid() {
        ...
        $this->db->from('tm_stockopname_aks');
    ...
    public function datadetail($idcompany, $ddocument, $ibagian) {
          ...
          return $this->db->query("             
                                    SELECT
                                       ...
                                       '' as e_remark 
                                    FROM
                                       f_mutasi_saldoawal_aks('$id_company', '$i_periode', '$d_jangka_awal', '$d_jangka_akhir', '$dfrom', '$dto', '$ibagian') x 
                                       INNER JOIN
                                          tr_material a 
    ...
    public function simpan($id,$idcompany,$ibagian,$idocument,$ddocument,$iperiode, $eremarkh){
          ...
          $this->db->insert('tm_stockopname_aks', $data);
    }
    ...
    public function simpandetail($idcompany, $id, $idmaterial, $qty, $eremark){
      ...
      $this->db->insert('tm_stockopname_aks_item', $data);
    }
    ...
    public function changestatus($id, $istatus){
        ...
        $this->db->where('id', $id);
        $this->db->where('id_company', $this->session->userdata('id_company'));
        $this->db->update('tm_stockopname_aks', $data);
    }
