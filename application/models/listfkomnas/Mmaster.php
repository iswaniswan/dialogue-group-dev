...
//    public function data($dfrom, $dto, $isupplier, $folder, $iperiode, $title){
    public function data($dfrom, $dto, $imenu,$folder){
        ...
        $datatables->add('action', function ($data) {
            ...
            if(check_role($i_menu, 4)){
                $data .= "<a href=\"#\" onclick='cancel(\"$inota\"); return false;'><i class='fa fa-trash'></i></a>&nbsp;&nbsp;";
            }
    ...
    function bacanota($inota,$ispb,$area){
        $query = $this->db->query(" 
                                SELECT 
                                    ...
                                    tm_nota.i_sj, to_char(tm_nota.d_sj,'dd-mm-yyyy') as d_sj,
