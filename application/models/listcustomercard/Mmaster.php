...
class Mmaster extends CI_Model {
    ...
    public function bacaperiode($dfrom,$dto,$iarea,$interval){
        ...
        if($iarea=='NA'){
            $sql="a.nama, a.kode, a.alamat, a.kota, a.area, a.supplier, a.jenis, a.iarea, a.icity, a.product, a.productname, a.group, ";
            switch ($bl){
                case '01' :
            ...
            $sql.=" from ( select isi[1] as nama, isi[8] as kode, isi[9] as product, isi[2] as alamat, isi[3] as kota, 
            isi[4] as area, isi[5] as jenis, isi[6] as iarea, isi[7] as icity, isi[11] as supplier, isi[10] as productname, isi[13] as group, ";
            switch ($bl){
                case '01' :
            ...
            ('SELECT Array [b.e_customer_name::text, b.e_customer_address::text, c.e_city_name::text, d.e_area_name::text, e.e_customer_classname::text, a.i_area::text, b.i_city::text, a.i_customer::text, f.i_product::text, f.e_product_name, h.e_supplier_name::text, g.i_supplier::text, i.e_product_groupname::text] as isi, to_number(to_char(a.d_nota, ''mm''),''99'') as bln, 
            ...
            i.e_product_groupname, to_char(a.d_nota, ''mm'')
            ...
            $sql.=" ) as a
            group by a.iarea, a.icity, a.group, a.nama, a.kode, a.alamat, a.kota, a.area, a.supplier, a.jenis, a.product, a.productname
            order by a.iarea, a.icity, a.group, a.kode, a.nama, a.alamat, a.kota, a.area, a.supplier, a.jenis, a.product, a.productname";
        }else{
            $sql=" a.nama, a.kode, a.alamat, a.kota, a.area, a.supplier, a.jenis, a.iarea, a.icity, a.product, a.productname, a.group, ";
            switch ($bl){
                case '01' :
            ...
            $sql.=" from crosstab
            ('SELECT Array [b.e_customer_name::text, b.e_customer_address::text, c.e_city_name::text,
            d.e_area_name::text, e.e_customer_classname::text, a.i_area::text, b.i_city::text, a.i_customer::text, f.i_product::text, 
            f.e_product_name, h.e_supplier_name::text, g.i_supplier::text, i.e_product_groupname::text] as isi, 
            to_number(to_char(a.d_nota, ''mm''),''99'') as bln, sum(f.n_deliver) AS jumlah
            FROM tm_nota a, tr_customer b, tr_city c, tr_area d, tr_customer_class e, tm_nota_item f, tr_product g, tr_supplier h,
            tr_product_group i, tr_product_type j
            WHERE a.f_nota_cancel = false AND b.i_customer = a.i_customer and a.f_nota_cancel=''f'' AND a.i_sj=f.i_sj AND 
            a.i_area=f.i_area AND a.i_area=''$iarea'' AND NOT a.i_nota IS NULL and b.i_city=c.i_city and b.i_area=c.i_area 
            and b.i_area=d.i_area AND b.i_customer_class=e.i_customer_class AND f.i_product=g.i_product AND g.i_supplier=h.i_supplier
            AND (a.d_nota >= to_date(''$dfrom'',''dd-mm-yyyy'') AND a.d_nota <= to_date(''$dto'',''dd-mm-yyyy''))
            AND g.i_product_type=j.i_product_type AND i.i_product_group=j.i_product_group
            GROUP BY b.e_customer_name, a.i_customer, b.e_customer_address, c.e_city_name, d.e_area_name, 
            ...
            $sql.=" ) as a
            group by a.iarea, a.icity, a.group, a.nama, a.kode, a.alamat, a.kota, a.area, a.supplier, a.jenis, a.product, a.productname
            order by a.iarea, a.icity, a.group, a.nama, a.alamat, a.kota, a.area, a.supplier, a.jenis, a.kode, a.product, a.productname";
        }
