...
class Mmaster extends CI_Model {
 ...
 public function referensi($cari, $idpartner, $ipartner, $ipartnergroup){
  ...
  public function getdetailrefitem($id){
    return $this->db->query("
                            SELECT
                            	a.id,
                            	b.id_document,
                            	b.id_product as id_material,
                            	c.i_product_base as i_material,
                            	c.e_product_basename as e_material_name,
                            	b.n_quantity,
                            	b.n_quantity_sisa
                            FROM
                            	tm_keluar_pinjamangj a
  ...
  public function runningid(){
    ...
    $this->db->from('tm_masuk_pinjamangj');
  ...
  public function cek_kodeedit($kode,$kodeold, $ibagian) {
    ...
    public function insertheader($id, $ibagian, $ikeluar, $datekeluar, $imemo, $ipartner, $eremark){
      $idcompany = $this->session->userdata('id_company');  
        ...
        $this->db->insert('tm_masuk_pinjamangj', $data);
    }
    ...
    public function insertdetail($id, $imaterial,$nquantity, $edesc, $imemo){             
      $idcompany = $this->session->userdata('id_company');  
        ...
        $this->db->insert('tm_masuk_pinjamangj_item', $data);
    }
    ...
    public function baca_detail($id){
        return $this->db->query("
                                SELECT 
                                	...
                                	a.id_document,
                                	c.id_document,
                                	a.id_product_base as id_material,
                                	d.i_product_base as i_material, 
                                	d.e_product_basename as e_material_name,
                                    a.n_quantity,
                                    c.n_quantity as qty_masuk,
                                    c.n_quantity_sisa,
                                    a.e_remark
                                FROM
                                	tm_masuk_pinjamangj_item a
                                	LEFT JOIN 
                                		tm_masuk_pinjamangj b
    ...
    public function updateheader($id, $ikeluar, $ibagian, $datekeluar, $eremark){
      ...
      $this->db->where('id', $id);
      $this->db->update('tm_masuk_pinjamangj', $data);
    }
    ...
    public function updatedetail($id, $imaterial,$nquantity, $edesc){
      ...
      $this->db->where('id_product_base', $imaterial);
      $this->db->update('tm_masuk_pinjamangj_item', $data);
    }
