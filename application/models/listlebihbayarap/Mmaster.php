...
//    public function data($dfrom, $dto, $isupplier, $folder, $iperiode, $title){
    public function data($isupplier, $folder, $iperiode, $title){
        $datatables = new Datatables(new CodeigniterAdapter);
        
			    $datatables->query("
                select a.supplier, a.i_alokasi, a.d_alokasi, a.v_jumlah, a.v_lebih,
                '$folder' AS folder,
                '$isupplier' AS isupplier,
                '$iperiode' AS iperiode,
                '$title' AS title
                from(
                    select '('||a.i_supplier||') '|| b.e_supplier_name as supplier, a.i_pelunasanap as i_alokasi, a.d_bukti as d_alokasi, a.v_jumlah, a.v_lebih
                    ...
                    union all
                    select '('||a.i_supplier||') '|| b.e_supplier_name as supplier, a.i_alokasi, a.d_alokasi, a.v_jumlah, a.v_lebih
