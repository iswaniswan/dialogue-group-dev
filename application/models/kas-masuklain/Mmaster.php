...
class Mmaster extends CI_Model {
    ...
    function data($i_menu, $folder, $dfrom, $dto){
        ...
        $datatables->query("   
                                SELECT DISTINCT 
                                    ...
                                    string_agg(DISTINCT  
                                    CASE
                                        WHEN a.e_partner_type = 'customer' THEN  f.e_customer_name
                                        WHEN a.e_partner_type = 'pic' THEN g.e_nama_karyawan
        ...
        $datatables->edit('e_partner_name', function ($data) {
            return '<span>'.str_replace("}", "", str_replace("{", "", str_replace(",", "<br>", $data['e_partner_name']))).'</span>';
        });
    ...
    public function cek_kode($kode,$ibagian){
        ...
        $this->db->from('tm_kas_masuklain_nonpiutang');
    ...
    public function runningnumber($thbl, $tahun, $ibagian){
        $cek = $this->db->query("
                ...
                FROM tm_kas_masuklain_nonpiutang
                WHERE i_status <> '5'
    ...
    function insertheader($id, $idocument, $datedocument, $ibagian, $idkasbank, $ibank, $epartnertype, $vnilai, $eremark){
      ...
      $this->db->insert('tm_kas_masuklain_nonpiutang', $data);
    }
    ...
    function insertdetail($id, $idpartner, $epartner, $vvalue, $edesc){
      ...
      $this->db->insert('tm_kas_masuklain_nonpiutang_item', $data);
    }
    ...
    public function changestatus($id, $istatus){
        ...
        $this->db->update('tm_kas_masuklain_nonpiutang', $data);
    }
    ...
    public function cek_partner($id, $epartnertype){
        return $this->db->query("
                                  SELECT
                                     ...
                                     END AS e_partner_name
                                  FROM
                                     tm_kas_masuklain_nonpiutang_item a 
                                     INNER JOIN 
  ...
  function deletedetail($id){
      $idcompany    = $this->session->userdata('id_company'); 
      return $this->db->query("DELETE FROM tm_kas_masuklain_nonpiutang_item WHERE id_document = '$id' AND id_company = '$idcompany'", FALSE);
  }
}
