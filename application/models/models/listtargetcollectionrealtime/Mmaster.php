...
class Mmaster extends CI_Model {
    ...
    function baca($iperiode,$akhir, $iuser)
    {
#      $this->db->SELECT("* FROM f_target_collection_rekapkodearea('$iperiode','$akhir');",false);
    ...
    function detail($iarea,$iperiode,$akhir)
    {
    ...
    function detailsales($iperiode,$akhir)
    {
      return $this->db->query("SELECT	a.i_salesman, a.e_salesman_name, sum(total) AS total, sum(realisasi) AS realisasi, sum(totalnon) AS totalnon, 
                          ...
                          FROM f_target_collection_rekapkodealokasi('$iperiode','$akhir') b
                          WHERE b.f_insentif='t' AND substring(b.kelompok,1,2)='02'
                          GROUP BY b.i_salesman, b.e_salesman_name
                          ) AS x
                          ...
                          FROM f_target_collection_rekapkodealokasi('$iperiode','$akhir') b
                          WHERE b.f_insentif='t' AND substring(b.kelompok,1,2)='00'
                          GROUP BY b.i_salesman, b.e_salesman_name, b.i_nota
                          ) AS c, f_target_collection_rekapkodealokasi('$iperiode','$akhir') b
                          WHERE b.f_insentif='t' AND b.i_nota=c.i_nota
                          GROUP BY b.i_salesman, b.e_salesman_name
                          ...
                          SELECT b.i_salesman, b.e_salesman_name, b.i_nota
                          FROM f_target_collection_rekapkodealokasi('$iperiode','$akhir') b
                          WHERE b.f_insentif='t' AND substring(b.kelompok,1,2)='01'
                          GROUP BY b.i_salesman, b.e_salesman_name, b.i_nota
                          ) AS c, f_target_collection_rekapkodealokasi('$iperiode','$akhir') b
                          WHERE b.f_insentif='t' AND b.i_nota=c.i_nota
                          GROUP BY b.i_salesman, b.e_salesman_name
    ...
    function detaildivisi($iarea,$iperiode,$akhir)
    {
/*
...
*/
      $this->db->SELECT("	a.i_area, a.e_area_name, a.i_nota, a.i_product_group, a.e_product_groupname, a.d_jatuh_tempo,   
                          ...
                          FROM (
                          SELECT a.i_area, a.e_area_name, b.i_nota, b.v_target_tagihan AS v_target_tagihan, 
                          b.v_realisasi_tagihan AS v_realisasi_tagihan
                          FROM 
                          tr_area a
                          LEFT JOIN f_target_collection_rekapkodealokasi('$iperiode','$akhir') b on(a.i_area=b.i_area)
                          WHERE a.f_area_real='t' AND b.e_periode='$iperiode' AND b.f_insentif='t'
