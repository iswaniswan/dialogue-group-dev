...
class Mmaster extends CI_Model {
    ...
    public function cek_kode($kode,$ibagian)
    {
        ...
        $this->db->from('tm_keluar_makloon_pengadaan');
    ...
    public function runningnumber($thbl,$tahun,$ibagian)
    {
        $cek = $this->db->query("
            ...
            FROM tm_keluar_makloon_pengadaan 
            WHERE i_status <> '5'
    ...
    public function simpan($id,$idocument,$ddocument,$ibagian,$ipartner,$eremarkh)
    {
        ...
        $this->db->insert('tm_keluar_makloon_pengadaan', $data);
    }
    ...
    public function simpandetail($id,$idproductwip,$idmaterial,$nquantity,$eremark,$nquantitywip1,$eremarkwip1)
    {
        ...
        $this->db->insert('tm_keluar_makloon_pengadaan_item', $data);
    }
    ...
    public function dataeditdetail($id)
    {
        return $this->db->query("
                                    SELECT
                                        ...
                                        d.e_color_name
                                    FROM
                                        tm_keluar_makloon_pengadaan_item a
    ...
    public function update($id,$idocument,$ddocument,$ibagian,$ipartner,$eremarkh)
    {
        ...
        $this->db->where('id', $id);
        $this->db->update('tm_keluar_makloon_pengadaan', $data);
    }
/* 
    public function updatedetail($id,$idproductwip,$idmaterial,$nquantity,$eremark,$nquantitywip1,$eremarkwip1)
    {
        ...
        $this->db->where('id', $id);
        $this->db->update('tm_keluar_makloon_pengadaan_item', $data);
    } */
    ...
    public function delete($id)
    {
        ...
        $this->db->delete('tm_keluar_makloon_pengadaan_item');
    }
        ...
        if ($istatus=='3' || $istatus== '6') {
            ...
            if ($istatus == '3') {
                ...
                $this->db->query("INSERT INTO tm_menu_approve (i_menu,i_level,i_document,e_approve,d_approve,e_database) VALUES
                    ('$this->i_menu','$this->i_level','$id','$this->username','$now','tm_keluar_makloon_pengadaan');", FALSE);
            }
        } else{
            $data = array(
                'i_status'  => $istatus,
