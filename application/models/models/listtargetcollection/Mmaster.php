...
#      $this->db->SELECT("* FROM f_target_collection_rekapkodearea('$iperiode','$akhir');",false);
    ...
    function detail($iarea,$iperiode)
    {
      return $this->db->query(" SELECT a.i_area, a.e_area_name, a.i_customer, a.e_customer_name, a.e_customer_classname, a.i_salesman, a.e_salesman_name, 
                                ...
                                from tr_area a
                                left join tm_collection_item b on(a.i_area=b.i_area)
                                where a.f_area_real='t' and b.e_periode='$iperiode' and b.f_insentif='t' and b.i_area='$iarea'
                                ...
                                from tr_area a
                                left join tm_collection_item b on(a.i_area=b.i_area)
                                where a.f_area_real='t' and b.e_periode='$iperiode' and b.f_insentif='f' and b.i_area='$iarea'
                                group by a.i_area, a.e_area_name, b.i_customer, b.e_customer_name, b.e_customer_classname, b.i_salesman, 
                                b.e_salesman_name, b.i_nota, b.d_nota
                                union all
                                ...
                                left join tm_collection_item b on(a.i_area=b.i_area)
                                where a.f_area_real='t' and b.e_periode='$iperiode' and b.f_insentif='t' and a.i_area=c.i_area 
                                and b.i_area='$iarea' and b.i_nota=c.i_nota
                                group by a.i_area, a.e_area_name, b.i_customer, b.e_customer_name, b.e_customer_classname, b.i_salesman, 
    ...
    function detailsales($iarea,$iperiode)
    {
      return $this->db->query("SELECT	a.i_salesman, a.e_salesman_name, sum(total) as total, sum(realisasi) as realisasi, sum(totalnon) as totalnon, 
                                ...
                                where b.e_periode='$iperiode' and b.f_insentif='t' and b.i_area='$iarea'
                                ...
                                0 as realisasitdktelat, 0 as realisasitelat
                                from tm_collection_item b
                                where b.e_periode='$iperiode' and b.f_insentif='f' and b.i_area='$iarea'
                                group by b.i_salesman, b.e_salesman_name
                                union all
                                ...
                                from tm_collection_item b
                                where b.e_periode='$iperiode' and b.f_insentif='t' and substring(b.e_kelompok,1,2)='02' and b.i_area='$iarea'
                                group by b.i_salesman, b.e_salesman_name
                                ) as x
                                ...
                                from tm_collection_item b
                                where b.e_periode='$iperiode' and b.f_insentif='t' and substring(b.e_kelompok,1,2)='00' and b.i_area='$iarea'
                                ...
                                select b.i_salesman, b.e_salesman_name, b.i_nota
                                from tm_collection_item b
                                where b.e_periode='$iperiode' and b.f_insentif='t' and substring(b.e_kelompok,1,2)='01' and b.i_area='$iarea'
                                group by b.i_salesman, b.e_salesman_name, b.i_nota
                                ) as c, tm_collection_item b
                                where b.e_periode='$iperiode' and b.f_insentif='t' and b.i_nota=c.i_nota and b.i_area='$iarea'
                                group by b.i_salesman, b.e_salesman_name
    ...
    {
      return $this->db->query(" SELECT a.i_area, a.e_area_name, a.i_nota, a.i_customer, a.e_customer_name, a.i_product_group, a.e_product_groupname, a.d_jatuh_tempo, to_char(a.d_jatuh_tempo_plustoleransi, 'yyyy-mm-dd') as d_jatuh_tempo_plustoleransi, sum(a.total) as total, sum(a.realisasi) as realisasi, sum(a.totalnon) as totalnon, sum(a.realisasinon) as realisasinon, sum(blmbayar) as blmbayar, sum(tdktelat) as tdktelat, sum(telat) as telat, sum(realisasitdktelat) as realisasitdktelat, sum(realisasitelat) as realisasitelat from
                                (
                                select a.i_area, a.e_area_name, b.i_nota, b.i_customer, b.e_customer_name, b.i_product_group, c.e_product_groupname, b.d_jatuh_tempo, b.d_jatuh_tempo_plustoleransi, b.v_target_tagihan as total, b.v_realisasi_tagihan as realisasi, 0 as totalnon, 0 as realisasinon, 0 as blmbayar, 0 as tdktelat, 0 as telat, 0 as realisasitdktelat, 0 as realisasitelat
                                from tr_area a
                                left join tm_collection_item b on(a.i_area=b.i_area)
                                ...
                                union all
                                select a.i_area, a.e_area_name, b.i_nota, b.i_customer, b.e_customer_name, b.i_product_group, c.e_product_groupname, b.d_jatuh_tempo, b.d_jatuh_tempo_plustoleransi, 0 as total, 0 as realisasi, b.v_target_tagihan as totalnon, b.v_realisasi_tagihan as realisasinon, 0 as blmbayar, 0 as tdktelat, 0 as telat, 0 as realisasitdktelat, 0 as realisasitelat
                                from tr_area a
                                left join tm_collection_item b on(a.i_area=b.i_area)
                                left join tr_product_group c on (b.i_product_group=c.i_product_group)
                                ...
                                union all
                                select x.i_area, x.e_area_name, x.i_nota, x.i_customer, x.e_customer_name, x.i_product_group, x.e_product_groupname, x.d_jatuh_tempo, x.d_jatuh_tempo_plustoleransi, 0 as total, 0 as realisasi, 0 as totalnon, 0 as realisasinon, x.v_target_tagihan as blmbayar, 0 as tdktelat, 0 as telat, 0 as realisasitdktelat, 0 as realisasitelat
                                from (
                                select a.i_area, a.e_area_name, b.i_nota, b.i_customer, b.e_customer_name, b.i_product_group, c.e_product_groupname, b.d_jatuh_tempo, b.d_jatuh_tempo_plustoleransi, 0 as total, 0 as realisasi, 0 as totalnon, 0 as realisasinon, b.v_target_tagihan, 0 as tdktelat, 0 as telat, 0 as realisasitdktelat, 0 as realisasitelat
                                from 
                                tr_area a
                                left join tm_collection_item b on(a.i_area=b.i_area)
                                left join tr_product_group c on (b.i_product_group=c.i_product_group)
                                ...
                                group by a.i_area, a.e_area_name, a.i_nota, a.i_product_group, a.e_product_groupname, a.d_jatuh_tempo, a.d_jatuh_tempo_plustoleransi,  a.i_customer, a.e_customer_name
