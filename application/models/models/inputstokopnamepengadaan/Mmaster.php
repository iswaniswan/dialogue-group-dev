...
class Mmaster extends CI_Model {
          ...
          $datatables->add('action', function ($data) {
              ...
              if (check_role($i_menu, 3)) {
                  if ($i_status == '1'|| $i_status == '2' || $i_status == '3' || $i_status == '7') {
                      $data         .= "<a href=\"#\" title='Edit' onclick='show(\"$folder/cform/edit/$id/$dfrom/$dto\",\"#main\"); return false;'><i class='ti-pencil-alt text-primary'></i></a>&nbsp;&nbsp;&nbsp;";
                  }
              }
    ...
    public function datadetail($idcompany, $ddocument, $ibagian) {
          ...
          return $this->db->query(" SELECT
                ...
                '' as e_remark 
            FROM
                f_mutasi_saldoawal_qcset('$id_company', '$i_periode', '$d_jangka_awal', '$d_jangka_akhir', '$dfrom', '$dto', '$ibagian') x 
                INNER JOIN
                    tr_material a 
    ...
    public function simpandetail($idcompany, $id, $idmaterial, $qty, $eremark, $igrade){
          $data = array(
                        'id_company'      => $idcompany,
                        'id_document'     => $id,
