...
class Mmaster extends CI_Model
{
    ...
    public function partner($idtype,$cari)
    {
        return $this->db->query("
            ...
            INNER JOIN tr_supplier b ON
                (b.id = a.id_supplier)
            INNER JOIN tm_keluar_makloon_bp_item d ON
                (d.id_document = a.id)
            WHERE
                d.n_quantity_sisa > 0
    ...
    public function cek_kode($kode,$ibagian)
    {
        ...
        $this->db->from('tm_masuk_makloon_bp');
    ...
    public function datareferensi($cari,$idpartner,$idtype)
    {
        return $this->db->query("            
            ...
            FROM
                tm_keluar_makloon_bp a
            INNER JOIN tm_keluar_makloon_bp_item b ON
                (a.id = b.id_document)
            WHERE 
    ...
    public function detailreferensi($id)
    {
        ...
        return $this->db->query("
            ...
            FROM
                tm_keluar_makloon_bp_item a
            INNER JOIN tm_keluar_makloon_bp aa ON
                (aa.id = a.id_document)
    ...
    public function simpan($id,$idocument,$ddocument,$ibagian,$idtype,$idpartner,$idreff,$eremark)
    {
        ...
        $this->db->insert('tm_masuk_makloon_bp', $data);
    }
    ...
    public function simpandetail($id,$iddocument,$idmaterial,$nqty,$idmateriallist,$nqtylist,$eremark)
    {
        ...
        $this->db->insert('tm_masuk_makloon_bp_item', $data);
    }
    ...
    public function dataeditreferensi($id)
    {
        return $this->db->query("
            ...
            INNER JOIN tm_keluar_makloon_bp b ON
    ...
    public function update($id,$idocument,$ddocument,$ibagian,$idtype,$idpartner,$idreff,$eremark)
    {
        ...
        $this->db->where('id',$id);
        $this->db->update('tm_masuk_makloon_bp', $data);
    }
    ...
    public function delete($id)
    {
        ...
        $this->db->delete('tm_masuk_makloon_bp_item');
    }
    ...
    public function simpanjurnal($id,$title)
    {
        $this->db->query("
            ...
            FROM
                tm_masuk_makloon_bp a
            INNER JOIN tm_masuk_makloon_bp_item b ON
                (b.id_document = a.id)
            WHERE
                a.id = $id
        ", FALSE);
