...
class Mmaster extends CI_Model
{
    ...
    public function partner($idtype,$cari)
    {
        return $this->db->query("
            ...
            INNER JOIN tr_supplier b ON
                (b.id = a.id_supplier)
            INNER JOIN tm_keluar_makloon_ak_item d ON
                (d.id_document = a.id)
            WHERE
                d.n_quantity_sisa > 0
    ...
    public function cek_kode($kode,$ibagian)
    {
        ...
        $this->db->from('tm_masuk_makloon_ak');
    ...
    public function datareferensi($cari,$idpartner,$idtype)
    {
        return $this->db->query("            
            ...
            FROM
                tm_keluar_makloon_ak a
            INNER JOIN tm_keluar_makloon_ak_item b ON
                (a.id = b.id_document)
            WHERE 
    ...
    public function detailreferensi($id)
    {
        ...
        return $this->db->query("
            ...
            FROM
                tm_keluar_makloon_ak_item a
            INNER JOIN tm_keluar_makloon_ak aa ON
                (aa.id = a.id_document)
    ...
    public function simpan($id,$idocument,$ddocument,$ibagian,$idtype,$idpartner,$idreff,$eremark)
    {
        ...
        $this->db->insert('tm_masuk_makloon_ak', $data);
    }
    ...
    public function simpandetail($id,$iddocument,$idmaterial,$nqty,$idmateriallist,$nqtylist,$eremark)
    {
        ...
        $this->db->insert('tm_masuk_makloon_ak_item', $data);
    }
    ...
    public function dataeditreferensi($id)
    {
        return $this->db->query("
            ...
            INNER JOIN tm_keluar_makloon_ak b ON
    ...
    public function update($id,$idocument,$ddocument,$ibagian,$idtype,$idpartner,$idreff,$eremark)
    {
        ...
        $this->db->where('id',$id);
        $this->db->update('tm_masuk_makloon_ak', $data);
    }
    ...
    public function delete($id)
    {
        ...
        $this->db->delete('tm_masuk_makloon_ak_item');
    }
    ...
    public function simpanjurnal($id,$title)
    {
        $this->db->query("
            ...
            SELECT
                ...
                '110-82000' AS i_coa,
                'BAHAN PEMBANTU & ACCESSORIS' AS e_coa,
            ...
            FROM
                tm_masuk_makloon_ak a
            INNER JOIN tm_masuk_makloon_ak_item b ON
                (b.id_document = a.id)
            WHERE
                a.id = $id
        ", FALSE);
