...
class Mmaster extends CI_Model
{
    ...
    public function runningid()
    {
        ...
        $this->db->from('tm_stockopname_unitpacking');
    ...
    public function runningnumber($thbl, $tahun, $ibagian)
    {
        $cek = $this->db->query("SELECT 
            ...
            FROM tm_stockopname_unitpacking
            WHERE i_status <> '5'
    ...
    {
        return $this->db->query("SELECT id FROM tm_stockopname_unitpacking WHERE id_company = '$idcompany'  AND i_bagian = '$ibagian' AND i_document = '$i_document'", FALSE);
    }
    ...
    public function datadetail($idcompany, $ibagian)
    {
        ...
        return $this->db->query(" SELECT 
                ...
                aa.n_quantity ,
                aa.e_remark 
            FROM tm_stockopname_unitpacking a
            INNER JOIN 
                tm_stockopname_unitpacking_item aa
                ON
    ...
    */
    ...
    public function changestatus($id, $istatus)
    {
        if ($istatus == '3' || $istatus == '6') {
            ...
            if ($istatus == '3') {
                ...
                $this->db->query("INSERT INTO tm_menu_approve (i_menu,i_level,i_document,e_approve,d_approve,e_database) VALUES
                    ('$this->i_menu','$this->i_level','$id','$this->username','$now','tm_stockopname_unitpacking');", FALSE);
            }
        } else {
            $data = array(
                'i_status'  => $istatus,
        ...
        $this->db->where('id', $id);
        $this->db->update('tm_stockopname_unitpacking', $data);
    }
    ...
    public function hapusdetail($id)
    {
        ...
        $this->db->delete("tm_stockopname_unitpacking_item");
        // return $this->db->query("DELETE FROM tm_stockopname_unitpacking_item WHERE id_document = '$id'", FALSE);
    }
