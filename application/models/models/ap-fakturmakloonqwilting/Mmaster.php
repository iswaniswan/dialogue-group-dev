...
class Mmaster extends CI_Model
{
    ...
    public function getpartner($cari, $i_menu) {
        return $this->db->query("
                            ...
                            WHERE 
                            	...
                            	AND (a.id NOT IN 
                            	(
                            	  SELECT id_referensi FROM tm_notamakloonquilting WHERE i_status <> '5' AND id_company = '".$this->session->userdata('id_company')."'
                            	)
                            	OR a.i_bagian NOT IN
                            	(
                            	  SELECT i_bagian_referensi FROM tm_notamakloonquilting WHERE i_status <> '5' AND id_company = '".$this->session->userdata('id_company')."'
                            	))
                            ORDER BY 
                            	b.e_supplier_name    
                                ", FALSE);
    ...
    public function cekkode($kode,$ibagian)
    {
        ...
        $this->db->from('tm_notamakloonquilting');
    ...
    public function insertheader($id, $ibagian, $inota, $dnota, $dreceivefaktur, $ipartner, $ireferensi, $dreferensi, $ifaktursup, $dfaktursup, $ipajak, 
        ...
        $this->db->insert('tm_notamakloonquilting', $data);
    }
    ...
    public function insertdetail($id, $idreffmasuk, $idwip, $nquantity, $harga, $hargatotal, $edesc) {
        ...
        $this->db->insert('tm_notamakloonquilting_item', $data);
    }
    ...
    public function updateheader($id, $ibagian, $ipartner, $inota, $dnota, $dreceivefaktur, $ifaktursup, $dfaktursup, $ipajak, 
        ...
        $this->db->update('tm_notamakloonquilting', $data);
    }
    ...
    public function updatedetail($id, $idreffmasuk, $idwip, $nquantity, $harga, $hargatotal, $edesc) {
        ...
        $this->db->where('id_company', $this->session->userdata('id_company'));
        $this->db->update('tm_notamakloonquilting_item', $data);
    }
