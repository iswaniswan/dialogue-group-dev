...
class Mmaster extends CI_Model {
     ...
     $idcompany = $this->session->userdata('id_company');
      ...
      $datatables->query("
                          ...
                          FROM 
                            ...
                            INNER JOIN tm_retur_makloon_unitjahit d
                              ON (a.id_document_reff = d.id AND a.id_company = d.id_company)
                            INNER JOIN tr_status_document e
                              ON (a.i_status = e.i_status)
                            INNER JOIN tr_supplier f 
                              ON (a.id_supplier = f.id AND a.id_company = f.id_company)
                          WHERE 
      ...
      return $this->db->query("
         SELECT DISTINCT
          ...
          FROM
              ...
              LEFT JOIN tm_retur_makloon_unitjahit_item b
                  on (a.id = b.id_document AND a.id_company = b.id_company)
          WHERE
              a.id_supplier = '$ipartner'
              AND a.i_status = '6'
  ...
  public function cek_kode($kode,$ibagian){
      ...
      $this->db->from('tm_retur_masuk_unitjahit');
  ...
  public function getdataitem($idreff, $ipartner){
      return $this->db->query("
                                SELECT  
                                  ...
                                  c.i_product_wip,
                                  c.e_product_wipname,
                                  a.n_quantity as n_quantity_wip,
                                  a.n_quantity_sisa as n_quantity_wip_sisa,
                                  c.i_color, 
                                  e.id as id_color,
                                  e.e_color_name,                               
                                  a.e_remark
                                 FROM
                                  ...
                                  INNER JOIN tm_retur_makloon_unitjahit b
  ...
  function insertheader($id, $idocument, $ibagian, $datedocument, $ipartner, $ireff, $eremark){
      ...
      $this->db->insert('tm_retur_masuk_unitjahit', $data);
  }
  ...
  function insertdetail($id, $ireff, $idproduct, $icolorpro, $nquantitywip, $nquantitywipmasuk, $edesc){
      ...
      $this->db->insert('tm_retur_masuk_unitjahit_item', $data);
  }
  ...
  public function changestatus($id,$istatus){
      ...
      if ($istatus=='6') {
          $query = $this->db->query("
              SELECT 
                ...
                b.id_supplier
              FROM 
                tm_retur_masuk_unitjahit_item a
                INNER JOIN tm_retur_masuk_unitjahit b
                  ON (a.id_document = b.id AND a.id_company = b.id_company)
              WHERE 
                a.id_document = '$id' 
              ", FALSE);
          if ($query->num_rows()>0) {
              foreach ($query->result() as $key) {
                  $this->db->query("
                      UPDATE
                          tm_retur_makloon_unitjahit_item
                      SET
      ...
      $this->db->update('tm_retur_masuk_unitjahit', $data);
  }
  ...
  public function cek_data($id, $ibagian){
      return $this->db->query("
                                ...
                                FROM
                                  ...
                                  INNER JOIN tr_bagian b
                                    ON (a.i_bagian = b.i_bagian AND a.id_company = b.id_company)
                                  INNER JOIN tr_supplier c
                                    ON (a.id_supplier = c.id AND a.id_company = c.id_company)
                                WHERE 
                                  a.id  = '$id'
  ...
  public function cek_datadetail($id, $ibagian){
      return $this->db->query("
                                SELECT
                                  ...
                                  c.i_product_wip,
                                  c.e_product_wipname,
                                  a.n_quantity as n_quantity_wip_masuk,
                                  f.n_quantity as n_quantity_wip_keluar,
                                  f.n_quantity_sisa as n_quantity_wip_sisa,
                                  c.i_color,
                                  e.id as id_color,
                                  e.e_color_name,
                                  a.e_remark
                                FROM
                                  tm_retur_masuk_unitjahit_item a 
                                  INNER JOIN 
                                    tm_retur_masuk_unitjahit b
                                    ON (a.id_document = b.id AND a.id_company = b.id_company)
                                  INNER JOIN 
                                    tm_retur_makloon_unitjahit_item f
  ...
  public function updatedetail($id, $ireff, $idproduct, $icolorpro, $nquantitywip, $nquantitywipmasuk, $edesc){
      ...
      $this->db->where('id_company', $this->idcompany);
      $this->db->update('tm_retur_masuk_unitjahit_item', $data);
  }
}
