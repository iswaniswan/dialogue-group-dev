...
class Mmaster extends CI_Model{
	...
	function data($i_menu){
        ...
        $datatables->query(" SELECT a.i_customer, a.i_customer_groupbayar, '$i_menu' AS i_menu 
		...
		$datatables->add('action', function ($data) {
            ...
            if(check_role($i_menu, 2)){
                $data .= "<a href=\"#\" onclick='show(\"customergroupbayar/cform/view/$i_customer/\",\"#main\"); return false;'><i class='fa fa-eye'></i></a>&nbsp;&nbsp;";
            }
            if(check_role($i_menu, 3)){
                $data .= "<a href=\"#\" onclick='show(\"customergroupbayar/cform/edit/$i_customer/\",\"#main\"); return false;'><i class='fa fa-pencil'></i></a>";
            }
	...
	function cek_data($icustomer){
		$this->db->select('a.i_customer, e_customer_name, i_customer_groupbayar as i_group');
        $this->db->from('tr_customer_groupbayar a');
	...
	public function insert($icustomer, $igroup){
        /*********INSERT KE GROUPBAYAR*********/    
            $data = array(
                'i_customer' 	        => $icustomer,
                'i_customer_groupbayar' => $igroup,
        );
            $this->db->insert('tr_customer_groupbayar', $data);
