...
//    public function data($dfrom, $dto, $iarea, $folder, $iperiode, $title){
    public function data($dfrom, $dto, $iarea, $folder, $iperiode, $title){
        ...
        if($iarea == "NA"){
          $datatables->query("
            SELECT	b.e_area_name, a.i_alokasi, a.d_alokasi, a.i_kbank, a.i_customer, c.e_customer_name, a.v_jumlah, a.f_alokasi_cancel,
        ...
        $datatables->add('action', function ($data) {
            ...
            $data       = '';
            $data      .= "<a href=\"#\" onclick='show(\"$folder/cform/proses/$ialokasi/$dalokasi/$iarea/$dfrom/$dto\",\"#main\"); return false;'><i class='fa fa-pencil'></i></a>";
            if ($fcancel!='t' && $iperiode<=$dperiode) {
                $data  .= "<a href=\"#\" onclick='hapus(\"$ialokasi\",\"$iarea\"); return false;'><i class='fa fa-trash'></i></a>";
            }
            return $data;
        });
