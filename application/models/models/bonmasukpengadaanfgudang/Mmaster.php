...
class Mmaster extends CI_Model {
  ...
  public function referensi($cari,$iasal){
      ...
      return $this->db->query("
          ...
          FROM
              ...
              LEFT JOIN tm_keluar_produksiak_item b
  ...
  public function cek_kode($kode,$ibagian)
  {
      ...
      $this->db->from('tm_masuk_pengadaan_fgudang');
  ...
  public function getdataitem($idreff, $ipengirim){
      return $this->db->query("
                              ...
                              FROM
                                ...
                                LEFT JOIN tm_keluar_produksiak b
  ...
  public function runningnumber($thbl,$tahun, $ibagian){
      $cek = $this->db->query("
          ...
          FROM tm_masuk_pengadaan_fgudang
          WHERE i_status <> '5'
  ...
  function insertheader($id, $idocument, $datedocument, $ibagian, $ipengirim, $ireff, $eremark){
      ...
      $this->db->insert('tm_masuk_pengadaan_fgudang', $data);
  }
  ...
  function insertdetail($id, $imaterial, $nquantity, $edesc, $ireff){
      ...
      $this->db->insert('tm_masuk_pengadaan_fgudang_item', $data);
  }
  ...
  /* public function changestatus($id,$istatus){
      ...
      if ($istatus=='6') {
          $query = $this->db->query("
              SELECT 
                ...
                a.n_sisa
              FROM 
                tm_masuk_pengadaan_fgudang_item a
                LEFT JOIN tm_masuk_pengadaan_fgudang b
                  ON (a.id_document = b.id AND a.id_company = b.id_company)
              WHERE 
                a.id_document = '$id' 
              ", FALSE);
      ...
      $this->db->update('tm_masuk_pengadaan_fgudang', $data);
  } */
        ...
        if ($istatus=='3' || $istatus== '6') {
            ...
            if ($istatus == '3') {
            	...
            	$this->db->query("INSERT INTO tm_menu_approve (i_menu,i_level,i_document,e_approve,d_approve,e_database) VALUES
					('$this->i_menu','$this->i_level','$id','$this->username','$now','tm_masuk_pengadaan_fgudang');", FALSE);
                }
        }else{
            $data = array(
                'i_status'  => $istatus,
  ...
  public function cek_data($id){
      return $this->db->query("
                              ...
                              FROM
                                tm_masuk_pengadaan_fgudang a
                                INNER JOIN tm_keluar_produksiak d
                                  ON (a.id_reff = d.id AND a.id_company = d.id_company)
                                INNER JOIN tr_bagian b
                                  ON (a.i_bagian = b.i_bagian AND a.id_company = b.id_company)
                                INNER JOIN tr_bagian c
  ...
  public function cek_datadetail($id){
      return $this->db->query("
                              ...
                              FROM
                                  tm_masuk_pengadaan_fgudang_item a 
                                INNER JOIN 
                                  tm_masuk_pengadaan_fgudang b
                                  ON (a.id_document = b.id AND a.id_company = b.id_company)
                                INNER JOIN 
                                  tm_keluar_produksiak_item f
  ...
  public function updateheader($id, $idocument, $datedocument, $ibagian, $ipengirim, $ireff, $eremark){
      $data = array(
  ...
  public function updatedetail($id, $imaterial, $nquantity, $edesc, $ireff){
      ...
      $this->db->where('id_company', $this->idcompany);
      $this->db->update('tm_masuk_pengadaan_fgudang_item', $data);
  }
}
