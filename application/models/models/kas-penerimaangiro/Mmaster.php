...
class Mmaster extends CI_Model {
    ...
    public function data($folder, $i_menu, $dfrom, $dto){
        ...
        $datatables->query("
                            SELECT
                                 ...
                                 a.id_karyawan,
                                 c.e_nama_karyawan,
                                 to_char(a.d_giro_duedate, 'dd-mm-yyyy') as d_giro_duedate, 
                                 a.id_customer, 
                                 b.e_customer_name,
                                 a.id_bank, 
                                 e.e_bank_name,
                                 a.v_jumlah,
                                 a.i_status_giro,
                                 f.e_status_name as statusgiro,
                                 f.label_color as labelgiro,
       ...
       $datatables->edit('statusgiro', function ($data) {
            return '<span class="label label-'.$data['labelgiro'].' label-rouded">'.$data['statusgiro'].'</span>';
        });
    ...
    public function insert($id, $ibagian, $idocument, $datedocument, $igiro, $dategiro, $dategiroduedate, $datesetor, $dategiroterima, $ikaryawan, $iarea, $icustomer, $ibank, $vjumlah, $eremarkh){
        $idcompany = $this->session->userdata('id_company');
        $data = array(
                        ...
                        'id_bank'       => $ibank,
                        'd_giro_duedate'=> $dategiroduedate,
                        'd_giro_terima' => $dategiroterima,
                        'd_setor'       => $datesetor,
                        'e_remark'      => $eremarkh,
                        'v_jumlah'      => $vjumlah,
                        'v_sisa'        => $vjumlah,
    ...
    public function get_data($id){
        return $this->db->query("
                                   SELECT
                                       ...
                                       e.e_bank_name,
                                       to_char(a.d_giro_duedate, 'dd-mm-yyyy') as d_giro_duedate,
                                       to_char(a.d_giro_terima, 'dd-mm-yyyy') as d_giro_terima,
                                       a.e_remark,
                                       a.v_jumlah,
                                       to_char(a.d_setor, 'dd-mm-yyyy') as d_setor,
                                       a.i_status,
                                       a.i_status_giro 
                                    FROM
                                       tm_giro a 
                                       ...
                                       JOIN
                                          tr_bagian f 
                                          ON a.i_bagian = f.i_bagian 
                                          AND a.id_company = f.id_company
                                      WHERE a.id = '$id'
                                ", FALSE);
    }

    public function update($id, $ibagian, $idocument, $datedocument, $igiro, $dategiro, $dategiroduedate, $datesetor, $dategiroterima, $ikaryawan, $iarea, $icustomer, $ibank, $vjumlah, $eremarkh){
        $idcompany = $this->session->userdata('id_company');
        $data = array(
                        'i_bagian'      => $ibagian,
                        'i_document'    => $idocument,
