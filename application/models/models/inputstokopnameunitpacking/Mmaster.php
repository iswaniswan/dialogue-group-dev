...
class Mmaster extends CI_Model {
    ...
    public function datadetail($idcompany, $ddocument, $ibagian) {
          ...
          return $this->db->query("             
                                    SELECT
                                       ...
                                       '' as e_remark 
                                    FROM
                                       f_mutasi_saldoawal_unitpacking('$id_company', '$i_periode', '$d_jangka_awal', '$d_jangka_akhir', '$dfrom', '$dto', '$ibagian') x 
                                       INNER JOIN
                                          tr_product_base a 
    ...
    public function simpandetail($idcompany, $id, $idproduct, $idcolor, $qty, $eremark){
          $data = array(
                        'id_company'        => $idcompany,
                        'id_document'       => $id,
    ...
    public function hapusdetail($id) {
          return $this->db->query(" 
                                    DELETE
                                    FROM
                                       tm_stockopname_unitpacking_item
                                    WHERE
                                       id_document = '$id'
                                  ", FALSE);
    } 
