...
class Mmaster extends CI_Model {
  ...
  function data($folder, $i_menu, $dfrom, $dto){
    ...
    $datatables = new Datatables(new CodeigniterAdapter);
        $datatables->query("   
          ...
          from tm_adjustment_bahanbaku a
  ...
  public function cek_kode($kode,$ibagian) {
      ...
      $this->db->from('tm_adjustment_bahanbaku');
  ...
  function bacagudang($ilevel, $idepart, $lokasi, $username, $idcompany){
    ...
    public function simpan($id,$idocument,$ddocument,$ibagian,$eremarkh)
    {
        ...
        $this->db->insert('tm_adjustment_bahanbaku', $data);
    }
    ...
    public function simpandetail($id,$imaterial,$nquantity,$eremark)
    {
        ...
        $this->db->insert('tm_adjustment_bahanbaku_item', $data);
    }
    ...
    public function dataeditdetail($id) {
        return $this->db->query("
            SELECT
              ...
              a.e_remark
            FROM tm_adjustment_bahanbaku_item a
    ...
    public function deletedetail($id){
        $this->db->query("DELETE FROM tm_adjustment_bahanbaku_item WHERE id_adjustment='$id'", false);
    }
