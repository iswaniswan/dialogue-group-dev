...
class Mmaster extends CI_Model {
  ...
  public function getjenis($ikelompok, $ibagian){
    ...
    $this->db->select("
      a.i_type_code, a.e_type_name from tr_item_type a where a.id_company = '$id_company' and a.i_kode_group_barang = 'GRB0003' $where
  ...
  function cek_datadet($id_company, $i_periode, $d_jangka_awal, $d_jangka_akhir, $dfrom, $dto, $ibagian, $ikelompok, $jnsbarang){   
    ...
    $this->db->select("
      x.*, a.e_product_basename, b.e_color_name from f_mutasi_saldoawal_qc('$id_company', '$i_periode', '$d_jangka_awal', '$d_jangka_akhir', '$dfrom', '$dto', '$ibagian') x
