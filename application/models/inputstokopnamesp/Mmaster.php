...
class Mmaster extends CI_Model {
    ...
    function data($i_menu,$folder,$dfrom,$dto){
        ...
        $datatables->query("
            ...
            WHERE
                ...
                $bagian
            ORDER BY 
                d_document DESC, a.i_document  DESC
        ", FALSE);
    ...
    public function runningid() {
        ...
        $this->db->from('tm_stockopname_sp');
    ...
    public function dataheader($idcompany, $i_document, $ibagian){
        $this->db->select("id from tm_stockopname_sp where id_company = '$idcompany' and i_bagian = '$ibagian' and i_document = '$i_document' ", false);
        return $this->db->get();
    }
    ...
    public function datadetail($idcompany, $ddocument, $ibagian) {
        ...
        return $this->db->query("
            SELECT
                ...
                '' AS e_remark
            FROM
                f_mutasi_saldoawal_sp('$this->company',
                '$i_periode',
                '$d_jangka_awal',
                '$d_jangka_akhir',
                '$dfrom',
    ...
    public function barang($cari, $ibagian, $ddocument) {
            ...
            return $this->db->query("            
                select x.id_company, x.i_material, a.id, a.e_material_name, b.e_satuan_name from f_mutasi_saldoawal_sp('$this->company', '$i_periode', '$d_jangka_awal', '$d_jangka_akhir', '$dfrom', '$dto', '$ibagian') x
    ...
    public function simpan($id,$idcompany,$ibagian,$idocument,$ddocument,$iperiode, $eremarkh){
            ...
            $this->db->insert('tm_stockopname_sp', $data);
    }
    ...
    public function simpandetail($idcompany, $id, $idmaterial, $qty, $eremark){
        ...
        $this->db->insert('tm_stockopname_sp_item', $data);
    }
    ...
    public function changestatus($id, $istatus){
        ...
        $this->db->where('id', $id);
        $this->db->where('id_company', $this->company);
        $this->db->update('tm_stockopname_sp', $data);
    }
    ...
    public function hapusdetail($id) {
            return $this->db->query(" 
            delete from tm_stockopname_sp_item where id_document = '$id'
            ", FALSE);
    }  
}
