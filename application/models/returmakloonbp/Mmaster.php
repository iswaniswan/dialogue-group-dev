...
/*(a.d_faktur_date_from ||' s/d '||a.d_faktur_date_to) as periode, */
    ...
    $query = $this->db->query("
                              ...
                              WHERE
                                ...
                                AND b.i_level = '".$this->session->userdata('i_level')."'
  ...
  public function cekkode($kode,$ibagian)
  {
      ...
      $this->db->from('tm_retur_makloonbp');
  ...
  public function runningid()
  {
    ...
    public function insertheader($id, $ibagian, $idocument, $ddocument, $idsupplier, $idreferensi, $eremark){
        ...
        $this->db->insert('tm_retur_makloonbp', $data);
    }
    ...
    public function insertdetail($id, $idmaterial, $nquantity, $nretur, $edesc, $idreff){
        ...
        $this->db->insert('tm_retur_makloonbp_item', $data);
    }

    public function deletedetail($id){
        return $this->db->query("DELETE FROM tm_retur_makloonbp_item WHERE id_document = '$id'", FALSE);    
    }
    ...
    public function bacadetail($id, $idsupplier, $ibagian){
      return $this->db->query("
                                SELECT DISTINCT
                                  ...
                                  e.i_reff
                                FROM
                                	tm_retur_makloonbp_item a
                                	LEFT JOIN
                                		tm_retur_makloonbp b
    ...
    public function updateheader($id, $ibagian, $idocument, $ddocument, $idsupplier, $idreferensi, $eremark){
      ...
      $this->db->where('id', $id);
      $this->db->update('tm_retur_makloonbp', $data);
    } 
    ...
    public function updatedetail($id, $idmaterial, $nquantity, $nretur, $edesc){
      ...
      $this->db->update('tm_retur_makloonbp_item', $data);
    }
    ...
    public function changestatus($id,$istatus,$groupmakloon,$ibagian) {
        if ($istatus=='6') {
            $query = $this->db->query("
                ...
                FROM 
                	tm_retur_makloonbp_item a
                	INNER JOIN tm_retur_makloonbp b ON (
                		a.id_document = b.id
                		AND a.id_company = b.id_company
                	)
                	INNER JOIN (
                		...
                		FROM 
                			...
                			INNER JOIN tm_masuk_makloon_bp c ON (
