...
class Mmaster extends CI_Model {
    ...
    public function getsjr($cari, $periode){
        ...
        return $this->db->query("
            SELECT
                ...
                e_area_name,
                i_sjr,
                TO_CHAR(d_sjr, 'dd-mm-yyyy') AS dsjr
            FROM
                tm_sjr a,
                tr_area b
            WHERE
                ...
                FROM
                    tm_ic_convertion
                WHERE
                    a.i_sjr = tm_ic_convertion.i_refference)
                AND TO_CHAR(a.d_sjr, 'yyyymm')>= '$periode'
                AND UPPER(a.i_sjr) LIKE '%$cari%'
            ORDER BY
                a.d_sjr_receive DESC,
                a.i_area ASC", 
        FALSE);
    }
