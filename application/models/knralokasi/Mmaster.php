...
class Mmaster extends CI_Model {
    ...
    public function insertheader($ialokasi, $ikn, $iarea, $icustomer, $dkn, $dalokasi, $vjumlah, $vlebih, $idt, $areadt){
        $dentry   = current_datetime();
        $this->db->query("
            INSERT INTO tm_alokasiknr 
            (i_alokasi,i_kn,i_area,i_jenis_bayar,i_customer,d_alokasi,v_jumlah,v_lebih,d_entry,i_dt,i_area_dt)
            VALUES
            ('$ialokasi','$ikn','$iarea','04','$icustomer','$dalokasi',$vjumlah,$vlebih,'$dentry','$idt', '$areadt')
        ");
    }
    ...
    public function insertdetail($ialokasi, $ikn, $iarea, $inota, $dnota, $dkn, $vjumlah, $vsisa, $i, $ipelunasanremark, $eremark){
        $this->db->query("
            INSERT INTO tm_alokasiknr_item
