        ...
        <div class="col-sm-6">
            ...
            <div class="m-b-0">
                <div class="form-group row">
                    ...
                    <div class="col-sm-1">
                        <button type="button" id="addrow" hidden="true" class="btn btn-info btn-sm"><i class="fa fa-plus mr-2"></i>Item</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <table id="tabledatay" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td class="text-right" colspan="5">PPN (<span id="xppn">10</span>%) :</td>
                            <td>
