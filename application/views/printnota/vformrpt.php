...
#    $cetak.="nilai na teh ieu yeuh : ".$row->v_nota_netto."\n\n";
      ...
      $kata=$bilangan->eja(round($netto_terbilang));
    ...
    if(($row->i_customer_va != '') || ($row->i_customer_va != null)){
      ...
      $cetak.=$ab."6. Pembayaran dapat ditransfer atas nama ".CHR(27).CHR(71).CHR(18).$cmp->name." ".CHR(27).CHR(72).CHR(15)."ke Rekening :".CHR(18)."\n";
