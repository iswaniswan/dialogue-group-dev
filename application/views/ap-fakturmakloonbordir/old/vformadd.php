            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="dfaktur" name="dfaktur" class="form-control date" value="<?php echo date("d-m-Y"); ?>" readonly>
                        </div>
                    </div>
                  
                    <div class="form-group row">
                        <label class="col-md-12">No Faktur Supplier</label>
                        <div class="col-sm-7">
                            <input type="text" id="ifaksup" name="ifaksup" class="form-control" value="">
                        </div> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" id="nopajak" name="nopajak" class="form-control" value="">
                        </div> 
                        <div class="col-sm-4">
                            <input type="text" id="dpajak" name="dpajak" class="form-control date" value="<?php echo date("d-m-Y"); ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="isjkeluar" id="isjkeluar" class="form-control select2" disabled="" onchange="getdata(this.value);">
                            </select>
                             <input type="hidden" id="pkp" name="pkp" class="form-control" value="" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" id="ndiscount" name="ndiscount" class="form-control" value="" readonly>
                        </div>
                        <div class="col-sm-3">
                            <input type="text" id="discount" name="discount" class="form-control" value="" readonly>
                        </div>
                        <div class="col-sm-3">
                            <input type="text" id="netto" name="netto" class="form-control" value="" readonly>
                        </div>
                        <div class="col-sm-3">
                            <input type="text" id="gross" name="gross" class="form-control" value="" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" id="dpp" name="dpp" class="form-control" value="" readonly>
                        </div>
                        <div class="col-sm-3">
                            <input type="text" id="ppn" name="ppn" class="form-control" value="" readonly>
                        </div>
                        <div class="col-sm-6">
    ...
    function getdata(sj) {
        ...
        success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><input style="width:180px" class="form-control" readonly id="i_sj'+zz+'" name="i_sj'+zz+'" value="'+i_sj+'"></td>';
