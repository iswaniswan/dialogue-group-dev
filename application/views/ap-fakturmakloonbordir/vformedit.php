            ...
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="hidden" name="inotaold" id="inotaold" value="<?= $data->i_document; ?>">
                    </div>
                    <div class="col-sm-4">
                        <div class="input-group">
                            <input type="text" name="inota" id="inota" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="FP-2010-000001" maxlength="15" class="form-control input-sm" value="<?= $data->i_document;?>" aria-label="Text input with dropdown button">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="dnota" id="dnota" class="form-control date" value="<?= $data->d_document; ?>" readonly="" onchange="max_tgl(this.value);">
                    </div>       
                    <div class="col-sm-2">
                        <input type="text" name="dreceivefaktur" id="dreceivefaktur" class="form-control date" value="<?= $data->d_terima_faktur; ?>" placeholder="<?php echo date("d-m-Y"); ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="hidden" class="form-control" id="ipartner" name="ipartner" value="<?= $data->i_partner ;?>" readonly>
                        <input type="text" class="form-control" id="epartner" name="epartner" value="<?= $data->e_supplier_name ;?>" readonly>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="ifaktursupp" id="ifaktursupp" class="form-control" value="<?= $data->i_nota_supplier; ?>" placeholder="Nomor Faktur Supplier">
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="ipajak" id="ipajak" class="form-control" value="<?= $data->i_pajak; ?>" placeholder="Nomor Pajak">
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <textarea class="form-control input-sm" id="eremark" name="eremark" placeholder="Isi keterangan jika ada!"><?=$data->e_remark;?></textarea>
                    </div>
                </div>
                <div class="form-group">
                <div class="form-group">
            ...
            <table id="tabledatax" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="hidden" class="form-control" id="icolor<?=$i;?>" name="icolor<?=$i;?>" value="<?= $row->i_color; ?>" readonly>
                            <input style="width:120px;" type="text" class="form-control" id="ecolorname<?=$i;?>" name="ecolorname<?=$i;?>" value="<?= $row->e_color_name; ?>" readonly>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <input type="hidden" class="form-control" id="vgross<?=$i;?>" name="vgross<?=$i;?>" value="" readonly>
                            <input type="hidden" class="form-control" id="vnetto<?=$i;?>" name="vnetto<?=$i;?>" value="" readonly>
                            <input type="hidden" class="form-control" id="vdpp<?=$i;?>" name="vdpp<?=$i;?>" value="" readonly>
                            <input type="hidden" class="form-control" id="vppn<?=$i;?>" name="vppn<?=$i;?>" value="" readonly>
                        </td>
                        <td>
                            <input style="width:250px;" type="text" class="form-control" id="edesc<?=$i;?>" name="edesc<?=$i;?>" value="<?=$row->e_remark;?>">
                        </td>
                    </tr>
                    <?}}?>
                </tbody>
...
function number() {
    ...
    function hitungnilai(i) {
        ...
        document.getElementById('vtotalbruto').value = (bruto.toFixed(2));
