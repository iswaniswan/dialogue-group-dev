            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">  
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control input-sm" value="<?= $data->d_estimate;?>" readonly>
                        </div>
                        <div class="col-sm-2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control input-sm" value="<?= $data->i_referensi;?>" readonly>
                        </div>
                        <div class="col-sm-2">
                            <input type="text" class="form-control input-sm" value="<?= $data->d_referensi;?>" readonly>
                        </div>
                        <div class="col-sm-4">
