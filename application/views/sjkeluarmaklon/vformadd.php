                ...
                <div class="col-md-12">  
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="hidden" name="itypepajak" id="itypepajak">
                            <input type="hidden" name="ndiskon" id="ndiskon">
                        </div>
                        <div class="col-sm-3">
                            <select type="text" name="idreff" required="" id="idreff" class="form-control input-sm select2"></select>
                        </div>
                        <div class="col-sm-2">
                            <input type="text" name="dreff" required="" id="dreff" class="form-control input-sm" placeholder="Tanggal Referensi" value="" readonly>
                        </div>
                        <div class="col-sm-4">
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data['detail']!=null && data['data']!=null) {
                        if (parseInt(data['detail'].length) < 1) {
                            swal('Maaf :(','Master Harga Makloon Supplier Harus Sudah Ada Sesuai Barang Di Memo!','error');
                            return false;
                        }
