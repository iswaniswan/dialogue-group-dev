                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <button type="button" class="btn btn-warning btn-rounded btn-sm" onclick="statuschangex('<?= $folder . "','" . $data->id; ?>','3','<?= $dfrom . "','" . $dto; ?>');"> <i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;Change Requested</button>&nbsp;
    ...
    $('#approve').click(function(event) {
       ...
       /*  for (var i = 1; i <= $('#jml').val(); i++) {
        ...
        if (!ada) {
            ...
            statuschangex('<?= $folder; ?>', $('#id').val(), '6', '<?= $dfrom . "','" . $dto; ?>');
        } else {
            return false;
        }
    });
