            ...
            <div class="row">
                <div class="col-sm-12">
                   <!--  <hr style="margin-top: -1rem;
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="pull-left"> <address>
                                <h4 class="font-bold" style="font-size: 12px; line-height: 10px;margin-top: 3px !important"><?= check_constant('NmPerusahaan');?></h4>
                                <h5 style="font-size: 12px;"><?= check_constant('AlmtPerusahaan');?>  </h5>
                                <h5 style="font-size: 12px;">Telp/Fax : <?= check_constant('TlpPerusahaan'). " / ". check_constant('FaxPerusahaan');?>  </h5>
                                <h5 style="font-size: 12px;"><?= check_constant('KotaPerusahaan');?>  </h5>
                            </address> </div>

                            <div class="pull-right text-right"> <address>
                                <h4 style="font-size: 12px; line-height: 10px;margin-top: 3px !important">Cimahi,&nbsp;<?= date('d', strtotime($row->d_op)).' '.$this->fungsi->mbulan(date('m', strtotime($row->d_op))).' '.date('Y', strtotime($row->d_op));?></h4>
                                <h5 style="font-size: 12px;">Kepada Yth,</h4>
                                <h5 class="font-bold" style="font-size: 14px;"><?= $row->e_supplier_name; ?></h4>
                                <h5 style="font-size: 12px;"><?= $row->e_supplier_address;?></h5>
                            </address> </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="pull-left"> 
                                <address style="padding:0px;margin-bottom: 0px !important">
                                    <table cellpadding="0" cellspacing="0" >
                                        <tr>
                                            <td width="170px" class="xx text-muted m-l-3" style="font-size: 12px">Tanggal Batas Pengiriman</td> 
                                            <td width="10px" class="xx huruf2 text-muted m-l-3" style="font-size: 12px">:</td> 
                        ...
                        <div class="col-sm-12" align="center" style="margin-bottom: 0.5rem; margin-top: 0.5rem !important">
                              <h3 style="font-size: 16px; line-height: 0px;"><b> ORDER PEMBELIAN</b><br></h3>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-sm-8">
                                    ...
                                    margin-bottom: 0rem;"> Dengan hormat, <br>Harap dikirimkan kepada kami, barang sebagai berikut : </p>
                                </div>

                                <div class="col-sm-4" >
                                     <p class="text-muted" style="font-size: 12px;
                                    margin-bottom: 0rem;"> Cara Pembayaran : <b> <?= ucwords(strtolower($row->jenis_pembelian));?> </b><br>Nomor OP : <b> <?= $row->i_op;?></b> </p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="pull-center m-t-30 text-center">
                                        <p style="font-size: 12px; margin-top: -1rem; margin-bottom: 1rem;">Hormat Kami,</p>
                                        <p style="font-size: 12px; margin-top: -1rem; margin-bottom: 2rem;">Pembuat,</p>
                                        <?php if($row->e_created!=''){?>
                                            <h3 style="font-size: 12px;">(&nbsp;&nbsp;&nbsp; <?= $row->e_created;?> &nbsp;&nbsp;&nbsp;)</h3>
                                        <?php }else{?>
                               ...
                               <!--  <div class="col-sm-3">
                                ...
                                <div class="col-sm-4">
                                    <div class="pull-center m-t-30 text-center">
                                        <p style="font-size: 12px; margin-top: -1rem; margin-bottom: 1rem;">&nbsp;</p>
                                ...
                                <div class="col-sm-4">
                                    <div class="pull-center m-t-30 text-center">
                                        <p style="font-size: 12px; margin-top: -1rem; margin-bottom: 1rem;">&nbsp;</p>
                                        <p style="font-size: 12px; margin-top: -1rem; margin-bottom: 2rem;">Menyetujui,</p>
                                        <?php if($row->e_approve!=''){?>
                                            <h3 style="font-size: 12px;">(&nbsp;&nbsp;&nbsp; <?= $row->e_approve;?> &nbsp;&nbsp;&nbsp;)</h3>
                                        <?php }else{?>
                                            <h3 style="font-size: 12px;">(...................................)</h3>
                                        <?php } ?>
                                    </div>
                    ...
                    <font face="Courier New" size="2"><?php date_default_timezone_set('Asia/Jakarta'); echo "Tanggal Cetak : ".$tgl=date("d")." ".$this->fungsi->mbulan(date("m"))." ".date("Y").",  Jam : ".date("H:i:s");?></font>
                <div class="row">
                <?php } ?>
            </div>
            <div class="noDisplay">
