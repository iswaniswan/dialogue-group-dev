        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <?php if ($data->i_status_harga == '6' || $data->i_status_harga == '3') { ?>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <span class="notekode">* Form ini hanya untuk edit harga!</span><br>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    if ($data2) {
                        ...
                        foreach ($data2 as $row) {
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-1">
                                    <input type="text" class="form-control input-sm" id="imaterialsupplier<?= $i; ?>" name="imaterialsupplier<?= $i; ?>" value="<?= $row->i_material_supplier; ?>" readonly>
                                </td>
                                <td class="col-1">
                                    <input type="text" readonly class="form-control input-sm text-right" id="nquantitypp<?= $i; ?>" name="nquantitypp<?= $i; ?>" value="<?= $row->n_sisa; ?>" autocomplete="off" readonly>
                                </td>

                                <td class="col-1">
                                    <input type="text" readonly class="form-control input-sm text-right" id="nquantity<?= $i; ?>" name="nquantity<?= $i; ?>" value="<?= $row->n_quantity; ?>" autocomplete="off">
                                ...
                                <td class="col-1">
                                    <input type="text" class="form-control input-sm text-right <?= $row->i_material; ?> number" id="vprice<?= $i; ?>" name="vprice<?= $i; ?>" value="<?= (!$row->v_price) ? null : number_format($row->v_price,4); ?>" autocomplete="off" onkeyup="hitungall(this.value, '<?= $row->i_material; ?>', '<?= $i; ?>' );angkahungkul(this);reformat(this);if(this.value=='0'){this.value='';}" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}">
                                </td>
                                <td class="col-1">
