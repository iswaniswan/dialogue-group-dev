            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="col-md-12">No Faktur Asal</label>
                        <div class="col-sm-3">
                            <input id="ifakturkomersial" name="ifakturkomersial"  class="form-control" value="<?php echo substr($isi->i_faktur_komersial,8,6); ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <?php if($isi->i_nota!='') {?>
				            ...
				            <?php }else{ ?>
                                <input readonly type="hidden" id="dnota" name="dnota" value="">
                            <?php } ?>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
		                    <input readonly id="esalesmanname" name="esalesmanname" class="form-control" value="<?php if($isi->e_salesman_name=='KONSINYASI') echo 'PUSAT BABY'; else echo $isi->e_salesman_name; ?>" readonly>
                    ...
                    <div class="form-group row">                                                                                                           
                        <div class="col-sm-3">                                                           
                            <div class="form-check">
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" id="fspbconsigment" name="fspbconsigment" class="custom-control-input" type="checkbox" readonly <?php if($isi->f_spb_consigment=='t') echo "checked";?>>
                        ...
                        <div class="col-sm-1"> 
                            <div class="form-check">
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" id="fmasalah" name="fmasalah" class="custom-control-input" type="checkbox" value="" <?php if($isi->f_masalah=='t') echo 'value="on" checked'; else echo 'value=""';?> onclick="cekmasalah();">
                                    <span class="custom-control-indicator"></span>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-3"> 
                            <div class="form-check">
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" id="finsentif" name="finsentif" class="custom-control-input" type="checkbox" value="" type="checkbox" <?php if($isi->f_insentif=='t') echo 'value="on" checked'; else echo 'value=""';?> onclick="cekinsentif();">
                                    <span class="custom-control-indicator"></span>
                        ...
                        <div class="col-sm-1"> 
                            <div class="form-check">
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" id="fcicil" name="fcicil" class="custom-control-input" type="checkbox" <?php if($isi->f_cicil=='t') echo 'value="on" checked'; else echo 'value=""';?> onclick="cekcicil();">
                                    <span class="custom-control-indicator"></span>
                    ...
                    <div class="form-group row">
                        <label class="col-md-12">Insentif</label>
                        <div class="col-sm-3">
                            <div class="form-check">
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" id="finsentif" name="finsentif" class="custom-control-input" type="checkbox" value="on" checked>
                                    <span class="custom-control-indicator"></span>
                        ...
                        <div class="col-sm-5">
                            <input readonly id="inotaold" name="inotaold" class="form-control" value="<?php echo $isi->i_nota_old; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
		                ...
		                ?>
                        <div class="col-sm-2">
                            <input maxlength="3" id="nspbtoplength" class="form-control" name="nspbtoplength" readonly value="<?php echo $isi->n_nota_toplength; ?>">
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input readonly id="eremark" name="eremark" class="form-control" value="<?php echo $isi->e_remark; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input id ="ncustomerdiscount1" name="ncustomerdiscount1" readonly class="form-control" value="<?php echo $isi->n_nota_discount1; ?>" onkeyup="formatcemua(this.value);editnilai();">
                        </div>
                        <div class="col-sm-5">
		                    <input readonly id="vcustomerdiscount1" name="vcustomerdiscount1" class="form-control" value="<?php echo number_format($isi->v_nota_discount1); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-12">Discount 2</label>
                        <div class="col-sm-3">
                            <input id="ncustomerdiscount2" name="ncustomerdiscount2" readonly class="form-control" value="<?php echo $isi->n_nota_discount2; ?>" onkeyup="formatcemua(this.value);editnilai();">
                        </div>
                        <div class="col-sm-5">
		                    <input readonly id="vcustomerdiscount2" name="vcustomerdiscount2" class="form-control" value="<?php echo number_format($isi->v_nota_discount2); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-12">Discount 3</label>
                        <div class="col-sm-3">
                            <input id="ncustomerdiscount3" name="ncustomerdiscount3" readonly class="form-control" value="<?php echo $isi->n_nota_discount3; ?>" onkeyup="formatcemua(this.value);editnilai();">
                        </div>
                        <div class="col-sm-5">
		                    <input readonly id="vcustomerdiscount3" name="vcustomerdiscount3" class="form-control" value="<?php echo number_format($isi->v_nota_discount3); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-12">Discount 4</label>
                        <div class="col-sm-3">
                            <input id="ncustomerdiscount4" name="ncustomerdiscount4" readonly class="form-control" value="<?php echo $isi->n_nota_discount4; ?>" onkeyup="formatcemua(this.value);editnilai();">
                        </div>
                        <div class="col-sm-5">
		                    <input readonly id="vcustomerdiscount4" name="vcustomerdiscount4" class="form-control" value="<?php echo number_format($isi->v_nota_discount4); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
		                ...
		                ?>
                        <div class="col-sm-6">
                            <input readonly id="vspbbersih" name="vspbbersih" readonly class="form-control" value="<?php echo number_format($isi->v_spb-$isi->v_spb_discounttotal); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Nilai Kotor (Realisasi)</label>
                        <div class="col-sm-6">
                            <input id="vnotagross" name="vnotagross" readonly class="form-control" value="<?php echo number_format($isi->v_nota_gross); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
			                ...
			                <input type="hidden" id="nprice" name="nprice" class="form-control" value="<?php echo $isi->n_price;?>">
			                <input type="hidden" id="vnotappn" name="vnotappn" class="form-control" value="<?php echo number_format($isi->v_nota_ppn); ?>">
                        </div>
                    </div>
                </div>
