            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <label class="col-md-4">Tanggal Alokasi</label>
                        <!-- <label class="col-md-4">No. Bank</label> -->
                        <label class="col-md-4">Tanggal Bank</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <label class="col-md-7">Ku/Giro/Tunai</label><label class="col-md-5">Bank</label>
                        <div class="col-sm-7">
                            <input readonly id= "vjumlah" name="vjumlahx" class="form-control" value="<?= number_format($isi->sisa);?>">
                            <input type="hidden" id="vlebih" name="vlebihx" value="0">
                            <input type="hidden" id="vsisa" name="vsisa" value="<?= $isi->sisa; ?>">
                        </div>
                        <div class="col-sm-5">
                            <input readonly id="ebankname" name="ebankname" value="<?= $isi->e_bank_name; ?>" class="form-control">
                            <input type="hidden" id="ebanknameicoabank" name="icoabank" value="<?= $isi->i_bank; ?>" class="form-control">
                            <input type="hidden" id="icoabang" name="icoabang" value="<?= $isi->i_coa; ?>" class="form-control">
                        </div>
                    </div> 
                ...
                <div class="col-md-6"> 
                    <div class="form-group row">
                        <label class="col-md-6">Debitur</label>
                        <label class="col-md-6">No. Bank</label>
                        <div class="col-sm-6">
                            <select class="form-control" id="icustomer" name="icustomer"  onchange="getdetailcustomer(this.value);"></select>
                            <input type="hidden" id= "ecustomername" name="ecustomername" class="form-control" value="">
                        </div>
                        <div class="col-sm-6">
                            <input readonly id= "ikbank" name="ikbank" class="form-control" value="<?= $isi->i_kas_masuk;?>">
                        </div>
                    </div> 
                    <div class="form-group row">
    ...
    function getdetailcustomer(id){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // $('#ecustomercity').val(formatcemua(data[0].e_city));
            },
            error: function () {
                swal('Error :)');
            }
