    ...
    <div class="white-box">
        <div class="table-responsive">
            <table class="tablesaw table-bordered table-hover table" id="sitabel">
                  ...
                  $nama='';
                    ...
                    if($icity=='' || ($icity==$row->icity && $kode==$row->kode) ){
                      ...
                      for($i=1;$i<=$interval;$i++){
  	                  ...
  	                  echo "<tr>
                      <td style='background-color:#F2F2F2;' colspan=7 align=center>T o t a l   ".$nama."</td>";
                      $bl=$blasal;
                      for($i=1;$i<=$interval;$i++){
                        switch ($bl){
                          case '1' :
                      ...
                      for($i=1;$i<=$interval;$i++){
  	                  ...
  	                  echo "<tr>
                              <th colspan=5 align=center>T o t a l   ".$nama."</th>";
                      $bl=$blasal;
                      for($i=1;$i<=$interval;$i++){
                        switch ($bl){
                          case '1' :
              ...
              echo "<tr>
                    <td colspan=7 style='background-color:#F2F2F2;' align=center>T o t a l   ".$nama."</td>";
              $bl=$blasal;
              for($i=1;$i<=$interval;$i++){
                switch ($bl){
                  case '1' :
