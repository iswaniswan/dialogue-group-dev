                        ...
                        <tbody>
                            <?php foreach ($datadetail as $key) {?>
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" name="iddocument<?=$i;?>" value="<?= $key->id_referensi;?>">
                                        <select id="idproductttb<?=$i;?>" name="idproductttb<?=$i;?>" class="form-control select2">
                                            <option value="<?= $key->id_productttb;?>"><?= $key->i_productttb.' - '.$key->e_productttb;?></option>
                                        </select>
                                    </td>
                                    <td><input type="text" id="nquantitysisa<?=$i;?>" class="form-control text-right input-sm" value="<?= $key->n_quantity_reff;?>" readonly></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="vharga<?=$i;?>" id="vharga<?=$i;?>" value="<?= number_format($key->v_price);?>"/>
                                        <input type="hidden" name="ndisc1<?=$i;?>" id="ndisc1<?=$i;?>" value="<?= $key->n_diskon1;?>"/>
                                        <input type="hidden" name="vdisc1<?=$i;?>" id="vdisc1<?=$i;?>" value="<?= $key->v_diskon1;?>"/>
                                        <input type="hidden" name="ndisc2<?=$i;?>" id="ndisc2<?=$i;?>" value="<?= $key->n_diskon2;?>"/>
                                        <input type="hidden" name="vdisc2<?=$i;?>" id="vdisc2<?=$i;?>" value="<?= $key->v_diskon2;?>"/>
                                        <input type="hidden" name="ndisc3<?=$i;?>" id="ndisc3<?=$i;?>" value="<?= $key->n_diskon3;?>"/>
                                        <input type="hidden" name="vdisc3<?=$i;?>" id="vdisc3<?=$i;?>" value="<?= $key->v_diskon3;?>"/>
                                        <input type="hidden" name="vdiscount<?=$i;?>" id="vdiscount<?=$i;?>" value="<?= number_format($key->v_diskon_tambahan);?>"/>
                                        <input type="hidden" name="vtotal<?=$i;?>" id="vtotal<?=$i;?>" value="<?= number_format($key->n_quantity * $key->v_price);?>"/>
                                        <input type="hidden" name="vtotaldiskon<?=$i;?>" id="vtotaldiskon<?=$i;?>" value="<?= $key->v_diskon_total;?>"/>
                                    </td>
                                </tr>
                                <?php $i++; } ?>
                        </tbody>
