        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><input class="form-control text-right" readonly id="sisa'+no+'" name="sisa'+no+'" value="'+data['detail'][a]['n_quantity_sisa']+'"></td>';
                    cols += '<td><input class="form-control text-right inputitem" id="nquantity'+no+'" placeholder="0" name="nquantity'+no+'" value="" onkeypress="return hanyaAngka(event);" onkeyup="ceksaldo('+no+');"></td>';
