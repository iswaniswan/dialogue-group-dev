...
<div class="col-sm-12">
    <!-- <div class="col-md-12">
                ...
                <!-- <br><br> -->
        <h3 class="box-title m-b-0">Detail Panel</h3>
        <div class="col-sm-12">
...
<script>
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td size="6"><select id="marker'+ counter +'" class="form-control input-sm select2" name="marker'+ counter +'" ></select></td>';
        cols += '<td size="12"><select class="form-control input-sm" data-nourut="'+ counter +'" name="namabrg'+ counter +'" id="namabrg'+ counter +'" ></select></td>';
        ...
        $('#namabrg'+ counter).select2({
            ...
            type: "POST",
            ajax: {
                url: "<?php echo site_url($folder.'/Cform/panel/');?>",
                data: function (params){
                    var query   = {
                        q            : params.term,
                        marker     : $('#marker' + counter).val()
                    }
                    return query;
                },
                dataType: 'json',
