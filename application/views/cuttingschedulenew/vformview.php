            ...
            <table id="tabledatax" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                ...
                <?php $z = 0; $group = ""; foreach ($datadetail as $key) { $i++; 
                        ...
                        <tr class="del<?= $z;?>">
                            ...
                            <td>
                                <input style="width:100px;" readonly type="text" class="form-control qty text-right input-sm inputitem" autocomplete="off" name="nquantitybahansisa[]" id="nquantitybahansisa<?=$z;?>" value="<?= $key->n_quantity;?>">
                            </td>
