            ...
            <div class="col-md-6">
                <div id="pesan"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="ikelas" class="form-control" required="" maxlength="5" onkeyup="gede(this)" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Nama Kelas</label>
                        <div class="col-sm-12">
                            <input type="text" name="enamakelas" class="form-control" required="" maxlength="30"  value="" >
                        </div>
                    </div>                
                    <div class="form-group">
