    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <label class="col-md-6">Tujuan</label><label class="col-md-6">Department/Partner</label>
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <select name="tujuankeluar" id="tujuankeluar" class="form-control select2" onchange="departemen(this.value);"> 
                                    <!-- getpic(this.value); -->
                            ...
                            <div class="col-md-6">
                                <select name="edept" id="edept" class="form-control select2" disabled=""></select>
                            </div>
                        </div>
                    </div>
