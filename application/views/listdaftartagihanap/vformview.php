        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                <table id="tabledata" class="display nowrap" cellspacing="0" width="100%">
                    ...
                    <tfoot align="right">
	                      <tr>
                          <th colspan="5" style="text-align: center;">Sub Total </th><th></th><th></th>
                        </tr>
	                      <tr>
                          <th colspan="5" style="text-align: center;" class="text-right">Grand Total</th>
                          <th class="text-right"><?= number_format($total->jml);?></th><th></th>
                        </tr>
                    </tfoot>
                </table>
            </div>
...
*/            var enamTotal = api
    ...
    */        $( api.column( 5 ).footer() ).html(enamTotal.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,'));
            ...
            "ajax": {
                "url": base_url + "<?php echo $folder; ?>/Cform/data/<?php echo $dfrom;?>/<?php echo $dto;?>/<?php echo $isupplier;?>",
                "type": "POST"
            },
            "displayLength": 10
        } );
