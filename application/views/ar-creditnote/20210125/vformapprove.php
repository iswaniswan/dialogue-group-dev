                        ...
                        <table id="tabledata" class="table color-table success-table table-bordered" cellspacing="0" width="100%"> 
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Qty Belum KN</th>
    ...
    function getdataedit() {
        ...
        success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><input style="width:90px" readonly class="form-control" style="text-align:right;" id="sisa'+zz+'" name="sisa'+zz+'" value="'+sisa+'"></td>';
