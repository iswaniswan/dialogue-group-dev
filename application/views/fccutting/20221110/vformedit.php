                            ...
                            ?>
                                <tr class="d-flex">
                                    ...
                                    <td class="col-1 text-right">
                                        <input type="number" class="form-control input-sm text-right" name="n_sisa_schedule_berjalan<?= $i; ?>" id="n_sisa_schedule_berjalan<?= $i; ?>" onblur="if(this.value==''){this.value='0';} berhitung(<?= $i; ?>);" onkeyup="berhitung(<?= $i; ?>);" onfocus="if(this.value=='0'){this.value='';}" value="<?= $key->n_sisa_schedule_berjalan; ?>">
                                    </td>
                                    <td class="col-1 text-right">
                                    ...
                                    <td class="col-1 text-right">
                                        <input type="number" class="form-control input-sm text-right" name="n_sisa_permintaan_cutting<?= $i; ?>" id="n_sisa_permintaan_cutting<?= $i; ?>" onkeyup="berhitung(<?= $i; ?>);" autocomplete="off" onblur="if(this.value==''){this.value='0';} berhitung(<?= $i; ?>);" onfocus="if(this.value=='0'){this.value='';}" value="<?= $key->n_sisa_permintaan_cutting; ?>">
                                    </td>
                                    <td class="col-1 text-right">
                                    ...
                                    <td class="col-1 text-right">
                                        <input readonly type="text" class="form-control input-sm text-right" name="n_fc_produksi_perhitungan<?= $i; ?>" id="n_fc_produksi_perhitungan<?= $i; ?>" value="<?= $key->n_schedule_jahit; ?>">
                                    </td>
                                    <td class="col-1 text-right">
                                        <input readonly type="text" class="form-control input-sm text-right" name="n_total_sisa<?= $i; ?>" id="n_total_sisa<?= $i; ?>" value="<?= $key->n_fc_produksi_perhitungan; ?>">
                                    </td>
                                    <td class="col-1 text-right">
                                        <input type="number" class="form-control input-sm text-right" name="n_up_cutting<?= $i; ?>" id="n_up_cutting<?= $i; ?>" onkeyup="angkahungkul(this); berhitung(<?= $i; ?>);" autocomplete="off" onblur="if(this.value==''){this.value='0';}berhitung(<?= $i; ?>);" onfocus="if(this.value=='0'){this.value='';}" value="<?= $key->n_up_cutting; ?>">
                                    </td>
                                    <td class="col-1 text-right">
                                        <input readonly type="text" class="form-control input-sm text-right qty_<?= $key->i_material; ?>" name="n_fc_cutting<?= $i; ?>" id="n_fc_cutting<?= $i; ?>" value="<?= $key->n_fc_cutting; ?>">
                                    </td>
                                    <td class="col-1 text-right">
                                        <input readonly type="text" class="form-control input-sm text-right" name="v_set<?= $i; ?>" id="v_set<?= $i; ?>" value="<?= $key->v_set; ?>">
                                    </td>
                                    <td class="col-1 text-right">
                                        <input readonly type="text" class="form-control input-sm text-right" name="v_gelar<?= $i; ?>" id="v_gelar<?= $i; ?>" value="<?= $key->n_jumlah_gelar; ?>">
                                    </td>
                                    <td class="col-3">
                                        <input readonly type="text" class="form-control input-sm" name="material<?= $i; ?>" id="material<?= $i; ?>" value="<?= $key->material; ?>">
                                    </td>
                                    <td class="col-1">
                                        <input readonly type="text" class="form-control input-sm text-right" name="n_fc_yang_dibutgetkan<?= $i; ?>" id="n_fc_yang_dibutgetkan<?= $i; ?>" value="<?= $key->n_fc_produksi_dibadgetkan; ?>">
                                    </td>
                                    <td class="col-1">
                                        ...
                                        <input readonly type="text" class="form-control input-sm text-right set_<?= $key->i_material; ?>" name="n_total_qty_kain_utama<?= $i; ?>" id="n_total_qty_kain_utama<?= $i; ?>" value="<?= $key->n_qty_kain_utama; ?>">
                                    </td>
