                    ...
                    <table id="tabledatay" class="table color-table inverse-table table-bordered" cellpadding="8" cellspacing="1" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>Material</th>
                                <th class="text-right">FC yg<br>Dibudgetkan</th>
                                <th class="text-right">Total Qty<br>Kain Utama</th>
                                <th>Keterangan</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $key->material; ?></td>
                                    <td class="text-right"><?= $key->n_fc_produksi_dibadgetkan; ?></td>
                                    <td class="text-right"><?= $key->n_qty_kain_utama; ?></td>
                                    <td><?= $key->e_remark; ?></td>
                                </tr>
                            <?php
                            } ?>
