                        ...
                        <tbody class="font-13">
                            ...
                            ?>
                                <tr class="d-flex">
                                    ...
                                    <td class="col-1 text-right">
                                        <input type="text" class="form-control input-sm text-right" name="n_sisa_permintaan_cutting<?= $i; ?>" id="n_sisa_permintaan_cutting<?= $i; ?>" onkeyup="angkahungkul(this); ngetang(<?= $i;?>);" autocomplete="off" onblur="if(this.value==''){this.value='0';} ngetang(<?= $i;?>);" onfocus="if(this.value=='0'){this.value='';}" value="0">
                                    </td>
                                    <td class="col-1 text-right">
                                    ...
                                    <td class="col-1 text-right">
                                        <input readonly type="text" class="form-control input-sm text-right" name="n_fc_produksi_perhitungan<?= $i; ?>" id="n_fc_produksi_perhitungan<?= $i; ?>" value="<?= $fc_cutting; ?>">
                                        <input type="hidden" name="n_fc_produksi<?= $i; ?>" id="n_fc_produksi<?= $i; ?>" value="<?= $key->fc_produksi; ?>">
                                    </td>
                                    <td class="col-1 text-right">
                                        <input type="text" class="form-control input-sm text-right" name="n_up_cutting<?= $i; ?>" id="n_up_cutting<?= $i; ?>" onkeyup="angkahungkul(this); up(<?= $i;?>);" autocomplete="off" onblur="if(this.value==''){this.value='0';}up(<?= $i;?>);" onfocus="if(this.value=='0'){this.value='';}" value="0">
                                    </td>
                                    <td class="col-1 text-right">
