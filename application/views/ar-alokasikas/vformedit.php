                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="idocumentold" id="ialokasiold" value="<?= $data->i_document;?>">   
                                    <input type="text" name="idocument" required="" id="ialokasi" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number;?>" maxlength="25" class="form-control input-sm" value="<?= $data->i_document;?>" aria-label="Text input with dropdown button">
                            ...
                            <div class="col-sm-2">
                                <input type="hidden" id="idreferensi" name="idreferensi" required="" value="<?= $data->id_referensi; ?>">
                                <input type="hidden" id="idjenis" name="idjenis" required="" value="<?= $data->id_jenis_alokasi; ?>">
                                <input type="hidden" id="idreferensiitem" name="idreferensiitem" required="" value="<?= $data->id_referensi_detail; ?>">
                                <input type="text" id="ireferensi" name="ireferensi" class="form-control input-sm" required="" readonly value="<?= $data->i_referensi; ?>">
                            </div>
                            <div class="col-sm-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="hidden" id="ecustomer" required="" name="ecustomer" value="<?= $data->e_partner_name;?>">
                                <input type="text" required="" class="form-control input-sm" readonly value="<?= $data->e_partner_name.' ('.$data->i_partner.')';?>">
                            </div>
                            <div class="col-sm-3">
                    ...
                    <tbody>
                        <?php foreach ($datadetail as $key) { $i++; ?>
                            <tr>
                                ...
                                <td>
                                    <select data-nourut="<?=$i;?>" id="idnota<?=$i;?>" class="form-control input-sm" name="idnota<?=$i;?>" onchange="getdetail(<?=$i;?>);">
                                        <option value="<?= $key->id_nota;?>"><?= $key->i_nota;?></option>
                                    </select>
                                </td>
                                <td><input type="text" readonly class="form-control input-sm" name="dnota<?=$i;?>" id="dnota<?=$i;?>" value="<?= $key->d_nota;?>"/></td>
                                <td>
                                    <input type="text" readonly class="form-control input-sm text-right" name="vnotabersih<?=$i;?>" id="vnotabersih<?=$i;?>" value="<?= number_format($key->v_nota);?>"/>
                                    <input type="hidden" readonly class="form-control input-sm text-right" name="vnilai<?=$i;?>" id="vnilai<?=$i;?>" value="<?= number_format($key->v_sisa_nota);?>"/>
                                </td>
                                <td><input type="text" id="vbayar<?=$i;?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="vbayar<?=$i;?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="<?= number_format($key->v_jumlah);?>" onkeyup="angkahungkul(this); reformat(this); hitung();"></td>
                                <td><input type="text" readonly class="form-control input-sm text-right" name="vsisa<?=$i;?>" id="vsisa<?=$i;?>" value="0"/></td>
                                <td><input type="text" readonly class="form-control input-sm text-right" name="vlebih<?=$i;?>" id="vlebih<?=$i;?>" value="0"/></td>
                                <td>
                                    <input type="text" class="form-control input-sm" name="eremark<?=$i;?>" id="eremark<?=$i;?>" placeholder="Jika Ada!" value="<?= $key->e_remark;?>"/>
                                    <input type="hidden" class="form-control input-sm" name="groupfaktur<?=$i;?>" id="groupfaktur<?=$i;?>" value="<?= $key->group_faktur;?>"/>
                                </td>
