            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                        ...
                        <div class="col-sm-12">
                            ...
                            <select name="isupplier" class="form-control select2">
                                ...
                                <option value="<?php echo $isupplier->i_supplier;?>">
                                    <?php echo $isupplier->e_supplier_name;?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <select name="iproductgroup" class="form-control select2">
                                ...
                                <option value="<?php echo $iproductgroup->i_product_group;?>">
                                    <?php echo $iproductgroup->e_product_groupname;?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <select name="iproductclass" class="form-control select2">
                                ...
                                <option value="<?php echo $iproductclass->i_product_class;?>">
                                    <?php echo $iproductclass->e_product_classname;?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="vproductretail" class="form-control" maxlength="30" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Tanggal Stop Produksi</label>
                        <div class="col-sm-12">
                            <input type="text" name="dproductstopproduction" class="form-control date" value="">
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            ...
                            <select name="iproductstatus" class="form-control select2">
                                ...
                                <option value="<?php echo $iproductstatus->i_product_status;?>">
                                    <?php echo $iproductstatus->e_product_statusname;?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <select name="iproducttype" class="form-control select2">
                                ...
                                <option value="<?php echo $iproducttype->i_product_type;?>">
                                    <?php echo $iproducttype->e_product_typename;?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <select name="iproductcategory" class="form-control select2">
                                ...
                                <option value="<?php echo $iproductcategory->i_product_category;?>">
                                    <?php echo $iproductcategory->e_product_categoryname;?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="dproductregister" id="dproductregister" class="form-control date" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Margin</label>
                        <div class="col-sm-12">
                            <input type="text" name="nproductmargin" class="form-control" maxlength="30"
                                onkeyup="gede(this)" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            ...
                            <select name="iproductseri" class="form-control select2">
                                ...
                                <option value="<?php echo $iproductseri->i_product_seri;?>">
                                    <?php echo $iproductseri->e_product_seriname;?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
