      ...
      <div class="panel-body table-responsive">
        ...
        <div class="col-md-6">
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              <input type="text" id="dto" name="dto" class="form-control date" required value=""
                readonly>
            </div>
          </div>
          <div class="form-group row">
              ...
              <select name="isupplier" id="isupplier" class="form-control select2" required="">
                ...
                <?php
                    foreach ($supplier->result() as $key) {?>
                        <option value="<?php echo $key->i_supplier; ?>">
                        <?php echo $key->i_supplier . " - " . $key->e_supplier_name; ?></option>
                <?php }?>
              </select>
            </div>
          </div>
