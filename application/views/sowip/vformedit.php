                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <?php if ($datahead->i_status == '1' || $datahead->i_status == '3' || $datahead->i_status == '7') { ?>
                                <button type="submit" id="submit" class="btn btn-success btn-rounded btn-sm mr-2"><i class="fa fa-lg fa-save mr-2"></i>Update</button>

                                <button type="button" id="addrow" class="btn btn-info btn-rounded btn-sm mr-2"><i class="fa fa-lg fa-plus mr-2"></i>Tambah</button>
                            <?php } ?>
                            <?php if ($datahead->i_status == '1') { ?>
                                <button type="button" id="send" class="btn btn-primary btn-rounded btn-sm mr-2"><i class="fa fa-lg fa-paper-plane-o mr-2"></i>Send</button>
                                <button type="button" id="hapus" class="btn btn-danger btn-rounded btn-sm mr-2"><i class="fa fa-lg fa-trash mr-2"></i>Delete</button>
                            <?php } elseif ($datahead->i_status == '2') { ?>
                                <button type="button" id="cancel" class="btn btn-primary btn-rounded btn-sm mr-2"><i class="fa fa-lg fa-refresh mr-2"></i>Cancel</button>
                            <?php } ?>
                            <button type="button" class="btn btn-inverse btn-rounded btn-sm mr-2" onclick="show('<?= $folder; ?>/cform/index/<?= $dfrom . "/" . $dto; ?>','#main'); return false;"><i class="fa fa-lg fa-arrow-circle-left mr-2"></i>Kembali</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <thead>
                    ...
                    <tr class="d-flex">
                        ...
                        <th class="text-right col-1" width="3%;" id="total"><?php $total = 0;
                                                                                ...
                                                                                echo $total; ?></th>
                        <th class="text-right col-1" width="3%;" id="totalrepair"><?php $totalrepair = 0;
                                                                                    foreach ($datadetail as $rowtotalrepair) {
                                                                                        $totalrepair += (float) $rowtotalrepair['n_quantity_repair'];
                                                                                    }
                                                                                    echo $totalrepair; ?></th>
                        <th class="col-3">&nbsp; &nbsp;</th>
                    </tr>
                ...
                <tbody>
                    ...
                    foreach ($datadetail as $key) {
                        ...
                        <tr class="d-flex">
                            ...
                            <td class="text-right col-1"><input type="text" id="nquantity<?= $i; ?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantity<?= $i; ?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="<?= $key["n_quantity"]; ?>" onkeyup="angkahungkul(this); sumo();"></td>
                            <td class="text-right col-1"><input type="text" id="nquantityrepair<?= $i; ?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantityrepair<?= $i; ?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="<?= $key["n_quantity_repair"]; ?>" onkeyup="angkahungkul(this); sumo();"></td>
...
<script>
    ...
    $("#addrow").on("click", function() {
        ...
        cols += `<td class="col-2"><input readonly type="hidden" id="idcolor${i}" class="form-control input-sm inputitem" autocomplete="off" name="idcolor${i}" value="<?= $key['id_color'] ?>"><input type="text" id="e_color${i}" class="form-control input-sm" autocomplete="off" name="e_color${i}" readonly></td>`;
        ...
        cols += `<td class="text-center col-1"><input type="text" id="nquantityrepair${i}" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantityrepair${i}" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\' value="0" onkeyup="angkahungkul(this); sumo();"></td>`;
    ...
    function sumo() {
        ...
        var qtyrepair = 0;
        for (n = 1; n <= jml; n++) {
            if ((isFinite($("#nquantity" + n).val()) && $("#nquantity" + n).val() !== '') && (isFinite($("#nquantityrepair" + n).val()) && $("#nquantityrepair" + n).val() !== '')) {
