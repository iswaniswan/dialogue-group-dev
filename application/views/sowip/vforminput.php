        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <button type="submit" id="submit" class="btn btn-block btn-success btn-sm"><i class="fa fa-lg mr-2 fa-save"></i>Simpan</button>
                        </div>
                        <div class="col-sm-3">
                            <button type="button" id="addrow" class="btn btn-block btn-info btn-sm"><i class="fa fa-lg mr-2 fa-plus"></i>Tambah</button>
                        </div>
                        <div class="col-sm-3">
                ...
                <tbody>
                    ...
                    foreach ($datadetail as $key) {
                        ...
                        <tr class="d-flex">
                            ...
                            <td class="text-right col-1"><input type="text" id="nquantity<?= $i; ?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantity<?= $i; ?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="<?= $key["qty_bagus"]; ?>" onkeyup="angkahungkul(this); sumo();"></td>
                            <td class="text-right col-1"><input type="text" id="nquantityrepair<?= $i; ?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantityrepair<?= $i; ?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="<?= $key["qty_repair"]; ?>" onkeyup="angkahungkul(this); sumo();"></td>
...
<script>
    ...
    $("#addrow").on("click", function() {
        ...
        cols += `<td class="col-1"><button type="button" title="Delete" class="ibtnDel btn btn-circle btn-danger"><i class="ti-close"></i></button></td>`;
        newRow.append(cols);
