            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <div class="col-sm-8">
                            ...
                            <input type="text" id="ekodemaster" name="ekodemaster" class="form-control" value="<?php echo $head->i_nota;?>" readonly>
                            
                        </div>
                        <div class="col-sm-4">
                            <label >Nama Bank</label>
                            <input type="text" id="ido" name="ido" class="form-control" readonly maxlength="" value="<?php echo $head->e_bank_name;?>">
                        </div>
                    </div>
                    <!-- <div class="form-group row">
                    <div class="col-sm-12">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-sm-6">
                            ...
                            <input type="text" id="dmasuk" name="dmasuk" class="form-control date" value="<?php echo $head->i_customer;?>" readonly>
                        </div>
                        <div class="col-sm-6">
                            <label>Nama Customer</label>
                            <input type="text" id="ireff" name="ireff" class="form-control" maxlength="" value="<?php echo $head->e_customer_name;?>"readonly>
                        </div>
                    </div>
                </div>
                            ...
                            <!-- <div class="panel-body table-responsive"> -->
                                <table id="tabledata" class="table color-table success-table table-bordered" cellspacing="0" width="100%" >
                                    ...
                                    $i++;?>
                                        ...
                                        <td class="col-sm-1">
                                            <input style ="width:200px" type="text" class="form-control" id="iproduct<?=$i;?>" name="iproduct<?=$i;?>"value="<?= $row->i_alokasi; ?>"  readonly >
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:300px"type="text" id="eproductname<?=$i;?>" name="eproductname<?=$i;?>"value="<?= $row->i_kbank; ?>" class="form-control" readonly >
                                        </td>                   
                                        <td class="col-sm-1">
                                            <input style ="width:150px" type="text" id="ecolor<?=$i;?>" name="ecolor<?=$i;?>"value="<?= $row->d_alokasi; ?>" class="form-control" readonly >
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:150px" class="form-control" type="text" id="qtyorder<?=$i;?>" name="qtyorder<?=$i;?>"value="<?= $row->d_kas_masuk; ?>" readonly>   
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:300px" class="form-control" type="text" id="eremarkh<?=$i;?>" name="eremarkh<?=$i;?>"value="<?= $row->v_jumlah; ?>" readonly>
                                        </td>
                                        </tr>
                                    <?}?>
