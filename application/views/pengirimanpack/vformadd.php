            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                     <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" id="dkeluar" name="dkeluar" class="form-control date" value="<?php echo date("d-m-Y"); ?>" readonly>  
                        </div>
                    </div>
                    <div class="form-group row">
            ...
            <table id="tabledatax" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center; width: 10%;">Belum diKirim</th>
   ...
   $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><input class="form-control text-right" readonly id="satuan'+no+'" name="satuan[]" value="'+data['detail'][a]['e_satuan_name']+'"></td>';
    ...
    function ceksaldo(i) {
        if (parseFloat($('#nquantity'+i).val()) > parseFloat($('#sisa'+i).val())) {
            swal('Quantity tidak boleh lebih dari Quantity Permintaan!!!');
