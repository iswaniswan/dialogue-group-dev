                ...
                <tbody>
                   <?php
                    ...
                    <tr>   
                        ...
                        <td>
                            <input style="width:100px" style="width:5%"style="width:5%"type="text" class="form-control" id="satuan<?=$i;?>" name="satuan[]" value="<?= $row->e_satuan_name; ?>" onkeyup="ceksaldo(<?=$i;?>);" readonly>
                        </td>                   
                        <td>
