                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="ipromo" id="ipromo" class="form-control select2" required="" data-placeholder="Pilih Promo">
                                    <option value="<?= $data->id_promo;?>"><?= $data->e_promo_name. ' ('.$data->i_promo_code.')';?></option>
                                </select>
                                ...
                                <input type="hidden" id="f_plus_discount" name="f_plus_discount" value="<?= $data->f_plus_discount;?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="iarea" id="iarea" class="form-control select2" required="">
                                    <option value="<?= $data->id_area;?>"><?= $data->e_area. ' ('.$data->i_area.')';?></option>
                                </select>
                            </div>
                            <div class="col-sm-5">
                                ...
                                <input type="hidden" id="ndiskon4" name="ndiskon4" class="form-control" readonly value="<?= $data->v_customer_discount3;?>">
                            </div>
                            <div class="col-sm-3">
            ...
            <div class="col-sm-12">
                <div class="table-responsive">
                    <table id="tabledatay" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                        ...
                        <tbody>
                            <?php if($datadetail->num_rows()>0){ foreach ($datadetail->result() as $key) { $i++; 
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="nquantity<?=$i;?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantity<?=$i;?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="<?= $key->n_quantity;?>" onkeyup="angkahungkul(this); cekqty('<?=$i;?>'); hitungtotal();">  <input type="hidden" readonly class="form-control input-sm text-right" name="fc<?=$i;?>" id="fc<?=$i;?>" value="<?= $key->fc;?>"/>
                                    <input type="hidden" id="n_quantity_min<?=$i;?>" name="n_quantity_min<?=$i;?>" value="<?= $key->n_quantity_min ;?>"/></td>
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 pudding">
                                                <input type="text" readonly class="form-control input-sm text-right" placeholder="%4" name="ndisc4<?=$i;?>" id="ndisc4<?=$i;?>" value="<?= $key->n_diskon4;?>"/>
                                                <input type="hidden" readonly class="form-control input-sm text-right" name="vdisc4<?=$i;?>" id="vdisc4<?=$i;?>" value="<?= $key->v_diskon4;?>"/>
                                            </div>
                                        </div>
                                    </td>
