...
<div class="col-sm-12">
        ...
        <table class="table color-bordered-table info-bordered-table" id="sitabel" cellpadding="0" cellspacing="0">
            <thead>
                ...
                <tr>
                    ...
                    <th style="font-size: 12px;text-align: center;vertical-align: middle;" rowspan=3>/DIVISI</th>
                </tr>
                ...
                <?php 
                    if($isi){
                        ...
                        $i++;
                            ...
                            echo "<a class='fa fa-pencil' href=\"#\" onclick='view_detail(\"$iperiode\",\"$iarea\");'></a>";
                            echo "</td>";
                            echo "<td class=\"action2\">";
                            echo "<a class='fa fa-pencil' href=\"#\" onclick='view_sales(\"$iperiode\",\"$iarea\");'></a>";
                            echo "</td>";
                            echo "<td class=\"action3\">";
                            echo "<a class='fa fa-pencil' href=\"#\" onclick='view_divisi(\"$iperiode\",\"$iarea\");'></a>";
                            echo "</td></tr>";	
                        }
    ...
    function view_detail(a, b) {
        lebar = 1366;
        tinggi = 768;
        eval('window.open("<?php echo site_url(); ?>"+"/listtargetcollectionall/cform/detail/"+a+"/"+b,"","width="+lebar+"px,height="+tinggi+"px,resizable=1,scrollbars=1,top=' +
    ...
    function view_sales(a, b) {
        ...
        eval('window.open("<?php echo site_url(); ?>"+"/listtargetcollectionall/cform/sales/"+a+"/"+b,"","width="+lebar+"px,height="+tinggi+"px,resizable=1,scrollbars=1,top=' +
            (screen.height - tinggi) / 2 + ',left=' + (screen.width - lebar) / 2 + '")');
    }
    ...
    function view_divisi(a, b) {
        ...
        tinggi = 768;
        periode = document.getElementById("iperiode").value;
        eval('window.open("<?php echo site_url(); ?>"+"/listtargetcollectionall/cform/divisi/"+a+"/"+b,"","width="+lebar+"px,height="+tinggi+"px,resizable=1,scrollbars=1,top=' +
            (screen.height - tinggi) / 2 + ',left=' + (screen.width - lebar) / 2 + '")');
    }
    </script>