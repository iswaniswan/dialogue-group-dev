                ...
                <div class="panel-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="idocument" id="ifaktur" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="FP-2010-000001" maxlength="20" class="form-control input-sm" value="<?= $number; ?>" aria-label="Text input with dropdown button">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" name="ddocument" id="ddocument" class="form-control input-sm" value="<?= $head->tgl; ?>" readonly="">
                                </div>
                                <div class="col-sm-4">
                    ...
                    <label class="col-md-2">Tanggal Pajak</label> -->
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="text" name="dreceivefaktur" id="dreceivefaktur" class="form-control input-sm date" value="<?php echo date("d-m-Y"); ?>" readonly="" onchange="return tgl_jatuhtempo(this.value);">
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <button type="button" id="submit" class="btn btn-success btn-block btn-sm"> <i class="fa fa-lg fa-save"></i>&nbsp;&nbsp;Simpan</button>
                                </div><div class="col-sm-4">
                                    <button type="button" class="btn btn-inverse btn-block btn-sm" onclick="show('<?= $folder; ?>/cform/index/<?= $dfrom . "/" . $dto; ?>','#main')"> <i class="fa fa-lg fa-arrow-circle-left"></i>&nbsp;&nbsp;Kembali</button>
                                </div><div class="col-sm-4">
                                    <button type="button" id="send" disabled="true" class="btn btn-primary btn-block btn-sm"><i class="fa fa-lg fa-paper-plane-o"></i>&nbsp;&nbsp;Send</button>
                                </div>
                            </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <table id="tabledatay" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                            ...
                            foreach ($detail as $key) {
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" readonly class="form-control input-sm" name="i_product_base<?= $i; ?>" id="i_product_base<?= $i; ?>" value="<?= $key->i_product_base . ' - ' . $key->e_product_basename; ?>" />
                                        ...
                                        <input type="hidden" readonly class="form-control input-sm" name="id_referensi_item<?= $i; ?>" id="id_referensi_item<?= $i; ?>" value="<?= $key->id; ?>" />
                                    </td>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td><input type="text" id="nkotor" name="nkotor" class="form-control input-sm text-right bold" value="<?= number_format($head->v_kotor); ?>" readonly></td>
                                <td colspan="2"></td>
                            </tr>
                            <tr>
                                <td class="text-right bold" colspan="6">Diskon :</td>
                                <td><input type="text" id="ndiskontotal" name="ndiskontotal" class="form-control input-sm text-right bold" readonly value="<?= number_format($head->v_diskon); ?>"></td>
                                <td colspan="2"></td>
                            </tr>
                            <tr>
                                <td class="text-right bold" colspan="6">DPP :</td>
                                <td><input type="text" id="vdpp" name="vdpp" class="form-control input-sm text-right bold" value="<?= number_format($head->v_dpp); ?>" readonly></td>
                                <td colspan="2"></td>
                            </tr>
                            <tr>
                                <td class="text-right bold" colspan="6">PPN (<?= $head->n_ppn; ?>%) :</td>
                                <td><input type="text" id="vppn" name="vppn" class="form-control input-sm text-right bold" value="<?= number_format($head->v_ppn); ?>" readonly></td>
                                <td colspan="2"></td>
                            </tr>
                            <tr>
                                <td class="text-right bold" colspan="6">Grand Total :</td>
                                <td><input type="text" id="nbersih" name="nbersih" class="form-control input-sm text-right bold" value="<?= number_format($head->v_bersih); ?>" readonly></td>
                                <td colspan="2"></td>
                            </tr>
                        </tfoot>
                    </table>
