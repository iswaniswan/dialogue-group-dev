                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-7">
                                ...
                                <?php }elseif($data->i_status=='2') {?>
                                    <button type="button" class="btn btn-primary btn-rounded btn-sm" onclick="changestatus('<?= $folder."','".$data->id;?>','7');"> <i class="fa fa-refresh"></i>&nbsp;&nbsp;&nbsp;Cancel</button>&nbsp;&nbsp;
                                <?php } ?> 
                            </div>                          
                        </div>   
                    </div> 
...
<div class="white-box" id="detail">
    ...
    <div class="panel-body table-responsive">
    <table id="tabledatax" class="table color-table inverse-table table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th>No</th>
