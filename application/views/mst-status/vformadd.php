            ...
            <div class="col-md-6">
                <div id="pesan"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="istatus" class="form-control" required="" maxlength="5" onkeyup="gede(this)" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Status Barang</label>
                        <div class="col-sm-12">
                            <input type="text" name="estatusname" class="form-control" maxlength="30"  value="" required="" >
                        </div>
                    </div>   
