            ...
            <div class="col-md-6">
                <div id="pesan"></div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="isubbagian" class="form-control" required="" maxlength="7" onkeyup="gede(this)" value="" onblur="checklength(this)">
                        </div>
                        <div class="col-sm-8">
...
<script>
 ...
 function checklength(el){
    if(el.value.length != 7){
        swal("Kode Sub Departemen Harus 7 Karakter");
    }
 }
</script>
