                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" name="ibrand" autocomplete="off" maxlength="15" id="ibrand" class="form-control" onkeyup="gede(this); clearcode(this);" required="" value="<?= $data->i_brand; ?>">
                                <span class="notekode" hidden="true"><b>* Kode Sudah Ada!</b></span>
                            </div>
                            <div class="col-sm-8">
                                <input type="text" name="ebrandname" id="ebrandname" class="form-control" onkeyup="gede(this); clearname(this);" required="" value="<?= $data->e_brand_name; ?>">
                            </div>
                        </div>           
                        <div class="form-group row">
                            <div class="col-sm-6">
