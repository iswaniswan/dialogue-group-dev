    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (let a = 0; a < data['detail'].length; a++) {
                ...
                cols += '<td><input readonly style="width:90px;" class="form-control" type="text" id="nquantity'+zz+'" name="nquantity'+zz+'" value="'+data['detail'][a]['n_quantity']+'">';
                ...
                cols += '<td><input class="form-control" style="width:300px;" type="text" id="edesc'+zz+'" name="edesc'+zz+'" value="" placeholder="Alasan Retur"></td>';
                newRow.append(cols);
                $("#tabledatax").append(newRow);
            }
            // max_tgl();
