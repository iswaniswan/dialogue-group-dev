            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <label class="col-md-6 text-center">Ceklist Untuk Mengedit Seluruh Warna</label>
                        <div class="col-sm-6">
                ...
                <table id="sitabel" class="table color-table success-table table-bordered class sitabel" cellpadding="8" cellspacing="1" width="100%">
                    ...
                    <thead>
                        <tr class="d-flex">
                            ...
                            <th class="text-center col-1">Gudang</th>
                            ...
                            <th class="text-center col-1">Kain Utama</th>
