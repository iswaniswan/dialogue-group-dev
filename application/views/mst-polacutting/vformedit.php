            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        <label class="col-md-4">Kode dan Nama Barang</label>
                        <label class="col-md-3">Nama Marker</label>
                        <label class="col-md-2 text-center">Marker Utama</label>
                        <label class="col-md-3 text-center">Ceklist Untuk Mengedit Seluruh Warna</label>
                        <div class="col-sm-4">
                            <select name="iproductwip" id="iproductwip" required="" class="form-control select2" data-placeholder="Cari Barang WIP">
                                <option value="<?= $data->i_product_wip . '|' . $data->i_color . '|' . $data->id; ?>"><?= $data->i_product_wip . ' - ' . $data->e_product_wipname . ' - ' . $data->e_color_name; ?></option>
                            </select>
                            ...
                            <select name="id_marker" id="id_marker" required="" class="form-control select2" data-placeholder="Pilih Marker">
                                <?php if ($marker->num_rows() > 0) {
                                    foreach ($marker->result() as $key) { ?>
                                        <option value="<?= $key->id; ?>" <?php if ($key->id==$data->id_marker) {?> selected <?php } ?> ><?= $key->e_marker_name; ?></option>
                                <?php }
                                } ?>
                            </select>
                        </div>
                        <div class="col-sm-2">
                            <input type="checkbox" class="form-control input-sm" name="f_marker_utama" id="f_marker_utama" <?php if ($data->f_marker_utama == 't') { ?> checked <?php } ?>>
                        </div>
                        <div class="col-sm-3">
                            <input type="checkbox" class="form-control input-sm" name="cek">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                    ...
                    <tbody>
                        ...
                        foreach ($detail as $key) {
                            ...
                            if ($group!=$key->e_nama_group_barang) {?>
                                <tr class="table-active">
                                    <td colspan="12" class="col-12 text-left font-weight-bold"><?= $key->e_nama_group_barang;?></td>
                                </tr>
                            <?php }
                        ...
                        ?>
                            <tr class="d-flex">
                                ...
                                <td class="col-2"><input type="text" readonly id="gudang<?= $i; ?>" class="form-control input-sm" name="gudang<?= $i; ?>" value="<?= $key->e_nama_group_barang; ?>"></td>
                                ...
                                <td class="col-1"><input type="text" id="bis3<?= $i; ?>" class="form-control text-right input-sm" autocomplete="off" name="bis3<?= $i; ?>" value="<?= $key->n_bis3; ?>" onkeyup="angkahungkul(this);"></td>
                                <td class="col-1">
                                ...
                                <td class="col-1 text-center"><input class="form-control input-sm" type="checkbox" id="f_kain_utama<?= $i; ?>" name="f_kain_utama<?= $i; ?>" <?php if ($key->f_kain_utama == 't') { ?> checked <?php } ?>></td>
                                <td class="col-1 text-center"><input class="form-control input-sm" type="checkbox" id="f_budgeting<?= $i; ?>" name="f_budgeting<?= $i; ?>" <?php if ($key->f_budgeting == 't') { ?> checked <?php } ?>></td>
                                <td class="col-1 text-center"><input class="form-control input-sm" type="checkbox" id="f_jahit<?= $i; ?>" name="f_jahit<?= $i; ?>" <?php if ($key->f_jahit == 't') { ?> checked <?php } ?>></td>
                                <td class="col-1 text-center"><input class="form-control input-sm" type="checkbox" id="f_packing<?= $i; ?>" name="f_packing<?= $i; ?>" <?php if ($key->f_packing == 't') { ?> checked <?php } ?>></td>
...
<script>
    ...
    function tambah(jml) {
        ...
        cols += `<td class="text-center col-1"><input class="form-control input-sm" type="checkbox" id="f_jahit${i}" name="f_jahit${i}" checked></td>`;
        cols += `<td class="text-center col-1"><input class="form-control input-sm" type="checkbox" id="f_packing${i}" name="f_packing${i}" checked></td>`;
