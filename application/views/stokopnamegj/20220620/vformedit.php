                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select data-nourut="<?= $i ;?>" id="idproduct<?= $i ;?>" class="form-control select2 input-sm" name="idproduct<?= $i ;?>" >
                                            <option value="<?= $key['id_product'].'|'.$key['e_jenis_barang']?>"><?= $key["i_product"].' - '.$key["e_product"];?></option>
                                        </select>
                                    </td>
...
<script>
    $(document).ready(function () {
        for (var i = 1; i <= $('#jml').val(); i++) {
             ...
             */
                ...
                var ikode = kode[0]+'|'+kode[1];
                var z = $(this).data('nourut');
                var ada = true;
                for(var x = 1; x <= $('#jml').val(); x++){
                    if ($(this).val()!=null) {
                        if((ikode == $('#idproduct'+x).val()) && (z!=x)){
                            swal ("kode barang tersebut sudah ada !!!!!");
                            ada = false;
                            break;
                        } else {
                            $('#e_color'+z).val(kode[3]);
    ...
    $("#addrow").on("click", function () {
        ...
        cols += `<td><select data-nourut="${i}" id="idproduct${i}" class="form-control input-sm" name="idproduct${i}" ></select></td>`;
         cols += `<td><input type="text" id="e_color${i}" class="form-control text-left input-sm inputitem" autocomplete="off" name="e_color${i}" readonly></td>`;
