            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                   <div class="form-group row">
                        ...
                        <div class="col-sm-2"> 
                            <input type="text" name="idocument" id="idocument" class="form-control" value="<?= $idocument;?>" readonly>
                        </div>
                        <div class="col-sm-2"> 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select data-nourut="<?= $i ;?>" id="idproduct<?= $i ;?>" class="form-control select2 input-sm" name="idproduct<?= $i ;?>" >
                                            <option value="<?= $key['id_product'].'|'.$key['jenis_barang']?>"><?= $key["i_product_base"].' - '.$key["e_product"];?></option>
                                        </select>
                                    </td>
                                    <td>
