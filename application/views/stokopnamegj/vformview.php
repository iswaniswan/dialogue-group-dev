...
<div class="white-box" id="detail">
    ...
    <div class="col-sm-12">
        <div class="card-body">
            <table id="tabledatay" data-show-pagination-switch="true" data-pagination="true" data-page-list="[10, 25, 50, 100, all]" class="table color-table tableFixHead inverse-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                <thead>
                    <tr>
                        <!-- <th></th> -->
                        ...
                        <th class="text-right">Jumlah SO <br> <?= $total; ?></th>
                        <th class="text-right">Jumlah SO Repair <br> <?= $total_repair; ?></th>
                        <th class="text-right">Jumlah SO Grade B <br> <?= $total_gradeb; ?></th>
                        <th>Keterangan</th>
                    </tr>
                </thead>
                <tbody>
