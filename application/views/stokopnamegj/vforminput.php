            ...
            <div class="panel-body">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <button type="button" hidden="true" id="send" onclick="changestatus('<?= $folder; ?>',$('#kode').val(),'2');" class="btn btn-primary btn-block btn-sm"><i class="fa fa-paper-plane-o mr-2"></i>Send</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <table id="tabledatay" class="table color-table tableFixHead success-table table-bordered" cellpadding="8" cellspacing="1" width="100%">
                <thead>
                    ...
                    <tr>
                        ...
                        <th class="text-right" width="3%;" id="total_repair"><?= 0; ?></th>
                        <th class="text-right" width="3%;" id="total_gradeb"><?= 0; ?></th>
                        <th colspan="2"></th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <select data-nourut="<?= $i; ?>" id="idmaterial<?= $i; ?>" class="form-control input-sm" name="idmaterial<?= $i; ?>">
                                    <option value="<?= $data['id'] . '|' . $data['e_color_name']; ?>" selected><?= $data['i_product'] . ' - ' . $data['e_product_name'] . ' (' . $data['e_color_name'] . ')'; ?></option>
                                </select>
                            </td>
                            <td><input type="text" id="e_satuan<?= $i; ?>" class="form-control input-sm inputitem" autocomplete="off" name="e_satuan<?= $i; ?>" readonly value="<?= $data['e_color_name']; ?>"></td>
                            <td class="text-right"><input type="text" data-qty="<?= $i; ?>" id="nquantity<?= $i; ?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantity<?= $i; ?>" onblur="if(this.value==''){this.value=0;}" onfocus="if(this.value=='0'){this.value=0;}" value="<?= $data['qty_bagus']; ?>" onkeyup="angkahungkul(this); sumo(<?= $i; ?>);"></td>
                            <td class="text-right"><input type="text" data-qty_repair="<?= $i; ?>" id="nquantity_repair<?= $i; ?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantity_repair<?= $i; ?>" onblur="if(this.value==''){this.value=0;}" onfocus="if(this.value=='0'){this.value=0;}" value="<?= $data['qty_repair']; ?>" onkeyup="angkahungkul(this); sumi(<?= $i; ?>);"></td>
                            <td class="text-right"><input type="text" data-qty_gradeb="<?= $i; ?>" id="nquantity_gradeb<?= $i; ?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantity_gradeb<?= $i; ?>" onblur="if(this.value==''){this.value=0;}" onfocus="if(this.value=='0'){this.value=0;}" value="<?= $data['qty_grade']; ?>" onkeyup="angkahungkul(this); sumu(<?= $i; ?>);"></td>
                            <td><input type="text" class="form-control input-sm" name="eremark<?= $i; ?>" id="eremark<?= $i; ?>" placeholder="Isi keterangan jika ada!" value="<?= $data['e_remark']; ?>"/></td>
