                ...
                <tbody>
                    ...
                    foreach ($datadetail as $row) {
                        ...
                        <tr>
                            ...
                            <td class="text-right"><input type="text" data-qty="<?= $i; ?>" id="nquantity<?= $i; ?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantity<?= $i; ?>" onblur="if(this.value==''){this.value=0;}" onfocus="if(this.value=='0'){this.value=0;}" value="0" onkeyup="angkahungkul(this); sumo(<?= $i; ?>);"></td>
                            <td class="text-right"><input type="text" data-qty_repair="<?= $i; ?>" id="nquantity_repair<?= $i; ?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantity_repair<?= $i; ?>" onblur="if(this.value==''){this.value=0;}" onfocus="if(this.value=='0'){this.value=0;}" value="0" onkeyup="angkahungkul(this); sumi(<?= $i; ?>);"></td>
                            <td class="text-right"><input type="text" data-qty_gradeb="<?= $i; ?>" id="nquantity_gradeb<?= $i; ?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantity_gradeb<?= $i; ?>" onblur="if(this.value==''){this.value=0;}" onfocus="if(this.value=='0'){this.value=0;}" value="0" onkeyup="angkahungkul(this); sumu(<?= $i; ?>);"></td>
