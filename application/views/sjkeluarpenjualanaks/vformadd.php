                ...
                <div class="col-md-6">
                    ...
                    <label class="col-md-6">Supplier</label>
                        ...
                        <div class="col-sm-3">
                         ...
                         <div class="col-sm-6">
                            <select name="isupplier" id="isupplier" class="form-control select2" onchange="gett(this.value);">
                            </select>
                        </div>
                    </div>
                    ...
                    <div id="pesan"></div>
                    <div class="form-group">
                        <!-- <label class="col-md-6">Jenis Pembayaran</label> -->
    ...
    $.ajax({
        ...
        success: function (data) {  
            ...
            for (let a = 0; a < data['jmlitem']; a++) {
                ...
                cols += '<td><input style="width:80px;" class="form-control" readonly type="hidden" id="nquantity'+a+'" name="nquantity'+a+'" value="'+nquantity+'"><input style="width:80px;" readonly class="form-control" type="text" id="npemenuhan'+a+'" name="npemenuhan'+a+'" value="'+npemenuhan+'"></td>';
                cols += '<td><input style="width:40px;"  type="hidden" id="isatuan'+a+'" name="isatuan'+a+'" value="'+isatuan+'"><input style="width:90px;" class="form-control" type="text" id="esatuan'+a+'" readonly name="esatuan'+a+'" value="'+esatuan+'"></td>';
