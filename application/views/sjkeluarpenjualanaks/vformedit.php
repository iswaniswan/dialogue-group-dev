                    ...
                    <!-- <input type="hidden" name="jml" id="jml"> -->
                            ...
                            $grandtotop=0;
                                    $i = 0;
                                        ...
                                        <td class="col-sm-1">
                                            <input style ="width:70px"type="text" id="nquantityeks<?=$i;?>" name="nquantityeks<?=$i;?>" value="<?=$row->n_qty_eks;?>" class="form-control">
                                        </td>
                                        <td class="col-sm-1">
                                        ...
                                        <td class="col-sm-1">
                                            <input style ="width:80px" class="form-control" type="text" id="nquantity<?=$i;?>" name="nquantity<?=$i;?>"value="<?= $row->n_qty; ?>"onkeyup= hitungnilai(this.value);>
                                        </td>
                                        <td class="col-sm-1">
