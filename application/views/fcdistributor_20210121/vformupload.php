                    ...
                    <tbody>
                        ...
                        foreach ($datadetail as $key) {
                            ...
                            <tr>
                                ...
                                <td><input type="text" readonly id="price<?= $i ;?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="price<?= $i ;?>" value="<?= $key["v_harga"];?>"></td>
...
var i = $('#jml').val();
    $("#addrow").on("click", function () {
        ...
        cols += `<td><input type="text" id="rata${i}" readonly class="form-control text-right input-sm" autocomplete="off" name="rata${i}" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\' value="0" onkeyup="angkahungkul(this);"></td>`;
