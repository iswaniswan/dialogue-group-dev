        ...
        <div class="panel panel-info">
            ...
            <?php if ($msg != '') echo "<i>".$msg."</i><br><br>"; ?>
                ...
                <div class="form-group">
                    <label class="col-md-6">Lokasi Packing</label>
                    <div class="col-sm-4">
                        <select name="ilokasipacking" id="ilokasipacking" class="form-control select2" > 
                        </select>
                        <input type="hidden" name="ikodepacking" id="ikodepacking" class="form-control" readonly>
                    </div>
                </div> 
...
$(document).ready(function () {
        $('#ilokasipacking').select2({
        placeholder: 'Pilih lokasi',
        allowClear: true,
        ajax: {
          url: '<?= base_url($folder.'/cform/lokasipacking'); ?>',
          dataType: 'json',
          delay: 250,          
        ...
        var kode = $('#ilokasipacking').text();
        kode = kode.split("-");
        $('#ikodepacking').val(kode[0].trim());
     });
});
...
var s=0;
    ...
    if (document.getElementById('ilokasipacking').value=='') {
        swal("Maaf Tolong Pilih Lokasi Packing!");
        return false;
...
function kodemaster(id){
        var ilokasipacking = $('#ilokasipacking'+id).val();
        $.ajax({
        type: "post",
        data: {
            'ilokasipacking': ilokasipacking
        },
