            ...
            <div class="container-fluid table-responsive">
                <table class="table table-hover table-bordered">
                    <thead style="background: #f8f9fa!important">
                        ...
                        <th class="text-center" style="width: 450px">Nama Barang Jadi</th>
                        <th class="text-right" style="width: 20px">Qty Kirim</th>
                        <th class="text-center" style="width: 200px">Keterangan</th>
                    </thead>
                    <tbody>
                        <?php $i=0; foreach ($datadetail as $row) {
                            $i++;?>
                            <tr>
                                ...
                                <td>
                                   <?= $row['e_product_basename'] . " - " . $row['e_color_name'] ?>
                                </td>
                                <td class="text-right">
