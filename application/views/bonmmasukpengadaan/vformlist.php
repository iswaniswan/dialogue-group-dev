        ...
        <div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-list"></i> <?= $title; ?>
                <?php  if(check_role($this->i_menu, 1)){ ?><a href="#" onclick="show('<?= $folder; ?>/cform/tambah/','#main'); return false;" class="btn btn-info btn-sm pull-right"><i
                        class="fa fa-plus"></i> &nbsp;<?= $title; ?> Pengesettan</a>
                <?php } ?>
                <!-- <?php  if(check_role($this->i_menu1, 1)){ ?><a href="#" onclick="show('<?= $folder1; ?>/cform/tambah/','#main'); return false;" class="btn btn-info btn-sm pull-right"><i
