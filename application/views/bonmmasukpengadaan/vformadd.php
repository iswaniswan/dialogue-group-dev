                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" name="idocument" id="idocument" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="BBM-2010-0001" maxlength="13" class="form-control input-sm" value="<?= $number;?>" aria-label="Text input with dropdown button">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="hidden" id="ijenis" name="ijenis">
                        </div>
                        <div class="col-sm-4">
                ...
                success: function (data) {  
                    ...
                    for (let a = 0; a < data['jmlitem']; a++) {
                        ...
                        var cols1       = "";
                            ...
                            cols1 += '<td><input readonly class="form-control qty input-sm text-right" autocomplete="off" type="text"  id="nquantitywip'+a+'" name="nquantitywip'+a+'" value="'+data['dataitem'][a]['n_quantity_wip']+'" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\' onkeyup="validasi('+a+');" ></td>';
    ...
    function konfirm() {
        ...
        if(jml==0){
            ...
            $.ajax({
                ...
                url: '<?= base_url($folder.'/cform/datavalidasi'); ?>',
                dataType: "json",
                success: function (data) { 
                    if(!data || data == false){
                        swal('Referensi sudah ada !');
                        ada = true;
                    }else {
                        ada = false;
                    }
