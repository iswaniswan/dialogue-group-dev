    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <label class="col-md-12">Keterangan (Sales)</label>
                        <div class="col-sm-12">
                            <input id="eapprove1" name="eapprove1" class="form-control" value="<?= $isi->e_approve1; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-12">Keterangan</label>
                        <div class="col-sm-12">
                            <input id="eapprove2" name="eapprove2" class="form-control">
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            <?php if ($detail) {
                                ...
                                foreach ($detail as $row) { 
                                    ...
                                    <td>
                                        <input style="text-align: right;" class="form-control" id="nacc<?=$i;?>" name="nacc<?=$i;?>" value="<?= $row->n_acc;?>" readonly>
                                    </td>
                                    <td>
