            ...
            <table id="tabledatax" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input style="width:450px;" class="form-control" readonly id="iproduct<?= $i ;?>" name="iproduct<?= $i ;?>" value="<?= $key->i_product_base. ' - '.$key->e_product_basename ;?>">
                        </td>
                        <td>
                            <input style="width:150px;" readonly class="form-control" id="ecolor<?= $i ;?>" name="ecolor<?= $i ;?>" value="<?= $key->e_color_name ;?>">
                        </td>
                        <td>
                            <input style="width:100px;" class="form-control text-right" readonly id="nquantitykeluar<?= $i ;?>" name="nquantitykeluar<?= $i ;?>" value="<?= $key->keluarfull ;?>">
                        </td>
                        <td>
                            <input style="width:100px;" class="form-control text-right" readonly id="sisa<?= $i ;?>" name="sisa<?= $i ;?>" value="<?= $key->keluar ;?>">
                        </td>
                        <td>
                            <input style="width:100px;" class="form-control text-right inputitem" id="nquantity<?= $i ;?>" placeholder="0" name="nquantity<?= $i ;?>" value="<?= $key->masuk ;?>" onblur='if(this.value==""){this.value="0";}' onfocus='if(this.value=="0"){this.value="";}' onkeypress="return hanyaAngka(event);" onkeyup="ceksaldo(<?= $i ;?>);">
                        </td>
                        <td>
                            <input style="width:300px;" class="form-control" id="eremark<?= $i ;?>" name="eremark<?= $i ;?>" value="<?= $key->e_remark ;?>">
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><input style="width:450px;" class="form-control" readonly id="iproduct'+no+'" name="iproduct'+no+'" value="'+data['detail'][a]['i_product_base']+ ' - ' +data['detail'][a]['e_product_basename']+'"></td>';
