...
<script>
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><input style="width:100px;" type="text" id="nquantity'+counter+'" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantity[]" value="0" onkeyup="hitungtotal(); reformat(this); cekval(this.value);"></td>';
        ...
        cols += '<td><input style="width:100px;" type="text" id="adddiskon'+ counter + '" class="form-control" name="adddiskon[]" value="0" onkeyup="hitungtotal(); reformat(this); cekval(this.value);"></td>';
