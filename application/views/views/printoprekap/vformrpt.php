...
#			$mot	= $rowi->e_product_motifname." ".str_repeat(" ",42-strlen($rowi->e_product_motifname ));
     ...
     if(strlen($rowi->e_remark)<43){
   			$mot = $rowi->e_remark." ".str_repeat(" ",42-strlen($rowi->e_remark ));
      }else{
        $mot = substr($rowi->e_remark,0,41);
      }
...
#          $cetak='';
  	...
  	if($quer->num_rows()>0){
		...
		$cetak.=$ab."Batas Pengiriman Terakhir : ".$dop.$spc1.CHR(27).CHR(45).CHR(1).str_repeat(" ",20).CHR(27).CHR(45).CHR(0)."     ".CHR(27).CHR(45).CHR(1).$spcttd.$company->ttd_op.$spcttx.CHR(27).CHR(45).CHR(0)."\n";				
