            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="ipromo" id="ipromo" autocomplete="off" class="form-control"required="" maxlength="15" onkeyup="gede(this); clearcode(this);" value="">
                                <span class="notekode" hidden="true"><b> * Kode Sudah Ada!</b></span>
                            </div>
                            <div class="col-sm-5">
                                <input type="text" name="epromo" id="epromo" onkeyup="gede(this); clearname(this);" class="form-control" value="" maxlength="300">
                            </div>
                            <div class="col-sm-4">
                                <input type="text" name="ejenis" id="ejenis" onkeyup="gede(this); clearname(this);" class="form-control" value="" maxlength="100">
                            </div>
                        </div>       
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="njumlah" id="njumlah"  class="form-control">
                            </div>
                            <div class="col-sm-2">
                                <input type="text" name="dperiode" id="dperiode" class="form-control date" value="" readonly>
                            </div>
                        </div>                               
