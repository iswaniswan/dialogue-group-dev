            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input readonly id="ecumstomeraddress" name="ecumstomeraddress" class="form-control" maxlength="100" value="<?php echo $isi->e_customer_address; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input id="fspbstokdaerah" name="fspbstokdaerah" class="form-control" type="hidden" readonly>
		                    <input id="fspbsiapnotagudang" name="fspbsiapnotagudang" class="form-control" type="hidden" <?php if($isi->f_spb_siapnotagudang=='t'){
                                                                            echo "value='on'";
                                                                            }else{
                                                                              echo "value=''";
                                                                            }?>>
		                    <input id="f_spb_op" name="f_spb_op" class="form-control" type="hidden" <?php if($isi->f_spb_op=='t'){
                                                                              echo "value='on'";
                                                                            }else{
                                                                              echo "value=''";
                                                                            }?>>
		                    <input id="f_spb_program" name="f_spb_program" class="form-control" type="hidden" <?php if($isi->f_spb_program=='t'){
                                                                              echo "value='on'";
                                                                            }else{
                                                                              echo "value=''";
                                                                            }?>>
		                    <input id="f_spb_cancel" name="f_spb_cancel" class="form-control" type="hidden" <?php if($isi->f_spb_cancel=='t'){
                                                                              echo "value='on'";
                                                                            }else{
                                                                              echo "value=''";
                                                                            }?>>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <?php if($isi->e_price_groupname==''){
                            ...
                            <input id="istore" name="istore" type="hidden" class="form-control" value="<?php echo $isi->i_store; ?>">
                            <input id="istorelocation" name="istorelocation" type="hidden" class="form-control" value="<?php echo $isi->i_store_location; ?>">
                        </div>
                    </div>
                    <div class="form-group">
		                ...
		                ?>
                        <div class="col-sm-6">
                            <input readonly id="vspb" name="vspb" class="form-control" value="<?php echo number_format($norderspbbefore); ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
		                    <input readonly id="vcustomerdiscount1" name="vcustomerdiscount1" class="form-control" value="<?php echo number_format($disc1); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input <?php if( ($isi->n_spb_discount1!='0.00') || ($isi->n_spb_discount2!='0.00') || ($isi->n_spb_discount2!='0.00') ){
						                echo "readonly ";
					                }?>id="vspbdiscounttotal" name="vspbdiscounttotal" class="form-control" readonly value="<?php echo number_format($disctot); ?>"></td>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                        <input id="eremarkx" name="eremarkx" maxlength="100" class="form-control" value="<?php echo $isi->e_remark1; ?>" >
                        </div>
                    </div>
                </div>
                                ...
                                <?php if ($detail) {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-control" style="text-align:right;" type="text" id="ndeliver<?=$i;?>" name="ndeliver<?=$i;?>" value="<?= $row->n_deliver; ?>" readonly onkeyup="hitungnilai(this.value,<?=$jmlitem;?>)">
                                                <input class="form-control" style="text-align:right;" type="hidden" id="ndeliverx<?=$i;?>" name="ndeliverx<?=$i;?>" value="<?= $row->n_deliver; ?>" readonly onkeyup="hitungnilai(this.value,<?=$jmlitem;?>)">
                                            </td>
                                            <td>
                                                <input class="form-control" style="text-align:right;" type="text" id="vtotal<?=$i;?>" name="vtotal<?=$i;?>" value="<?= $total; ?>" readonly>
                                                <input class="form-control" style="text-align:right;" type="hidden" id="vtotalx<?=$i;?>" name="vtotalx<?=$i;?>" value="" readonly>
                                            </td>
                                            <td>
                                                <input class="form-control" style="text-align:right;" type="text" id="eremark<?=$i;?>" name="eremark<?=$i;?>" value="<?= $row->ket; ?>" readonly onkeyup="hitungnilai(this.value,<?=$jmlitem;?>)">
                                            </td>
                                        </tr>
                                    <?php  } ?>
