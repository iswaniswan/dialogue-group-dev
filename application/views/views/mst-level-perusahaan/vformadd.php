            ...
            <div class="col-md-6">
                <div id="pesan"></div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="ilevel" name="ilevel" autocomplete="off" class="form-control"  value="" required="" maxlength="15" onkeyup="gede(this);clearcode(this);" >
                            <span id="cek" hidden="true"> 
                                    <font size="3" face="Courier New" color="red">Kode Sudah Ada!</font> 
                            </span>
                        </div>
                        <div class="col-sm-8">
                            <input type="text" name="elevel" class="form-control" maxlength="35" onkeyup="gede(this);clearname(this);" value="" required="">
                        </div>
                    </div>                                  
