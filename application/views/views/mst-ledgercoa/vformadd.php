        ...
        <div class="panel-body table-responsive">
            ...
            <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="iledger" id="iledger" class="form-control input-sm" required="" maxlength="10" onkeyup="gede(this)" value="" placeholder="<?= $number;?>">
                            <span id="cek" hidden="true"> 
                                <font size="3" face="Courier New" color="red">Kode Sudah Ada!</font> 
                            </span>
                        </div>
                        <div class="col-sm-5">
                            <input type="text" name="eledger" id="eledger" class="form-control" value="" required="" onkeyup="gede(this)" placeholder="Nama Group Coa">
                        </div>
                        <div class="col-sm-3">
