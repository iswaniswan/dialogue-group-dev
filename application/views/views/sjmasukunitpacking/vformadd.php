                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" name="idocument" id="i_document_bbm" required="" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number; ?>" maxlength="16" class="form-control input-sm" value="" aria-label="Text input with dropdown button">
                        ...
                        <div class="col-sm-3">
                            <input type="text" id="idocumentsup" name="idocumentsup" class="form-control input-sm" placeholder="Surat Jalan Supplier" required="" value="" onkeyup="gede(this);">
                        </div>
                    </div>
                    <div class="form-group row">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#i_document_bbm').mask('SSS-0000-000000S');
        $('.select2').select2();
        showCalendar('.date');
        number();
    });
    ...
    $('#ceklis').click(function(event) {
        if ($('#ceklis').is(':checked')) {
            $("#i_document_bbm").attr("readonly", false);
        } else {
            $("#i_document_bbm").attr("readonly", true);
            $("#ada").attr("hidden", true);
            number();
        }
    });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><input class="form-control input-sm text-right" readonly id="nquantitykeluar' + no + '" name="nquantitykeluar' + no + '" value="' + data['detail'][a]['n_quantity'] + '"></td>';
                    cols += '<td><input class="form-control input-sm text-right" readonly id="sisa' + no + '" name="sisa' + no + '" value="' + data['detail'][a]['n_quantity_sisa'] + '"></td>';
                    cols += '<td><input class="form-control input-sm text-right inputitem" id="nquantity' + no + '" name="nquantity' + no + '" value="' + data['detail'][a]['n_quantity_sisa'] + '" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\' onkeypress="return hanyaAngka(event);" onkeyup="ceksaldo(' + no + ');"></td>';
                    cols += '<td><input class="form-control input-sm" id="eremark' + no + '" name="eremark' + no + '" value=""></td>';
                    newRow.append(cols);
