                        ...
                        foreach ($datadetail as $key) {
                            ...
                            if($group==""){ ?>
                                <tr class='tdna'>
                                    ...
                                    <td><input readonly class="form-control input-sm text-right" autocomplete="off" type="text" id="nquantity<?=$i;?>" name="nquantity<?=$i;?>" value="<?= $key->n_quantity;?>" placeholder="0" onkeyup="angkahungkul(this); cekqty(<?=$i;?>); hetang(this.value,<?= $key->id_material.','.$key->id_document;?>)"></td>
                                    <td></td>
                                </tr>
