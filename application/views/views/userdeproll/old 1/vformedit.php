                    ...
                    <tbody>
                       <?$i = 0;
                        ...
                        <tr>
                            ...
                            <?
                            if($row->i_apps == '2'){?>
                                    <button type="button" onclick="hapusdetail(<?= $row->i_menu.','.$row->id_user_power.','.$row->i_departement.','.$row->i_level;?>);" title="Delete" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                            </td>
                            <?}?>
                        </tr>
                        <?}?>
...
<script>
    ...
    function hapusdetail(imenu,userpower,dept,level) {
    swal({   
