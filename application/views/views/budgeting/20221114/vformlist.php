    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            ...
            <?php if(check_role($this->i_menu, 1)){ ?>
                <a href="#" onclick="show('<?= $folder; ?>/cform/indexx/<?= $dfrom."/".$dto;?>','#main'); return false;" class="btn btn-info btn-sm pull-right">
                    <i class="fa fa-list"></i> &nbsp;list Forecast
                </a>
                <a href="#" onclick="show('<?= $folder; ?>/cform/index2/<?= $dfrom."/".$dto;?>','#main'); return false;" class="btn btn-info btn-sm pull-right">
                    <i class="fa fa-plus"></i> &nbsp;tambah budgeting qty
                </a>
            <?php } ?>
        </div>            
