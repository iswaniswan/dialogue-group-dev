                    ...
                    <table id="tabledatay" class="table color-table nowrap success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                        ...
                        <tbody>
                            ...
                            foreach ($datadetaill as $row) {
                                ...
                                <tr>
                                    <td class="text-center"><?= $no; ?></td>
                                    <td class="text-left"><?= $row->i_material; ?></td>
                                    <td class="text-left"><?= ucwords(strtolower($row->e_material_name)); ?></td>
                                    <td class="text-right">
                                    ...
                                    <td class="text-right">
                                        <input readonly type="text" class="form-control input-sm text-right w90" name="acc_pelengkap<?= $x; ?>" id="acc_pelengkap<?= $x; ?>" autocomplete="off" onkeyup="angkahungkul(this); hetang(<?= $x; ?>);" onblur="if(this.value==''){this.value='0';hetang(<?= $x; ?>);}" onfocus="if(this.value=='0'){this.value='';}" value="<?= number_format($row->n_acc_pelengkap, 2); ?>">
                                    </td>
                                    <td class="text-right">
                                    ...
                                    <td class="text-right">
                                        <input type="text" class="form-control input-sm text-right w90" name="schedule<?= $x; ?>" id="schedule<?= $x; ?>" autocomplete="off" onkeyup="angkahungkul(this); hetang(<?= $x; ?>);" onblur="if(this.value==''){this.value='0';hetang(<?= $x; ?>);}" onfocus="if(this.value=='0'){this.value='';}" value="<?= number_format($row->estimasi, 2); ?>">
                                    </td>
                                    <td class="text-right">
                                    ...
                                    <td class="text-right">
                                        <input type="text" class="form-control input-sm text-right w90" name="sisaop<?= $x; ?>" id="sisaop<?= $x; ?>" autocomplete="off" onkeyup="angkahungkul(this); hetang(<?= $x; ?>);" onblur="if(this.value==''){this.value='0';hetang(<?= $x; ?>);}" onfocus="if(this.value=='0'){this.value='';}" value="<?= number_format($row->op_sisa, 2); ?>">
                                    </td>
                                    <td class="text-right">
                                        <input readonly type="text" class="form-control input-sm text-right w90" name="nilai_budgeting<?= $x; ?>" id="nilai_budgeting<?= $x; ?>" autocomplete="off" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" onkeyup="angkahungkul(this);" value="<?= number_format($row->n_budgeting_perhitungan, 2); ?>">
                                    </td>
                                    <td class="text-right">
                                        <input type="text" class="form-control input-sm text-right w90" name="up<?= $x; ?>" id="up<?= $x; ?>" autocomplete="off" onkeyup="angkahungkul(this); hetang(<?= $x; ?>);" onblur="if(this.value==''){this.value='0';hetang(<?= $x; ?>);}" onfocus="if(this.value=='0'){this.value='';}" value="<?= number_format($row->persen_up, 2); ?>">
                                    </td>
                                    <td class="text-right">
                                        <input readonly type="text" class="form-control input-sm text-right w90" name="nilai_actual<?= $x; ?>" id="nilai_actual<?= $x; ?>" autocomplete="off" value="<?= number_format($row->n_budgeting, 2); ?>">
                                    </td>
                                    <td class="text-left"><?= ucwords(strtolower($row->e_satuan_konversi)); ?></td>
                                    <td>
                                        <input type="text" class="form-control input-sm w150" name="ket<?= $x; ?>" id="ket<?= $x; ?>" value="<?= $row->e_remark; ?>" autocomplete="off">
