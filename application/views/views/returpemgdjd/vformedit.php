                ...
                <?$i = 0;
                        ...
                        <tr>
                            <td style="text-align: center;"><?= $i;?>
                                ...
                                <input style ="width:150px" type="hidden" class="form-control" id="ibtb<?=$i;?>" name="ibtb<?=$i;?>"value="<?= $row->id_btb;?>" readonly >
                            ...
                            <td>
                                <input type="text" style="width:100px" class="form-control" id="qtyretur<?=$i;?>" name="qtyretur<?=$i;?>" value="<?= $row->n_quantity_retur; ?>" onkeyup="gettotal(this);">
