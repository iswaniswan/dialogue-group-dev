        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-md-12">Upload File (Optional)</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <button type="button" id="upload" class="btn btn-success btn-block btn-sm"><i class="fa fa-upload mr-1 mr-2"></i>Upload SO</button>
                            </div>
                            <div class="col-md-6">
...
<script>
    ...
    function export_data() {
        ...
        $('#href_export').attr('href', '<?php echo site_url($folder . '/cform/export/'); ?>');
        return true;
