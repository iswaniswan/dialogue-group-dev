        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                <table id="tabledata" class="display nowrap" cellspacing="0" width="100%">
                    ...
                    <tfoot align="right">
	                      <tr><th colspan="4" style="text-align: center;">Sub Total </th><th></th></tr>
	                      <tr><th colspan="4" style="text-align: right;">Grand Total </th><th style="text-align: right;"><?= number_format($total->jml);?></th>
                        </tr>
                    </tfoot>
                </table>
            </div>
...
*/            var enamTotal = api
    ...
    */        $( api.column( 4 ).footer() ).html(enamTotal.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,'));
            },
            "language": {
                "decimal": ",",
                "thousands": "."
            ...
            "ajax": {
                "url": base_url + "<?php echo $folder; ?>/Cform/data/<?php echo $isupplier;?>",
                "type": "POST"
            },
            "displayLength": 10
        } );
