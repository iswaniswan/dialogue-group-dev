                    ...
                    <?php $no = 0; $group = ''; foreach ($detail as $key) { $no++; ?>
                        ...
                        <?php }else{ 
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <?= $key->qtyma;?>
                                    <input type="hidden" id="jmllembar<?= $i ;?>" name="jmllembar<?= $i ;?>" value="<?= $key->qtyma;?>">
                                </td>
                                <td>
                                    <?= $key->e_remark;?>
...
<script>   
    ...
    $('#approve').click(function(event) {
        ...
        for (var x = 0; x < $("#jml").val(); x++) {
            ...
            if (parseInt($('#jmllembar'+x).val()) > parseInt($('#qtysc'+x).val())) {
                var habis = true;
                iproduct += $('#imaterial'+x).val()+', ';
            }
        }
        ...
        if (habis==false) {
            ...
            swal("Yaaahhh :(", "Jml Kode "+iproduct.substr(0,n)+" Melebihi Jml Sisa :(", "error");
            return false;
        }
    });
</script>