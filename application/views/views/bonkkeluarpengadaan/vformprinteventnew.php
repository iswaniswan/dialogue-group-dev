                        ...
                        if($data_barcode->num_rows() > 0) { ?>
                            ...
                            foreach($data_barcode->result() as $db) { ?>
                                    ...
                                    <script>
                                        ...
                                        var canvas = document.getElementById("qrcode<?= $db->id ?>");
                                        // var context = canvas.getContext("2d");
                                        // context.fillStyle = "blue";
                                        // context.font = "bold 14px Arial";
                                        // context.fillText("Zibri", (canvas.width / 2) - 17, canvas.height + 2);
                                        // // draw to canvas...
                                        canvas.toBlob(function(blob) {
                                            saveAs(blob, "<?=$db->e_company. ' - '. $db->e_name. ' - '. $db->e_ruangan;?>.png");
                                        });
