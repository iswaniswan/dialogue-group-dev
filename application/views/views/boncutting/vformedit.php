                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="text" name="ibonk" id="ibonk" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number;?>" maxlength="17" class="form-control input-sm" value="<?= $data->i_document;?>" aria-label="Text input with dropdown button">
                ...
                <tbody>
                    <?php $z = 0; $group = ""; foreach ($datadetail as $key) { $i++; 
                        ...
                        <tr>
                            ...
                            <td><select data-nourut="<?= $i; ?>" id="idproduct<?= $i; ?>" class="form-control input-sm" name="idproduct<?= $i; ?>"><option value="<?= $key->id_panel;?>"><?= $key->i_panel . ' - ' . $key->bagian . ' - ' . $key->e_color_name;?></option></select><input type="hidden" id="idpanel<?= $i; ?>" name="idpanel[]" value="<?= $key->id_panel; ?>"></td>
                            <td>
                                <input type="text" id="nquantity<?= $i; ?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantity[]" onblur='if(this.value==""){this.value="0";}' onfocus='if(this.value=="0"){this.value="";}' value="<?= $key->n_quantity; ?>" onkeyup="angkahungkul(this);">
                                <input type="hidden" id="nquantity_awal<?= $i; ?>" name="nquantity_awal[]" value="<?= $key->n_saldo_akhir; ?>">
                            </td>
                            <td><input type="text" class="form-control input-sm" name="eremark[]" id="eremark<?= $i; ?>" value="<?= $key->e_remark; ?>" placeholder="Isi keterangan jika ada!"/><input type="hidden" name="vprice<?= $i; ?>" id="vprice<?= $i; ?>" ></td>
