        ...
        <div class="panel-heading">
            ...
            <?php echo $this->pquery->form_remote_tag(array('url' => site_url($folder.'/cform/pindah'), 'update' => '#pesan', 'type' => 'post', 'class' => 'form-horizontal')); ?>
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="hidden" id="iperiode1" name="iperiode1">
                    ...
                    <div class="form-group row">
                        ...
                        <button type="submit" class="btn btn-inverse btn-rounded btn-sm"> <i class="fa fa-spinner"></i>&nbsp;&nbsp;Proses</button></a>
                        </div>
                    </div>
                </div>
                </form>
...
function dipales()
  {
    if(document.getElementById("iperiode1").value!=''){
