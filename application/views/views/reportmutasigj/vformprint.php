                    ...
                    <table id="tabledata" class="stripe row-border order-column table color-table inverse-table table-bordered class" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" colspan="4" rowspan="2"></th>
                                ...
                                <th class="text-center" colspan="12" rowspan="2"></th>
                            </tr>
                            <tr>
                                <th class="text-center">Dari Packing</th>
                                <th class="text-center">Dari WIP</th>
                                <th class="text-center">DARI DIST / TOKO<br>(DS/BLN/IMA)</th>
                                <th class="text-center">Dari WIP</th>
                                <th class="text-center table-success"></th>
                                <th class="text-center">Ke Pelanggan</th>
                                <th class="text-center">Ke Pelanggan</th>
                                <th class="text-center">Dari WIP</th>
                                <th class="text-center table-success"></th>
                            </tr>
                            <tr>
                                <th class="text-center table-warning">SA1</th>
                                <th class="text-center table-warning">SA2</th>
                                <th class="text-center table-warning">Z1</th>
                                <th class="text-center table-warning">SA1+SA2+Z1</th>
                                <th class="text-center">K</th>
                                <th class="text-center">GG</th>
                                <th class="text-center">RP</th>
                                <th class="text-center">Z2</th>
                                <th class="text-center table-success">K+GG+RP+Z2</th>
                                <th class="text-center">L</th>
                                <th class="text-center">Z3</th>
                                <th class="text-center">XXX</th>
                                <th class="text-center table-success">L+Z3+XXX</th>
                                <th class="text-center table-warning">SA1 + K + GG - L</th>
                                <th class="text-center table-warning">SA2 + RP - XXX</th>
                                <th class="text-center table-warning">Z4 = Z1+Z2-Z3</th>
                            ...
                            <tr>
                                ...
                                <th class="text-center table-info">Kirim barang jadi<br>bagus (DO/SJ)</th>
                                <th class="text-center table-info">Kirim Grade B<br>(DO/SJ)</th>
                                ...
                                <th class="table-warning text-center">Saldo Akhir<br>Grade B</th>
                                ...
                                <th class="table-active text-center">SO<br>Grade B</th>
                                ...
                                <th class="table-danger text-center">Selisih<br>Grade B</th>
                            ...
                            <tr>
                                ...
                                <td class="bold text-right"><?= $sum_n_saldo_awal_gradeb; ?></td>
                                ...
                                <td class="bold text-right"><?= $sum_n_saldo_akhir_gradeb; ?></td>
                                ...
                                <td class="bold text-right"><?= $sum_n_so_gradeb; ?></td>
                                ...
                                <td class="bold text-right"><?= $sum_n_selisih_gradeb; ?></td>
                            ...
                            if ($data->num_rows() > 0) {
                                foreach ($data->result() as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right <?= warna($row->n_saldo_awal_gradeb); ?>"><?= $row->n_saldo_awal_gradeb; ?></td>
                                        ...
                                        <td class="text-right <?= warna($row->n_saldo_akhir_gradeb); ?>"><?= $row->n_saldo_akhir_gradeb; ?></td>
                                        ...
                                        <td class="text-right <?= warna($row->n_so_gradeb); ?>"><?= $row->n_so_gradeb; ?></td>
                                        ...
                                        <td class="text-right <?= warna($row->n_selisih_gradeb); ?>"><?= $row->n_selisih_gradeb; ?></td>
