              ...
              <thead>
                <?php if($isi){ ?>
                    <tr>
                        ...
                        echo '<th rowspan=2>Nilai Nota</th>';
                        ?>
                    </tr>
                    <tr>
                        <?php 
                ...
                <tbody>
                    ...
                    foreach($isi as $row){
                        ...
                        if($icity=='' || ($icity==$row->icity && $kode==$row->iarea) ){
                            ...
                            for($i=1;$i<=$interval;$i++){
                                switch ($bl){
                                    ...
                                    $totalrp=$totalrp+$row->notajan*$row->unitprice;
                                    ...
                                    $totkotarp=$totkotarp+$row->notajan*$row->unitprice;
                                    $totarea=$totarea+$row->notajan;
                                    $totarearp=$totarearp+$row->notajan*$row->unitprice;
                                    break;
                                    case '2' :
                                    $total=$total+$row->notafeb;
                                    $totalnota=$total*intval($row->notafeb);
                                    $totalrp=$totalrp+$row->notafeb*$row->unitprice;
                                    ...
                                    $totkotarp=$totkotarp+$row->notafeb*$row->unitprice;
                                    $totarea=$totarea+$row->notafeb;
                                    $totarearp=$totarearp+$row->notafeb*$row->unitprice;
                                    break;
                                    case '3' :
                                    $total=$total+$row->notamar;
                                    $totalnota=$total*intval($row->notamar);
                                    $totalrp=$totalrp+$row->notamar*$row->unitprice;
                                    ...
                                    $totkotarp=$totkotarp+$row->notamar*$row->unitprice;
                                    $totarea=$totarea+$row->notamar;
                                    $totarearp=$totarearp+$row->notamar*$row->unitprice;
                                    break;
                                    case '4' :
                                    $total=$total+$row->notaapr;
                                    $totalnota=$total*intval($row->notaapr);
                                    $totalrp=$totalrp+$row->notaapr*$row->unitprice;
                                    ...
                                    $totkotarp=$totkotarp+$row->notaapr*$row->unitprice;
                                    $totarea=$totarea+$row->notaapr;
                                    $totarearp=$totarearp+$row->notaapr*$row->unitprice;
                                    break;
                                    case '5' :
                                    $total=$total+$row->notamay;
                                    $totalnota=$total*intval($row->notamay);
                                    $totalrp=$totalrp+$row->notamay*$row->unitprice;
                                    ...
                                    $totkotarp=$totkotarp+$row->notamay*$row->unitprice;
                                    $totarea=$totarea+$row->notamay;
                                    $totarearp=$totarearp+$row->notamay*$row->unitprice;
                                    break;
                                    case '6' :
                                    $total=$total+$row->notajun;
                                    $totalnota=$total*intval($row->notajun);
                                    $totalrp=$totalrp+$row->notajun*$row->unitprice;
                                    ...
                                    $totkotarp=$totkotarp+$row->notajun*$row->unitprice;
                                    $totarea=$totarea+$row->notajun;
                                    $totarearp=$totarearp+$row->notajun*$row->unitprice;
                                    break;
                                    case '7' :
                                    $total=$total+$row->notajul;
                                    $totalnota=$total*intval($row->notajul);
                                    $totalrp=$totalrp+$row->notajul*$row->unitprice;
                                    ...
                                    $totkotarp=$totkotarp+$row->notajul*$row->unitprice;
                                    $totarea=$totarea+$row->notajul;
                                    $totarearp=$totarearp+$row->notajul*$row->unitprice;
                                    break;
                                    case '8' :
                                    $total=$total+$row->notaaug;
                                    $totalnota=$total*intval($row->notaaug);
                                    $totalrp=$totalrp+$row->notaaug*$row->unitprice;
                                    ...
                                    $totkotarp=$totkotarp+$row->notaaug*$row->unitprice;
                                    $totarea=$totarea+$row->notaaug;
                                    $totarearp=$totarearp+$row->notaaug*$row->unitprice;
                                    break;
                                    case '9' :
                                    $total=$total+$row->notasep;
                                    $totalnota=$total*intval($row->notasep);
                                    $totalrp=$totalrp+$row->notasep*$row->unitprice;
                                    ...
                                    $totkotarp=$totkotarp+$row->notasep*$row->unitprice;
                                    $totarea=$totarea+$row->notasep;
                                    $totarearp=$totarearp+$row->notasep*$row->unitprice;
                                    break;
                                    case '10' :
                                    $total=$total+$row->notaokt;
                                    $totalnota=$total*intval($row->notaokt);
                                    $totalrp=$totalrp+$row->notaokt*$row->unitprice;
                                    ...
                                    $totkotarp=$totkotarp+$row->notaokt*$row->unitprice;
                                    $totarea=$totarea+$row->notaokt;
                                    $totarearp=$totarearp+$row->notaokt*$row->unitprice;
                                    break;
                                    case '11' :
                                    $total=$total+$row->notanov;
                                    $totalnota=$total*intval($row->notanov);
                                    $totalrp=$totalrp+$row->notanov*$row->unitprice;
                                    ...
                                    $totkotarp=$totkotarp+$row->notanov*$row->unitprice;
                                    $totarea=$totarea+$row->notanov;
                                    $totarearp=$totarearp+$row->notanov*$row->unitprice;
                                    break;
                                    case '12' :
                                    $total=$total+$row->notades;
                                    $totalnota=$total*intval($row->notades);
                                    $totalrp=$totalrp+$row->notades*$row->unitprice;
                                    ...
                                    $totkotarp=$totkotarp+$row->notades*$row->unitprice;
                                    $totarea=$totarea+$row->notades;
                                    $totarearp=$totarearp+$row->notades*$row->unitprice;
                                    break;
                                }
                                $bl++;
                                if($bl==13)$bl=1;
                            ...
                            echo '<th style="background-color:#F2F2F2; text-align: right;">'.number_format($totkota).'</th>';
                            echo '<th style="background-color:#F2F2F2; text-align: right;">'.number_format($totkotarp).'</th></tr>';
                            $grandtotkota=$grandtotkota+$totkota;
                            $grandtotrpkota=$grandtotrpkota+$totkotarp;
                            echo "<tr>
                            ...
                            echo '<th style="background-color:#F2F2F2; text-align: right;">'.number_format($totarea).'</th>';
                            echo '<th style="background-color:#F2F2F2; text-align: right;">'.number_format($totarearp).'</th></tr>';
                            $totarea01=0;
                            $totarea02=0;
                            $totarea03=0;
                            $totarea04=0;
                        ...
                        echo '<th style="text-align: right">'.number_format($totalrp).'</th>';
                        echo "</tr>";
                        $icity=$row->icity;
                        $kode=$row->iarea;
                    }
                    ...
                    echo '<th style="background-color:#F2F2F2; text-align: right;">'.number_format($grandtotkota).'</th>';
                    echo '<th style="background-color:#F2F2F2; text-align: right;">'.number_format($grandtotrpkota).'</th></tr>';
                }
                ?>
            </tbody>
        </table>
