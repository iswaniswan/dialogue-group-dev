                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <select data-nourut="<?= $i; ?>" id="idmarker<?= $i; ?>" class="form-control select2 input-sm" name="idmarker<?= $i; ?>">
                                    ...
                                    <select data-nourut="<?= $i; ?>" id="idproduct<?= $i; ?>" class="form-control select2 input-sm" name="idproduct<?= $i; ?>">
                                        <option value="<?= $key->id_panel_item; ?>"><?= $key->i_panel . ' - ' . $key->bagian . '-' . $key->i_material . '-' . $key->e_material_name; ?></option>
                                    </select>
                                </td>
                                <td>
                                    ...
                                    <input type="hidden" id="nquantity_awal<?= $i; ?>" name="nquantity_awal<?= $i; ?>" value="<?= $key->n_saldo_akhir; ?>">
                                </td>
                                <td>
