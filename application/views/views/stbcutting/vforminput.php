                        ...
                        foreach($data2 as $row){
                            ...
                            <?php } else {
                                ...
                                <tr class="d-flex">
                                    ...
                                    <td class="col-1">  
                                        <input type="text" class="form-control input-sm" autocomplete="off" id="imaterialsupplier<?=$i;?>" name="imaterialsupplier<?=$i;?>"value="<?= $row->i_material; ?>">
                                    </td>
                                    <td class="col-1">
                                    ...
                                    <td class="col-1">
                                        <input  type="text" class="form-control input-sm text-right" id="nquantity<?=$i;?>" name="nquantity<?=$i;?>" value="<?= $row->n_sisa; ?>" autocomplete="off" onkeyup="valstock(<?=$i;?>);hitungall(this.value, '<?= $row->i_material; ?>', '<?= $i; ?>' ); angkahungkul(this);if(this.value=='0'){this.value='';}" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}"> 
                                    ...
                                    <td class="col-1">  
                                        <input type="text" class="form-control input-sm text-right <?= $row->i_material; ?> number" id="vprice<?=$i;?>" name="vprice<?=$i;?>" value="<?php (!$v_harga_konversi) ? null : number_format($v_harga_konversi,4); ?>" autocomplete="off" onkeyup="hitungall(this.value, '<?= $row->i_material; ?>', '<?= $i; ?>' );angkahungkul(this);reformat(this);if(this.value=='0'){this.value='';}" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" placeholder="0" >
                                    </td>
                                    <td class="col-1">
                ...
                <tbody>  
                    ...
                    if($datatotal){
                        ...
                        <tr>
                            ...
                            <td colspan="1" class="text-right"><input type="text" class="form-control input-sm text-right number" id="totalsemua" value="<?= $total_semua; ?>" readonly></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
