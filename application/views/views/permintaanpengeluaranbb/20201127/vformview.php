            ...
            for (let a = 0; a < data['detail'].length; a++) {
                ...
                if (jenispengeluaran == "JK00002") {
                    if (lastmaterial == i_material) {
                        ...
                        cols += '<td rowspan="1"><input type="text" id="nquantity2'+ counter + '" value="'+n_qty2+'" class="form-control" placeholder="0" name="nquantity2[]" onkeyup="cekval(this.value); reformat(this);" readonly></td>';
