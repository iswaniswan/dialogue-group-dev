                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" name="idocument" id="imasukreturwip" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="BONM-2010-000001" maxlength="15" class="form-control input-sm" value="<?=$data->i_document;?>" aria-label="Text input with dropdown button">
            ...
            <table id="tabledatax" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                <thead> 
                    <tr>
                        ...
                        <th class="text-center" width="12%;">Qty Retur</th>
                ...
                <?php
                    ...
                    <tr>   
                        ...
                        <td>  
                            <input type="hidden" class="form-control" id="idproduct<?=$i;?>" name="idproduct[]"value="<?= $row->id_product; ?>">
                        ...
                        <td>  
                            <input type="hidden" id="idcolor<?=$i;?>" name="idcolor[]" value="<?= $row->id_color; ?>" readonly>
                            <input type="hidden" id="icolor<?=$i;?>" name="icolor[]" value="<?= $row->i_color; ?>" readonly>
                            <input type="text" class="form-control input-sm" id="ecolorname<?=$i;?>" name="ecolorname[]"value="<?= $row->e_color_name; ?>" readonly>
                        </td>                    
                        <td>
                            <input type="text" class="form-control input-sm text-right" id="nquantityjht<?=$i;?>" name="nquantityjht[]" value="<?= $row->n_quantity_jahit; ?>" readonly> 
                            <input type="hidden" class="form-control input-sm text-right" id="nquantitysisa<?=$i;?>" name="nquantitysisa[]" value="<?= $row->n_sisa; ?>"> 
                        </td>
                        <td>
                            <input type="text" class="form-control input-sm text-right inputitem" id="nquantitymasuk<?=$i;?>" name="nquantitymasuk[]" value="<?= $row->n_quantity_masuk; ?>" onblur='if(this.value==""){this.value="0";}' onfocus='if(this.value=="0"){this.value="";}' onkeyup="validasi(<?=$i;?>);">
                        </td>
                        <td>
...
<script>
    $(document).ready(function () {
        ...
        $('#imasukreturwip').mask('SSS-0000-000000S');
    ...
    $('#ceklis').click(function(event) {
        if($('#ceklis').is(':checked')){
            $("#imasukreturwip").attr("readonly", false);
        }else{
            $("#imasukreturwip").attr("readonly", true);
        }
    });
        ...
        var ipengirim = $('#ipengirim').val();
            $.ajax({
                ...
                var newRow = $("<tr>");
                    ...
                    cols += '<td><input style="width:100px;" readonly class="form-control" type="text" id="nquantity'+a+'" name="nquantity[]" value="'+nquantity+'"><input style="width:100px;" readonly class="form-control" type="hidden" id="nquantitysisa'+a+'" name="nquantitysisa[]" value="'+nquantitysisa+'"></td>';
    ...
    function validasi(i){            
        if (parseFloat($('#nquantitymasuk'+i).val()) > parseFloat($('#nquantityjht'+i).val())) {
            swal('Quantity Masuk Tidak Boleh Melebihi Quantity Yang Belum Di Terima!!!');
            $('#nquantitymasuk'+i).val($('#nquantityjht'+i).val());
        }
