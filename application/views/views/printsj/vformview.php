...
/*                api.column(groupColumn, {page:'current'} ).data().each( function ( group, i ) {
    ...
    function yyy(b){
        lebar =450;
        tinggi=400;
        eval('window.open("<?php echo site_url(); ?>"+"/printsj/cform/cetak/"+b,"","width="+lebar+"px,height="+tinggi+"px,resizable=1,scrollbars=1,top='+(screen.height-tinggi)/2+',left='+(screen.width-lebar)/2+'")');
      }
</script>
