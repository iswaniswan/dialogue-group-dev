                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" name="idocument" required="" id="isj" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number;?>" maxlength="16" class="form-control input-sm" value="" aria-label="Text input with dropdown button">
                        ...
                        <div class="col-sm-4">
                            <select name="ipartner" required="" id="ipartner" class="form-control select2"></select>
                        </div>
                    </div> 
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" name="dreff" required="" id="dreff" class="form-control input-sm" placeholder="Tanggal Ref" readonly>
                        </div>
                        <div class="col-sm-7">
