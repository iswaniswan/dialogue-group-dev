            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input id="ibapbold" name="ibapbold" type="text" class="form-control" maxlength="10" value="<?= $isi->i_bapb_old;?>">
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="col-md-6"> 
                    ...
                    <div class="form-group row">
                        <label class="col-md-12">No Segel Pergi</label>
                        <div class="col-sm-12">
                            <input id="i_segel_pergikirim" name="i_segel_pergikirim" class="form-control" required="" 
                            readonly value="<?= $isi->i_segel_pergikirim; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-12">No Segel Pulang</label>
                        <div class="col-sm-12">
                            <input id="vbapb" name="vbapb" class="form-control" required="" 
                            readonly value="<?= $isi->i_segel_pulangkirim; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="table-responsive">
                        <table id="tabledata" class="table color-table inverse-table table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center; width: 12%;">Nilai Harga 03</th>
                                ...
                                <?php if ($detail) {
                                    ...
                                    foreach ($detail as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-control" readonly type="text" id="vsj<?= $i;?>" name="vsj<?= $i;?>" value="<?= $row->v_sj;?>">
                                            </td>
                                            <td>
                                                <input class="form-control text-right" readonly type="text" id="vsj<?= $i;?>" name="vsj<?= $i;?>" value="<?= $row->quantity;?>">
                                            </td>
                                            <td>
                                                <input class="form-control text-right" readonly type="text" id="vsj<?= $i;?>" name="vsj<?= $i;?>" value="<?= $row->jumlah03;?>">
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <?php if (check_role($i_menu, 4)) {?>
                                                    <button type="button" onclick="hapusdetail('<?= $row->i_bapb."','".$row->i_area."','".$row->i_sj.'","'.$dfrom.'","'.$dto.'","'.$isi->i_customer;?>'); return false;" title="Delete" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                    <?php }
                        ...
                        <table id="tableex" class="table color-table success-table table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <input type="hidden" name="jmlx" id="jmlx" value="<?= $jmlitemx;?>">
                            </tbody>
                        </table>
                    </div>
                </div>
