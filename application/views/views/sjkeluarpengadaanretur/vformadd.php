            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" name="idocument" id="isj" required="" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number;?>" maxlength="16" class="form-control input-sm" value="" aria-label="Text input with dropdown button">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <textarea type="text" name="eremarkh" placeholder="Isi dengan Alasan Retur" class="form-control input-sm" maxlength="250"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-12">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (let x = data['detail'].length; x > 0 ; x--) {
                            ...
                            cols += '<td colspan="2"><input class="form-control remark input-sm" type="text" name="eremark[]" value="" placeholder="Isi dengan Alasan Retur"></td></tr>';
                            newRow1.append(cols);
                            $('#nquantity'+z).focus();
