                ...
                <div class="panel-body table-responsive">
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <textarea name="eremarkh" id="eremarkh" class="form-control input-sm" placeholder="Isi keterangan jika ada .."></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <button type="button" id="addrow" class="btn btn-info btn-block btn-sm"><i class="fa fa-plus fa-lg mr-2"></i>Tambah</button>
                            </div>
                            <div class="col-sm-3">
                                <button type="button" disabled="true" id="send" onclick="changestatus('<?= $folder; ?>',$('#kode').val(),'2');" class="btn btn-primary btn-block btn-sm"><i class="fa fa-paper-plane-o fa-lg mr-2"></i>Send</button>
                            </div>
                            <div class="col-sm-3">
