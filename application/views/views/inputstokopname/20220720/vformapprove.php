                         ...
                         <table id="tabledatax" class="table color-table inverse-table table-bordered class" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control input-sm inputitem" name="" value="<?= $key["i_material"].' - '.$key["e_material_name"] ?>" readonly></td>
                                    <td><input readonly type="text" id="e_satuan<?= $i ;?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="e_satuan<?= $i ;?>" 
                                        value="<?= $key['e_satuan_name'] ?>"></td>
