            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <label class="col-md-6">Nomor Alokasi</label><label class="col-md-6">Tanggal Alokasi</label>
                        <div class="col-sm-6">
                            <input id="ialokasi" name="ialokasi" class="form-control" required="" readonly value="<?= $isi->i_alokasi;?>">
                        </div>
                        <div class="col-sm-6">
                            <input id= "dalokasi" name="dalokasi" class="form-control" required="" readonly value="<?= date('d-m-Y', strtotime($isi->d_alokasi));?>">
                        </div>
                    </div>                    
                    <div class="form-group row">
                        <label class="col-md-6">Nomor KN</label><label class="col-md-6">Tanggal KN</label>
                        <div class="col-sm-6">
                            <input id="ikn" name="ikn" class="form-control" readonly value="<?= $isi->i_kn; ?>">
                        </div>
                        <div class="col-sm-6">
                            <input id="dkn" class="form-control" name="dkn" readonly value="<?= date('d-m-Y', strtotime($isi->d_kn));?>">
                        </div>
                    </div>                      
                    <div class="form-group row">
...
<script> 
    function dipales(){
        if(($("#dalokasi").val()!='') && ($("#vjumlah").val()!='') && ($("#vjumlah").val()!='0') && ($("#icustomer").val()!='')) {
