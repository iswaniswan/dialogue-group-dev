                    ...
                    if ($datadetail) {
                        foreach ($datadetail as $key) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="hidden" value="<?= $key->id_material;?>" name="id_material<?= $i; ?>" id="id_material<?= $i; ?>">
                                    <?= $key->i_material;?>
                                </td>
                                <td>
                                    <?= $key->e_material_name;?>
                                ...
                                <td>
                                    <input value="<?= $key->n_quantity; ?>" type="number" id="n_quantity<?= $i; ?>" class="form-control text-right input-sm inputqty <?= $key->id_material; ?>" autocomplete="off" name="n_quantity<?= $i; ?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" onkeyup="hetang(<?= $i; ?>);" onchange="hetang(<?= $i; ?>);">
                                    <input value="<?= $key->n_stock; ?>" type="hidden" id="n_stock<?= $i; ?>" name="n_stock<?= $i; ?>">
                                </td>
                                <td><input value="" type="text" class="form-control input-sm" name="e_remark_item<?= $i; ?>" id="e_remark_item<?= $i; ?>" placeholder="Isi keterangan jika ada!" /></td>
