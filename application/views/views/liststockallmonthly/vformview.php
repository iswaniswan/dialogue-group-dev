    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            ...
            <!--             <div class="panel-body table-responsive"> -->
                <div class="col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0"><?php NmPerusahaan; ?></h3>
                            ...
                            <tbody>
                                <?php if ($isi) {
                                    ...
                                    foreach ($isi as $row) {
                                        ...
                                        $total=$row->hiji+$row->dua+$row->tilu+$row->opat+$row->lima+$row->tujuh+$row->salapan+$row->sapuluh+$row->sabelas+$row->duabelas+$row->tilubelas+$row->tujuhbelas+$row->duatilu+$row->tiluhiji+$row->aa+$row->bon+$row->counter+$row->pb;
                                        ?>
                                        <tr>
                                            ...
                                            <td class="text-right"><?= $row->bon;?></td>
