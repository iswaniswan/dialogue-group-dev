            ...
            <div class="col-md-6">
                <div id="pesan"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="iproductclass" class="form-control" maxlength="30" onkeyup="gede(this)" value="<?= $data->i_product_class; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-md-6">
                <div id="pesan"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="iproductstatus" class="form-control" maxlength="30" onkeyup="gede(this)" value="<?= $data->i_product_status; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Jenis</label>
                        <div class="col-sm-12">
                            <input type="text" name="iproducttype" class="form-control" maxlength="30" onkeyup="gede(this)" value="<?= $data->i_product_type; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Sub Kategori</label>
                        <div class="col-sm-12">
                        <input type="text" name="iproductcategory," class="form-control" maxlength="30" onkeyup="gede(this)" value="<?= $data->i_product_category; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
