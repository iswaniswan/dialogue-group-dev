...
<script>
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><input type="text" id="nquantity'+ counter + '" class="form-control text-right input-sm" name="nquantity[]" value="" placeholder="0" onkeypress="return hanyaAngka(event);"></td>';
