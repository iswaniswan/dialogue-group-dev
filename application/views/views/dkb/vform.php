            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" id= "ddkb" name="ddkb" class="form-control date" value="<?= date('d-m-Y');?>">
                            <input id="idkb" name="idkb" type="hidden">
                        </div>
                        <div class="col-sm-6">
                            <input id="idkbold" name="idkbold" type="text" class="form-control" maxlength="10">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-12">Via</label>
                        <div class="col-sm-12">
                            <select name="idkbvia" id="idkbvia" class="form-control" onchange="getex(this.value);">
                                <option value="">-- Pilih --</option>
                                <?php if ($via) {                                 
                                    foreach ($via as $via) { ?>
                                        <option value="<?php echo $via->i_dkb_via;?>"><?= $via->e_dkb_via;?></option>
                                    <?php }; 
                                } ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-offset-6 col-sm-12">
                            ...
                            <button type="button" class="btn btn-inverse btn-rounded btn-sm" onclick='show("<?= $folder;?>/cform/","#main")'> <i
                                ...
                                &nbsp;&nbsp;
                                <button hidden="true" type="button" id="addex" class="btn btn-warning btn-rounded btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Expedisi</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6"> 
                        ...
                        <div class="form-group row">
                            <label class="col-md-12">Supir</label>
                            <div class="col-sm-12">
                                <input type="text" id="esupirname" name="esupirname" class="form-control" maxlength="30" onkeyup="gede(this)">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-12">Nomor Polisi</label>
                            <div class="col-sm-12">
                                <input type="text" id="ikendaraan" name="ikendaraan" class="form-control" maxlength="9">
                            </div>
                        </div>
                        <div class="form-group row">
