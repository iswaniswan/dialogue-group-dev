                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" name="ippap" id="ippap" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number;?>" maxlength="25" class="form-control input-sm" value="" aria-label="Text input with dropdown button">
                        ...
                        <div class="col-sm-2">
                            <input type="text" id="dppap" name="dppap" class="form-control date" onchange="number();" required="" readonly value="<?= date("d-m-Y"); ?>">
                        </div>

                        <div class="col-sm-2">
                            <input type="text" id="drppap" name="drppap" class="form-control date" required="" readonly value="<?= date("d-m-Y"); ?>">
                        </div>
