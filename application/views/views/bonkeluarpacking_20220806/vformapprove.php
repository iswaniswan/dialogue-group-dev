                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="text" name="ibonk" id="ibonk" value="<?= $data->i_keluar_packing;?>" class="form-control" readonly>                                
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <input type="text" id="dbonk" name="dbonk" class="form-control" required="" readonly value="<?= $data->d_keluar_packing;?>">
                        </div>
                        <div class="col-sm-3">
