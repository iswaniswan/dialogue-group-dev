                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="hidden" name="ibonkold" id="ibonkold" value="<?= $data->i_keluar_packing;?>">
                                <input type="text" name="ibonk" id="ibonk" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number;?>" maxlength="17" class="form-control input-sm" value="<?= $data->i_keluar_packing;?>" aria-label="Text input with dropdown button">
                        ...
                        <div class="col-sm-2">
                            <input type="text" id="dbonk" name="dbonk" class="form-control date"  required="" readonly value="<?= $data->d_keluar_packing;?>">
                        </div>
                        <div class="col-sm-3">
                        ...
                        foreach ($detail as $row) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" value="<?= $row->i_product_base;?>" readonly id="iproduct<?=$i;?>" name="iproduct[]" class="form-control">
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="text" value="<?= $row->n_quantity_product;?>" id="nquantity<?=$i;?>" class="form-control text-right inputitem" autocomplete="off" name="nquantity[]" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="0" onkeyup="angkahungkul(this);">
                                </td>
                                <td>
...
<script>
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><input type="text" id="nquantity'+ counter + '" class="form-control text-right inputitem" name="nquantity[]" value="0" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\' onkeypress="return hanyaAngka(event);"></td>';
