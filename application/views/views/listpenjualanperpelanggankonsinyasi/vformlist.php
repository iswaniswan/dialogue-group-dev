    ...
    <div class="white-box">
        <div class="table-responsive">
            <table class="tablesaw table-bordered table-hover table" id="sitabel">
                  ...
                  $grandtotkota=0;
                    ...
                    if($icity=='' || ($icity==$row->icity && $kode==substr($row->kode,0,2)) ){
                      ...
                      for($i=1;$i<=$interval;$i++){
  	                  ...
  	                  echo "<tr>
                              <th colspan=5 align=center>T o t a l   K o t a</th>";
                      $bl=$blasal;
                      for($i=1;$i<=$interval;$i++){
                        switch ($bl){
                          case '1' :
                      ...
                      echo "<tr>
                            <th colspan=5 align=center>T o t a l   A r e a</th>";
                      $bl=$blasal;
                      for($i=1;$i<=$interval;$i++){
                        switch ($bl){
                        case '1' :
                          echo '<td align=right>'.number_format($totarea01).'</td>';
                          break;
                        case '2' :
                          echo '<td align=right>'.number_format($totarea02).'</td>';
                          break;
                        case '3' :
                          echo '<td align=right>'.number_format($totarea03).'</td>';
                          break;
                        case '4' :
                          echo '<td align=right>'.number_format($totarea04).'</td>';
                          break;
                        case '5' :
                          echo '<td align=right>'.number_format($totarea05).'</td>';
                          break;
                        case '6' :
                          echo '<td align=right>'.number_format($totarea06).'</td>';
                          break;
                        case '7' :
                          echo '<td align=right>'.number_format($totarea07).'</td>';
                          break;
                        case '8' :
                          echo '<td align=right>'.number_format($totarea08).'</td>';
                          break;
                        case '9' :
                          echo '<td align=right>'.number_format($totarea09).'</td>';
                          break;
                        case '10' :
                          echo '<td align=right>'.number_format($totarea10).'</td>';
                          break;
                        case '11' :
                          echo '<td align=right>'.number_format($totarea11).'</td>';
                          break;
                        case '12' :
                          echo '<td align=right>'.number_format($totarea12).'</td>';
                          break;
                        }
                        $bl++;
                        if($bl==13)$bl=1;
                      }
                      echo '<td align=right>'.number_format($totarea).'</td></tr>';
                      $totarea01=0;
                      $totarea02=0;
                      $totarea03=0;
                      $totarea04=0;
              ...
              echo "<tr>
                    <th colspan=5 align=center>G r a n d   T o t a l</th>";
              $bl=$blasal;
              for($i=1;$i<=$interval;$i++){
                switch ($bl){
                  case '1' :
