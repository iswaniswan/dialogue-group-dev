                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                             ...
                             <input type="hidden" name="dsebelumberlaku" id="dsebelumberlaku" class="form-control" readonly value="<?= date("d-m-Y",strtotime($data->d_berlaku))?>">
                        </div>
                        <div class="col-sm-3">
...
$('#dberlaku').datepicker({
  ...
  startDate: document.getElementById('dsebelumberlaku').value,
});
