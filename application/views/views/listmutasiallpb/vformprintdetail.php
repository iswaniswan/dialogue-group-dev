...
$periode=mbulan($b)." - ".$a;
if($detail){
	echo "<center class='judul huruf'><h2>".check_constant('NmPerusahaan')."</h2></center>";
	echo "<center class='nmper huruf'><h3>LAPORAN MUTASI STOCK - $row->customer ($row->e_customer_name)</h3></center>";
