            ...
            <div class="panel-body table-responsive">
                ...
                <div id="pesan"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="iproductclass" class="form-control" required="" maxlength="3" onkeyup="gede(this)">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Nama Class</label>
                        <div class="col-sm-12">
                            <input type="text" name="eproductclassname" class="form-control" required="" maxlength="30" onkeyup="gede(this)">
                        </div>
                    </div>
                    <div class="form-group">
