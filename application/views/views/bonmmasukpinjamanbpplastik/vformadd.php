            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <select name="imemo" id="imemo" class="form-control select2" disabled="true" onchange="getmemo(this.value);">
                            </select>
                        </div>
                        <div class="col-sm-2">
                            <input type="text" id="dmemo" name="dmemo" class="form-control" value="" placeholder="<?= date('d-m-Y');?>" readonly>
                        </div>           
                    </div>
                    <div class="form-group row">
...
<script>
   $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td style="text-align: center"><input hidden class="form-control" readonly id="idmaterial'+no+'" name="idmaterial[]" value="'+data['detail'][a]['id_material']+'"><input style="width:120px" class="form-control" readonly id="imaterial'+no+'" name="imaterial'+no+'" value="'+data['detail'][a]['i_material']+'"></td>';
                    cols += '<td><input style="width:350px" type="text" class="form-control" id="ematerial'+no+'" name="ematerial'+no+'" value="'+data['detail'][a]['e_material_name']+'" readonly></td>';
                    cols += '<td><input style="width:120px" type="text" class="form-control" id="nquantitymemo'+no+'" name="nquantitymemo[]" value="'+data['detail'][a]['n_quantity']+'" readonly></td>';
                    cols += '<td><input style="width:120px" type="text" class="form-control" id="nquantitysisa'+no+'" name="nquantitysisa[]" value="'+data['detail'][a]['n_quantity_sisa']+'" readonly></td>';
                    cols += '<td><input style="width:120px" type="text" class="form-control text-right" id="nquantity'+no+'" placeholder="0" name="nquantity[]" value="'+data['detail'][a]['n_quantity_sisa']+'" onkeypress="return hanyaAngka(event);" onkeyup="ceksaldo('+no+');"></td>';
                    cols += '<td><input style="width:250px" class="form-control" id="edesc'+no+'" name="edesc[]" value="" placeholder="Isi keterangan jika ada!"></td>';
                    newRow.append(cols);
    ...
    function ceksaldo(i) {
        if (parseFloat($('#nquantity'+i).val()) > parseFloat($('#nquantitysisa'+i).val())) {
