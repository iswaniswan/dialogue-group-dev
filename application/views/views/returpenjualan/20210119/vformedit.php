            ...
            <div class="panel-body table-responsive">
                ...
                <div id="pesan"></div>
                    <div class="form-group row">
                        ...
                        <label class="col-md-8">No TTB</label>
                        <label class="col-md-4">Tanggal Retur</label>
                        <!-- <div class="col-sm-4">
                            <input type="text" name="idept" id="idept" class="form-control" value="<?php echo $data->i_ttb?>" readonly>
                        </div> -->
                        <div class="col-sm-8">
                            <input type="text" name="ittb" id="ittb" class="form-control" value="<?php echo $data->i_ttb?>"readonly>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" id= "ipajak "name="ipajak" class="form-control" value="<?php echo $data->i_pajak ?>" readonly>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="col-md-6">
                     <div class="form-group row">
                        ...
                        <div class="col-sm-6"> 
                            <input type="hidden" id= "icustomer "name="icustomer" class="form-control" value="<?php echo $data->i_customer ?>" readonly>         
                            <input type="text" id= "ecustomer "name="ecustomer" class="form-control" value="<?php echo $data->e_customer_name ?>"readonly>         
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">          
                            <input  name="discount" id="discount" class="form-control" value="<?php echo $data->n_discount ?>" readonly>
                        </div>
                        <div class="col-sm-4">                            
                            <input type="text" name="dpp" id="dpp" class="form-control" value="<?php echo $data->dpp ?>" readonly>
                        </div>
                        <div class="col-sm-4">                            
                            <input type="text" name="ppn" id="ppn" class="form-control" value="<?php echo $data->ppn ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">          
                            <input type="text" name="vspb" id="vspb" class="form-control" value="<?php echo $data->v_ttb_gross ?>" readonly>
                        </div>
                        <div class="col-sm-4">                            
                            <input type="text" name="vspbdiscounttotal" id="vspbdiscounttotal" class="form-control" value="<?php echo $data->v_ttb_discounttotal ?>" readonly>
                        </div>
                        <div class="col-sm-4">                            
                            <input type="text" name="vspbbersih" id="vspbbersih" class="form-control" value="<?php echo $data->v_ttb_netto ?>" readonly>
                        </div>
                    </div>
                </div>
                <!-- <div class="col-md-6">
                ...
                <!-- <div class="col-md-6">
                    ...
                    <table id="tabledata" class="table color-table success-table table-bordered" cellspacing="0" width="100%" >
                            ...
                            <tbody>
                                ...
                                <td>
                                    <input style ="width:80px" class="form-control" type="text" id="nquantity<?=$i;?>" name="nquantity<?=$i;?>"value="<?= $row->n_quantity_retur; ?>" onkeyup="hitungnilai(this.value)";>
                                </td>
                                <td>
                                    <input style ="width:80px" class="form-control" type="text" id="total<?=$i;?>" name="total<?=$i;?>"value="<?= $row->v_total; ?>"  readonly>
                                </td>
                                <td>
                                    <input style ="width:200" class="form-control" type="text" id="edesc<?=$i;?>" name="edesc<?=$i;?>"value="<?= $row->e_ttb_remark; ?>" >
                                </td>
                                <!-- <td align="center">
...
//cols += '<td><button type="button" id="addrow" title="Delete" class="ibtnDel btn btn btn-danger"><i class="fa fa-trash"></i></button></td>';
    ...
    for(i=1;i<jml;i++){
        ...
        if (isNaN(parseFloat(isi))){
            ...
            // swal(jml);
            dtmp1=parseFloat(formatulang(Number.document.getElementById("discount").value));
            vdis1   =0;
            vtot    =0;
            dpp     =0;
            ppn     =0;
