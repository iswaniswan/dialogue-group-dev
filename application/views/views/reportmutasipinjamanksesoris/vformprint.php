                            ...
                            <div class="pull-left"> 
                                <address style="padding:0px">
                                    <table cellpadding="0" cellspacing="0" >
                                        ...
                                        <tr>
                                            <td width="160px" class="xx text-muted m-l-3" style="font-size: 12px"><b>Partner</b></td> 
                                            <td width="10px" class="xx huruf2 text-muted m-l-3" style="font-size: 12px"><b>:</b></td> 
                                            <td width="300px" class="xx huruf2 text-muted m-l-3" style="font-size: 12px"><b><?= $partner->e_partner_name;?></b></td> 
                                        </tr>
                                    </table>
                                </address>
                            </div>
                                ...
                                <table id="tabledata" class="table table-bordered" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center">Konversi Pinjaman</th>
                                    ...
                                    <tbody>
                                        ...
                                        <td style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center"><?= $row->konversi; ?></td>
