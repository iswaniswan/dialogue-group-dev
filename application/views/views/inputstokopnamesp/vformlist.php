<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-info">
           <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp; <?= $title_list; ?>
            <?php if(check_role($this->i_menu, 1)){ ?><a href="#" onclick="show('<?= $folder; ?>/cform/index2/<?= $dfrom."/".$dto;?>','#main'); return false;" class="btn btn-info btn-sm pull-right"><i
            ...
            <div class="panel-body table-responsive">
                ...
                <table id="tabledata" class="display nowrap" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th width="3%;">No</th>
                            <th class="text-center">Nomor <br>Dokumen</th>
                            <th class="text-center">Tanggal <br>Dokumen</th>
                            <th>Periode</th>
