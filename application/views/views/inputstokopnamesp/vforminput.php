            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                   <div class="form-group row">
                        ...
                        <div class="col-sm-5"> 
                            <textarea name="eremarkh" id="eremarkh" placeholder="Isi keterangan Jika Ada!" class="form-control input-sm"></textarea>   
                        </div>
                    </div>  
            ...
            <table id="tabledatax" class="table color-table success-table table-bordered class" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" width="10%">Jumlah SO</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input readonly type="text" id="e_satuan<?= $i ;?>" class="form-control input-sm" name="e_satuan<?= $i ;?>" value="<?= $key['e_satuan_name'] ?>"></td>
...
var i = $('#jml').val();
    $("#addrow").on("click", function () {
        ...
        cols += `<td><input type="text" id="e_satuan${i}" class="form-control input-sm" name="e_satuan${i}" readonly></td>`;
