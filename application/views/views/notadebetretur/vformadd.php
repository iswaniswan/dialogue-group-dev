        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    var qtyorder            = data['detail'][a]['n_retur_sisa'];
                    ...
                    cols += '<td><input style="width:400px;" class="form-control" readonly type="text" id="eproductname'+zz+'" name="eproductname'+zz+'" value="'+htmlentity(namaproduk)+'"></td>';
                    ...
                    cols += '<td><input style="width:100px;" class="form-control" type="text" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\' value="0" id="qtyretur'+zz+'" name="qtyretur'+zz+'" placeholder="0" onkeyup="validasi('+zz+'); reformat(this);gettotal(this);"></td>';
                    cols += '<td><input class="form-control" style="width:300px;"  type="text" id="edesc'+zz+'" name="edesc'+zz+'" value=""></td>';
