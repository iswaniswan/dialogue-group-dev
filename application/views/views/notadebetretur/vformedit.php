            ...
            <table id="tabledatax" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                ...
                <?$i = 0;
                        ...
                        <tr>
                            ...
                            <td>
                                <input style ="width:450px" type="text" class="form-control" id="ematerialname<?=$i;?>" name="ematerialname<?=$i;?>"value="<?= htmlentities($row->e_material_name); ?>" readonly >
                            </td>
                            <td>
                            ...
                            <td>
                                <input type="text" style="width:100px" class="form-control" id="qtyretur<?=$i;?>" name="qtyretur<?=$i;?>" value="<?= $row->n_quantity_retur; ?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" onkeyup="validasi(<?=$i?>); gettotal(this);">
