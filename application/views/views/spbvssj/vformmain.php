           ...
           <div class="panel-heading"> <i class="fa fa-list"></i> <?= $title; ?>
            ...
            <div class="panel-body table-responsive">
                ...
                <div id="pesan"></div>
                    ...
                    <div class="form-group row">
                        <label class="col-md-12">Dikelompokkan Berdasarkan Group Barang</label>
                        <div class="col-sm-3">
                            <select id="is_groupbrg" name="is_groupbrg" class="form-control select2">
                            <option value=""></option>
...
$(document).ready(function () {
    $('.select2').select2({
        placeholder: 'Cari Berdasarkan Group Barang'
    });
    showCalendar('.date');
});
</script>
