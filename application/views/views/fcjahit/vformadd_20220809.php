                    ...
                    <table id="tabledatay" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-right" width="7%;">Stok<br>Pengadaan</th>
                                <th class="text-right" width="5%;">FC<br>Jahit</th>
                        ...
                        <tbody>
                            ...
                            foreach ($datadetail->result() as $key) {
                                ...
                                $fc = floor(($key->n_quantity + $key->n_pengadaan) / 3);
                                $nfc = $fc * 3;
                                $fc_internal = $fc + (($key->n_quantity + $key->n_pengadaan) - $nfc);
                                if ($group == "") { ?>
                                    <tr class="table-active">
                                        <td class="text-center"><a href="#" class="toggler" data-icon-name="fa-eye-slash" data-prod-cat="<?= $subkategori; ?>"><i class="fa fa-eye-slash text-success"></i></a></td>
                                ...
                                <tr class="<?= $subkategori; ?>" style="display:none">
                                    ...
                                    <td>
                                        <input readonly class="form-control input-sm text-right" type="text" id="n_fcjahit<?= $i; ?>" name="n_fcjahit<?= $i; ?>" placeholder="0" onkeyup="angkahungkul(this); cekvalidasi(<?= $i; ?>)" value="<?= $key->n_quantity + $key->n_pengadaan; ?>">
                                    </td>
                                    <td>
