            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <label class="col-md-12">Tanggal Promo</label>
                        <div class="col-sm-12">
                            <input type="text" readonly id= "dpromo" name="dpromo" class="form-control date" value="<?= date('d-m-Y');?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input id="epromoname" required="" class="form-control" name="epromoname" onkeyup="gede(this);">
                        </div>
                    </div>            
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" required="" readonly id= "dpromostart" name="dpromostart" class="form-control date" value="">
                        </div>
                        <div class="col-sm-6">
                            <input type="text" required="" readonly id= "dpromofinish" name="dpromofinish" class="form-control date" value="">
                        </div>
                    </div>                          
                    <div id="disc" class="form-group row" hidden="true">
                        ...
                        <div class="col-sm-6" id="disc1">
                            <input type="text" id= "npromodiscount1" name="npromodiscount1" class="form-control" value="0" onkeypress="return hanyaAngka(event);">
                        </div>
                        <div class="col-sm-6" id="disc2">
                            <input type="text" id= "npromodiscount2" name="npromodiscount2" class="form-control" value="0" onkeypress="return hanyaAngka(event);">
                        </div>
                    </div>                          
                    ...
                    <div class="form-group row">
                        <div class="col-sm-offset-5 col-sm-12">
                            ...
                            <button type="button" id="addrow" class="btn btn-info btn-rounded btn-sm" disabled=""><i class="fa fa-plus"></i>&nbsp;&nbsp;Product
                            </button>&nbsp;&nbsp;                                
                            <button type="button" id="addpel" class="btn btn-inverse     btn-rounded btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Pelanggan
                                <button hidden="true" type="button" id="addpelgr" class="btn btn-inverse btn-rounded btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Group Pelanggan
                                </button>
                            </button>&nbsp;&nbsp;                               
                            <button hidden="true" type="button" id="addar" class="btn btn-primary btn-rounded btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Area
                            </button>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                            ...
                            <select name="ipromotype" id="ipromotype" required="" class="form-control" onchange="getpromo(this.value);">
                                ...
                                <?php if ($promo) {                                 
                                    foreach ($promo as $key) { ?>
                                        <option value="<?php echo $key->i_promo_type;?>"><?= $key->e_promo_typename;?></option>
                                    <?php }; 
                                } ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <select name="ipricegroup" id="ipricegroup" required="" class="form-control select2" disabled=""></select>
                        </div>
                    </div> 
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <select name="productgroup" id="productgroup" class="form-control" onchange="group(this.value);">
                                ...
                                <option value="sp">Semua Product</option>
                                <?php if ($group) {
                    ...
                    <div class="col-md-12">
                        <div class="form-check">
                            <label class="custom-control custom-checkbox">
                                <input type="checkbox" id="fallcustomer" name="fallcustomer" class="custom-control-input">
                    ...
                    <div class="col-md-12">
                        <div class="form-check">
                            <label class="custom-control custom-checkbox">
                                <input type="checkbox" id="fallarea" name="fallarea" class="custom-control-input" value="on" checked>
                                <span class="custom-control-indicator"></span>
                ...
                <input type="hidden" name="jmlp" id="jmlp" value="0">
                <input type="hidden" name="jmlc" id="jmlc" value="0">
                <input type="hidden" name="jmlg" id="jmlg" value="0">
                <input type="hidden" name="jmla" id="jmla" value="0">
                <div class="col-md-12">
                    <table id="tablep" class="display table" cellspacing="0" width="100%" hidden="true">
                        <thead>
                            <tr>
                    ...
                    <table id="tablec" class="display table" cellspacing="0" width="100%" hidden="true">
                        <thead>
                            <tr>
                                <th style="text-align: center; width: 4%;">No</th>
                    ...
                    <table id="tableg" class="display table" cellspacing="0" width="100%" hidden="true">
                        <thead>
                            <tr>
                                <th style="text-align: center; width: 4%;">No</th>
                    ...
                    <table id="tablea" class="display table" cellspacing="0" width="100%" hidden="true">
                        <thead>
                            <tr>
                                <th style="text-align: center; width: 4%;">No</th>
...
<script>
    ...
    $("#addpel").on("click", function () {
        ...
        cols += '<td><button type="button" id="addpel" title="Delete" class="ibtnDel btn btn btn-danger"><i class="fa fa-trash"></i></button></td>';
        newRow.append(cols);
    ...
    function getdetailc(id){
        ...
        for(i=1;i<=x;i++){            
            if((a == $('#icustomer'+i).val()) && (i!=x)){
                alert ("Kode Pelanggan : "+a+" sudah ada !!!!!");            
                ada=true;            
                break;        
            }else{            
                ada=false;             
    ...
    $("#addpelgr").on("click", function () {
        ...
        cols += '<td><button type="button" id="addpelgr" title="Delete" class="ibtnDel btn btn btn-danger"><i class="fa fa-trash"></i></button></td>';
        newRow.append(cols);
    ...
    $("#addar").on("click", function () {
        ...
        cols += '<td><button type="button" id="addar" title="Delete" class="ibtnDel btn btn btn-danger"><i class="fa fa-trash"></i></button></td>';
        newRow.append(cols);
