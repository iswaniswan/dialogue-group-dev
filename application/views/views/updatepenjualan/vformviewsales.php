...
<div class="col-sm-12">
    <div class="white-box">
        <h3 class="box-title">Target Penjualan Per Sales Area <?= $eareaname;?></h3>
            ...
            <table class="table color-bordered-table info-bordered-table">
                <thead>
                    <tr>
                        ...
                        <th style="font-size: 13px; text-align: center;">SPB Bln ini</th>
                        <th style="font-size: 13px; text-align: center;">% SPB</th>
                    </tr>
                </thead>
                <tbody>
                    <?php 
                    if($data){
                        ...
                        foreach($data as $row){
                            ...
                            <tr>
                                ...
                                <td style="font-size: 12px; text-align: right;"><?= number_format($row->v_spb_gross); ?></td>
