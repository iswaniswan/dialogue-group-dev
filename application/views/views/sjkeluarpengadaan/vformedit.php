                    ...
                    <?php $z = 0; $group = ""; foreach ($datadetail as $key) { $i++; 
                        ...
                        ?>
                            <?php if($group==""){?>
                                <tr id="tr<?= $z;?>">
                                    ...
                                    <td>
                                        <input class="form-control input-sm" type="text" id="eremarkwip<?= $z ;?>" name="eremarkwip<?= $z ;?>" value="<?= $key->e_remark_wip;?>" placeholder="Isi keterangan jika ada!" onkeyup="samadenganmarkx(this.value,<?= $z ;?>);"> 
                                    </td>
                        ...
                        <tr class="del<?= $z;?>">
                            ...
                            <td>
                                ...
                                <input type="hidden" class="form-control erwip<?= $z ;?> input-sm" name="eremarkwip1[]" value="<?=$key->e_remark_wip;?>" placeholder="Isi keterangan jika ada!"/>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            for (let x = data['detail'].length; x > 0 ; x--) {
                                ...
                                cols1 += '<input type="hidden" class="form-control erwip'+z+' input-sm" name="eremarkwip1[]" value="" placeholder="Isi keterangan jika ada!">';
