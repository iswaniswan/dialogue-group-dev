            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" required="" readonly id= "tgl" name="tgl" class="form-control date" onchange="cekperiode();" value="<?= $tgl;?>">
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-offset-5 col-sm-12">
                            <button type="submit" id="submit" onclick="return konfirmas();" class="btn btn-success btn-rounded btn-sm"> <i class="fa fa-exchange"></i>&nbsp;&nbsp;Transfer
                            </button>&nbsp;&nbsp;
