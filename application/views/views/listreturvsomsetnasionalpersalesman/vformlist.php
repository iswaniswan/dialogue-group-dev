...
#            echo '<tr><td><b>'.$kodenya.'</b></td>';
										...
										if($row->bln==$bl){
											$akhir=($blasal+$interval)-1;
#            if($kodenya=='13' and substr($salesnya,0,2)=='D9'){
#              echo 'bln='.$row->bln.' - bl='.$bl.'<br>';
#              echo 'blakhir='.$blakhir.' - akhir='.$akhir.'<br>';
#            }
#            echo 'tesssssss';
											if($blakhir!=$akhir){
												while ($blakhir<$akhir){
											...
											$akhir=($blasal+$interval)-1;
#            if($kodenya=='13' and substr($salesnya,0,2)=='D9') echo 'tesssssss';
											if($blakhir!=$akhir){
												while ($blakhir<$akhir){
													echo '<td align=right>0</td>';
													echo '<td align=right>0</td>';
...
#*#*#*#*#*
											echo '</tr>';
											echo '<tr><td colspan=2 align=center><b>Total</td>';
											$bl=$blasal;
											for($i=1;$i<=$interval;$i++){
												switch($bl){
													case '1':
...
#          if(substr($salesnya,0,2)=='CC' and $area=='13') echo 'ada';
										$bl=$blasal;
										if($row->bln==$bl){
											$akhir=($blasal+$interval)-1;
											if($blakhir!=$akhir){
...
#            $blakhir=$bl;
											...
											for($i=1;$i<=$interval;$i++){
												if($row->bln==$bl){
													...
													$akhir=($blasal+$interval)-1;
#                echo 'area='.$area.' - blakhir='.$blakhir.' - akhir'.$akhir.'<br>';
													if($blakhir!=$akhir){
														while ($blakhir<$akhir){
															echo '<td align=right>0</td>';
															echo '<td align=right>0</td>';
...
#                echo '<td align=right>0%</td>';
													$blakhir=$blasal;
													if($blakhir!=$akhir){
														while ($blakhir<$akhir && $blakhir<$row->bln){
															echo '<td align=right>0</td>';
															echo '<td align=right>0</td>';
															echo '<td align=right>0%</td>';
															$blakhir++;
...
#####
							echo '</tr>';
							echo '<tr><td colspan=2 align=center><b>Grand Total</td>';
							$bl=$blasal;
							for($i=1;$i<=$interval;$i++){
								switch($bl){
									case '1':
