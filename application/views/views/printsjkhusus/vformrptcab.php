...
?>
      <table width="98%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td height="1" align=right width="12%" class="huruf ici"><?php echo $sub; ?></td>
        </tr>
      </table>
<?php 
    }
...
?>
  <table width="100%" border="0" class="huruf ici">
    ...
    <tr>
      ...
      <td align=right width="10%"><?php echo number_format($row->v_nota_gross,2,',','.'); ?></td>
      <td width="12%">&nbsp;</td>
    </tr>
    <tr>
      <td width="2%">&nbsp;</td>
      ...
      <td width="9%" align=center>:</td>
      <td align=right width="10%"><?php echo number_format($row->v_nota_discounttotal,2,',','.'); ?></td>
      <td>&nbsp;</td>
    </tr>
...
?>
    ...
    <tr>
        ...
        <td width="9%" align=center>:</td>
        <td align=right  width="10%"><?php echo number_format(($dpp),2,',','.'); ?></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td width="2%">&nbsp;</td>
        ...
        <td width="9%" align=center>:</td>
        <td align=right  width="10%"><?php echo number_format($row->v_nota_ppn,2,',','.'); ?></td>
        <td>&nbsp;</td>
      </tr>
<?php 
    }
