            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        <label class="col-md-5">Bulan From</label><label class="col-md-5">Bulan To</label>
                        <div class="col-sm-5">
                        ...
                        <div class="col-sm-2">
                            <button type="submit" id="submit" class="btn btn-info btn-sm"> <i
...
function cetak(id) {
    var lebar = 1024;
    var tinggi = 768;
    eval('window.open("<?= site_url($folder); ?>"+"/cform/cetak/"+id,"","width="+lebar+"px,height="+tinggi+"px,resizable=1,menubar=1,scrollbars=1,top=' +
