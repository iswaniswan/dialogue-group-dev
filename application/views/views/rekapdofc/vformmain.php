            ...
            <div class="panel-body table-responsive">
                ...
                <div id="pesan"></div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select  name="isupplier" id="isupplier" class="form-control select2" required="" value=""></select>
                            <input type="hidden" name="esuppliername" id="esuppliername" class="form-control" required="" value="">
                        </div>
                    </div>
                    <div class="form-group row">
