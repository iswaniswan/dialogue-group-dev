        ...
        <!-- <table class="isinya" border='0' align="center" width="70%"> -->
            <div class="row">
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-12">
                              <h3 align="center" style="font-size: 16px; line-height: 0px;"><b>Laporan Mutasi Pinjaman</b><br></h3>
                            <div class="pull-left"> 
                                <address style="padding:0px">
                                    <table cellpadding="0" cellspacing="0" >
                                        ...
                                        <tr>
                                            ...
                                            <td width="10px" class="xx huruf2 text-muted m-l-3" style="font-size: 12px"><b>:</b></td> 
                                            <td width="300px" class="xx huruf2 text-muted m-l-3" style="font-size: 12px"><b><?= $partner->e_partner;?></b></td> 
                                        </tr>
                                    </table>
                                </address>
                            </div>
                                ...
                                <table id="tabledata" class="table table-bordered" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center">Masuk</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center">Keluar</th>                                            
