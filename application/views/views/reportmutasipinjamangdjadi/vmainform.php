...
function print(){
        ...
        var ikelompok       = $('#ikelompok').val();
        var ipartner        = $('#ipartner').val().split("|");
        var idpartner       = ipartner[0];
        var typepartner     = ipartner[1];
        var dfrom = $('#dfrom').val();
        var dto = $('#dto').val();
        if (ibagian == "" || jnsbarang == "" || ikelompok == "" || dfrom == "" || dto == "" ) {
            ...
            //alert(idpartner);
            eval('window.open("<?php echo site_url($folder); ?>"+"/cform/cetak/"+ibagian+"/"+jnsbarang+"/"+ikelompok+"/"+idpartner+"/"+typepartner+"/"+dfrom+"/"+dto,"","screenX=0,screenY=0,left=0,top=0,fullscreen=yes,width="+(screen.availWidth-5)+",height="+(screen.availHeight-(55)))');
