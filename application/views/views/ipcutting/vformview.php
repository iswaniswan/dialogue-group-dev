                        ...
                        ?>
                            <?php if ($group == "") { ?>
                                <tr id="tr<?= $z; ?>" class="warna">
                                    <td colspan="7"><?= $key->i_product_wip . ' - ' . $key->e_product_wipname . ' - ' . $key->e_color_name; ?>
                                        <input readonly data-nourut="<?= $z; ?>" id="iproduct<?= $z; ?>" type="hidden" class="form-control input-sm" name="iproduct<?= $z; ?>" value="<?= $key->i_product_wip . ' - ' . $key->e_product_wipname . ' - ' . $key->e_color_name; ?>">
                                    ...
                                    <td class="text-right">
                                        <?= $key->n_quantity_wip_sisa; ?><input readonly class="form-control qty input-sm text-right" autocomplete="off" type="hidden" name="nquantitywipsisa<?= $z; ?>" id="nquantitywipsisa<?= $z; ?>" value="<?= $key->n_quantity_wip_sisa; ?>">
                                    </td>
                                    <!--    <td>
                            ...
                            <tr class="del<?= $z; ?>">
                                ...
                                <td>
                                    ...
                                    <input class="form-control input-sm" readonly type="hidden" value="<?= $key->i_material; ?>">
                                    <?= $key->i_material; ?>
                                </td>
                                <td><input class="form-control input-sm" readonly type="hidden" value="<?= $key->e_material_name; ?>"><?= $key->e_material_name; ?></td>
                                <td><input class="form-control input-sm" name="e_bagian[]" readonly type="hidden" value="<?= $key->e_bagian; ?>"><?= $key->e_bagian; ?></td>
                                <td class="text-right"><input class="form-control input-sm text-right" name="n_gelar[]" readonly type="hidden" value="<?= $key->n_gelar; ?>"><?= $key->n_gelar; ?></td>
                                <td class="text-right"><input class="form-control input-sm text-right" name="n_set[]" readonly type="hidden" value="<?= $key->n_set; ?>"><?= $key->n_set; ?></td>
                                <td class="text-right"><input class="form-control input-sm text-right" name="n_panjang_gelar[]" readonly type="hidden" value="<?= $key->n_panjang_gelar; ?>"><?= $key->n_panjang_gelar; ?></td>
                                <td class="text-right"><input class="form-control input-sm text-right" name="n_panjang_kain[]" readonly type="hidden" value="<?= $key->n_panjang_kain; ?>"><?= $key->n_panjang_kain; ?></td>
                                ...
                                <td><input class="form-control input-sm" type="hidden" name="edesc[]" id="edesc<?= $iter; ?>" value="<?= $key->e_remark; ?>" placeholder="Isi keterangan jika ada!"><?= $key->e_remark; ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
