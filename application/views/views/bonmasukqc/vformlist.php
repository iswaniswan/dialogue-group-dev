<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-info">
            ...
            <?php  if(check_role($this->i_menu, 1)){ ?><a href="#" onclick="show('<?= $folder; ?>/cform/tambah/<?=$dfrom;?>/<?=$dto;?>/<?=$this->i_menu;?>/','#main'); return false;" class="btn btn-info btn-sm pull-right"><i
