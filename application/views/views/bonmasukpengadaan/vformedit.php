                        ...
                        if ($datadetail) {
                            foreach ($datadetail as $key) {
                                ...
                                if ($group != $key->id_product_wip) { ?>
                                    <tr>
                                        <td colspan="2"><input class="form-control input-sm" readonly value="<?= $key->i_product_wip.' - '.$key->e_product_wipname;?>"></td>
                                        <td><input class="form-control input-sm" readonly value="<?= $key->e_color_name;?>"></td>
                                        <td colspan="2"><input autocomplete="off" class="form-control input-sm text-right" id="n_qty_wip" placeholder="0" name="n_qty_wip" onblur="if(this.value=='' ){this.value='0' ;}" onfocus="if(this.value=='0' ){this.value='' ;}" value="0" onkeypress="return hanyaAngka(event);" onkeyup="set('<?= $kode;?>',this.value);"></td>
                                        <td colspan="2"></td>
                                    </tr>
                                <?php }
                ...
                if (data['detail'].length > 0) {
                    ...
                    for (let a = 0; a < data['detail'].length; a++) {
                        ...
                        if (group != data['detail'][a]['id_product_wip']) {
                            var newRow1 = $("<tr>");
                            cols1 += '<td colspan="2"><input class="form-control input-sm" readonly value="' + data['detail'][a]['i_product_wip'] + ' - ' + data['detail'][a]['e_product_wipname'] + '"></td>';
                            cols1 += '<td><input class="form-control input-sm" readonly value="' + data['detail'][a]['e_color_name'] + '"></td>';
                            cols1 += '<td colspan="2"><input autocomplete="off" class="form-control input-sm text-right" id="n_qty_wip' + no + '" placeholder="0" name="n_qty_wip' + no + '" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\' value="0" onkeypress="return hanyaAngka(event);" onkeyup="set(' + kode + ',this.value);"></td>';
                        ...
                        cols += '<td><input class="form-control input-sm text-right" autocomplete="off" id="nquantity_bs' + no + '" placeholder="0" name="nquantity_bs' + no + '" readonly value="0"></td>';
