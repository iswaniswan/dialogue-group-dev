            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row" hidden="">
                        <div class="col-sm-7">
                            ...
                            <input type="text" id="imemo" name="imemo" class="form-control" maxlength="" value="<?php echo $head->i_memo;?>" readonly>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-7">
                            <label >Nomor Bon Masuk</label>
                            <input type="text" id="i_bonmm" name="i_bonmm" class="form-control" readonly maxlength="" value="<?php echo $head->i_bonmm;?>">
                        </div>
                        
                        <div class="col-sm-4">
                            <label >Tanggal Pengembalian</label>
                             <input type="text" id="dbonk" name="dbonk" class="form-control date" value="<?php echo $head->d_bonmm;?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-7">
                            ...
                            <input type="text" id="reff" name="reff" class="form-control" value="<?php echo $head->i_bonmk;?>" readonly>
                        </div>

                        <div class="col-sm-4">
                            <label>Gudang</label>
                            <input type="text" id="namagudang" name="namagudang" class="form-control" value="<?php echo $head->e_nama_master;?>" readonly>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" value="<?php echo $head->tujuan_keluar;?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row" hidden="">
                        <div class="col-sm-7">
                            <label >Nama PIC Internal</label>
                            <input type="text" id="pic" name="pic" class="form-control" readonly value="<?php echo $head->pic;?>">
                        </div>
                        
                        <div class="col-sm-5">
                            <label >Nama Department</label>
                            <input type="text" id="dept" name="dept" class="form-control" readonly value="<?php echo $head->department;?>">
                        </div>
                    </div>
                    
                    <?php if (strtolower($head->tujuan_keluar) == "external") { ?>
                        <div class="form-group" hidden=""> 
                            <div class="col-sm-7">
                                <label >Nama PIC External</label>
                                <input type="text" id="pic_eks" name="pic_eks" class="form-control" readonly value="<?php echo $head->pic_eks;?>">
                            </div>
                        </div>
                    <?php } ?>
                    <div class="form-group">
