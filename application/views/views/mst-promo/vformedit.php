    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                <i class="fa fa-pencil fa-lg mr-2"></i>  <?= $title; ?> <a href="#"
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12 row">
                    <div class="col-md-12">
                        <button type="button" id="submit" class="btn mr-2 btn-success btn-rounded btn-sm"> <i class="fa fa-save mr-2"></i>Update</button>
                        <button <?php if ($data->f_all_product == 't') {?> hidden='true' <?php } ?> type="button" id="addrowproduct" class="btn mr-2 btn-info btn-rounded btn-sm"><i class="fa fa-plus mr-2"></i>Product</button>
                        <button <?php if ($data->f_all_customer == 't') {?> hidden='true' <?php } ?> type="button" id="addrowcustomer" class="btn mr-2 btn-warning btn-rounded btn-sm"><i class="fa fa-plus mr-2"></i>Pelanggan</button>
                        <button <?php if ($data->f_all_area == 't') {?> hidden='true' <?php } ?> type="button" id="addrowarea" class="btn mr-2 btn-primary btn-rounded btn-sm"><i class="fa fa-plus mr-2"></i>Area</button>
                        ...
                        foreach ($detail->result() as $key) {
                            ...
                            <tr>
                                ...
                                <td><select data-nourut="<?= $p; ?>" required class="form-control" name="i_product[]" id="i_product<?= $p; ?>">
                                        <option value="<?= $key->id_product; ?>"><?= $key->i_product_base . ' - ' . $key->e_product_name; ?></option>
                                    </select></td>
                                <td><input type="text" readonly class="form-control input-sm text-right" id="v_unit_price<?= $p; ?>" name="v_unit_price[]" value="<?= number_format($key->v_unit_price); ?>"></td>
                                <td><input type="text" class="form-control input-sm text-right" onkeyup="onlyangka(this);" id="n_quantity_min<?= $p; ?>" name="n_quantity_min[]" value="<?= $key->n_quantity_min; ?>" onblur="if(this.value==''){this.value='1';}" onfocus="if(this.value=='1'){this.value='';}"></td>
                        ...
                        foreach ($customer->result() as $key) {
                            ...
                            <tr>
                                ...
                                <td><select data-nourut="<?= $c; ?>" required class="form-control" name="i_customer[]" id="i_customer<?= $c; ?>">
                                        <option value="<?= $key->id_customer; ?>"><?= $key->i_customer . ' ' . $key->e_customer_name; ?></option>
                                    </select></td>
                                <td><input type="text" readonly class="form-control input-sm form-control-sm" id="e_customer_address<?= $c; ?>" value="<?= $key->e_customer_address; ?>"></td>
                                <td class="text-center"><i title="Delete" class="fa fa-minus-circle fa-lg text-danger ibtnDel"></i></td>
                            </tr>
                    <?php }
                    } ?>
                        ...
                        foreach ($area->result() as $key) {
                            ...
                            <tr>
                                ...
                                <td><select data-nourut="<?= $a; ?>" required class="form-control" name="i_area[]" id="i_area<?= $a; ?>">
                                        <option value="<?= $key->id_area; ?>"><?= $key->i_area . ' - ' . $key->e_area_name; ?></option>
                                    </select></td>
                                <td class="text-center"><i title="Delete" class="fa fa-minus-circle fa-lg text-danger ibtnDel"></i></td>
                            </tr>
                    <?php }
...
<script>
    $(document).ready(function () {
        ...
        for (let i = 1; i <= $("#jml_product").val(); i++) {
            $("#i_product" + i).select2({
        ...
        for (let i = 1; i <= $("#jml_customer").val(); i++) {
