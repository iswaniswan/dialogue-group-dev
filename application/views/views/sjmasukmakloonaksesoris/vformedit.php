                        ...
                        foreach ($datadetail as $key) {
                            ...
                            if($group==""){ ?>
                                <tr class='tdna'>
                                    ...
                                    <td><input class="form-control input-sm" readonly type="text" id="idocument<?=$i;?>" name="idocument<?=$i;?>" value="<?= $key->i_document;?>"></td>
                                    ...
                                    <td><input class="form-control input-sm text-right" autocomplete="off" type="text" id="nquantity<?=$i;?>" name="nquantity<?=$i;?>" value="<?= $key->n_quantity;?>" placeholder="0" onkeyup="angkahungkul(this); cekqty(<?=$i;?>); hetang(this.value,<?= $key->id_material.','.$key->id_document;?>)"></td>
                                    <td></td>
                                </tr>
                    ...
                    if (data['detail']!=null && data['data']!=null) {
                        ...
                        for (let x = 0; x < data['detail'].length; x++) {
                            ...
                            if(group==""){
                                ...
                                cols += '<td><input class="form-control input-sm text-right" autocomplete="off" type="text" id="nquantity'+x+'" name="nquantity'+x+'" value="'+data['detail'][x]['n_quantity_sisa']+'" placeholder="0" onkeyup="angkahungkul(this); cekqty('+x+'); hetang(this.value,'+data['detail'][x]['id_material']+','+data['detail'][x]['id_document']+')"></td>';
                                cols += '<td></td></tr>';
