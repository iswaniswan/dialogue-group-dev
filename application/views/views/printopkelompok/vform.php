            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <select name="opfrom" id="opfrom" class="form-control select2" disabled="" onchange="cekopfrom(this.value);">
                                <option value=""></option>
                            </select>
                        </div>
                    </div>
...
<script>
    ...
    lebar =450;
    tinggi=400;
    eval('window.open("<?php echo site_url(); ?>"+"printopkelompok/cform/cetak/"+b+"/"+c,"","width="+lebar+"px,height="+tinggi+"px,resizable=1,scrollbars=1,top='+(screen.height-tinggi)/2+',left='+(screen.width-lebar)/2+'")');
  }
