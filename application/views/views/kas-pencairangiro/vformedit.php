        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            ...
                            <input type="text" name="idocument" id="idocument" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="GRC-2012-000001" class="form-control input-sm" value="<?=$data->i_document;?>" aria-label="Text input with dropdown button">
                ...
                <div class="form-group row">                    
                    ...
                    <div class="col-sm-3">
                        <select class="form-control select2" name="icustomer" id="icustomer">
                            <option value="<?=$data->id_customer;?>"><?=$data->e_customer_name;?></option>
                        </select>
                    </div>
                    <div class="col-sm-3">
                        <select class="form-control select2" name="ikriling" id="ikriling">
                    ...
                    if ($datadetail) {
                        foreach ($datadetail as $row) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="jumlah<?=$i;?>" class="form-control" name="jumlah<?=$i;?>" style="width:150px;" readonly value="<?= number_format($row->v_jumlah);?>">
                                </td>
                            </tr>
                        <?php } 
                    }?>
