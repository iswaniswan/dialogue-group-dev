        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3">Nomor Forecast</label>
                        <label class="col-md-2">Tanggal Forecast</label>
                        <label class="col-md-7">Keterangan</label>                        
                        <div class="col-sm-3">
                            <input type="text" id="iforecast" readonly name="iforecast" class="form-control input-sm" maxlength="18" value="<?= $data->i_forecast;?>" required="">
                        </div>
                        <div class="col-sm-2">
