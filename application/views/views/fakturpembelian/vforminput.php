                ...
                <div class="col-md-12">
                    ...
                    ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="text" name="inota" id="inota" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="FP-2010-000001" maxlength="15" class="form-control input-sm" value="" aria-label="Text input with dropdown button">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="dnota" id="dnota" class="form-control input-sm" value="<?php echo date("d-m-Y"); ?>" readonly="" onchange="max_tgl(this.value);number();">
                                <input type="hidden" name="d_btb" id="d_btb" value="<?php echo $data->d_btb; ?>" readonly>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="dpajak" id="dpajak" class="form-control input-sm date" value="" readonly>
                            </div>
                            <div class="col-sm-2">
                                <input type="text" name="ifaktur" id="ifaktur" class="form-control input-sm" value="">
                            </div>
                            <div class="col-sm-2">
                                <input type="text" name="dfsupp" id="dfsupp" class="form-control input-sm" value="<?php echo date("d-m-Y"); ?>" readonly="" onchange="return tgl_jatuhtempo();">
                            </div>
                            <div class="col-sm-2">
                                <input type="text" name="dreceivefaktur" id="dreceivefaktur" class="form-control input-sm" value="<?php echo date("d-m-Y"); ?>" readonly="">
                            </div>
                            <div class="col-sm-2">
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-sm-1"><input type="text" name="vdiskon" id="vdiskon" class="form-control input-sm" value="0" onkeyup="hitung()"></div>
                            <div class="col-sm-1">
                                <input type="hidden" name="vtotaldis" id="vtotaldis" class="form-control input-sm" value="0" readonly>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="col-sm-1 text-center">
                                    <input type="checkbox" id="plus<?php echo $i; ?>" class="form-control input-sm"  name="plus<?php echo $i; ?>" onclick="plus(<?php echo $i ?>)">
                                </td>
                                <td class="col-sm-1">
                                ...
                                <td class="col-sm-1">
                                    <input style="width:100px" class="form-control input-sm text-right" type="text" id="vharga<?= $i; ?>" name="vharga<?= $i; ?>" value="<?= number_format($row->v_price,2); ?>" readonly>
                                    <input style="width:100px" class="form-control input-sm" type="hidden" id="itipe<?= $i; ?>" name="itipe<?= $i; ?>" value="<?= $row->f_ppn; ?>" readonly>
                                    <input style="width:100px" class="form-control input-sm" type="hidden" id="nppn<?= $i; ?>" name="nppn<?= $i; ?>" value="<?= $row->n_ppn; ?>" readonly>
                                </td>
                                <td class="col-sm-1">
                                    <input style="width:100px" class="form-control input-sm text-right" type="text" id="vharga_manual<?= $i; ?>" name="vharga_manual<?= $i; ?>" value="<?= number_format($row->v_price,2); ?>" onkeyup="angkahungkul(this);hitung();reformat(this);">
                                </td>
                                <td class="col-sm-1">
                                ...
                                <td class="col-sm-1">
                                    <input style="width:150px" class="form-control input-sm text-right" type="text" id="v_pembulatan_item<?= $i; ?>" name="v_pembulatan_item<?= $i; ?>" value="0" onfocus="if($(this).val()=='0'){$(this).val('')}" onblur="if($(this).val()==''){$(this).val('0')}" onkeyup="angkahungkul(this);reformat(this);">
                                </td>
                                <td style="width:2%;" class="text-center">
                                    <!-- <input type="checkbox" checked id="cek<?php echo $i; ?>" name="cek<?php echo $i; ?>" onclick="hitungnilai(<?php echo $i ?>)"> -->
                                    <input type="checkbox" checked id="cek<?php echo $i; ?>" class="form-control input-sm" name="cek<?php echo $i; ?>" onclick="hitung();">
                                </td>
                            </tr>
                        <? }
                    } else {
                        ...
                        ?>
                        <button type="button" class="btn btn-inverse btn-rounded btn-sm" onclick='show("<?= $folder; ?>/cform/tambah","#main")'> <i class="fa fa-arrow-circle-left mr-2"></i>Kembali
                        </button>
                    <? } ?>
                </tbody>
                <tfoot>
                    <tr>
                        <th class="text-right" colspan="12">Nilai Bruto Rp.</th>
                        <th><input type="text" name="vtotalbruto" id="vtotalbruto" class="form-control text-right input-sm" value="0" readonly></th>
                        <th colspan="4">Diskon Supplier (%)</th>
                    </tr>
                    <tr>
                        <th class="text-right" colspan="12">Nilai Diskon Tambahan Rp.</th>
                        <th>
                            <input type="text" autocomplete="off" name="vdiskon" id="vdiskon" class="form-control text-right input-sm" onblur="if(this.value==''){this.value='0';hitung();}" onfocus="if(this.value=='0'){this.value='';}" value="0" onkeyup="hitung(); reformat(this);">
                    ...
                    <tr>
                        <th class="text-right" colspan="12">Nilai Diskon Total (<span id="diskon_persen"><?= $data->n_diskon; ?></span>%) Rp.</th>
                        <th>
                    ...
                    <tr>
                        <th class="text-right" colspan="12">Nilai DPP Rp.</th>
                        <th><input type="text" name="vtotaldpp" id="vtotaldpp" class="form-control text-right input-sm" value="0" readonly></th>
                        <th class="text-right" colspan="4"></th>
                    </tr>
                    <tr>
                        <th class="text-right" colspan="12">Nilai PPN Rp.</th>
                        <th><input type="text" name="vtotalppn" id="vtotalppn" class="form-control text-right input-sm" value="0" readonly></th>
                        <th colspan="5">Pembulatan</th>
                    </tr>
                    <tr>
                        <th class="text-right" colspan="12">Nilai Netto Rp.</th>
                        <th><input type="text" name="vtotalnet" id="vtotalnet" class="form-control text-right input-sm" value="0" readonly></th>
                        <th><input type="text" name="v_pembulatan" id="v_pembulatan" class="form-control text-right input-sm" value="0" onfocus="if($(this).val()=='0'){$(this).val('')}" onblur="if($(this).val()==''){$(this).val('0')}" onkeyup="angkahungkul(this);reformat(this);"></th>
                        <th class="text-right" colspan="3"></th>
                    </tr>
                </tfoot>
...
<script>
    $(document).ready(function() {
        ...
        $(".select2").select2();
        showCalendar('.date');
        $('#dnota, #dfsupp, #dreceivefaktur').datepicker({
            autoclose: true,
            todayHighlight: true,
            format: "dd-mm-yyyy",
            todayBtn: "linked",
            daysOfWeekDisabled: [0],
            startDate: document.getElementById('d_btb').value,
        });
        hitung();
        tgl_jatuhtempo();
        fixedtable($('.table'));
    ...
    function hitung() {
        ...
        for (var i = 1; i <= jml; i++) {
            ...
            if ($("#cek" + i + ":checked").length > 0) {
                var v_dpp = harga * qty;
                /* dpp = (parseFloat(vharga) / ((n_ppn + 100) / 100)); */
    ...
    function hitungnilai_20212203(i) {
        var totfak = formatulang(document.getElementById('vtotalfa').value);
        var totdpp = formatulang(document.getElementById('vtotaldpp').value);
        var totppn = formatulang(document.getElementById('vtotalppn').value);
        var totfak = formatulang(document.getElementById('vtotalfa').value);
