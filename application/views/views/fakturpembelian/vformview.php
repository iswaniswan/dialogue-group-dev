            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    ...
                    <!-- <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" name="vdiskon" id="vdiskon" class="form-control input-sm" value="<?= number_format($data->v_diskon_lain); ?>" readonly>
                        </div>
                         <div class="col-sm-2">
                            <input type="text" name="vtotaldis" id="vtotaldis" class="form-control input-sm" value="<?= number_format($data->v_sub_diskon); ?>" readonly>
                        </div>
                        <div class="col-sm-2">
                            <input type="text" name="vtotaldpp" id="vtotaldpp" class="form-control input-sm" value="<?= number_format($data->v_dpp); ?>" readonly>
                        </div>
                        <div class="col-sm-2">
                            <input type="text" name="vtotalppn" id="vtotalppn" class="form-control input-sm" value="<?= number_format($data->v_ppn); ?>" readonly>
                        </div> 
                        <div class="col-sm-2">
                           <input type="text" name="vtotalbruto" id="vtotalbruto" class="form-control input-sm" value="<?= number_format($data->v_total_bruto); ?>" readonly>
                        </div>
                        <div class="col-sm-2">
                            <input type="text" name="vtotalnet" id="vtotalnet" class="form-control input-sm" value="<?= number_format($data->v_total_net); ?>" readonly>
                        </div>
                        <div class="col-sm-2">
                           <input type="hidden" name="vtotalfa" id="vtotalfa" class="form-control input-sm" value="<?= number_format($data->v_total); ?>" readonly>
                        </div>                    
                    </div>   -->
                    <div class="form-group row">
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="col-sm-1">
                                    <input style="width:100px" class="form-control input-sm text-right" type="text" id="vharga_manual<?= $i; ?>" name="vharga_manual<?= $i; ?>" value="<?= number_format($row->v_price_manual,2); ?>" readonly onkeyup="angkahungkul(this);hitung();reformat(this);">
                                </td>
                                <td class="col-sm-1">
                                    <input style="width:100px" class="form-control text-right input-sm" type="text" id="vdpp<?= $i; ?>" name="vdpp<?= $i; ?>" value="<?= number_format($row->v_dpp); ?>" readonly>
                                </td>
                                <td class="col-sm-1">
                                    <input style="width:100px" class="form-control text-right input-sm" type="text" id="vppn<?= $i; ?>" name="vppn<?= $i; ?>" value="<?= number_format($row->v_ppn); ?>" readonly>
                                </td>
                                <td class="col-sm-1">
                                    <input style="width:150px" type="hidden" id="vtotal<?= $i; ?>" name="vtotal<?= $i; ?>" value="<?= number_format($row->v_total); ?>" readonly>
                                    ...
                                    <input style="width:150px" class="form-control text-right input-sm" type="text" id="vtotalsem<?= $i; ?>" name="vtotalsem<?= $i; ?>" value="<?= number_format($row->v_total); ?>" readonly>
                                </td>
                                <td class="col-sm-1">
