    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <a href="#" onclick="show('<?= $folder; ?>/cform/index/<?= $dfrom . "/" . $dto; ?>','#main'); return false;" class="btn btn-info btn-sm pull-right"><i class="fa fa-list"></i>&nbsp;<?= $title_list; ?> </a>
            </div>
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <select name="ibagian" id="ibagian" class="form-control input-sm select2" required="">
                                <?php if ($bagian) {
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="text" name="inota" id="inota" readonly="" onkeyup="gede(this);" placeholder="FP-2010-000001" maxlength="15" class="form-control input-sm input-sm" value="<?= $data->i_nota; ?>" aria-label="Text input with dropdown button">
                        ...
                        <div class="col-sm-2">
                        <input type="hidden" name="d_btb" id="d_btb" value="<?= $date->d_btb; ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" name="ipajak" id="ipajak" class="form-control input-sm" value="<?= $data->i_pajak; ?>">
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-2">
                            <input type="text" name="dreceivefaktur" id="dreceivefaktur" class="form-control input-sm date" value="<?= date("d-m-Y", strtotime($data->d_terima_faktur)); ?>" readonly="">
                        </div>
                        <div class="col-sm-2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <textarea class="form-control input-sm input-sm" name="eremark" placeholder="Isi keterangan jika ada!"><?= $data->e_remark; ?></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <? if ($data->i_status == '1') { ?>
                            <div class="col-sm-12">
                                ...
                                <button type="button" id="send" class="btn btn-primary btn-rounded btn-sm" onclick="return getenabledsend();"><i class="fa fa-paper-plane-o"></i>&nbsp;&nbsp;Send</button>
                        ...
                        <? } else { ?>
                            ...
                            <button type="button" class="btn btn-inverse btn-rounded btn-sm" onclick="show('<?= $folder; ?>/cform/index/<?= $dfrom . "/" . $dto; ?>','#main')"> <i class="fa fa-arrow-circle-left"></i>&nbsp;&nbsp;Kembali</button>
                            <button type="button" id="send" disabled class="btn btn-primary btn-rounded btn-sm" onclick="return getenabledsend();"><i class="fa fa-paper-plane-o"></i>&nbsp;&nbsp;Send</button> -->
                                <?php if ($data->i_status == '1' || $data->i_status == '3' || $data->i_status == '7') { ?>
                                    <button type="submit" id="submit" class="btn btn-success btn-rounded btn-sm"><i class="fa fa-save"></i>&nbsp;&nbsp;Update</button>&nbsp;
                                    <button hidden="true" type="button" id="send" class="btn btn-primary btn-rounded btn-sm"><i class="fa fa-paper-plane-o ml-2"></i>&nbsp;&nbsp;Send</button>&nbsp;
                                <?php } ?>
            ...
            <table id="tabledatax" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="col-sm-1">
                                    <input style="width:100px" class="form-control text-right input-sm" type="text" id="vharga<?= $i; ?>" name="vharga<?= $i; ?>" value="<?= number_format($row->v_price,2); ?>" readonly>
                                ...
                                <td class="col-sm-1">
                                    <input style="width:100px" class="form-control input-sm text-right" type="text" id="vharga_manual<?= $i; ?>" name="vharga_manual<?= $i; ?>" value="<?= number_format($row->v_price_manual,2); ?>" onkeyup="angkahungkul(this);hitung();reformat(this);">
                                </td>
                                <td class="col-sm-1 ">
                                ...
                                <td class="col-sm-1">
                                    <input style="width:150px" class="form-control input-sm text-right" type="text" id="v_pembulatan_item<?= $i; ?>" name="v_pembulatan_item<?= $i; ?>" value="<?= number_format($row->v_pembulatan_item);?>" onfocus="if($(this).val()=='0'){$(this).val('')}" onblur="if($(this).val()==''){$(this).val('0')}" onkeyup="angkahungkul(this);reformat(this);">
                                </td>
                            </tr>
                    <? }
                    } ?>
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <th>
                            <input type="text" autocomplete="off" name="vdiskon" id="vdiskon" class="form-control text-right input-sm" onblur="if(this.value==''){this.value='0';hitung();}" onfocus="if(this.value=='0'){this.value='';}" value="<?= number_format($data->v_sub_diskon); ?>" onkeyup="hitung(); reformat(this);">
                    ...
                    <tr>
                        ...
                        <th><input type="text" name="v_pembulatan" id="v_pembulatan" class="form-control text-right input-sm" value="<?= number_format($data->v_pembulatan);?>" onfocus="if($(this).val()=='0'){$(this).val('')}" onblur="if($(this).val()==''){$(this).val('0')}" onkeyup="angkahungkul(this);reformat(this);"></th>
                        <th class="text-right" colspan="2"></th>
                    </tr>
                </tfoot>
