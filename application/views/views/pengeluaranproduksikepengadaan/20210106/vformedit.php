                    ...
                    <?php foreach ($datadetail as $key) {?>
                        <tr>
                            ...
                            <td>
                                ...
                                <td>
                                    <input class="form-control input-sm text-right" type="text" id="npemenuhan<?= $i ;?>" name="npemenuhan<?= $i ;?>" value="<?= $key->qtymaterial;?>" placeholder="0" onkeyup="angkahungkul(this);">
                                </td>
                                <td>
                    ...
                    success: function (data) {
                        if (data['head']!=null && data['detail']!=null) {
                            ...
                            for (let x = 0; x < data['detail'].length; x++) {
                                ...
                                cols += '<td><input class="form-control input-sm text-right" type="text" id="npemenuhan'+x+'" name="npemenuhan'+x+'" value="'+data['detail'][x]['n_panjang_kain_sisa']+'" placeholder="0" onkeyup="angkahungkul(this);"></td>';
