            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                        <input type="text" id= "eremark "name="eremark" class="form-control" maxlength="30" value="<?= $data->e_remark; ?>" readonly>
                        </div>
                    </div>   
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select required="" id="idepartement" name="idepartement" class="form-control select2" disabled="">
                    ...
                    <div class="table-responsive">
                        <table id="tabledata" class="table table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <td class="col-sm-1">
                                    <input style ="width:80px"type="text" class="form-control" id="nqtykeluar<?=$i;?>" name="nqtykeluar<?=$i;?>"value="<?= number_format($row->n_quantity_keluar,0);?>" readonly>
                                <td class="col-sm-1">
                                    <input style ="width:300px"type="text" class="form-control" id="edesc<?=$i;?>" name="edesc<?=$i;?>"value="<?=$row->e_remark;?>" readonly>
                                </td>
                                </tr>
                                <?}?>
                            </tbody>
