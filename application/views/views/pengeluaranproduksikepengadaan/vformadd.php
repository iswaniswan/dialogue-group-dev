            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                     <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" name="ikeluar" id="ikeluar" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number;?>" maxlength="17" class="form-control input-sm" required="" value="" aria-label="Text input with dropdown button">
                        ...
                        <div class="col-sm-2">
                            <input type="text" id="dkeluar" name="dkeluar" class="form-control input-sm date" value="<?php echo date("d-m-Y"); ?>" readonly>  
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" id="dmemo" name="dmemo" class="form-control input-sm" value="" readonly>
                        </div>
                        <div class="col-sm-7">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <span class="notekode">* Tanggal Dokumen, Tidak Boleh Lebih Kecil Dari Tanggal Referensi!</span>
                        </div>
                    </div>
                </div>
            </div>
   ...
   $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td style="text-align: center"><input hidden class="form-control input-sm" readonly id="idmaterial'+no+'" name="idmaterial[]" value="'+data['detail'][a]['id_material']+'"><input class="form-control input-sm" readonly id="imaterial'+no+'" name="imaterial'+no+'" value="'+data['detail'][a]['i_material']+'"></td>';
                    cols += '<td><input type="text" class="form-control input-sm" id="ematerial'+no+'" name="ematerial'+no+'" value="'+data['detail'][a]['e_material_name']+'" readonly></td>';
                    cols += '<td><input type="text" class="form-control input-sm text-right" id="nquantitymemo'+no+'" name="nquantitymemo[]" value="'+data['detail'][a]['n_quantity']+'" readonly></td>';
                    cols += '<td><input class="form-control input-sm text-right" readonly id="sisa'+no+'" name="sisa[]" value="'+data['detail'][a]['n_quantity_sisa']+'"></td>';
                    cols += '<td><input class="form-control input-sm text-right" id="nquantity'+no+'" placeholder="0" autocomplete="off" name="nquantity[]" value="" onkeypress="return hanyaAngka(event);" onkeyup="ceksaldo('+no+');"></td>';
                    cols += '<td><input class="form-control input-sm text-right" readonly id="satuan'+no+'" name="satuan[]" value="'+data['detail'][a]['e_satuan_name']+'"></td>';
                    cols += '<td><input class="form-control input-sm" id="edesc'+no+'" name="edesc[]" value="" placeholder="Keterangan jika ada!"></td>';
                    newRow.append(cols);
    ...
    function ceksaldo(i) {
        if (parseFloat($('#nquantity'+i).val()) > parseFloat($('#sisa'+i).val())) {
            swal('Maaf :(','Jumlah tidak boleh lebih dari Jumlah Sisa!!!','error');
