            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" id = "enamamaster" name="enamamaster" class="form-control" value="<?= $data->e_sumber;?>"readonly>
                            <input type="hidden" id = "ikodemaster" name="ikodemaster" class="form-control" value="<?= $data->i_sumber;?>"readonly>
                        </div>
                    </div>
                    <div class="form-group">
...
$(document).ready(function () {
  ...
  var counter = document.getElementById("jml").value;
    $("#addrow").on("click", function () {
        ...
        if(cols =! ""){       
            document.getElementById("jml").value = counter;  
            cols += '<td><select type="text" id="kodebrg'+ counter + '" class="form-control" name="kodebrg'+ counter + '" value="" onchange="getmaterial('+ counter + ');"></td>';
            cols += '<td><input type="text" id="namabrg'+ counter + '" type="text" class="form-control" name="namabrg' + counter + '" value=""></td>';
            ...
            cols += '<td><input type="text" id="ecolorname'+ counter + '" type="text" class="form-control" name="ecolorname' + counter + '" value=""></td>';
