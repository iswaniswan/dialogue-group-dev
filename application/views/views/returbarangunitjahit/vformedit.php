                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <select id="ireff" required="" class="form-control select2">
                                <option value="<?= $data->id_document_reff.'|'.$data->d_document_reff;?>"><?= $data->i_document_reff;?></option>
                            </select>
                ...
                <tbody>
                    <?php foreach ($datadetail as $key) { ?>
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control input-sm" readonly value="<?= $key->i_product_wip;?>">
                                <input hidden class="form-control input-sm" readonly name="idproduct<?=$i;?>" value="<?= $key->id_product_wip;?>">
                            </td>
                            <td><input class="form-control input-sm" readonly value="<?= $key->e_product_wipname;?>"></td>
                            <td><input readonly class="form-control input-sm" value="<?= $key->e_color_name;?>"></td>
                            <td><input class="form-control input-sm text-right" id="quantity<?=$i;?>" readonly value="<?= $key->n_quantity_reff;?>"></td>
                            <td><input class="form-control input-sm text-right" autocomplete="off" id="nquantity<?=$i;?>" name="nquantity<?=$i;?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="<?= $key->n_quantity;?>" onkeyup="angkahungkul(this); ceksaldo(<?=$i;?>);"></td>
                            <td><input class="form-control input-sm" placeholder="Isi keterangan jika ada!" name="eremark<?=$i;?>" value="<?= $key->e_remark;?>"></td>
                        </tr>
                        <?php $i++; 
                    } ?>
                </tbody>
