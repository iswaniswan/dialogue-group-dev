                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="hidden" id="idocumentold" name="idocumentold" class="form-control" required="" readonly value="<?=$data->i_document; ?>">
                                <input type="text" name="idocument" id="idocument" readonly="" autocomplete="off" onkeyup="gede(this);" value="<?=$data->i_document;?>" maxlength="25" class="form-control input-sm" value="" aria-label="Text input with dropdown button">
                                <input type="hidden" id="idocumentold" name="idocumentold" class="form-control" required="" readonly value="<?=$data->i_document; ?>">
                    ...
                    if ($datadetail) {
                        foreach ($datadetail as $row) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="edesc<?=$i;?>" class="form-control"  name="edesc<?=$i;?>" style="width:300px;" value="<?= $row->e_remark;?>">
                                </td>
                                <td>
                                    <input type="checkbox" name="chk<?=$i;?>" value="cek" id="chk<?=$i;?>" checked = true onchange="ngetang();">
                                </td>
                            </tr>
                        <?php } 
                    }?>
