    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            ...
            <?php if(check_role($this->i_menu, 1)){ ?>
                <a href="#" onclick="show('<?= $folder; ?>/cform/indexkn/<?= $dfrom."/".$dto;?>','#main'); return false;" class="btn btn-info btn-sm pull-right">
                    <i class="fa fa-list"></i> &nbsp;list kn
                </a>
            <?php } ?>
        </div>            
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        datatableedit('#tabledata', base_url + '<?= $folder; ?>/Cform/data/<?= $dfrom.'/'.$dto;?>',5,6);
    });
