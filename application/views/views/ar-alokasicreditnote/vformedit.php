                ...
                <div class="panel-body table-responsive">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="hidden" id="idkn" name="idkn" required="" value="<?= $data->id_referensi; ?>">
                    ...
                    <tbody>
                        <?php foreach ($datadetail as $key) { $i++; ?>
                            <tr>
                                ...
                                <td><input type="text" readonly class="form-control input-sm text-right" name="vnilai<?=$i;?>" id="vnilai<?=$i;?>" value="<?= number_format($key->v_sisa_nota);?>"/></td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" id="vjumlahlebih" name="vjumlahlebih" class="form-control input-sm text-right" value="<?= number_format($data->v_lebih);?>" readonly>
                            </td>
                            <td></td>
                        </tr>
                    </tfoot>
