            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <label class="col-md-3">Tanggal Bon K</label><label class="col-md-9">Keterangan</label>
                        <div class="col-sm-3">
                            <input required="" readonly id= "dbk" name="dbk" class="form-control date" value="<?= date('d-m-Y');?>">
                            <input id="ibk" name="ibk" type="hidden">
                        </div>
                        <div class="col-sm-9">
