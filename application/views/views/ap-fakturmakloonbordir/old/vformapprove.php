        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="dfaktur" name="dfaktur" class="form-control" value="<?php echo $data->d_nota; ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" id="ifaksup" name="ifaksup" class="form-control" value="<?php echo $data->no_faktur_supplier; ?>" readonly>
                        </div> 
                        <div class="col-sm-4">
            ...
            <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="hidden" id="partner" name="partner" class="form-control" value="<?php echo $data->partner; ?>" readonly>
                            <select name="ipartner" id="ipartner" class="form-control select2" onchange="sjkeluar(this.value);" disabled="">
                                <option value=""></option>
                                <?php if ($partner) {
                        ...
                        <div class="col-sm-6">
                            <input type="hidden" id="isjkeluar" name="isjkeluar" class="form-control" value="<?php echo $data->i_sj_keluar; ?>" readonly>
                            <select name="iisjkeluar" id="iisjkeluar" class="form-control select2" onchange="getdata(this.value);" disabled="">
    ...
    function getdataedit(sj, nota) {
        ...
        success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    var checked = '';
                    v_gross = edit * v_price;
                    v_discount  = v_gross*n_discount;

                    var cols        = "";
                    var newRow = $("<tr>");
                    if(edit == qty_belumnota){
                        var zz = zz+1;
                        ...
                        cols += '<td><input style="width:120px" class="form-control" readonly id="i_wip'+zz+'" name="i_wip'+zz+'" value="'+i_wip+'"></td>';
                        cols += '<td><input style="width:400px" class="form-control" readonly id="namabarang'+zz+'" name="namabarang'+zz+'" title="'+e_namabrg+'" value="'+e_namabrg+'"></td>';
                        cols += '<td><input style="width:80px" readonly class="form-control" style="text-align:right;" id="qty_belumnota'+zz+'" name="qty_belumnota'+zz+'" value="'+edit+'"></td>';
                        cols += '<td><input style="width:100px" readonly class="form-control" style="text-align:right;" id="hargasatuan'+zz+'" name="hargasatuan'+zz+'" value="'+v_price+'"></td>';
                        cols += '<td><input style="width:150px" readonly class="form-control" style="text-align:right;" id="hargatotal'+zz+'" name="hargatotal'+zz+'" value="'+v_gross+'"><input style="width:80px" type="hidden" class="form-control" style="text-align:right;" id="discount'+zz+'" name="discount'+zz+'" value="'+v_discount+'"></td>';
