                    ...
                    <table id="tabledatay" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" width="7%;">Warna</th>
                                <th class="text-right" width="7%;">FC Jahit</th>
                                <th class="text-right" width="7%;">Internal</th>
                                <th class="text-right" width="8%;">Eksternal</th>
                        ...
                        <tbody>
                            ...
                            foreach ($datadetail as $key) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control input-sm text-right" type="text" id="n_internal<?= $i; ?>" name="n_internal<?= $i; ?>" placeholder="0" onkeyup="angkahungkul(this); cekvalidasi(<?= $i; ?>)" value="<?= $key->n_quantity; ?>">
                                    </td>
                                    <td>
                                        <input readonly class="form-control input-sm text-right" type="text" id="n_eksternal<?= $i; ?>" name="n_eksternal<?= $i; ?>" value="0">
                                    </td>
                                    <td>
...
<script>
    function cekvalidasi(i) {
        ...
        n_internal = $("#n_internal" + i).val();
        var n_eksternal = 0.00;

        //alert("cek");
        if (parseFloat(n_internal) > parseFloat(n_quantity)) {
            swal('Tidak boleh melebihi Forecast Jahit');
            $("#n_internal" + i).val(n_quantity);
            n_internal = n_quantity;
        }

        n_eksternal = parseFloat(n_quantity) - parseFloat(n_internal);
        $("#n_eksternal" + i).val(n_eksternal);
    ...
    $(document).ready(function() {
        ...
        $('#iuraianjahit').mask('SSS-0000-000000S');
        $('.select2').select2();
