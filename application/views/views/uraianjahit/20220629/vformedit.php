                        ...
                        <tbody>
                            ...
                            foreach ($datadetail as $key) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control input-sm text-right" type="text" id="n_internal<?= $i; ?>" name="n_internal<?= $i; ?>" placeholder="0" onkeyup="angkahungkul(this); cekvalidasi(<?= $i; ?>)" value="<?= $key->n_quantity_internal; ?>">
                                    </td>
                                    <td>
                                        <input class="form-control input-sm text-right" type="text" id="n_eksternal<?= $i; ?>" name="n_eksternal<?= $i; ?>" value="<?= $key->n_quantity_eksternal; ?>" readonly>
                                    </td>
                                    <td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#iuraianjahit').mask('SS-0000-000000S');
        $('.select2').select2();
