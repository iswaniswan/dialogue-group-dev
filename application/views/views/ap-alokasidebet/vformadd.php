            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" name="ikasbankkeluarap" id="ialokasidebet" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number;?>" maxlength="15" class="form-control input-sm" value="" aria-label="Text input with dropdown button">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-md-2">Tanggal Debet</label>
                        <div class="col-sm-4">
                            <select class="form-control select2" name="isupplier" id="isupplier" onchange="getdebet(this.value);" disabled>
                            </select>
                        </div>
                        <div class="col-sm-5">
                            <select name="idebet" id="idebet" class="form-control select2" onchange="getjenisfaktur(this.value);" disabled="true">
                            </select>
                        </div>
                        <div class="col-sm-2">
                            <input class="form-control" name="ddebet" id="ddebet" value="" placeholder="Tanggal Debet" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" style="text-align:right;" name="vsisa" id="vsisa" class="form-control" placeholder="Nominal Sisa Hutang" value="0" readonly>
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="hidden" name="vbayarfaktur" id="vbayarfaktur" class="form-control" value="" readonly>
                        </div>
                        <div class="col-sm-4">
                            <input type="text" style="text-align:right;" name="vsisadebet" id="vsisadebet" class="form-control" placeholder="Nominal Jumlah Bayar" value="" readonly>
                        </div>
                    </div>
...
$('#ceklis').click(function(event) {
    if($('#ceklis').is(':checked')){
        $("#ialokasidebet").attr("readonly", false);
    }else{
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (let a = 0; a < data['detail'].length; a++) {
                ...
                cols += '<td><input class="form-control" type="text" name="vbayarnota'+no+'" style="text-align:right;" id="vbayarnota'+no+'" value="0" placeholder="0" onkeyup="getjumlahbayar();">';
                ...
                cols += '<td><input class="form-control" type="text" id="edesc'+no+'" name="edesc'+no+'" value="" placeholder="Isi keterangan jika ada!"></td>';
                newRow.append(cols);
...
function getjumlahbayar(){
    ...
    for(var i=1; i<=jml ;i++){
        ...
        vbayarnota    = formatulang($('#vbayarnota'+i).val());
        vbayarnotaold = formatulang($('#vbayarnotaold'+i).val());
