            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="hidden" onchange="cektanggal()" id= "tglreceive" name="tglreceive" class="form-control date" readonly value="<?= $isi->d_sjp_receive; ?>">
                            <input onchange="cektanggal()" id= "dreceive" name="dreceive" class="form-control date" readonly value="<?= $isi->d_sjp_receive; ?>">
                        </div>
                        <div class="col-sm-3">
                            ...
                            if($detail){
                                foreach($detail as $row){ 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input style="text-align: right;" class="form-control" id="ndeliver<?= $i;?>" name="ndeliver<?= $i;?>" value="<?= $row->n_quantity_deliver;?>" readonly>
                                        </td> 
                                        <td>
