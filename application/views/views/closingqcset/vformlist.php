            ...
            <div class="panel-body table-responsive">
                    ...
                    <div class="col-md-8">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <button type="button" class="btn btn-info" onclick="return closing($('#bulan').val(), $('#tahun').val(), $('#ibagian').val())"> <i class="fa fa-check-square-o"></i>&nbsp;&nbsp;Update Saldo</button>
                            </div>
                        </div>
                    </div>
<div class="col-md-12">
...
<script>
    ...
    function closing(bulan,tahun, ibagian) {
        swal({   
            ...
            text: "Update Saldo Awal QC Set Bulan "+bulan+" Tahun "+tahun,   
            type: "warning",   
            ...
            if (isConfirm) { 
                $.ajax({
                    ...
                    success: function (data) {
                        if(data == 1) {
                            swal("Update Saldo Awal QC Set!", "Data berhasil di update :)", "success");
