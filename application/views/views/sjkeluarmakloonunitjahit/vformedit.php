            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="iforecast" name="iforecast" class="form-control input-sm" placeholder="Harus Diisi!!!" required="" value="<?= $data->i_forecast;?>" maxlength="15">
                        </div>
                        <div class="col-sm-2">
                    ...
                    <?php $z = 0; $group = ""; foreach ($datadetail as $key) { $i++; 
                        ...
                        ?>
                            <?php if($group==""){?>
                                <tr id="tr<?= $z;?>">
                                    ...
                                    <td></td>
                                    <td><input class="form-control input-sm text-right inputitem" id="qw<?= $z;?>" name="nquantitywip<?= $z;?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="<?= $key->n_quantity_wip; ?>" onkeyup="hitung(<?=$z?>); angkahungkul(this);" data-id="<?=$key->id_product_wip;?>"></td>
                                    <td></td>
                        ...
                        <tr class="del<?= $z;?>">
                            ...
                            <td>
                                ...
                                <input type="hidden" name="vharga[]" value="<?= $key->v_price;?>">
                            </td>
                            <td>
                                <input class="form-control input-sm" readonly type="text" value="<?= $key->e_material_name;?>">
                            </td>
                             <td>
                                <input class="form-control input-sm" readonly type="text" value="<?= $key->e_satuan_name;?>">
                            </td>
                            <td>
                                <input type="text" class="form-control qty text-right input-sm inputitem" autocomplete="off" name="nquantity[]" id="<?=$key->id_product_wip.$i?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="<?= $key->n_quantity;?>" readonly>
                                <input class="form-control text-right inputitem" autocomplete="off" type="hidden" id="tmp_<?=$key->id_product_wip.$i?>" value="<?= $key->n_quantity;?>" readonly>
                            </td>
                            <td colspan="2">
                                <input type="text" class="form-control input-sm" name="eremark[]" value="<?= $key->e_remark;?>" placeholder="Isi keterangan jika ada!"/>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            for (let x = data['detail'].length; x > 0 ; x--) {
                                ...
                                cols1 += '<td><input type="hidden" name="idproductwip[]" value="'+data['detail'][xx]['id_product_wip']+'"><input type="text" name="vharga[]" value="'+data['detail'][xx]['v_price']+'">';
                                ...
                                cols1 += '<td><input class="form-control qty input-sm text-right inputitem" autocomplete="off" type="text" name="nquantity[]" id="nquantity'+x+'" value="'+data['detail'][xx]['n_quantity']+'" readonly><input class="form-control text-right inputitem" autocomplete="off" type="hidden" id="nquantity_'+x+'" value="'+data['detail'][xx]['n_quantity']+'" readonly></td>';
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (let x = data['detail'].length; x > 0 ; x--) {
                            ...
                            cols += '<td><input class="form-control qty input-sm text-right inputitem" autocomplete="off" type="text" name="esatuan[]" value="'+data['detail'][xx]['e_satuan_name']+'" readonly></td>';
                            cols += '<td><input class="form-control input-sm text-right inputitem" autocomplete="off" type="text" name="nquantity[]" id="'+idwip+x+'"  value="'+data['detail'][xx]['n_quantity']+'" readonly><input class="form-control text-right inputitem" autocomplete="off" type="hidden" id="tmp_'+idwip+x+'" value="'+data['detail'][xx]['n_quantity']+'" readonly></td>';
