        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" name="ecustomerbankname" class="form-control" value="<?= $data->e_customer_bankname; ?>">
                    </div>
                </div>
                <div class="form-group">
                        <label class="col-md-12">No Account</label>
                        <div class="col-sm-12">
                            <input type="text" name="ecustomerbankaccount" class="form-control" value="<?= $data->e_customer_bankaccount; ?>">
                        </div>
                    </div>
                <div class="form-group">
