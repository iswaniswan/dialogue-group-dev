        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <!-- <a href="#"
                    ...
                    class="btn btn-info btn-sm pull-right"><i class="fa fa-list"></i></i>&nbsp; <?= $title_list; ?>
                </a> -->
            </div>
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-md-5">Sub Bagian/Partner</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="send" class="btn btn-primary btn-rounded btn-sm" disabled onclick="return getenabledsend();"><i class="fa fa-paper-plane-o"></i>&nbsp;&nbsp;Send</button>
...
<div class="white-box" id="detail">
    ...
    <div class="table-responsive">
        <table id="tabledata" class="table color-table success-table table-bordered" cellspacing="0" width="100%" hidden="">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Kode Barang</th>
                    <th class="text-center">List Nama Barang</th>
                    <th class="text-center">Qty</th>
                    <th class="text-center">Satuan</th>
    ...
    <div class="table-responsive">
        <table id="tabledata2" class="table color-table success-table table-bordered" cellspacing="0" width="100%" hidden="">
            <thead>
                <tr>
                    <th class="text-center">No</th>
                    <th class="text-center">Kode Barang</th>
...
function cek() {
    ...
    if (dbonk == ''  || istore == '' || tujuankeluar == '' || dept == '' || jenispengeluaran == '' || ppic == '') {
        ...
        if(jml==0){
            ...
            for (var i = 1; i <=jml; i++) {
                if(($("#imaterial"+i).val()=='' || $("#imaterial"+i).val()==null) || ($("#nquantity"+i).val()=="" || $("#nquantity"+i).val()==null || $("#nquantity"+i).val()==0)){
                    swal('Data item masih ada yang salah !!!');
                    return false;
                }
                //alert($("#nquantity"+i).val());
            }
        }
    }
    //return false;
