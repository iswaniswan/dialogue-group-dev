                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="text" name="i_document" id="i_document" readonly="" onkeyup="gede(this);" placeholder="PP-2010-000001" maxlength="15" class="form-control input-sm" value="<?= $data->i_document; ?>" aria-label="Text input with dropdown button">
                            </div>
                        ...
                        <div class="col-sm-3">
                            <input type="text" id="i_bagian_receive" name="i_bagian_receive" class="form-control input-sm date" required="" readonly value="<?= $data->e_bagian_name; ?> | <?= $data->name ?>">
                        </div>
                    </div>
                    <div class="form-group row">
