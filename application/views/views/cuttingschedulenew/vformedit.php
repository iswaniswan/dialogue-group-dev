                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" name="idocument" id="idocument" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="SC-2010-000001" maxlength="15" class="form-control input-sm" value="<?=$data->i_document;?>" aria-label="Text input with dropdown button">
            ...
            <table id="tabledatax" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                ...
                <?php $z = 0; $group = ""; foreach ($datadetail as $key) { $i++; 
                        ...
                        <tr class="del<?= $z;?>">
                            ...
                            <td><input style="width:100px;" type="text" readonly id="d_schedule" class="form-control input-sm date" name="d_schedule[]" value="<?= date('d-m-Y', strtotime($key->d_schedule));?>"></td>
                            <!-- <td>
                            ...
                            <td colspan="2">
                                <input style="width:180px;" type="text" class="form-control input-sm" name="edesc[]" id="edesc<?=$z;?>" value="<?= $key->e_remark;?>" placeholder="Isi keterangan jika ada!"/>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>         
