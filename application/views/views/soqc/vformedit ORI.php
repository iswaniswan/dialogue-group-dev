                        ...
                        <table id="tabledatax" class="table color-table success-table table-bordered class" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input readonly type="hidden" id="idcolor<?= $i ;?>" class="form-control input-sm inputitem" autocomplete="off" name="idcolor<?= $i ;?>" 
                                        value="<?= $key['id_color'] ?>">
                                        <input readonly type="hidden" id="e_color<?= $i ;?>" class="form-control input-sm inputitem" autocomplete="off" name="e_color<?= $i ;?>" 
                                        value="<?= $key['e_color_name'] ?>">
                                        <input readonly type="hidden" id="skin<?= $i ;?>" class="form-control input-sm inputitem" autocomplete="off" name="skin<?= $i ;?>" 
                                        value="<?= $key['id_material'] ?>">
                                        <input readonly type="text" id="e_skin<?= $i ;?>" class="form-control input-sm inputitem" autocomplete="off" name="e_skin<?= $i ;?>" 
                                        value="<?= $key['e_material_name'] ?>"></td>
                                    <td><input readonly type="text" id="statusbarang<?= $i ;?>" class="form-control input-sm inputitem" autocomplete="off" name="statusbarang<?= $i ;?>" 
                                        value="<?= $key['status_barang'] ?>"></td>
