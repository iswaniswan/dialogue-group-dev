                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($key['id'] == 0 || $key['id'] == null || $key['id'] == ''){?>
                                            <option value=''> - </option>
                                        <?php } else {?>
                                    ...
                                    <td><input readonly type="hidden" id="idcolor<?= $i ;?>" class="form-control input-sm inputitem" autocomplete="off" name="idcolor<?= $i ;?>" 
                                        ...
                                        <select data-urut="<?= $i ;?>" id="skin<?= $i ;?>" class="form-control select2 input-sm" name="skin<?= $i ;?>" >
                                        <?php if ($key['id2'] == 0 || $key['id2'] == null || $key['id2'] == ''){?>
                                            <option value=''> - </option>
                                        <?php } else {?>
                                            <option value="<?= $key['id2']?>"><?= $key["i_material"].' - '.$key["e_material_name"];?></option>
                                        <?php }?>
                                        </select>
                                    </td>
                                    <td>
                                        <select id="statusbarang<?= $i ;?>" class="form-control select2 input-sm" name="statusbarang<?= $i ;?>" >
                                        <?php if ($key['status_barang'] != 0 || $key['status_barang'] != null || $key['status_barang'] != ''){?>
                                            <?php if ($key['status_barang'] == 'Sudah Packing'){?>
