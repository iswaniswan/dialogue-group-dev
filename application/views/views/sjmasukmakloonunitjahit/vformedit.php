        ...
        <div class="table-responsive">
            <table id="tabledatax" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                ...
                <tbody>
                    ...
                    <td>
                        <input class="form-control  input-sm text-right inputitem" id="nquantity<?= $i ;?>" placeholder="0" name="nquantity<?= $i ;?>" value="<?= $key->masuk ;?>" onkeypress="return hanyaAngka(event);" onkeyup="ceksaldo(<?= $i ;?>);">
                    </td>
                    <td>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><input class="form-control input-sm text-right inputitem" id="nquantity'+no+'" placeholder="0" name="nquantity'+no+'" value="" onkeypress="return hanyaAngka(event);" onkeyup="ceksaldo('+no+');"></td>';
