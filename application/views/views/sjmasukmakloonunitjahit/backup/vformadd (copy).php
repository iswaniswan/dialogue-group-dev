...
function cekval(input){
    ...
    $("#addrow").on("click", function () {
       ...
       // $("#tabledata").attr("hidden", false);
        ...
        cols += '<td><input type="text" readonly id="ecolorname'+ counter + '" class="form-control" name="ecolorname'+ counter + '"><input type="hidden" id="icolor'+ counter + '" class="form-control" name="icolor'+ counter + '" ></td>';
    ...
    function getproduct(id){
        ...
        success: function (data) {
            ...
            ada=false;
            var a = $('#product'+id).val();
            var e = $('#ematerialname'+id).val();
            var jml = $('#jml').val();
            for(i=1;i<=jml;i++){
                if((a == $('#product'+i).val()) && (i!=jml)){
