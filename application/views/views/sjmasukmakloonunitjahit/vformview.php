                ...
                <tbody>
                    ...
                    <tr>
                     ...
                     <td style="text-align: center">
                        <input type="text" class="form-control" readonly id="ireferensi<?= $i ;?>" name="ireferensi<?= $i ;?>" value="<?=  $key->i_document ;?>">
                        <input hidden class="form-control" readonly id="id_document<?= $i ;?>" name="id_document<?= $i ;?>" value="<?=  $key->id_document_reff ;?>">
                        <input hidden class="form-control" readonly id="id_product_wip<?= $i ;?>" name="id_product_wip<?= $i ;?>" value="<?=  $key->id_product_wip ;?>">
                    </td>
                    <td>
                        <input class="form-control" readonly id="iproduct<?= $i ;?>" name="iproduct<?= $i ;?>" value="<?= $key->i_product_wip. ' - '.$key->e_product_wipname ;?>">
                    </td>
                    <td>
                        <input readonly class="form-control" id="ecolor<?= $i ;?>" name="ecolor<?= $i ;?>" value="<?= $key->e_color_name ;?>">
                    </td>
                    <td><input class="form-control text-right" readonly id="sisa<?= $i ;?>" name="sisa<?= $i ;?>" value="<?= $key->keluarfull ;?>"></td>
                    <td><input class="form-control text-right" id="nquantity<?= $i ;?>" placeholder="0" name="nquantity<?= $i ;?>" value="<?= $key->masuk ;?>" readonly></td>
                    <td><input class="form-control" id="eremark<?= $i ;?>" name="eremark<?= $i ;?>" value="<?= $key->e_remark ;?>" readonly></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
