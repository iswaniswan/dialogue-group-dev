                    ...
                    if ($detail) {
                        foreach ($detail as $row) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" style="width:150px" value="<?= $row->i_material;?>" readonly id="imaterial<?=$i;?>" class="form-control input-sm" name="imaterial<?=$i;?>">
                                </td>
                                <td>
                                    <input type="text" style="width:400px" value="<?= $row->e_material_name;?>" readonly id="ematerial<?=$i;?>" class="form-control input-sm" name="ematerial<?=$i;?>">
                                </td>
                                <td>
                                    <input type="hidden" value="<?= $row->i_satuan_code;?>" id="isatuan<?=$i;?>" name="isatuan<?=$i;?>">
                                    <input type="text" style="width:150px"  value="<?= $row->e_satuan_name;?>" readonly id="esatuan<?=$i;?>" class="form-control input-sm" name="esatuan<?=$i;?>">
                                </td>
                                <td>
                                    <input type="text" style="width:100px" value="<?= $row->n_quantity_btb;?>" id="nquantitybtb<?=$i;?>" class="form-control text-right input-sm inputitem" name="nquantitybtb<?=$i;?>" readonly>
                                ...
                                <td>
                                    <input type="text" style="width:100px" value="<?= $row->n_quantity_retur;?>" id="nquantity<?=$i;?>" class="form-control text-right input-sm" autocomplete="off" name="nquantity<?=$i;?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="0" onkeyup="angkahungkul(this);" readonly>
                                </td>
                                <td>
                                    <input type="text" style="width:300px" id="edesc<?=$i;?>" class="form-control input-sm" value="<?= $row->e_remark;?>" name="edesc<?=$i;?>" readonly>
                                </td>
                            </tr>
                        <?php } 
                    }?>
