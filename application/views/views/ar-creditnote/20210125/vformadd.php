            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <label class="col-md-6">Tanggal Kredit Nota</label>
                        <div class="col-sm-3">
                           <select name="customer" id="customer" class="form-control select2" onchange="getnota(this.value);">
                                <option value=""></option>
                                <?php if ($customer) {
                        ...
                        <div class="col-sm-3">
                            <select name="nota" id="nota" class="form-control select2" disabled="" onchange="getdata(this.value);">
                            </select>
                             <input type="hidden" id="pkp" name="pkp" class="form-control" value="" readonly>
                        </div>

                        <div class="col-sm-2">
                            <input type="text" id="dkn" name="dkn" class="form-control date" value="<?php echo date("d-m-Y"); ?>" readonly>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#nota').select2({
            ...
            allowClear: true,
            ajax: {
                url: '<?= base_url($folder.'/cform/notaretur'); ?>',
                dataType: 'json',
                delay: 250,
    ...
    function getdata(kode) {
        ...
        success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><input style="width:90px" readonly class="form-control" style="text-align:right;" id="qty'+zz+'" name="qty'+zz+'" value="'+sisa+'"></td>';
