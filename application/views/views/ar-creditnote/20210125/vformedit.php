            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <select name="nota" id="nota" class="form-control select2" onchange="getdata(this.value);">
                                <option value="<?php echo $data->i_nota; ?>" selected><?php echo $data->i_nota; ?></option>
                            </select>
                            <input type="hidden" id="pkp" name="pkp" class="form-control" value="<?php echo $data->pkp; ?>" readonly>
                        </div>

                        <div class="col-sm-2">
                            <input type="text" id="dkn" name="dkn" class="form-control date" value="<?php echo $data->d_kn; ?>" readonly>
                        </div>
...
<script>
    ...
    function getdataedit() {
        ...
        url: '<?= base_url($folder.'/cform/getdetailknedit'); ?>',
        dataType: "json",
        success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><input style="width:150px" class="form-control" readonly id="v_price'+zz+'" name="v_price'+zz+'" value="'+v_price+'"><input style="width:150px" type="hidden" class="form-control" readonly id="v_discount'+zz+'" name="v_discount'+zz+'" value="'+v_discount+'"></td>';
                    cols += '<td><input style="width:150px" class="form-control" readonly id="v_gross'+zz+'" name="v_gross'+zz+'" value="'+v_gross+'"></td>';
                    cols += '<td><input style="width:200px" type="text" id="edesc'+ zz + '" class="form-control" name="edesc' + zz + '" value="'+e_remark+'"/></td>';
                    cols += '<td style="text-align: center;"><input type="checkbox" id="chk'+zz+'" name="chk'+zz+'" checked/></td>';
                    newRow.append(cols);
                    $("#tabledata").append(newRow);
