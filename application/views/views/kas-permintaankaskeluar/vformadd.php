            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group row">                     
                        ...
                        <div class="col-sm-5">
                            <select name="icustomer" id="icustomer" class="form-control select2" multiple="multiple" onchange="return getcustomer(this.value);" disabled>
                            </select>
                        </div>
                        <div class="col-sm-2">
