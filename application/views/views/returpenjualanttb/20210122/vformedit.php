            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <select name="ttb" id="ttb" class="form-control select2" onchange="getdata(this.value);">
                                 <option value="<?php echo $data->i_ttb; ?>" selected><?php echo $data->i_ttb; ?></option>
                            </select>
                        </div>

                        <div class="col-sm-2">
                            <input type="text" id="dbbm" name="dbbm" class="form-control date" value="<?php echo $data->d_bbm; ?>" readonly>
                        </div>
                    </div>
                </div>
                 <div class="col-md-6">
     ...
     function getdataedit() {
        ...
        success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><input style="width:150px" type="hidden" class="form-control" style="text-align:right;" id="i_color'+zz+'" name="i_color'+zz+'" value="'+i_color+'"><input readonly style="width:150px"  class="form-control" style="text-align;" id="e_color'+zz+'" name="e_color'+zz+'" value="'+e_color_name+'"></td>';
                    cols += '<td><input style="width:90px" readonly class="form-control" style="text-align:right;" id="qty_permintaan'+zz+'" name="qty_permintaan'+zz+'" value="'+qty_permintaan+'"></td>';
                    cols += '<td><input style="width:90px" class="form-control" style="text-align:right;" id="qty_retur'+zz+'" name="qty_retur'+zz+'" value="'+qty_retur+'" onkeyup="validasi('+zz+');"></td>';
        ...
        if (ikodelokasi !='' && customer !='' && ttb !='') {
            if(jml==0){
                ...
                if (count > 0) {
                    ...
                    swal('Harap Centang Dan isi Qty Retur');
                    return false;
                }
            }
        }else{
