        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    ...
                    <span>Saldo Gudang : Rp. <?= number_format($saldo->saldo); ?></span><br>
                </div>
                    ...
                    <table id="tabledata" class="stripe row-border order-column table color-table inverse-table table-bordered class" style="width:100%">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="text-center">Dari<br>Makloon</th>
                                <th class="text-center">Dari<br>Gudang Lain</th>
                                <th class="text-center">Dari<br>Gudang Jadi</th>
                                <th class="text-center table-success"></th>
                                <th class="text-center">Ke<br>Supplier</th>
                                <th class="text-center">Ke<br>Makloon</th>
                                <th class="text-center">Ke<br>Internal</th>
                                <th class="text-center">Ke<br>Cutting</th>
                                <th class="text-center">Ke<br>Gudang Jadi</th>
                                <th class="text-center table-success"></th>
                            </tr>
                            <tr>
                                ...
                                <th class="text-center table-success">X + Y + V + Z</th>
                                <th class="text-center">A</th>
                                <th class="text-center">B</th>
                                <th class="text-center">C</th>
                                <th class="text-center">D</th>
                                <th class="text-center">E</th>
                                <th class="text-center table-success">A + B + C + D + E</th>
                            </tr>
                            <tr>
                                <th class="table-warning text-center">Saldo Awal</th>
                                <th class="text-center table-info">Pembelian</th>
                                <th class="text-center table-info">SJ Masuk Makloon</th>
                                <th class="text-center table-info">Penerimaan Gudang Material</th>
                                <th class="text-center table-info">Penerimaan Retur Gudang Jadi</th>
                                <th class="text-center table-success">Total Terima<br></th>
                                <th class="text-center table-info">Retur Pembelian</th>
                                <th class="text-center table-info">SJ Keluar Makloon</th>
                                <th class="text-center table-info">STB Material</th>
                                <th class="text-center table-info">STB Material Cutting</th>
                                <th class="text-center table-info">STB WIP</th>
                            ...
                            <tr>
                                ...
                                <td class="bold text-right"><?= number_format($sum_n_masuk_3,2); ?></td>
                                <td class="bold text-right"><?= number_format($sum_n_masuk_4,2); ?></td>
                                ...
                                <td class="bold text-right"><?= number_format($sum_n_keluar_3,2); ?></td>
                                <td class="bold text-right"><?= number_format($sum_n_keluar_4,2); ?></td>
                                <td class="bold text-right"><?= number_format($sum_n_keluar_5,2); ?></td>
                            ...
                            if ($data->num_rows() > 0) {
                                foreach ($data->result() as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right <?= warna($row->n_masuk_3); ?>"><?= number_format($row->n_masuk_3,2); ?></td>
                                        <td class="text-right <?= warna($row->n_masuk_4); ?>"><?= number_format($row->n_masuk_4,2); ?></td>
                                        ...
                                        <td class="text-right <?= warna($row->n_keluar_3); ?>"><?= number_format($row->n_keluar_3,2); ?></td>
                                        <td class="text-right <?= warna($row->n_keluar_4); ?>"><?= number_format($row->n_keluar_4,2); ?></td>
                                        <td class="text-right <?= warna($row->n_keluar_5); ?>"><?= number_format($row->n_keluar_5,2); ?></td>
