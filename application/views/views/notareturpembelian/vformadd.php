                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="idocument" required="" id="inotaretur" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number;?>" maxlength="25" class="form-control input-sm" value="" aria-label="Text input with dropdown button">
                            ...
                            <div class="col-sm-4">
                                <input type="hidden" id="idsupplier" name="idsupplier" required="" value="<?= $data->id; ?>">
                ...
                <table id="tabledatay" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                    ...
                    <tbody>
                        <?php $no = 0; $group = ""; foreach ($datadetail as $key) { 
                            ...
                            if($group==""){ ?>
                                <tr class="pudding">
                                    <td colspan="9">Nomor Referensi : <b><?= $key->i_document;?></b> &nbsp;&nbsp;-&nbsp;&nbsp; Tanggal Referensi : <b><?= $key->d_document;?></b> &nbsp;&nbsp;-&nbsp;&nbsp; <b>(<?= $key->e_bagian_name;?>)</b></td>
                                </tr>
                                <?php 
                            }else{
                                if($group!=$key->i_document){?>
                                    <tr class="pudding">
                                        <td colspan="9">Nomor Referensi : <b><?= $key->i_document;?></b> &nbsp;&nbsp;-&nbsp;&nbsp; Tanggal Referensi : <b><?= $key->d_document;?></b> &nbsp;&nbsp;-&nbsp;&nbsp; <b>(<?= $key->e_bagian_name;?>)</b></td>
                                    </tr>
                                    <?php $no = 1; 
                            ...
                            <tr>
                                ...
                                <td>
                                    <input readonly type="hidden" id="id_referensi<?=$i;?>" name="id_referensi<?=$i;?>" value="<?= $key->id;?>">
                                ...
                                <td><input type="text" readonly class="form-control input-sm text-right" name="n_qty<?=$i;?>" id="n_qty<?=$i;?>" value="<?= $key->n_quantity;?>"/></td>
                                <td><input type="text" class="form-control input-sm text-right" name="n_qty_retur<?=$i;?>" id="n_qty_retur<?=$i;?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}"  value="0" onkeyup="angkahungkul(this); cekqty(<?=$i;?>);"/></td>
                                <td><input type="text" class="form-control input-sm" name="eremark<?=$i;?>" id="eremark<?=$i;?>" placeholder="Jika Ada!"></td>
                            </tr>
                            <?php 
                        } ?>
                    </tbody>
