                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                               ...
                               <input type="hidden" name="d_entry" id="d_entry" class="form-control" value="<?php echo $data->d_entry; ?>" readonly>
                            </div>
            ...
            if(( data['brgop'] != null)){ 
                ...
                for (let a = 0; a < data['brgop'].length; a++) {
                    ...
                    group=product;
                        ...
                        /* ITEMNYA */ 
                        cols += '<td hidden><input readonly style="width:70px;" class="form-control" type="text" id="sisa'+a+'" name="sisa'+a+'" value ='+n_quantity+'></td>';
