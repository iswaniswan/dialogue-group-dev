                            ...
                            foreach ($datadetail as $key) {
                                ...
                                if ($group != $key->id_product_wip) { ?>
                                    <tr>
                                        ...
                                        <td colspan="3"><input autocomplete="off" class="form-control input-sm text-right" id="n_qty_wip" placeholder="0" name="n_qty_wip" onblur="if(this.value=='' ){this.value='0' ;}" onfocus="if(this.value=='0' ){this.value='' ;}" value="0" onkeypress="return hanyaAngka(event);" onkeyup="set('<?= $kode; ?>',this.value);"></td>
                                        <td colspan="2"></td>
                                    </tr>
                                <?php }
