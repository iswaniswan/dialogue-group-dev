            ...
            <table id="tabledatax" class="table color-table dark-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                ...
                <tbody>
                    ...
                    <tr>                    
                        ...
                        <td>
                            <input style="width:100px" style="width:5%"style="width:5%"type="text" class="form-control inputitem" id="nquantitywipmasuk<?=$i;?>" name="nquantitywipmsk[]" value="<?= $row->n_quantity_wip_masuk; ?>" readonly>
                        </td>                       
                        <td>  
   ...
   $(document).ready(function () {
    ...
    $('#approve').click(function(event) {
        ...
        for (var i = 1; i <= $('#jml').val(); i++) {
            ...
            if (parseInt($('#nquantitywipmasuk'+i).val()) > parseInt($('#nquantitysisawip'+i).val())) {
