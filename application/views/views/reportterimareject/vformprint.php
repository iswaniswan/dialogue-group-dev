                            ...
                            <table id="tabledata" class="table nowrap font-12 table-bordered table2excel" cellspacing="0">
                                ...
                                <thead>
                                    ...
                                    <tr class="warna_table">
                                        ...
                                        <th class="text-right warna_out"><i class="fa fa-question-circle fa-lg mr-2" tabindex="0" data-trigger="focus" class="btn btn-default" data-container="body" data-toggle="popover" data-placement="bottom" title=""></i>Kirim BJ</th>
                                        ...
                                        <th class="text-right warna_out"><i class="fa fa-question-circle fa-lg mr-2" tabindex="0" data-trigger="focus" class="btn btn-default" data-container="body" data-toggle="popover" data-placement="bottom" title=""></i>Kirim Repair</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($data2 as $row) {
                                        ...
                                        $warna2 = ($row->terima_bb > 0) ? 'warna_in' : '';
                                        $warna3 = ($row->kirim_bj > 0) ? 'warna_out' : '';
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-right <?= $warna2; ?>"><?= $row->terima_bb; ?></td>
                                            <!-- <td class="text-right"><?= 0; ?></td> -->
                                            <td class="text-right"><?= $row->terima_repair; ?></td>
                                            <td class="text-right"><?= $row->terima_reject; ?></td>
                                            <td class="text-right <?= $warna2; ?>"><?= $row->total_terima; ?></td>
                                            <td class="text-right <?= $warna3; ?>"><?= $row->kirim_bj; ?></td>
                                            <td class="text-right"><?= $row->kirim_repair; ?></td>
                                            <!-- <td class="text-right"><?= 0; ?></td> -->
                                            <!-- <td class="text-right"><?= 0; ?></td> -->
                                            <td class="text-right"><?= $row->kirim_reject; ?></td>
                                            <td class="text-right <?= $warna3; ?>"><?= $row->total_kirim; ?></td>
