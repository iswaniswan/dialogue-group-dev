...
<script>
    ...
    $("#addrow").on("click", function() {
        ...
        cols += '<td><input type="text" id="nquantity' + counter + '" class="form-control text-right input-sm inputitem" name="nquantity[]" value="0" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\' onkeyup="angkahungkul(this);validasi(' + counter + ')"></td>';
