...
<script>
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><select style=width:150px; type="text" id="iap'+ counter + '" class="form-control" name="iap'+ counter + '" onchange="getdo('+ counter + ');"><input readonly type="hidden" id="iop'+ counter + '" class="form-control" name="iop'+ counter + '"/></td>';
        cols += '<td><input readonly type="text" id="dap'+ counter + '" class="form-control" name="dap'+ counter + '"/></td>';
        ...
        cols += '<td><input readonly type="text" id="nreceive'+ counter + '" class="form-control" name="nreceive' + counter + '"/></td>';
        ...
        $('#iap'+ counter).select2({
        placeholder: 'Pilih Kode AP',
        allowClear: true,
        ajax: {
          url: '<?= base_url($folder.'/cform/datado/'); ?>'+isupplier +'/' +iarea,
          dataType: 'json',
          delay: 250,
          processResults: function (data) {
            return {
    ...
    function getdo(id){
        ...
        url: '<?= base_url($folder.'/cform/getdoitem/'); ?>'+isupplier +'/' +iarea,
        dataType: "json",
        success: function (data) {
            $('#iap'+id).val(data[0].i_ap);
            $('#dap'+id).val(data[0].d_ap);
            ...
            $('#nreceive'+id).val(data[0].n_receive);
    ...
    function hitung(){
        ...
        gross=0;
        for(i=1;i<=jml;i++){
          qty=formatulang(document.getElementById("nreceive"+i).value);
