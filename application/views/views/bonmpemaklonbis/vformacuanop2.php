                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            onkeyup="gede(this)" value="<?php foreach ($op as $iop){ echo $iop." - "; } ?>">
                    ...
                    <div class="form-group">
                        ...
                        <?php 
		  				...
		  				?>
                           <input type="checkbox" name="pkp" id="pkp" value="<?=$getpkp->f_supplier_pkp?>" class="tinggi" style="position: relative;bottom: 2px;" <?php echo $check; ?> onclick="hitungnilai();">&nbsp;&nbsp;&nbsp;<span id="topnya"></span>
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <div class="panel-body table-responsive">
                                <table id="tabledata" class="display table" cellspacing="0" width="100%">
                                    ...
                                    $i = 0;
                                        ...
                                        <td class="col-sm-1">
                                            <input style ="width:150px"type="text" id="ekodemaster<?=$i;?>" name="ekodemaster<?=$i;?>"value="<?= $row[0]->e_nama_master; ?>" readonly >
                                            <input style ="width:150px"type="hidden" id="ikodemaster<?=$i;?>" name="ikodemaster<?=$i;?>"value="<?= $row[0]->i_kode_master; ?>" readonly >
                                        </td>
                                        <td class="col-sm-1">
                                        <input style ="width:90px" type="text" id="imaterial<?=$i;?>" name="imaterial<?=$i;?>"value="<?= $row[0]->i_material; ?>" readonly >
                                        </td>
                                        <td class="col-sm-1">
                                        <input style ="width:200px" type="text" id="ematerialname<?=$i;?>" name="ematerialname<?=$i;?>"value="<?= $row[0]->e_material_name; ?>" readonly >
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:70px" type="text" id="esatuan<?=$i;?>" name="esatuan<?=$i;?>"value="<?= $row[0]->e_satuan; ?>" readonly >
                                            <input style ="width:70px" type="hidden" id="isatuan<?=$i;?>" name="isatuan<?=$i;?>"value="<?= $row[0]->i_satuan; ?>" readonly >
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:70px"type="text" id="nquantity<?=$i;?>" name="nquantity<?=$i;?>"value="<?= $row[0]->n_quantity; ?>"onkeyup= hitungnilai(this.value);>
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:60px"type="text" id="vpriceop<?=$i;?>" name="vpriceop<?=$i;?>"value="<?= $row[0]->hrgop; ?>"readonly>
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:60px"type="text" id="diskon<?=$i;?>" name="diskon<?=$i;?>"value="0" onkeyup= hitungnilai(this.value);>
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:60px"type="text" id="vtotalop<?=$i;?>" name="vtotalop<?=$i;?>"value="<?= $row[0]->hrgop; ?>" readonly>
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:60px"type="text" id="vprice<?=$i;?>" name="vprice<?=$i;?>"value="<?= $row[0]->hrgasup; ?>" onkeyup= hitungnilai(this.value);>
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:60px"type="text" id="vtotal<?=$i;?>" name="vtotal<?=$i;?>"value="<?= $row[0]->totalhrgasup; ?>" readonly>
                                        </td>
                                        <td class="col-sm-1">
                                        ...
                                        <input style ="width:60px"type="hidden" id="iop<?=$i;?>" name="iop<?=$i;?>"value="<?= $row[0]->i_op; ?>"readonly >
                                        </tr>
                                        <?}?>
