        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" id= "dfrom" name="dfrom" class="form-control date" required value="<?= $dfrom; ?>" readonly>
                        </div>
                        <div class="col-sm-3">
                            <input type="text" id= "dto" name="dto" class="form-control date" required value="<?= $dto; ?>" readonly>
                        </div>
                    </div>
                <div class="col-md-6">
                    <div class="form-group">
                            <label class="col-md-6">Tanggal Bon M</label>
                            <div class="col-sm-6">
                                <input id="dsj" name="dsj" class="form-control date" required="" value = "">
                            </div>
                    </div>
                            ...
                            <div class="panel-body table-responsive">
                                <table id="tabledata" class="display table" cellspacing="0" width="100%">
                                    ...
                                    <?$i = 0;
                                        ...
                                        <td class="col-sm-1">
                                            <input style ="width:150px"type="text" id="isj<?=$i;?>" name="isj<?=$i;?>"value="<?= $row->i_sj; ?>" readonly >
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:90px" type="text" id="dsj<?=$i;?>" name="dsj<?=$i;?>"value="<?= $row->d_sj; ?>" readonly >
                                        </td>
                                        <td class="col-sm-1">
                                        ...
                                        <td class="col-sm-1">
                                        <input style ="width:70px" type="text" id="epotongan<?=$i;?>" name="epotongan<?=$i;?>"value="<?= $row->e_potongan; ?>" readonly >
                                        <input style ="width:70px" type="hidden" id="icuttype<?=$i;?>" name="icuttype<?=$i;?>"value="<?= $row->i_cut_type; ?>" readonly >
                                        </td>
                                        <td class="col-sm-1">
                                        <input style ="width:70px" type="text" id="enamaukuran<?=$i;?>" name="enamaukuran<?=$i;?>"value="<?= $row->e_nama_ukuran; ?>" readonly >
                                        <input style ="width:70px" type="hidden" id="isizetype<?=$i;?>" name="isizetype<?=$i;?>"value="<?= $row->i_size_type; ?>" readonly >
                                        </td>
                                        <td class="col-sm-1">
