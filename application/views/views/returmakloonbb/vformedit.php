                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" name="iretur" id="ireturbb" readonly="" autocomplete="off" onkeyup="gede(this);" value="<?=$data->i_document;?>" maxlength="15" class="form-control input-sm" value="" aria-label="Text input with dropdown button">
