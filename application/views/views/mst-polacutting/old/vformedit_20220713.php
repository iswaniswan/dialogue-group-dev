                ...
                <table id="tabledatax" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                    ...
                    <thead>
                        <tr class="d-flex">
                            ...
                            <th class="text-center col-5" width="35%">Nama Material</th>
                            <!-- <th class="text-center" width="15%">Konversi ke Set</th>-->
                            <th class="text-center col-1" width="12%">Gudang</th>
                            <th class="text-center col-1" width="12%">Bagian</th>
                            <th class="text-center col-1" width="12%">Gelar</th>
                            <th class="text-center col-1" width="12%">Set</th>
                            <th class="text-center col-2" width="12%;">Kebutuhan Bis<sup>2</sup>an</th>
                            <th class="text-center col-2" width="12%;">Ukuran Bis<sup>2</sup>an</th>
                            <th class="text-center col-1" width="5%;">Cutting</th>
                            <th class="text-center col-1" width="5%;">Autocutter</th>
                            <th class="text-center col-1" width="5%;">Badan</th>
                            <th class="text-center col-1" width="5%;">Print</th>
                            <th class="text-center col-1" width="5%;">Bordir</th>
                            <th class="text-center col-1" width="5%;">Quilting</th>
                            <th class="text-center col-1" width="3%">Act</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        ?>
                            <tr class="d-flex">
                                ...
                                <td class="col-1"><input type="text" readonly id="gudang<?= $i; ?>" class="form-control input-sm" name="gudang<?= $i; ?>" value="<?= $key->gudang; ?>"></td>
                                <td class="col-1"><input type="text" id="bagian<?= $i; ?>" class="form-control input-sm" autocomplete="off" name="bagian<?= $i; ?>" value="<?= $key->bagian; ?>"></td>
                                <td class="col-1"><input type="text" id="vgelar<?= $i; ?>" class="form-control text-right input-sm" autocomplete="off" name="vgelar<?= $i; ?>" value="<?= $key->v_gelar; ?>" onkeyup="angkahungkul(this);"></td>
                                <td class="col-1"><input type="text" id="vset<?= $i; ?>" class="form-control text-right input-sm" autocomplete="off" name="vset<?= $i; ?>" value="<?= $key->v_set; ?>" onkeyup="angkahungkul(this);"></td>
                                <td class="col-2"><input type="text" id="bis3<?= $i; ?>" class="form-control text-right input-sm" autocomplete="off" name="bis3<?= $i; ?>" value="<?= $key->n_bis3; ?>" onkeyup="angkahungkul(this);"></td>
                                <td class="col-2"><select data-urut="<?= $i; ?>" id="id_bisbisan<?= $i; ?>" class="form-control input-sm" name="id_bisbisan<?= $i; ?>">
                                        <option value="<?= $key->id_bisbisan; ?>"><?= $key->n_bisbisan . ' - ' . $key->e_jenis_potong; ?></option>
                                    </select></td>
                                <!-- <td class="text-center"><input type="checkbox" name="fbis<?= $i; ?>" <?php if ($key->f_bisbisan == 't') {
                                                                                                                echo "checked";
                                                                                                            } ?> id="fbis<?= $i; ?>" class="swit<?= $i; ?>"/></td> -->
                                <td class="text-center col-1"><input type="checkbox" id="f_cutting<?= $i; ?>" name="f_cutting<?= $i; ?>" <?php if ($key->f_cutting == 't') { ?> checked <?php } ?>></td>
                                <td class="text-center col-1"><input type="checkbox" id="autocutter<?= $i; ?>" name="autocutter<?= $i; ?>" <?php if ($key->f_autocutter == 't') { ?> checked <?php } ?>></td>
                                <td class="text-center col-1"><input type="checkbox" id="badan<?= $i; ?>" name="badan<?= $i; ?>" <?php if ($key->f_badan == 't') { ?> checked <?php } ?>></td>
                                <td class="text-center col-1"><input type="checkbox" id="print<?= $i; ?>" name="print<?= $i; ?>" <?php if ($key->f_print == 't') { ?> checked <?php } ?>></td>
                                <td class="text-center col-1"><input type="checkbox" id="bordir<?= $i; ?>" name="bordir<?= $i; ?>" <?php if ($key->f_bordir == 't') { ?> checked <?php } ?>></td>
                                <td class="text-center col-1"><input type="checkbox" id="quilting<?= $i; ?>" name="quilting<?= $i; ?>" <?php if ($key->f_quilting == 't') { ?> checked <?php } ?>></td>
