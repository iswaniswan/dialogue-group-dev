                            ...
                            <div class="panel-body table-responsive">
                                <table id="tabledata" class="display table" cellspacing="0" width="100%">
                                    ...
                                    $i = 0;
                                        ...
                                        <td class="col-sm-1">
                                            <input style ="width:70px"type="text" id="nquantity<?=$i;?>" name="nquantity<?=$i;?>"value="<?= $row->n_quantity; ?>"onkeyup= hitungnilai(this.value);>
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:60px"type="text" id="vpriceop<?=$i;?>" name="vpriceop<?=$i;?>"value="<?= $row->hrgop; ?>"readonly>
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:60px"type="text" id="diskon<?=$i;?>" name="diskon<?=$i;?>"value="0" onkeyup= hitungnilai(this.value);>
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:60px"type="text" id="vtotalop<?=$i;?>" name="vtotalop<?=$i;?>"value="<?= $row->hrgop; ?>" readonly>
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:60px"type="text" id="vprice<?=$i;?>" name="vprice<?=$i;?>"value="<?= $row->hrgasup; ?>" onkeyup= hitungnilai(this.value);>
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:60px"type="text" id="vtotal<?=$i;?>" name="vtotal<?=$i;?>"value="<?= $row->totalhrgasup; ?>" readonly>
                                        </td>
                                        <td class="col-sm-1">
