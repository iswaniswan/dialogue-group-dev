            ...
            <div class="col-md-12">
                <div id="pesan"></div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="icolor" id="icolor" class="form-control" required="" onkeyup="gede(this);" value="" placeholder="Kode Warna" autocomplete="off">
                            <span id="cek" hidden="true"> 
                                <font size="3" face="Courier New" color="red">Kode Sudah Ada!</font> 
                            </span>
                        </div>
                        <div class="col-sm-8">
                            <input type="text" name="ecolorname" id="ecolorname" class="form-control" onkeyup="gede(this);"  value="" placeholder="Nama Warna" autocomplete="off">
                        </div>
                    </div>       
