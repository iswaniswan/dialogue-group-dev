        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                <table id="tabledata" class="display nowrap" cellspacing="0" width="100%">
                    ...
                    <tfoot align="right">
	                      <tr><th colspan="5" style="text-align: center;">Sub Total </th><th></th><th></th></tr>
	                      <tr>
...
//            $( api.column( 6 ).footer() ).html(enamTotal.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,'));
            ...
            "ajax": {
                "url": base_url + "<?php echo $folder; ?>/Cform/data/<?php echo $notajt;?>/<?php echo $dopname;?>/<?php echo $iarea;?>",
                "type": "POST"
            },
            "displayLength": 10
        } );
