        ...
        <div class="panel panel-info">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                         <input type="hidden" name="ipajak" id="ipajak" class="form-control" value="<?= $head->i_pajak;?>" readonly>
                          <input type="hidden" name="dpajak" id="dpajak" class="form-control" value="<?= $head->d_pajak;?>"
                        readonly >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <textarea readonly class="form-control input-sm" name="eremark" placeholder="Isi keterangan jika ada!"><?= $head->e_remark;?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <div class="form-group row">
