            ...
            <div class="col-md-12">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3"> 
                        <div class="input-group">
                            ...
                            <input type="hidden" name="idocumentold" id="idocumentold" class="form-control" value="<?= $head->i_document;?>" readonly="">
                            <input type="text" name="idocument" id="i_faktur_penjualan_bb" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="FP-2010-000001" maxlength="20" class="form-control input-sm" value="<?= $head->i_document;?>" aria-label="Text input with dropdown button">
                    ...
                    <div class="col-sm-4">
                     <!--    <input type="hidden" name="isjaja" id="isjaja" class="form-control" value="" readonly> -->
                        <input type="hidden" name="id_partner" class="form-control" value="<?= $head->id_partner;?>" readonly>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        ...
                        readonly >
                        <input type="text" name="dreceivefaktur" id="dreceivefaktur" class="form-control date" value="<?= $head->d_terima_faktur;?>" readonly="" onchange="return tgl_jatuhtempo(this.value);">
                    </div>
                    <div class="col-sm-2">
                        <input type="text" name="djatuhtempo" id="djatuhtempo" class="form-control" value="<?= $head->d_jatuh_tempo;?>" readonly>
                    </div>
                    <div class="col-sm-4">
                        <?php if ($head->e_partner_type == "customer") {  ?>
                            ...
                            <select name="kodeharga" id="kodeharga" class="form-control select2" required="" onchange="get_harga();">
                                ...
                                <?php if ($kodeharga) {
                                    foreach ($kodeharga as $row):?>
                                        <option value="<?= $row->id;?>" <?php if ($row->id == $head->id_harga_kode) {?> selected <?php } ?> > <?= $row->i_harga. " - " .$row->e_harga;?></option>
...
<script>
    ...
    $( "#i_faktur_penjualan_bb" ).keyup(function() {
        $.ajax({
            ...
            dataType: "json",
            success: function (data) {
                if (data==1 && ($('#i_faktur_penjualan_bb').val() != $('#idocumentold').val())) {
