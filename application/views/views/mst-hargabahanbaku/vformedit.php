            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-md-6">Satuan Pembelian</label>
                        <div class="col-sm-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="imaterialsupplier" id="imaterialsupplier" class="form-control" required="" value="<?= $data->i_material_supplier; ?>">
                        </div> 
...
function dipales(){
    ...
    var imaterialsupplier = $('#imaterialsupplier').val();
    var isatuansupp     = $('#isatuansupplier').val();
            ...
            if (isConfirm) { 
                $.ajax({
                    ...
                    data: {
                        ...
                        'harga'         : harga,
                        'norder'        : norder,
                        'imaterialsupplier' : imaterialsupplier,
                        'isatuansupp'   : isatuansupp,
                    ...
                    success: function (data) {
                        ...
                        // show('<?= $folder;?>/cform/edit/<?=$kodebrg;?>/<?=$isupplier;?>/<?=$dberlaku;?>/<?=$dfrom;?>/<?=$suppfilter;?>/<?=$id;?>','#main');   
                    },
                    error: function () {
