                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <button type="button" class="btn btn-warning btn-rounded btn-sm mr-2" onclick="statuschange('<?= $folder ?>','<?= $data->id;?>','3','','');"> <i class="fa fa-pencil-square-o mr-2"></i>Change Requested</button>
                            <button type="button" class="btn btn-danger btn-rounded btn-sm mr-2"  onclick="statuschange('<?= $folder ?>', '<?= $data->id;?>','4','','');"> <i class="fa fa-times mr-2"></i>Reject</button>
                            <button type="button" class="btn btn-success btn-rounded btn-sm" onclick="statuschange('<?= $folder ?>', '<?= $data->id;?>','6','','');"> <i class="fa fa-check-square-o mr-2"></i>Approve</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <!-- <label class="col-md-6">Harga Konversi</label>
