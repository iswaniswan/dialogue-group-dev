        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label class="col-md-12">Jenis Pelanggan</label>
                        <div class="col-sm-12">
                            <select name="customergroup" id="customergroup" class="form-control select2" onchange="getarea(this.value);">
                                <option value="">-- Pilih Jenis Pelanggan --</option>
                                <?php if ($customergroup) {                                   
                                    foreach ($customergroup as $icustomergroup) { ?>
                                        <option value="<?php echo $icustomergroup->i_customer_group;?>"><?= $icustomergroup->i_customer_group." - ".$icustomergroup->e_customer_groupname;?></option>
                                    <?php }; 
                                } ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row" id="areaa">
                        <label class="col-md-12">Area</label>
                        <div class="col-sm-12">
                            <select name="iarea" id="iarea" class="form-control"onchange="getcust(this.value);">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <select name="ibranch" id="ibranch" class="form-control select2" onchange="getdetailpel(this.value);"></select>
                        </div>
                    </div>
                    <!-- <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <select class="form-control select2" name="isalesmanx" id="isalesmanx" onchange="getsales(this.value);"></select>
                        ...
                        <table id="tabledata" class="display table" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center;">Disc3</th>
...
<script>
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><input type="text" id="norder'+xx+'" class="form-control" name="norder'+xx+'" onkeypress="return hanyaAngka(event)"  onkeyup="hitungnilai(this.value,'+xx+')" autocomplete="off"><input type="hidden" id="nquantitystock'+xx+'" name="nquantitystock'+xx+'" value=""></td>';
        cols += '<td><input type="text" id="ncustomerdiscount1'+xx+'" class="form-control" name="ncustomerdiscount1'+xx+'" onkeyup="cekval(this.value); reformat(this);hitungnilai(this.value,'+xx+')"/ ></td>';
        cols += '<td><input type="text" id="ncustomerdiscount2'+xx+'" class="form-control" name="ncustomerdiscount2'+xx+'" onkeyup="cekval(this.value); reformat(this);hitungnilai(this.value,'+xx+')"/ ></td>';
        cols += '<td><input type="text" id="ncustomerdiscount3'+xx+'" class="form-control" name="ncustomerdiscount3'+xx+'" onkeyup="cekval(this.value); reformat(this);hitungnilai(this.value,'+xx+')"/ ></td>';
...
alert(i);
    ...
    function getarea(kode) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url($folder.'/Cform/getcust2');?>",
            data: {
            // 'i_area'            : iarea,
            'group_customer'    : customergroup
            },
