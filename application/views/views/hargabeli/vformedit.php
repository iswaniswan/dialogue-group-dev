            ...
            <div class="panel-body table-responsive">
                ...
                <div id="pesan"></div>
                    <!-- <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="iproduct" class="form-control" required="" maxlength="5" onkeyup="gede(this)" value="<?= $data->i_product; ?>">
                        </div>
                    </div> -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="ipricegroup" class="form-control" required="" maxlength="30" onkeyup="gede(this)" value="<?= $data->i_price_group; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Nama Barang</label>
                        <div class="col-sm-12">
                            <input type="text" name="eproductname" class="form-control" maxlength="30" onkeyup="gede(this)" value="<?= $data->e_product_name; ?>">
                        </div>
                    </div>
                    <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            ...
                            <?php foreach ($iproductgrade as $r):?>
                                <option value="<?php echo $r->i_product_grade;?>" <?= $r->i_product_grade == $data->i_product_grade ? "selected" : "" ?>><?php echo $r->i_product_grade." - ".$r->e_product_gradename;?></option>
                            <?php endforeach; ?>
                            </select>
                        </div>
                    <div>
