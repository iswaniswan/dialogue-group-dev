        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label class="col-md-7">Nomor Referensi Pengeluaran</label>
            ...
            success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                   ...
                   if (lastmaterial == i_material) {
                        ...
                        cols += '<td><input type="text" id="edesc'+ counter + '" class="form-control" name="edesc[]" value="'+e_remark+'"/><input type="hidden" id="v_price'+ counter + '" class="form-control" name="v_price[]" value="'+v_price+'"/></td>';
                    } else {
                        ...
                        cols += '<td rowspan="1"><input type="text" style="width:100px;" id="pemenuhan'+ counter + '" value="'+n_qty+'" class="form-control" placeholder="0" name="pemenuhan[]" onkeyup="validasi('+counter+');"/></td>';
                        cols += '<td rowspan="1"><input style="width:100px;" type="text" readonly  id="imaterial2'+ counter + '" type="text" class="form-control" name="imaterial2[]" value="'+i_material2+'" required></td>';
