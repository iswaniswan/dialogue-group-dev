                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                             <div class="input-group">
                                ...
                                <input type="text" name="idocument" id="idocument" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="TGR-2012-000001" class="form-control input-sm" value="<?=$data->i_document;?>" aria-label="Text input with dropdown button">
                        ...
                        <div class="col-sm-2">
                            <input class="form-control datedoc" name="ddocument" id="ddocument" readonly="" required="" value="<?= $data->d_document; ?>">
                        </div>
                        <div class="col-sm-3">
                            <input class="form-control" name="igiro" id="igiro" value="<?= $data->i_giro; ?>">
                        </div> 
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input class="form-control date" name="dgiro" id="dgiro" readonly="" required="" value="<?= $data->d_giro; ?>">
                        </div>
                        <div class="col-sm-2">
                            <input class="form-control date" name="dgiroduedate" id="dgiroduedate" readonly="" required="" value="<?= $data->d_giro_duedate; ?>">
                        </div>
                        <div class="col-sm-2">
                            <input class="form-control date" name="dsetor" id="dsetor" required="" value="<?= $data->d_setor; ?>" readonly>
                        </div>
                        <div class="col-sm-2">
                            <input class="form-control date" name="dgiroterima" id="dgiroterima" readonly="" required="" value="<?= $data->d_giro_terima; ?>">
                        </div>
                        <div class="col-sm-3">
