                ...
                <div class="panel-body table-responsive">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="hidden" id="idreferensi" name="idreferensi" required="" value="<?= $id; ?>">
                                <input type="hidden" id="idjenis" name="idjenis" required="" value="<?= $idjenis; ?>">
                                <input type="hidden" id="idreferensiitem" name="idreferensiitem" required="" value="<?= $iditem; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="hidden" id="idcustomer" required="" name="idcustomer" value="<?= $data->id_partner;?>">
                                <input type="hidden" id="ecustomer" required="" name="ecustomer" value="<?= $data->e_partner_name;?>">
                                <input type="hidden" id="grouppartner" name="grouppartner" value="<?= $data->group_partner;?>">
...
<script>
    ...
    $("#addrow").on("click", function () {
        ...
        cols += `<td><input type="text" class="form-control input-sm" name="eremark${i}" id="eremark${i}" placeholder="Jika Ada!"/><input type="hidden" class="form-control input-sm" name="groupfaktur${i}" id="groupfaktur${i}" value=""/></td>`;
