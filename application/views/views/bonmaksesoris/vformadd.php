...
<script>
   $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><input type="text" class="form-control" id="nquantitysisa'+no+'" name="nquantitysisa[]" value="'+data['detail'][a]['n_quantity_sisa']+'" readonly></td>';
                    cols += '<td><input type="text" class="form-control text-right" id="nquantity'+no+'" placeholder="0" name="nquantity[]" value="'+data['detail'][a]['n_quantity_sisa']+'" onkeypress="return hanyaAngka(event);" onkeyup="ceksaldo('+no+');"></td>';
    ...
    function ceksaldo(i) {
        if (parseFloat($('#nquantity'+i).val()) > parseFloat($('#nquantitymemo'+i).val())) {
            swal('Qty pengembalian tidak boleh lebih dari qty pengeluaran!!!');
            $('#nquantity'+i).val($('#nquantitymemo'+i).val());
        }
    }
