        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <select name="ikodeunit" id ="ikodeunit"class="form-control select2" onchange="getid(this.value);">
                            <option value="">-- Pilih Kelompok Barang --</option>
                            <?php foreach ($kodeunit as $r):?>
                            
                            <option value="<?php echo $r->kode_unit;?>"><?php echo $r->kode_unit." - ".$r->nama;?>
                            </option>
                            <?php endforeach; ?>
                            <input type="hidden" id="idunitpacking" name="idunitpacking" class="form-control" required= "" maxlength="4">
                        </select>
