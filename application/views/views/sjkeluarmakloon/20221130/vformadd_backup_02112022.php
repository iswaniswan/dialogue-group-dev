            ...
            <table id="tabledatalistx" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" style="width: 30%;">Barang WIP | Barang Material (item)</th>
    ...
    $(document).ready(function() {
        ...
        $("#addrowlist").on("click", function() {
            ...
            $("#addlist" + iter).on("click", function() {
                ...
                col += `<td class="text-right"><spanlist${u} id="snum${u}"></spanlist${u}><input type="hidden" id="idkeluarhead${u}${nox}" name="idkeluarhead[]"><input type="hidden" id="idwip${u}${nox}" name="idwip[]"></td>`;
                col += `<td><select data-urutan="${u}${nox}" data-nourut="${u}${nox}" id="idmateriallist${u}${nox}" class="form-control input-sm" name="idmateriallist[]"></select></td>`;
                col += `<td><input type="text" id="nquantitylist${u}${nox}" class="form-control text-right input-sm inputqty" autocomplete="off" name="nquantitylist[]" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\' value="0" onkeyup="angkahungkul(this);"></td>`;
                col += `<td><select data-nourut="${u}${nox}" id="idmateriallist2${u}${nox}" class="form-control input-sm" name="idmateriallist2[]" ></select></td>`;
                col += `<td><input type="text" id="nquantitylist2${u}${nox}" class="form-control text-right input-sm inputqty" autocomplete="off" name="nquantitylist2[]" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\' value="0" onkeyup="angkahungkul(this);hetang(${u}${nox});hetangqtysisa(this, ${u}${nox})"><input type="hidden" id="nquantitylist2sisa${u}${nox}" class="form-control text-right input-sm inputqty" autocomplete="off" name="nquantitylist2sisa[]"></td>`;
