            ...
            <div class="col-md-6">
                <div id="pesan"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="nquantity" class="form-control" value="<?= $data->n_quantity; ?>" readonly>
                        </div>
                    </div>  
                    <div class="form-group">
                        <label class="col-md-12">Nama Motif/Warna</label>
                        <div class="col-sm-12">
                            <select name="icolor" class="form-control select2" readonly>
                            <option value="">Pilih Nama Motif/Warna</option>
                            <?php foreach ($warna as $icolor):?>
                                <option value="<?php echo $icolor->i_color;?>"
                                    <?php if($icolor->i_color==$data->i_color) { ?> selected="selected" <?php } ?>>
                                    <?php echo $icolor->i_color."-".$icolor->e_color_name;?></option>
                            <?php endforeach; ?>
                        </select>
                        </div>
                    </div>                                      
