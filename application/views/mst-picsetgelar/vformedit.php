    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                <i class="fa fa-pencil fa-lg"></i> &nbsp; <?= $title; ?> <a href="#" onclick="show('<?= $folder; ?>/cform/','#main'); return false;" class="btn btn-info btn-sm pull-right"><i class="fa fa-list"></i> <?= $title_list; ?> </a>
            </div>
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input autofocus type="text" name="e_pic_name" autocomplete="off" id="ikodelokasi" class="form-control" placeholder="Nama PIC .." required="" value="<?= $data->e_pic_name;?>">
                        </div>
                        <div class="col-sm-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <button type="submit" id="submit" class="btn btn-success btn-block btn-sm"> <i class="fa fa-lg fa-save"></i>&nbsp;&nbsp;Update</button>&nbsp;
                        </div>
                        <div class="col-sm-6">
