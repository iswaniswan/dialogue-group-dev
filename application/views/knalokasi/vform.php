            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <label class="col-md-4">Tanggal Alokasi</label><label class="col-md-4">No. KN</label><label class="col-md-4">Tanggal KN</label>
                        <div class="col-sm-4">
                            <input type="text" required="" placeholder="Pilih Tanggal" readonly id= "dalokasi" name="dalokasi" class="form-control date">
                        </div>
                        <div class="col-sm-4">
                            <input readonly id= "ikn" name="ikn" class="form-control" value="<?= $isi->i_kn;?>">
                        </div>
                        <div class="col-sm-4">
                            <input type="text" required="" placeholder="Pilih Tanggal" readonly id= "dkn" name="dkn" class="form-control" value="<?= $isi->d_kn;?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-6">No DT</label><label class="col-md-6">Jenis Bayar</label>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <select name="ijenisbayar" id="ijenisbayar" required="" class="form-control">
                                <option value="">-- Pilih --</option>
                                <?php if ($jenis) {                                 
                                    foreach ($jenis as $key) { ?>
                                        <option value="<?= $key->i_jenis_bayar;?>"><?= $key->e_jenis_bayarname;?></option>
                                    <?php }; 
                                } ?>
                            </select>
                        </div>
                ...
                <div class="col-md-6"> 
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input type="hidden" id= "icustomer" name="icustomer" class="form-control" value="<?= $isi->i_customer;?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input readonly id= "ecustomercity" name="ecustomercity" class="form-control" value="<?= $isi->e_customer_city;?>">
                        </div>
                    </div>  
                    <div class="form-group row">
...
<script>
    ...
    /*function cektanggal() {
        ...
        if ((perdt != '') && (perbukti != '')) {
            if (compareDates(document.getElementById('dbukti').value, document.getElementById('ddt').value) == -1) {
                swal("Tanggal bukti pelunasan tidak boleh lebih kecil dari tanggal DT !!!");
    ...
    function dipales() {
        cek = 'false';
        cok = 'false';
        if ((document.getElementById("ikn").value != '') && (document.getElementById("dkn").value != '') && (document.getElementById("dalokasi").value != '') && (document.getElementById("ijenisbayar").value != '') && (document.getElementById("vjumlah").value != '') && (document.getElementById("vjumlah").value != '0') && (document.getElementById("icustomer").value != '')) {
