    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                <i class="fa fa-table"></i> &nbsp; <?= $title; ?> <a href="#"
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input name="dfrom" id="dfrom" class="form-control date" required="">
                        </div>
                        <div class="col-sm-6">
                            <input name="dto" id="dto" class="form-control date" required="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-12">Lama Order</label>
                        <div class="col-sm-12">
                            <input name="nlamaorder" id="nlamaorder" class="form-control" onkeypress="return hanyaAngka(event);" required="">
                        </div>
                    </div>
                    <div class="form-group row">
