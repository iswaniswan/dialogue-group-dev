<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-info">
            <div class="panel-heading"><i class="fa fa-list fa-lg mr-2"></i><?= $title; ?>
                <?php if (check_role($this->i_menu, 1)) { ?><a href="#" onclick="show('<?= $folder; ?>/cform/tambah_referensi/<?= $dfrom . "/" . $dto; ?>','#main'); return false;" class="btn btn-info btn-sm pull-right"><i class="fa fa-plus fa-lg mr-2"></i><?= $title; ?></a>
                    <!-- <a href="#" onclick="show('<?= $folder; ?>/cform/tambah_referensi/','#main'); return false;" class="btn btn-info btn-sm pull-right"><i class="fa fa-plus fa-lg mr-2"></i><?= $title; ?> Dari Uraian Jahit</a> -->
                <?php } ?>
            </div>
