                ...
                <table class="table table-hover table-bordered">
                    <thead style="background: #f8f9fa!important">
                        <tr>
                            ...
                            <th class="text-left">Qty<br>Retur</th>
                            <th class="text-left">Qty<br>Penyusun</th>
                            <th class="text-left">Qty<br>Akhir</th>
                            <th class="text-left">Qty<br>Kurang</th>
                        ...
                        foreach ($datadetail as $key) {
                            ...
                            <tr id="tr<?= $i; ?>" class="tdna">
                                <?php if ($group == "") { ?>
                                    ...
                                    <td><b><?= $key['i_product_wip'] ?> [ <?= $key['e_marker_name'] ?> ]</b></td>
                                    <td colspan="3"><b><?= $key['e_product_wipname'] . ' - ' . $key['e_color_name'] ?></b></td>
                                    <td class="text-right"><b><?= $key['max'] ?></b></td>
                                    <td colspan="2"><?= $key['e_remark'] ?></td>
                                    <?php } else {  
                                    if ($group != $key['id_product_wip']) { $no ++;?>
                                        <td class="text-center"><?= $no; ?></td>
                                        <td><b><?= $key['i_product_wip'] ?> [ <?= $key['e_marker_name'] ?> ]</b></td>
                                        <td colspan="3"><b><?= $key['e_product_wipname'] . ' - ' . $key['e_color_name'] ?></b></td>
                                        <td class="text-right"><b><?= $key['max'] ?></b></td>
