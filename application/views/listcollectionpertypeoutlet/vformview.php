    ...
    <div class="panel-body table-responsive">
        <table class="table color-bordered-table info-bordered-table" id="sitabel" cellpadding="0" cellspacing="0">
            <thead>
                ...
                <?php if($isi){ ?>
                    <tr>
	                    <th style="font-size: 12px;text-align: center;vertical-align: middle;" rowspan=2>Outlet</th>
                        <?php 
                            if($dfrom!=''){
                        		$tmp=explode("-",$dfrom);
                        		$blasal=$tmp[1];
                            ...
                            for($i=1;$i<=$interval;$i++){
                                switch ($bl){
                                    case '1' :
                                      echo '<th style="font-size: 12px;text-align: center;vertical-align: middle;" colspan=6>Jan</th>';
                                      break;
                                    case '2' :
                                      echo '<th style="font-size: 12px;text-align: center;vertical-align: middle;" colspan=6>Feb</th>';
                                      break;
                                    case '3' :
                                      echo '<th style="font-size: 12px;text-align: center;vertical-align: middle;" colspan=6>Mar</th>';
                                      break;
                                    case '4' :
                                      echo '<th style="font-size: 12px;text-align: center;vertical-align: middle;" colspan=6>Apr</th>';
                                      break;
                                    case '5' :
                                      echo '<th style="font-size: 12px;text-align: center;vertical-align: middle;" colspan=6>Mei</th>';
                                      break;
                                    case '6' :
                                      echo '<th style="font-size: 12px;text-align: center;vertical-align: middle;" colspan=6>Jun</th>';
                                      break;
                                    case '7' :
                                      echo '<th style="font-size: 12px;text-align: center;vertical-align: middle;" colspan=6>Jul</th>';
                                      break;
                                    case '8' :
                                      echo '<th style="font-size: 12px;text-align: center;vertical-align: middle;" colspan=6>Agu</th>';
                                      break;
                                    case '9' :
                                      echo '<th style="font-size: 12px;text-align: center;vertical-align: middle;" colspan=6>Sep</th>';
                                      break;
                                    case '10' :
                                      echo '<th style="font-size: 12px;text-align: center;vertical-align: middle;" colspan=6>Okt</th>';
                                      break;
                                    case '11' :
                                      echo '<th style="font-size: 12px;text-align: center;vertical-align: middle;" colspan=6>Nov</th>';
                                      break;
                                    case '12' :
                                      echo '<th style="font-size: 12px;text-align: center;vertical-align: middle;" colspan=6>Des</th>';
                                      break;
                                }
                                $bl++;
                                if($bl==13)$bl=1;
		        ...
		        foreach($isi as $row){
                    ...
                    if($jenis==''){
                        if($row->bln==$bl){
                            ...
                            echo '<tr><td>'.$row->i_customer_class.'.'.$row->e_customer_classname.'</td>';
                            echo '<td align=right>'.number_format($persentarget,2).'%</td>';
                    ...
                    }elseif ($jenis==$row->i_customer_class){
                        if($row->bln==$bl){
                            foreach($sumperiode as $tt){
                                if($row->bln==$tt->bln){
                                  $totaltarget=$tt->total;
                        ...
                        if($row->bln==$bl){
                            ...
                            echo '</tr><tr><td>'.$row->i_customer_class.'.'.$row->e_customer_classname.'</td>';
                            foreach($sumperiode as $tt){
                                if($row->bln==$tt->bln){
                                    $totaltarget=$tt->total;
                                    break;
