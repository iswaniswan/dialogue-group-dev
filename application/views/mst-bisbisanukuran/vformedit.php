                    ...
                    <tr>
                        ...
                        <td>
                            <input type="hidden" id="isatuanmaterial<?= $i;?>" name="isatuanmaterial<?= $i;?>"
                                class="form-control" value="<?=$data->i_satuan_code; ?>" readonly>
                        ...
                        <td class="text-center">
                            ...
                            <input type="radio" class="cekdefault" name="cekdefault" id="cekdefault<?= $i;?>"
                                onclick="cek();" <?php if($key->f_default=='t'){echo "checked";}?> readonly>
                        </td>
                        <td class="text-center"><button type="button" title="Delete"
    ...
    $("#addrow").on("click", function() {
        if ($('#isatuan').val() != null) {
            ...
            cols += '<td><select id="eperator' + i + '" class="form-control input-sm" name="eperator' +
                i +
                '"><option value=""></option><option value="*">Kali (*)</option><option value="/">Bagi (/)</option><option value="+">Tambah (+)</option><option value="-">Kurang (-)</option></select></td>';
            cols += '<td><input type="text" id="faktor' + i +
                '" class="form-control text-right input-sm inputitem" autocomplete="off" name="faktor' +
                i +
                '" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\' value="0" onkeyup="angkahungkul(this);"></td>';
