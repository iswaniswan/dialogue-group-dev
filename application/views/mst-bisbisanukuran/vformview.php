            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input class="form-control" type="text" name="dregister" id="dregister"
                        ...
                        <div class="col-sm-3">
                            <input type="text" name="ikodebrg" id="ikodebrg" class="form-control" onkeyup="gede(this);"
                                value="<?=$data->i_material;?>" placeholder="Kode Barang" readonly>
                        </div>
                        <div class="col-sm-6">
                            <input type="text" name="enamabrg" class="form-control" onkeyup="gede(this)"
                                value="<?=$data->e_material_name;?>" placeholder="Nama Barang" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-1">
                            <input type="text" name="npanjang" class="form-control" maxlength="20"
                                value="<?=$data->n_panjang;?>" placeholder="0" readonly>
                        </div>
                        <div class="col-sm-1">
                            <input type="text" name="nlebar" class="form-control" maxlength="20"
                                value="<?=$data->n_lebar;?>" placeholder="0" readonly>
                        </div>
                        <div class="col-sm-1">
                            <input type="text" name="ntinggi" class="form-control" maxlength="20"
                                value="<?=$data->n_tinggi;?>" placeholder="0" readonly>
                        </div>
                        <div class="col-sm-1">
                            <input type="text" name="isatuanukuran" id="isatuanukuran" class="form-control" value="CM"
                                readonly>
                        </div>
                        <div class="col-sm-1">
                            <input type="text" name="nberat" class="form-control" maxlength="30"
                                value="<?=$data->n_berat;?>" placeholder="0" readonly>
                        </div>
                        <div class="col-sm-1">
                            <input type="hidden" class="form-control" value="GR" name="isatuanberat" id="isatuanberat"
                                readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <textarea name="edeskripsi" id="edeskripsi" class="form-control" placeholder="Keterangan"
...
<div class="white-box" id="detailbis">
    ...
    <div class="col-sm-12">
        <div class="table-responsive">
            <table id="tabledataxbis" class="table color-table inverse-table table-bordered class" cellpadding="8"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input readonly type="text" id="n_bisbisan<?= $i; ?>"
                                class="form-control text-center input-sm inputitem" autocomplete="off"
                        ...
                        <td><input readonly type="text" id="v_lebar_kain_awal<?= $i; ?>"
                                class="form-control text-center input-sm inputitem" autocomplete="off"
                        ...
                        <td>
                            <select disabled required data-nourut="<?= $i; ?>" id="id_jenis_potong<?= $i; ?>"
            ...
            <table id="tabledatax" class="table color-table inverse-table table-bordered class" cellpadding="8"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="eperator<?= $i;?>" disabled class="form-control input-sm"
                                name="eperator<?= $i;?>">
                                <option value=""></option>
                        ...
                        <td>
                            <input value="<?= $key->n_faktor;?>" readonly type="text" id="faktor<?= $i;?>"
                        ...
                        <td>
                            <select data-nourut="<?= $i;?>" disabled id="isatuankonversi<?= $i;?>"
                        ...
                        <td class="text-center">
                            ...
                            <input type="radio" class="cekdefault" disabled name="cekdefault" id="cekdefault<?= $i;?>"
