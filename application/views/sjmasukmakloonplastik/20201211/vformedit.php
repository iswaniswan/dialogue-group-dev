            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select required="" id="isjkm" name="isjkm" class="form-control" onchange="getdetailsjkm();">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><select type="text" style=width:320px id="i_2material'+zz+'" class="form-control" name="i_2material'+ zz + '" value="" onchange="getmaterial('+ zz + ');"> <option value="'+i_2material+'" selected>'+i_2material+' - '+e_2material+'</option></td>';
                    ...
                    cols += '<td><input type="text" id="edesc'+ zz + '" class="form-control" name="edesc' + zz + '" value="'+e_remark+'"/></td>';
                     // cols += '<td><input onkeypress="return hanyaAngka(event);" onkeyup="hitungnilaiall();" class="form-control" style="text-align:right;" id="ndeliver'+zz+'" name="ndeliver'+zz+'" value="'+stock+'"><input type="hidden" id="nstock'+zz+'" name="nstock'+zz+'" value="'+stock+'"><input type="hidden" id="vtotal'+zz+'" name="vtotal'+zz+'" value="0"></td>';
                     if (i_2material != ''){
                        cols += '<td style="text-align: center;"><input type="checkbox" checked id="chk'+zz+'" name="chk'+zz+'" onclick="setaction('+zz+');"></td>';
                     } else {
                        cols += '<td style="text-align: center;"><input type="checkbox" id="chk'+zz+'" name="chk'+zz+'" onclick="setaction('+zz+');"></td>';
                     }
