        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <button type="submit" id="submit" class="btn btn-success btn-block btn-sm"> <i class="fa fa-search"></i>&nbsp;&nbsp;Proses</button>
                        </div>
                        <div class="col-sm-6">
    ...
    <script>
        ...
        function export_data() {
            ...
            if (ibagian == '') {
                ...
                $('#href').attr('href', '<?php echo site_url($folder . '/cform/export/' . $dfrom . '/' . $dto . '/'); ?>' + ibagian + '/' + ddocument);
                return true;
            }
        }
    </script>