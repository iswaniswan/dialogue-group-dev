<div class="row">
    <div class="col-lg-12">
        ...
        <div class="panel-body table-responsive">
            <?= $this->pquery->form_remote_tag(array('url' => site_url($folder.'/cform/indexkn'), 'update' => '#main', 'type' => 'post', 'class' => 'form-horizontal')); ?>
            <div class="col-md-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        datatableedit('#tabledata', base_url + '<?= $folder; ?>/Cform/datakn/<?= $dfrom.'/'.$dto;?>',5,6);
    });
