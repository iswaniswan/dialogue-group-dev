                    ...
                    if($data2){
                        ...
                        foreach($data2 as $row){
                            ...
                            <tr>
                                ...
                                <td>
                                        <input type="text" class="form-control input-sm text-right" id="nquantity<?=$i;?>" name="nquantity<?=$i;?>" value="<?= $row->n_quantity; ?>" onkeyup="valstock(<?=$i;?>); hitung(this.value);ngkahungkul(this);"> 
                                ...
                                <td>  
                                    <input type="text" class="form-control input-sm text-right inputitem" id="vprice<?=$i;?>" name="vprice<?=$i;?>"value="<?= number_format($row->v_price); ?>" onkeyup="hitung(this.value); angkahungkul(this); reformat(this);" readonly>
                                </td>
                                <td>
