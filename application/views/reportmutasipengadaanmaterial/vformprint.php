                    ...
                    <table id="tabledata" class="stripe row-border order-column table color-table inverse-table table-bordered class" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th class="table-active text-center middle" rowspan="5">Nama Material</th>
                                <th class="table-active text-center middle" rowspan="5">Satuan</th>
                            ...
                            <tr>
                                ...
                                <th class="text-center">STB Pengadaan</th>
                                <th class="text-center table-success"></th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <th class="text-center table-info">Kirim ke<br>Jahit</th>
                            ...
                            if ($data->num_rows() > 0) {
                                foreach ($data->result() as $key) {
                                    ...
                                    $n_masuk_1 += $key->n_masuk_1;
                                    $n_masuk_total += $key->n_masuk_total;
                                    $n_keluar_1 += $key->n_keluar_1;
                                    $n_keluar_total += $key->n_keluar_total;
                                    $n_saldo_akhir += $key->n_saldo_akhir;
                                    $n_so += $key->n_so;
                                    $n_selisih += $key->n_selisih;
                                }
                            } ?>
                            <tr>
                                <td class="text-right bold"><?= $n_saldo_awal; ?></td>
                            ...
                            if ($data->num_rows() > 0) {
                                foreach ($data->result() as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= wordwrap($row->e_material_name, 30, "<br>\n"); ?></td>
                                        <td><?= wordwrap($row->e_satuan_name, 15, "<br>\n"); ?></td>
