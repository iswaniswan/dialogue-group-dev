                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" name="idocument" id="i_so_bb" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="SO-2021-000001" maxlength="25" class="form-control input-sm" value="<?= $number;?>" aria-label="Text input with dropdown button">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-12">  
                            <button type="submit" id="submit" class="btn btn-success btn-rounded btn-sm" onclick="return validasi();"> <i class="fa fa-search"></i>&nbsp;&nbsp;Cari</button>
