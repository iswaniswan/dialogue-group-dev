                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input type="text" name="idocument" id="iadjustment" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number;?>" maxlength="25" class="form-control input-sm" value="<?= $data->i_adjustment;?>" aria-label="Text input with dropdown button">
                        ...
                        <div class="col-md-2">
                            <input type="text" id="ddocument" name="ddocument" class="form-control input-sm date" required="" readonly value="<?= $data->d_adjustment;?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    if ($datadetail) {
                        foreach ($datadetail as $row) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" value="<?= $row->n_quantity_material;?>" id="nquantity<?=$i;?>" class="form-control text-right input-sm" autocomplete="off" name="nquantity[]" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="0" onkeyup="angkahungkul(this);">
                                </td>
                                <td>
...
<script>
   ...
   // var i = 0;
    $("#addrow").on("click", function () {
        ...
        cols += '<td><select data-nourut="'+i+'" id="imaterial'+i+'" class="form-control select2" name="imaterial[]"></td>';
    ...
    $('#ceklis').click(function(event) {
        if($('#ceklis').is(':checked')){
            $("#iadjustment").attr("readonly", false);
        }else{
            $("#iadjustment").attr("readonly", true);
            $("#ada").attr("hidden", true);
            number();
        }
    });

    $( "#iadjustment" ).keyup(function() {
        $.ajax({
            type: "post",
            data: {
                'kode' : $(this).val(),
