            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <input type="hidden" id="iarea" name="iarea" value="<?php if($iarea) echo $iarea; ?>">
                        <input type="hidden" id="ispg" name="ispg" value="<?php if($ispg) echo $ispg; ?>">
                        <input type="hidden" id="icustomer" name="icustomer" value="<?php if($icustomer) echo $icustomer; ?>">
                    </div>
                    <div class="form-group row">
