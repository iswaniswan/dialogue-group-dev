            ...
            <div id="pesan"></div>
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="ikodejenis" class="form-control" required="" maxlength="7" onkeyup="gede(this)" value="" onblur="checklength(this)">
                        </div>
                        <div class="col-sm-7">
                            <input type="text" name="enamajenis" class="form-control" required="" maxlength="30"  value="" >
                        </div>
                    </div>       
...
$(document).ready(function () {
    ...
    allowClear: true,
    ajax: {
      url: '<?= base_url($folder.'/cform/groupbarang'); ?>',
      dataType: 'json',
      delay: 250,          
