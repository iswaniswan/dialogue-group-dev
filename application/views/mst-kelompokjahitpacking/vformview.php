            ...
            <div class="col-md-6">
                <div id="pesan"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="enamajahitpacking" class="form-control" maxlength="30"  value="<?= $data->e_nama_jahitpacking; ?>" readonly>
                        </div>
                    </div>   
                    <div class="form-group">
                        <label class="col-md-12">Kode Unit Jahit</label>
                        <div class="col-sm-12">
                        <select name="iunitjahit" class="form-control select2" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                        <select name="eunitjahitname" class="form-control select2" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">                            
                        <select name="iunitpacking" class="form-control select2" readonly>
                            <option value="">Pilih Kode Unit Packing</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                        <select name="enamapacking" class="form-control select2" readonly>
