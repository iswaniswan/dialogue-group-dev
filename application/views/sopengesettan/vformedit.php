                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="hidden" name="idocold" id="idocold" value="<?= $data->i_document; ?>">
                                <input type="text" name="idoc" id="idocument" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number; ?>" maxlength="17" class="form-control input-sm" value="<?= $data->i_document; ?>" aria-label="Text input with dropdown button">
                        ...
                        <div class="col-sm-2">
                            <input type="text" id="ddocument" name="ddoc" class="form-control date" required="" readonly value="<?= $data->d_document; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr class="del<?= $z; ?>">
                                ...
                                <td>
                                    <input type="text" id="n_qty_retur_<?= $key->id_product_wip; ?>_<?= $i; ?>" class="form-control text-right input-sm" autocomplete="off" name="n_so_bagus[]" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="<?= $key->n_so_bagus; ?>" onkeyup="hetang('<?= $i; ?>', '<?= $key->id_product_wip; ?>');angkahungkul(this);">
                                </td>
                                <td colspan="2">
                                    <input class="form-control input-sm" type="text" name="eremark[]" value="<?= $key->e_remark; ?>" placeholder="Isi keterangan jika ada!">
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
...
<script>
    ...
    $("#addrow").on("click", function() {
        ...
        cols += `<td colspan="8"><select data-nourut="${i}" id="idproduct${i}" class="form-control input-sm" name="idproduct${i}" ></select></td>`;
