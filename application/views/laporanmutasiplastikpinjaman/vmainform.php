            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <select name="ibagian" id="ibagian" class="form-control select2" required="" onchange="getkategori(this.value);">
                            </select>
                        </div>
                        <div class="col-sm-3">
...
;        
        ...
        var dfrom = $('#dfrom').val();
        var dto = $('#dto').val();
        if (ibagian == "" || jnsbarang == "" || ikelompok == "" || dfrom == "" || dto == "" || ipartner == "") {
            swal("Data Header belum Lengkap !!!");
        } else {
            eval('window.open("<?php echo site_url($folder); ?>"+"/cform/cetak/"+ibagian+"/"+jnsbarang+"/"+ikelompok+"/"+ipartner+"/"+dfrom+"/"+dto,"","screenX=0,screenY=0,left=0,top=0,fullscreen=yes,width="+(screen.availWidth-5)+",height="+(screen.availHeight-(55)))');
