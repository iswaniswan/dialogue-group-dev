        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                       <!--  <div class="col-sm-12"> -->
                            <div class="col-sm-4"><button type="submit" id="submit" class="btn btn-success btn- btn-block btn-sm" onclick="return konfirm();"><i class="fa fa-save"></i>&nbsp;&nbsp;Simpan</button></div>
                            <div class="col-sm-4"><button type="button" class="btn btn-inverse btn- btn-block btn-sm" onclick="show('<?= $folder; ?>/cform/index/<?= $dfrom . "/" . $dto; ?>','#main')"> <i class="fa fa-arrow-circle-left"></i>&nbsp;&nbsp;Kembali</button></div>
                            <div class="col-sm-4"><button type="button" hidden="true" id="send" class="btn btn-primary btn- btn-block btn-sm"><i class="fa fa-paper-plane-o"></i>&nbsp;&nbsp;Send</button></div>
                       <!--  </div> -->
                    </div>
                </div>
            </div>
            ...
            <table id="tabledatax" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                <thead>
                    <tr>
                        ...
                        <th width="35%;" class="">Nama Panel</th>
                        <th width="10%;" class="">Warna</th>
                        <th width="10%;" class=" text-right">Qty Penyusun</th>
                        <th width="10%;" class=" text-right">Qty Kirim</th>
                        <th width="10%;" class=" text-right">Qty Terima</th>
                        <th width="10%;" class=" text-right">Qty BS</th>
                        <th class="">Ket</th>
                    </tr>
                </thead>
                <tbody>
                ...
                if (data['detail'].length > 0) {
                    ...
                    for (let a = 0; a < data['detail'].length; a++) {
                        ...
                        if (group != data['detail'][a]['id_product_wip']) {
                            cols1 += '<td class="text-center"><i class="fa fa-plus-circle fa-lg text-success" aria-hidden="true"></i><br><i class="fa fa-minus-circle fa-lg text-info" aria-hidden="true"></i></td>';
                            cols1 += '<td>' + data['detail'][a]['i_product_wip'] + ' - ' + data['detail'][a]['e_product_wipname'] + '<br>'+data['detail'][a]['i_material'] + ' - ' + data['detail'][a]['e_material_name']+'</td>';
