                    ...
                    <div class="form-group row">            
                            ...
                            <select name="ijenis" id="ijenis" required="" class="form-control select2" data-placeholder="Pilih Jenis Keluar">
                                ...
                                <?php if ($jenis) {
                                    foreach ($jenis as $row):?>
                                        <option value="<?= $row->id;?>" <?php if ($row->id == $data->id_jenis) {?> selected <?php } ?>>
                                            <?= $row->e_jenis_name;?>
                                        </option>
                                    <?php endforeach; 
                                } ?>
                        ...
                        <div class="col-sm-3">
                            <select name="ireferensi" required="" id="ireferensi" class="form-control select2">
                                <option value="<?= $data->id_document_reff;?>">
                                    <?= $data->i_referensi;?>
                                </option>
                            </select>
                        </div>
                    ...
                    if ($datadetail) {
                        foreach ($datadetail as $row) {?>
                            <tr>
                                ...
                                <td>
                                    <input type="hidden" id="idreferensi<?=$i;?>" name="idreferensi<?=$i;?>" value="<?= $row->id_document_reff;?>">
                                    <input type="text" readonly class="form-control input-sm" value="<?= $row->i_referensi;?>">
                                </td>
                                <td>
                                    <input type="text" class="form-control input-sm" readonly value="<?= $row->d_referensi;?>">
                                </td>
                                <td>
                                    <input type="text" id="v_nilai_reff<?=$i;?>" readonly class="form-control input-sm text-right" value="<?= number_format($row->n_sisa);?>" >
                                </td>
                                <td>
                                    <input type="text" id="v_nilai<?=$i;?>" class="form-control input-sm text-right" name="v_nilai<?=$i;?>" value="<?= number_format($row->n_nilai);?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" onkeyup="angkahungkul(this); reformat(this); hetang(<?=$i;?>); cek_nilai(<?=$i;?>);">
                                </td>
                                <td>
