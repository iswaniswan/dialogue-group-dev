        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><input readonly class="form-control" style="text-align:center;" id="n_qty'+zz+'" name="n_qty'+zz+'" value="'+n_qty+'"></td>';
                    ...
                    cols += '<td><select type="text" style=width:350px id="i_2material'+zz+'" class="form-control" name="i_2material'+ zz + '" value="" onchange="getmaterial('+ zz + ');"> <option value="'+i_2material+'" selected>'+i_2material+' - '+e_2material+'</option></td>';
                    cols += '<td><input type="text" id="n_2qty'+ zz + '" class="form-control" placeholder="0" name="n_2qty'+ zz + '" value="'+n_2qty+'" onkeyup="cekval(this.value); reformat(this);"/></td>';
                    ...
                    cols += '<td><input type="text" id="edesc'+ zz + '" class="form-control" name="edesc' + zz + '" value="'+e_remark+'"/></td>';
                     ...
                     if (i_2material != ''){
                        cols += '<td style="text-align: center;"><input type="checkbox" checked id="chk'+zz+'" name="chk'+zz+'"></td>';
                     } else {
                        cols += '<td style="text-align: center;"><input type="checkbox" id="chk'+zz+'" name="chk'+zz+'"></td>';
                     }
