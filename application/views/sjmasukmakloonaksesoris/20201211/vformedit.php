        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label class="col-md-6">Referensi SJ Keluar</label>
                         <label class="col-md-6">Tanggal SJ Masuk</label>
                        <div class="col-sm-6">
                            <!-- <select required="" id="isjkm" name="isjkm" class="form-control" onchange="getdetailsjmm();" >
                                <option value="<?php //echo $head->i_sj_reff;?>" selected><?= $head->i_sj_reff//." || ".$head->d_sjkm;?></option>
                            </select> -->
                              <input type="text" id="isjkm" name="isjkm" class="form-control" value="<?php echo $head->i_sj_reff;?>" readonly>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="col-md-6">
                    <div class="form-group row" id="itujuan">
                        <label class="col-md-6">Nomor SJ Partner</label>
                        <label class="col-md-6">Partner</label>
                        <div class="col-sm-6">
                           <input type="text" id="dokpartner" name="dokpartner" class="form-control" value="<?php echo $head->sj_partner;?>">
                        </div>
                        <div class="col-sm-6">
                            <input type="text" id="epartner" name="epartner" class="form-control" value="<?php echo $head->e_supplier_name;?>" readonly>
                            <input type="hidden" id="partner" name="partner" class="form-control" value="<?php echo $head->partner;?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
  ...
  function cekqty(counter){
    ...
    $('#nquantity'+counter).val(vjumlah);
     ...
     $("#addrow").on("click", function () {
        ...
        cols += '<td><select type="text" style=width:350px id="i_material'+zz+'" class="form-control" name="i_material'+ zz + '" value="" onchange="getmaterialsj('+ zz + ');"></td>';
        cols += '<td><input readonly class="form-control" style="text-align:center;" id="n_qty'+zz+'" name="n_qty'+zz+'" value=""></td>';
        ...
        cols += '<td><select type="text" style=width:350px id="i_2material'+zz+'" class="form-control" name="i_2material'+ zz + '" value="" onchange="getmaterial('+ zz + ');"></td>';
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    var n_qty_sekarang       = data['detail'][a]['sekarang'];
                    var e_remark    = data['detail'][a]['e_remark'];
                    var qtynow = parseFloat(n_qty) + parseFloat(n_qty_sekarang);
                    //qtynow = qtynow.replace(",",".");
                    //qtynow = parseFloat(qtynow2.replace(",", "."));
                    ...
                    cols += '<td><input style=width:80px readonly class="form-control" style="text-align:left;" id="n_qty'+zz+'" name="n_qty'+zz+'" value="'+qtynow+'"></td>';
                    cols += '<td><input type="number" min="0" style=width:100px class="form-control" style="text-align:left;" id="n_2qty'+zz+'" name="n_2qty'+zz+'" value="'+n_qty_sekarang+'" onkeyup="validasi('+zz+');"></td>';
                    ...
                    cols += '<td><input style=width:150px type="text" id="edesc'+ zz + '" class="form-control" name="edesc' + zz + '" value="'+e_remark+'"/></td>';
