        ...
        <div class="panel panel-info">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    <label class="col-md-6">Supplier</label><label class="col-md-6">Kategori Barang</label>  
                    <div class="col-sm-6">
                ...
                <div class="form-group row">                 
                <label class="col-md-6">Jenis Barang</label><label class="col-md-6">Kode Barang</label>                    
                    <div class="col-sm-6">
