...
<div class="white-box" id="detail">
    ...
    <div class="col-sm-12">
        <div class="table-responsive">
            <table id="tabledatax" class="table color-table tableFixHead inverse-table table-bordered class display nowrap" width="100%">
                <thead>
                    <tr > 
                        <th class="text-center ">No</th>
                        <th class="text-center ">Kode</th>
                        <th class="text-center ">Nama <br> Barang</th>
                        <th class="text-center ">Kategori <br> Penjualan</th>
                        <th class="text-center ">Harga</th>
                        <th class="text-center ">Rata<sup>2</sup> <br> OP (3 bln)</th>
