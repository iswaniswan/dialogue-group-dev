                    ...
                    <div class="form-group">
                       ...
                       <!--  <button type="button" id="upload" class="btn btn-outline-info btn-rounded btn-sm"><i class="fa fa-upload"></i>&nbsp;&nbsp;Upload</button>   -->
                        <!-- <button type="button" class="btn btn-success btn-rounded btn-sm" onclick='show("<?= $folder;?>/cform/approve","#main")'><i class="fa fa-check"></i>&nbsp;&nbsp;Approve</button> -->
                            ...
                            <?php }elseif($head->i_status=='3') {?>
                                <button type="button" id="send" class="btn btn-primary btn-rounded btn-sm mr-2"><i class="fa fa-paper-plane-o mr-2"></i>Send</button>
                                <button type="button" id="addrow" class="btn btn-info btn-rounded btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</button>
                            <?php }
                            elseif($head->i_status=='2') {?>
                        ...
                        <table id="tabledatax" class="table color-table tableFixHead success-table table-bordered class display nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr class="d-flex">
                                    ...
                                    <td class="col-1"><input type="text" id="category_penjualan<?= $i ;?>" class="form-control input-sm" readonly name="category_penjualan<?= $i ;?>" value="<?= $key["e_class_name"];?>"></td>
                                    <td class="text-right col-1"><input type="text" id="price<?= $i ;?>" class="form-control text-right input-sm" autocomplete="off" name="price<?= $i ;?>" onblur='if(this.value==""){this.value="0";}' onfocus='if(this.value=="0"){this.value="";}' value="<?= $key["v_harga"];?>" onkeyup="angkahungkul(this);"></td>
...
var i = $('#jml').val();
    $("#addrow").on("click", function () {
        ...
        cols += `<td class="text-right col-1"><input type="text" id="rata${i}" readonly class="form-control text-right input-sm" autocomplete="off" name="rata${i}" value="0"></td>`;
