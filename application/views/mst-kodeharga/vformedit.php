                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" name="iharga" id="iharga" class="form-control" required="" maxlength="15" onkeyup="gede(this); clearcode(this);" value="<?= $data->i_harga; ?>">
                                <span class="notekode" hidden="true"><b>* Kode Sudah Ada!</b></span>
                            </div>
                            <div class="col-sm-8">
                                <input type="text" name="eharga" id="eharga" maxlength="100" class="form-control" required="" onkeyup="gede(this); clearname(this);" value="<?= $data->e_harga; ?>">
                            </div>
                        </div>                       
