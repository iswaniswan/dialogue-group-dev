                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="text" name="idocument" id="isj" required="" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number; ?>" maxlength="15" class="form-control input-sm" value="<?= $data->i_document; ?>">
                            </div>
                            ...
                            <select name="itujuan" id="itujuan" class="form-control select2" onchange="number();clear_partner();" required="">
                                <?php if ($kategori) {
                                    foreach ($kategori as $row) : ?>
                                        <option value="<?= $row->id; ?>" <?php if ($row->id == $data->id_kategori_jahit) { ?> selected <?php } ?>>
                                            <?= $row->e_nama_kategori; ?>
                                        </option>
                                <?php endforeach;
                                } ?>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="nquantity<?= $i; ?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantity<?= $i; ?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="<?= $key->n_quantity; ?>" onkeyup="angkahungkul(this);cek_stock('<?= $i; ?>');">
                                    <input type="hidden" id="nquantity_stock<?= $i; ?>" name="nquantity_stock<?= $i; ?>" value="<?= $key->n_saldo_akhir; ?>">
                                </td>
                                <td>
                                    <input type="text" class="form-control input-sm" name="eremark<?= $i; ?>" id="eremark<?= $i; ?>" value="<?= $key->e_remark; ?>" placeholder="Isi keterangan jika ada!">
                                    <input type="hidden" class="form-control input-sm" name="vprice<?= $i; ?>" id="vprice<?= $i; ?>" value="0">
                                </td>
                                <td class="text-center">
...
<script>
            ...
            $('#idproduct' + i).select2({
                ...
                if (!ada) {
                    ...
                    $.ajax({
                        ...
                        url: '<?= base_url($folder . '/cform/price'); ?>',
                        dataType: "json",
                        success: function(data) {
                            $('#vprice' + z).val(data[0].v_price);
                            $('#nquantity' + z).focus();
                        },
                        error: function() {
                            swal('Data kosong : (');
    ...
    $("#addrow").on("click", function() {
        ...
        cols += `<td>
                    <input type="text" id="nquantity${i}" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantity${i}" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\' value="0" onkeyup="angkahungkul(this);cek_stock(${i});">
                    <input type="hidden" id="nquantity_stock${i}" name="nquantity_stock${i}" value="0">
                </td>`;
        ...
        $('#idproduct' + i).select2({
            ...
            if (!ada) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $('#vprice' + z).val(data[0].v_price);
                        $('#nquantity_stock' + z).val(data[0].n_saldo_akhir);
                        $('#nquantity' + z).focus();
                        cek_stock(z);
                    },
                    error: function() {
