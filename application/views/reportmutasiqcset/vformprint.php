                                ...
                                <table id="tabledata" class="table table-bordered" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;">Satuan</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center">Saldo Awal</th>
                                            <!-- <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center">Masuk Pembelian</th> -->
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center">Bon Masuk</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center">Masuk Makloon</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center">Masuk Pinjaman</th>
                                            ...
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center">Bon Keluar</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center">Keluar Makloon</th>
                                    ...
                                    <tbody>
                                        ...
                                        <td style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center"><?= $row->m_maklon; ?></td>
                                        <td style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center"><?= $row->m_pinjam; ?></td>
                                        <!-- <td style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center"><?//= $row->k_jual; ?></td>
                                        <td style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center"><?//= $row->k_returbeli; ?></td> -->
