<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-info">
            ...
            <?php } ?>
            <!-- <?php  if(check_role($this->i_menu1, 1)){ ?><a href="#" onclick="show('<?= $folder; ?>/cform/tambahmanual/<?= $dfrom."/".$dto;?>','#main'); return false;" class="btn btn-info btn-sm pull-right"><i
                class="fa fa-plus"></i> &nbsp;<?= $title; ?> Manual</a>
            <?php } ?> -->
        </div>            
