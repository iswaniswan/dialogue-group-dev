                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="hidden" name="ikodeso" id="ikodeso" class="form-control date" value="<?= $data->i_stok_opname_bahanbakuaks;?>">
                        </div>
                    </div>
                        ...
                        <table id="tabledata" class="table table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <td style="text-align: center;"><?= $i;?>
                                    ...
                                    <input style ="width:100px"type="hidden" class="form-control" id="ikode<?=$i;?>" name="ikode<?=$i;?>"value="<?= $row->i_stok_opname_bahanbakuaks; ?>" readonly >
                                </td>
                                <td class="col-sm-1">
