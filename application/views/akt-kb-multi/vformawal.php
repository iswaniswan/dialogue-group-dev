            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input name="eareaname" id="eareaname" class="form-control"readonly="" value="PUSAT">
                            <input type="hidden" name="iarea" id="iarea" class="form-control" required="" value="00">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input name="dkb" id="dkb" class="form-control date" required="" value="<?= date('d-m-Y');?>" onchange="cektanggal();">
                        </div>
                    </div>
                    <div class="form-group row">
