            ...
            <div class="panel-body table-responsive">
                <table id="myTable" class="table table-bordered" cellspacing="0"  width="100%">
                    ...
                    <tbody>
                        ...
                        <td class="col-sm-1">
                            <input style="width:100px;"  type="text" id="kodebrg<?=$i;?>" class="form-control" name="kodebrg<?=$i;?>"value="<?= $row->i_material; ?>"readonly >
                        </td>
                        <td class="col-sm-1">
                            <input style="width:350px;"  type="text" id="namabrg<?=$i;?>" class="form-control" name="namabrg<?=$i;?>"value="<?= $row->e_material_name; ?>"readonly>
                        </td>
                        <td class="col-sm-1">                            
