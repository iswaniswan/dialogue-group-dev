                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="idocument" required="" id="ibudgeting" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number; ?>" maxlength="25" class="form-control input-sm" value="" aria-label="Text input with dropdown button">
    ...
    if ($datadetail) { ?>
        ...
        <div class="col-sm-12">
            <div class="table-responsive">
                <table id="sitabel" class="table color-table nowrap success-table table-bordered class" cellpadding="8"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= ucwords(strtolower($key->e_material_name)) . ' - ' . $key->bagian; ?></td>
                    ...
                    <tbody>
                        ...
                        foreach ($bisbisan as $key) {
                            ...
                            <tr>
                                ...
                                <td class="text-right"><?= number_format($key->n_bisbisan, 1); ?></td>
                                <td class="text-right"><?= number_format($key->pemakaian, 3); ?></td>
                                <td class="text-right"><?= number_format($key->kebutuhan, 3); ?></td>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="d-flex">
                                    ...
                                    <td class="text-right col-1">
                                        <input readonly type="text" class="form-control input-sm font-11 text-right" name="acc_pelengkap<?= $x; ?>" id="acc_pelengkap<?= $x; ?>" autocomplete="off" onkeyup="angkahungkul(this); hetang(<?= $x; ?>);" onblur="if(this.value==''){this.value='0';hetang(<?= $x; ?>);}" onfocus="if(this.value=='0'){this.value='';}" value="<?= number_format($row->acc_pelengkap, 2); ?>">
                                    </td>
                                    ...
                                    <td class="text-right col-1">
                                        <input type="text" class="form-control input-sm font-11 text-right" name="schedule<?= $x; ?>" id="schedule<?= $x; ?>" autocomplete="off" onkeyup="angkahungkul(this); hetang(<?= $x; ?>);" onblur="if(this.value==''){this.value='0';hetang(<?= $x; ?>);}" onfocus="if(this.value=='0'){this.value='';}" value="0">
                                    </td>
                                    <td class="text-right col-1">
                                    ...
                                    <td class="text-right col-1">
                                        <input type="text" class="form-control input-sm font-11 text-right" name="sisaop<?= $x; ?>" id="sisaop<?= $x; ?>" autocomplete="off" onkeyup="angkahungkul(this); hetang(<?= $x; ?>);" onblur="if(this.value==''){this.value='0';hetang(<?= $x; ?>);}" onfocus="if(this.value=='0'){this.value='';}" value="<?= number_format($row->estimasi); ?>">
                                    </td>
                                    <td class="text-right col-1">
                                        <input readonly type="text" class="form-control input-sm font-11 text-right" name="nilai_budgeting<?= $x; ?>" id="nilai_budgeting<?= $x; ?>" autocomplete="off" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" onkeyup="angkahungkul(this);" value="<?= number_format($hitungan, 2); ?>">
                                    </td>

                                    <td class="text-right col-1">
                                        <input type="text" class="form-control input-sm font-11 text-right" name="up<?= $x; ?>" id="up<?= $x; ?>" autocomplete="off" onkeyup="angkahungkul(this); hetang(<?= $x; ?>);" onblur="if(this.value==''){this.value='0';hetang(<?= $x; ?>);}" onfocus="if(this.value=='0'){this.value='';}" value="0">
                                    </td>

                                    <td class="text-right col-1">
                                        <input readonly type="text" class="form-control input-sm font-11 text-right" name="nilai_actual<?= $x; ?>" id="nilai_actual<?= $x; ?>" autocomplete="off" value="<?= number_format($hitungan, 2); ?>">
                                    </td>
                                    <td class="col-1"><?= ucwords(strtolower($row->e_satuan_konversi)); ?></td>
                                    <td class="col-2"><input type="text" class="form-control input-sm font-11" name="ket<?= $x; ?>" id="ket<?= $x; ?>" autocomplete="off"></td>
