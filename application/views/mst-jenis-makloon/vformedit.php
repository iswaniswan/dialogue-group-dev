                ...
                <div id="pesan"></div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" id="itype" name="itype" class="form-control" required="" autocomplete="off" maxlength="15" onkeyup="gede(this);clearcode(this);" value="<?= $data->i_type_makloon; ?>">

                            <input type="hidden"  id="olditype" name="olditype" class="form-control" required="" maxlength="15" value="<?= $data->i_type_makloon; ?>" readonly>
                            <span id="cek" hidden="true"> 
                                    <font size="3" face="Courier New" color="red">Kode Sudah Ada!</font> 
                            </span>
                        </div>
                         <div class="col-sm-8">
                            <input type="text" name="etype" class="form-control" required="" onkeyup="gede(this);clearname(this);" value="<?= $data->e_type_makloon_name; ?>">
                        </div>
                    </div>                                 
