...
<div class="col-sm-12">
    <div class="white-box">
        <h3 class="box-title">Detail Tagihan Per Salesman Area <?= $eareaname;?></h3>
                    ...
                    if($data){
                        ...
                        foreach($data as $row){
                            ...
                            <tr>
                                ...
                                <td style="font-size: 13px; text-align: center;"><?= $row->i_kn; ?></td>
                                <td style="font-size: 13px; text-align: center;"><?= $row->d_kn; ?></td>
