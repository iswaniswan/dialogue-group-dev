        ...
        <div class="panel panel-info">
            ...
            <?php echo $this->pquery->form_remote_tag(array('url' => site_url($folder.'/cform/index'), 'update' => '#main', 'type' => 'post', 'class' => 'form-horizontal')); ?>
                ...
                <table id="tabledata" class="table color-table inverse-table table-bordered"" cellspacing="0" width="100%">
                    <thead>
                        <tr>
	                        <th style="text-align:center;" rowspan=1 width="20%">Group Barang</th>
		                    <th style="text-align:center;" rowspan=1 width="20%">Kategori Barang</th>
                            <?php                         
                                if($dfrom!=''){
	                            	$tmp=explode("-",$dfrom);
	                            	$blasal=$tmp[1];
                                ...
                                for($i=0;$i<=$interval;$i++){
                                    switch ($bl){
                                        case '01' :
                                          echo '<th style="text-align:center;" colspan=1>Januari</th>';
                                          break;
                                        case '02' :
                                          echo '<th style="text-align:center;" colspan=1>Februari</th>';
                                          break;
                                        case '03' :
                                          echo '<th style="text-align:center;" colspan=1>Maret</th>';
                                          break;
                                        case '04' :
                                          echo '<th style="text-align:center;" colspan=1>April</th>';
                                          break;
                                        case '05' :
                                          echo '<th style="text-align:center;" colspan=1>Mei</th>';
                                          break;
                                        case '06' :
                                          echo '<th style="text-align:center;" colspan=1>Juni</th>';
                                          break;
                                        case '07' :
                                          echo '<th style="text-align:center;" colspan=1>Juli</th>';
                                          break;
                                        case '08' :
                                          echo '<th style="text-align:center;" colspan=1>Agustus</th>';
                                          break;
                                        case '09' :
                                          echo '<th style="text-align:center;" colspan=1>September</th>';
                                          break;
                                        case '10' :
                                          echo '<th style="text-align:center;" colspan=1>Oktober</th>';
                                          break;
                                        case '11' :
                                          echo '<th style="text-align:center;" colspan=1>November</th>';
                                          break;
                                        case '12' :
                                          echo '<th style="text-align:center;" colspan=1>Desember</th>';
                                          break;
                                    }
                                    $bl++;
                                    if($bl==13)$bl=1;
                    ...
                    <tbody>
		                ...
		                foreach($data as $row){
                            ...
                            echo "<tr>
                                    <td>$row->e_nama_group_barang</td>
                                    <td style='width:300px;'>$row->e_nama_kelompok</td>";
                            $bl=$blasal;
                            $interval = $interfall->inter;
                            for($i=0;$i<=$interval;$i++){
                                switch ($bl){
                                    case '01' :
                                        $total_jan      =$total_jan+$data_jan;
                                        echo '<td align=right>'.number_format($data_jan,3).'</td>';
                                        break;
                                    case '02' :
                                        $total_feb      =$total_feb+$data_feb;
                                        echo '<td align=right>'.number_format($data_feb,3).'</td>';
                                        break;
                                    case '03' :
                                        $total_mar      =$total_mar+$data_mar;
                                        echo '<td align=right>'.number_format($data_mar,3).'</td>';
                                        break;
                                    case '04' :
                                        $total_apr      =$total_apr+$data_apr;
                                        echo '<td align=right>'.number_format($data_apr,3).'</td>';
                                        break;
                                    case '05' :
                                        $total_may      =$total_may+$data_may;
                                        echo '<td align=right>'.number_format($data_may,3).'</td>';
                                        break;
                                    case '06' :
                                        $total_jun      =$total_jun+$data_jun;
                                        echo '<td align=right>'.number_format($data_jun,3).'</td>';
                                        break;
                                    case '07' :
                                        $total_jul      =$total_jul+$data_jul;
                                        echo '<td align=right>'.number_format($data_jul,3).'</td>';
                                        break;
                                    case '08' :
                                        $total_aug      =$total_aug+$data_aug;
                                        echo '<td align=right>'.number_format($data_aug,3).'</td>';
                                        break;
                                    case '09' :
                                       $total_sep      =$total_sep+$data_sep;
                                        echo '<td align=right>'.number_format($data_sep,3).'</td>';
                                        break;
                                    case '10' :
                                        $total_oct      =$total_oct+$data_oct;
                                        echo '<td align=right>'.number_format($data_oct,3).'</td>';
                                        break;
                                    case '11' :
                                        $total_nov      =$total_nov+$data_nov;
                                        echo '<td align=right>'.number_format($data_nov,3).'</td>';
                                        break;
                                    case '12' :
                                        $total_des      =$total_des+$data_des;
                                        echo '<td align=right>'.number_format($data_des,3).'</td>';
                                        break;
                                }
                              $bl++;
                              if($bl==13)$bl=1;
                    ...
                    <tfoot>
                         <tr>
                            <th style="text-align:center;" colspan="2">Total Budgeting</th>
                            <?php               
                                $bl=$blasal;          
                                for($i=0;$i<=$interval;$i++){
                                    switch ($bl){
                                        case '01' :
                                          echo '<th style="text-align:center;" colspan=1>'.number_format($total_jan,3).'</th>';
                                          break;
                                        case '02' :
                                          echo '<th style="text-align:center;" colspan=1>'.number_format($total_feb,3).'</th>';
                                          break;
                                        case '03' :
                                          echo '<th style="text-align:center;" colspan=1>'.number_format($total_mar,3).'</th>';
                                          break;
                                        case '04' :
                                          echo '<th style="text-align:center;" colspan=1>'.number_format($total_apr,3).'</th>';
                                          break;
                                        case '05' :
                                          echo '<th style="text-align:center;" colspan=1>'.number_format($total_may,3).'</th>';
                                          break;
                                        case '06' :
                                          echo '<th style="text-align:center;" colspan=1>'.number_format($total_jun,3).'</th>';
                                          break;
                                        case '07' :
                                          echo '<th style="text-align:center;" colspan=1>'.number_format($total_jul,3).'</th>';
                                          break;
                                        case '08' :
                                          echo '<th style="text-align:center;" colspan=1>'.number_format($total_aug,3).'</th>';
                                          break;
                                        case '09' :
                                          echo '<th style="text-align:center;" colspan=1>'.number_format($total_sep,3).'</th>';
                                          break;
                                        case '10' :
                                          echo '<th style="text-align:center;" colspan=1>'.number_format($total_oct,3).'</th>';
                                          break;
                                        case '11' :
                                          echo '<th style="text-align:center;" colspan=1>'.number_format($total_nov,3).'</th>';
                                          break;
                                        case '12' :
                                          echo '<th style="text-align:center;" colspan=1>'.number_format($total_des,3).'</th>';
                                          break;
                                    }
                                    $bl++;
                                    if($bl==13)$bl=1;
