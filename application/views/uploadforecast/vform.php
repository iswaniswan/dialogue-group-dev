    ...
    <div class="col-sm-12 ol-md-12 col-xs-12">
        <form id="submit">
            <div class="white-box">
                ...
                <button type="submit" id="submit" onclick="return konfirm();" class="btn btn-success btn-rounded btn-sm"> <i class="fa fa-upload"></i>&nbsp;&nbsp;Upload</button>
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if (status=='berhasil') {
                        ...
                        //     timer: 1500
                        // });
                        show('<?= $folderx;?>/cform/loadview/'+tahun+'/'+bulan+'/'+customer,'#main');   
                    }else{
                        swal({
                            title: "Gagal!",
