                                ...
                                <table id="tabledata" class="table table-bordered" cellspacing="0">
                                    <thead>
                                        <tr class="warna_table">
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle; width: 3%;vertical-align: middle;" class="text-center text-white">No</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-white">Kode Barang</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle; width: 40%" class="text-white">Nama Barang</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-white">Satuan</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center text-white">Saldo Awal</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center text-white">Bon Masuk</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center text-white">Penerimaan dari Gudang</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center text-white">Retur Masuk</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center text-white">Bon Keluar</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center text-white">Keluar Makloon</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center text-white">Retur Keluar</th>
                                            <!-- <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center">Keluar Pinjaman</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center">Keluar Produksi</th> -->
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center text-white">Adjustment</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center text-white">Saldo Akhir</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center text-white">SO</th>
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center text-white">Selisih</th> 
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $i = 0;
                                        ...
                                        <td style="font-size: 11px; padding: 2px 7px;vertical-align: middle;"><?= $row->i_material; ?></td>
                                        <td style="font-size: 11px; padding: 2px 7px;vertical-align: middle;"><?= $row->e_material_name; ?></td>
                                        <td style="font-size: 11px; padding: 2px 7px;vertical-align: middle;"><?= $row->e_satuan_name; ?></td>
                                        ...
                                        <td style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center"><?= $row->m_gudang; ?></td>
                                        ...
                                        <td style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center"><?= $row->k_makloon; ?></td>
                                        ...
                                        <td style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center"><?//= $row->k_produksi; ?></td> -->
