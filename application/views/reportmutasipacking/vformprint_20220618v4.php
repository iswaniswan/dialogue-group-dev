...
<head>
	...
	<link type="text/css" rel="stylesheet" href="https://cdn.jsdelivr.net/npm/handsontable@6.2.2/dist/handsontable.full.min.css">
	<!-- color CSS -->
		...
		$.ajax({
			...
			success: function(data) {
				...
				const hot = new Handsontable(container, {
					data: prepend(['Kode','Nama Barang','Warna','Saldo Awal','Saldo Awal','(BARANG BAGUS)','Pengisian','Terima','Hasil Packing','(UNTUK DIPERBAIKI)','Proses Pengisian','Kirim','Saldo Akhir','Saldo Akhir','SO','SO','Selisih','Selisih'], data),
					colHeaders: [
						'Kode', 
						'Nama Barang', 
						'Warna', 
