		...
		<div class="row">
			<div class="col-sm-12">
				<div class="row mt-4">
					...
					<div id="example2" class="hot" style="max-width: 100%;"></div>
					<!-- <div class="controls">
	...
	$(function() {
		...
		$.ajax({
			...
			success: function(data) {
				...
				const hot = jspreadsheet(container, {
					data: data,
					columns: [{
							title: 'Kode',
							type: 'text',
						...
						{
							title: '(UNTUK DIPERBAIKI)',
							type: 'numeric',
							align: 'right',
							width: '170',
						},
						{
							title: 'Proses Pengisian',
							type: 'numeric',
							align: 'right',
							width: '150',
						},
					...
					nestedHeaders: [
						...
						[{
							...
							title: 'Dari Pengisian',
							align: 'center',
						}, {
							title: '',
							align: 'center',
						}, {
							title: 'Ke GUDANG JADI',
							align: 'center',
						}, {
							title: 'Ke WIP',
							align: 'center',
					...
					/* nestedHeaders: [
						[{title: '',colspan: '5'}, {title: 'MASUK',colspan: '3'}, {title: 'KIRIM',colspan: '4'}, {title: '',colspan: '6'}],
						[{title: '',colspan: '5'},'Dari WIP','Dari Pengisan','','ke GUDANG JADI','Ke WIP','Ke Pengisan','', {title: '',colspan: '6'}],
						[{title: '',colspan: '4'},'Total','Terima untuk di Packing','Terima Proses','Total','Kirim','Kirim Repair','Kirim untuk','Total','','Total','','Total','','Total'],
