                ...
                <table id="tabledata" class="display nowrap" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th>Bagian</th>
                            <th>Tujuan</th>
                            <th>Tgl. Terima Tujuan</th>
                            <th>Jenis Barang Keluar</th>
                            <th>Keterangan</th>
                            <th>Status Dok</th>
                            <th>Action</th>
                        </tr>
...
<script>
    ...
    function cetak_v2(id, dfrom, dto, ibagian) {
        var lebar = 1024;
        var tinggi = 768;
        eval('window.open("<?= site_url($folder); ?>"+"/cform/cetak_v2/"+id+"/"+dfrom+"/"+dto+"/"+ibagian,"","width="+lebar+"px,height="+tinggi+"px,resizable=1,menubar=1,scrollbars=1,top='+(screen.height-tinggi)/2+',left='+(screen.width-lebar)/2+'")');
    }
</script>