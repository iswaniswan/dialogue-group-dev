            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <label class="col-md-3">Tanggal Bon M</label><label class="col-md-9">Keterangan</label>
                        <div class="col-sm-3">
                            <input required="" readonly id= "dbm" name="dbm" class="form-control date" value="<?= date('d-m-Y');?>">
                            <input id="ibm" name="ibm" type="hidden">
                        </div>
                        <div class="col-sm-9">
...
<script>
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><input style="text-align: right;" id="nquantity'+xx+ '" class="form-control" name="nquantity'+xx+'" onkeypress="return hanyaAngka(event);"></td>';
        ...
        if(!ada){
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('#eproductname'+id).val(formatcemua(data[0].nama));
                    $('#motif'+id).val(formatcemua(data[0].motif));
                    $('#emotifname'+id).val(formatcemua(data[0].namamotif));
                },
                error: function () {
                    swal('Error :)');
                }
    ...
    function dipales(a){
        if( (document.getElementById("dbm").value!='') ) {
            if(a==0){
