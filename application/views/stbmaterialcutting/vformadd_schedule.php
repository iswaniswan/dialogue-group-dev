                ...
                <div class="panel-body table-responsive">
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <select name="i_bagian_receive" required="" id="i_bagian_receive" class="form-control select2" readonly>
                                    ...
                                    <?php if ($ibagian) { ?>
                                        <option value="<?= trim($ibagian->i_bagian); ?>|<?= $ibagian->id_company ?>"><?= $ibagian->e_bagian_name; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                ...
                <table id="table" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-right" width="8%;">QTY Kirim</th>
                        ...
                        if ($datadetail) {
                            foreach ($datadetail as $key) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" value="<?= $key->id_material; ?>" id="id_material<?= $i; ?>" name="id_material<?= $i; ?>">
                                        <input type="hidden" value="<?= $key->i_material; ?>" id="i_material<?= $i; ?>" name="i_material<?= $i; ?>">
                                        <?= $key->i_material; ?>
                                    </td>
                                    <td>
                                        <?= $key->e_material_name; ?>
                                    ...
                                    <td>
                                        <input min="0" value="<?= $key->n_quantity_sisa; ?>" type="number" id="n_quantity<?= $i; ?>" class="form-control text-right input-sm inputqty <?= $key->id_material; ?>" autocomplete="off" name="n_quantity<?= $i; ?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" onkeyup="hetang(<?= $i; ?>);" onchange="hetang(<?= $i; ?>);">
                                    ...
                                    <td>
                                        ...
                                        <input value="<?= $key->id_forecast; ?>" type="hidden" name="id_forecast<?= $i; ?>" id="id_forecast<?= $i; ?>"/>
                                    </td>
...
<script>
    ...
    $("#submit").click(function(event) {
        ...
        for (let i = 1; i <= $('#jml').val(); i++) {
            ...
            var i_material = $('#i_material'+i).val();
            var id_material = $('#id_material'+i).val();
            var total = total_input(id_material);
            if ( total > stock) {
                swal("Maaf :(", "Jumlah "+ i_material +" = " + total + ", tidak boleh lebih dari stock = " + stock + "", "error");
                $('#n_quantity' + i).val(0);
                ada = true;
            }
    ...
    function number() {
        var i_bagian = $('#i_bagian_receive').val().split('|')[0];
        $.ajax({
            type: "post",
            data: {
                'tgl': $('#d_document').val(),
    ...
    function total_input(id_material) {
        var sum = 0;
