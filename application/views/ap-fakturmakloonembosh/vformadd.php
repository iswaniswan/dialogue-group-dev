        ...
        <div class="panel panel-info">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group row"> 
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="vtotaldis" id="vtotaldis" class="form-control" value="" placeholder="0.00" readonly>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><input type="hidden" id="icolor'+no+'" name="icolor'+no+'" value="'+data['detail'][a]['i_color']+'"><input readonly style="width:120px;" class="form-control" id="ecolor'+no+'" name="ecolor'+no+'" value="'+data['detail'][a]['e_color_name']+'"></td>';
