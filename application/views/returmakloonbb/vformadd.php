                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" name="iretur" id="ireturbb" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number;?>" maxlength="15" class="form-control input-sm" value="" aria-label="Text input with dropdown button">
...
<script>
    ...
    $('#ceklis').click(function(event) {
        if($('#ceklis').is(':checked')){
            $("#ireturbb").attr("readonly", false);
        }else{
            $("#ireturbb").attr("readonly", true);
            $("#ada").attr("hidden", true);
            number();
        }
    });
    ...
    $('#dretur, #ibagian').change(function(event) {
        number();
    });
...
function getdetail(id) {   
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var idtypemakloon = data['head']['id_type_makloon'];
            $('#dnota').val(dnota);
            $('#idtypemakloon').val(idtypemakloon);
