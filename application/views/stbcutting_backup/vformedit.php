                    ...
                    if ($detail) {
                        foreach ($detail as $row) {
                            ...
                            <tr>
                                ...
                                <td><input type="text" readonly id="esatuan<?= $i; ?>" class="form-control input-sm" name="esatuan[]" value="<?= $row->e_satuan_name; ?>"></td>
                                <td><input type="text" readonly id="d_schedule<?= $i; ?>" class="form-control input-sm" name="d_schedule[]" value="<?= $row->d_schedule; ?>"></td>
                                <td><input type="text" id="nquantity<?= $i; ?>" class="form-control text-right input-sm inputitem" autocomplete="off" readonly name="nquantity[]" value="<?= $row->n_sisa_material_schedule; ?>" onkeyup="angkahungkul(this);"></td>
                                <td><input type="text" id="nquantity_kirim<?= $i; ?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantity_kirim[]" onblur='if(this.value==""){this.value="0";}' onfocus='if(this.value=="0"){this.value="";}' value="<?= $row->n_quantity_material; ?>" onkeyup="angkahungkul(this);cek(<?= $i; ?>)"></td>
...
<script>
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><input type="text" readonly id="esatuan'+i+'" class="form-control input-sm" name="esatuan[]"></td>';
        cols += '<td><input type="text" readonly id="d_schedule'+i+'" class="form-control input-sm" name="d_schedule[]"></td>';
        cols += '<td><input type="text" id="nquantity'+i+'" class="form-control text-right input-sm inputitem" autocomplete="off" readonly name="nquantity[]" value="0" onkeyup="angkahungkul(this);"></td>';
