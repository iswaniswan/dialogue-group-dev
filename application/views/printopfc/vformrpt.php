...
#					for($yy=14;$yy!=$i;$yy--){
		...
		$cetak.=CHR(15);		
		$cetak.=$ab.CHR(192).str_repeat(CHR(196),5).CHR(193).str_repeat(CHR(196),8).CHR(193).str_repeat(CHR(196),8).CHR(193).str_repeat(CHR(196),11).CHR(193).str_repeat(CHR(196),46).CHR(193).str_repeat(CHR(196),44).CHR(217)."\n";				
		$cetak.=$ab.str_repeat(" ",84)."    Hormat kami,             "."\n";				
  	...
  	if($quer->num_rows()>0){
		...
		$cetak.=$ab."Batas Pengiriman Terakhir : ".$dop.$spc1.CHR(27).CHR(45).CHR(1).str_repeat(" ",20).CHR(27).CHR(45).CHR(0)."\n";
		...
		$cetak.=$ab."Cara Pembayaran           : ".$bayar.$spc1."  Adm. Pembelian                          \n\n".CHR(18);				
 ...
 // echo $cetak;
	function CetakHeader($row,$hal,$nor,$abn,$ab,$ipp){
		...
		$hr=$tmp[2];
		$dop=$hr." ".mbulan($bl)." ".$th;
		$cetek.=$nor.CHR(27).CHR(71).$company->name."                   ".$company->kota_company.", ".$dop.CHR(27).CHR(72)."\n";		
		$cetek.=$nor.CHR(27).CHR(71).$company->alamat_company.CHR(27).CHR(72)."\n\n";		
		$cetek.=$nor.CHR(27).CHR(120).CHR(1).CHR(27).CHR(119).CHR(1).CHR(14)."OP FORECAST".CHR(20).CHR(27).CHR(120).CHR(0).CHR(27).CHR(119).CHR(0)."               Kepada Yth.\n";		
		...
		$cetek.=$nor."No.SPmB : ".$row->i_reff."                    ".CHR(15)."\n";		
