...
//         var groupColumn = 2;
  ...
  function yyy(b){
    lebar =450;
    tinggi=400;
    eval('window.open("<?php echo site_url(); ?>"+"/printopfc/cform/cetak/"+b+"","width="+lebar+"px,height="+tinggi+"px,resizable=1,menubar=1,scrollbars=1,top='+(screen.height-tinggi)/2+',left='+(screen.width-lebar)/2+'")');
  }
</script>
