            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="col-sm-8">
                            <label class="col-md-8">No Pengeluaran Pinjaman</label>
                            <select required="" id="ibonmk" name="ibonmk" class="form-control" disabled="" onchange="getdetailbonmk();">
                            </select>
                        </div>
                    </div>                
...
function cek() {
        ...
        if (dkonversi == '') {
            ...
            if (found == "lebih") {
                ...
                alert("Jumlah Barang Masuk Harus Di Isi");
                return false;
            } else {
                return true;
            }
