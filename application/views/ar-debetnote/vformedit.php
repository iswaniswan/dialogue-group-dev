        ...
        <div class="panel panel-info">
            ...
            <div class="col-md-6">
                <div class="form-group row">
                     ...
                     <div class="col-sm-4">
                        <input class="form-control date" name="dnota" id="dnota" readonly="" value="<?= $data->d_nota_ar; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="panel-body table-responsive">
                        <table id="tabledata" class="table table-bordered" cellspacing="0" width="100%" >
                            ...
                            <tbody>
                                ...
                                <td class="col-sm-1">
                                    <input style ="width:150px" class="form-control" type="text" id="jumlah<?=$i;?>" name="jumlah<?=$i;?>" value="<?= $row->n_price_back; ?>" onkeyup="validasi(); reformat(this);">
                                </td>
                                </tr>
                                <?php } ?>
