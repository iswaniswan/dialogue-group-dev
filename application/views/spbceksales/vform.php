                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-offset-5 col-sm-8">
                            <button type="submit" id="submit" class="btn btn-success btn-rounded btn-sm" onclick="return dipales(parseFloat(document.getElementById('jml').value));"> <i class="fa fa-save"></i>&nbsp;&nbsp;Dicek</button>
                            &nbsp;&nbsp;
                                ...
                                <?php if ($detail) {
                                    ...
                                    foreach ($detail as $row) { 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-control form-control-success" style="text-align:right;" type="text" id="norder<?=$i;?>" name="norder<?=$i;?>" onkeyup="hitungnilai(this.value)" value="<?= $jujum; ?>">
                                            </td>
                                            <td>
