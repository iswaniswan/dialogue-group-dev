                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" name="idocument" id="i_so_ak" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="SO-2021-000001" maxlength="25" class="form-control input-sm" value="<?= $number;?>" aria-label="Text input with dropdown button">
...
<script>
    ...
    $('#ceklis').click(function(event) {
        if($('#ceklis').is(':checked')){
            $("#i_so_ak").attr("readonly", false);
        }else{
            $("#i_so_ak").attr("readonly", true);
        }
    });
