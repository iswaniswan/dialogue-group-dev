                    ...
                    <div class="panel-body table-responsive">
                        <table id="tabledata" class="table table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <td class="col-sm-1">
                                    <input style ="width:120px"type="text" class="form-control" id="imaterial<?=$i;?>" name="imaterial<?=$i;?>"value="<?= $row->kode; ?>" readonly >
                                </td>
                                <td class="col-sm-1">
                                ...
                                <td class="col-sm-1">
                                    <input style ="width:120px" type="text" class="form-control" id="esatuan<?=$i;?>" name="esatuan<?=$i;?>"value="<?= $row->e_satuan; ?>" readonly >
                                </td>
                               <!--  <td class="col-sm-1">
                                    <input style ="width:80px" type="text" class="form-control" id="iunitkonv<?=$i;?>" name="iunitkonv<?=$i;?>"value="" readonly >
                                </td> -->
                                <td class="col-sm-1">
                                    <input style ="width:120px"type="text" class="form-control" id="saldoawal<?=$i;?>" name="saldoawal<?=$i;?>"value="<?= $row->saldoawal; ?>"readonly >
                                </td>
                                <td class="col-sm-1">
                                    <input style ="width:120px"type="text" class="form-control" id="sjmasuk<?=$i;?>" name="sjmasuk<?=$i;?>"value="<?= $row->sjmasuk; ?>"readonly >
                                </td>
                                <td class="col-sm-1">
                                    <input style ="width:120px"type="text" class="form-control" id="sjmasukmakloon<?=$i;?>" name="sjmasukmakloon<?=$i;?>"value="<?= $row->sjmasukmakloon; ?>" readonly>
                                </td>
                                <td class="col-sm-1">
                                    <input style ="width:120px"type="text" class="form-control" id="sjkeluar<?=$i;?>" name="sjkeluar<?=$i;?>"value="<?= $row->sjkeluar; ?>" readonly>
                                </td>
                                <td class="col-sm-1">
                                    <input style ="width:120px"type="text" class="form-control" id="sjkeluarmakloon<?=$i;?>" name="sjkeluarmakloon<?=$i;?>"value="<?= $row->sjkeluarmakloon; ?>" readonly>
                                </td>
                                
                                <td class="col-sm-1">
                                    <input style ="width:120px"type="text" class="form-control" id="adjustment<?=$i;?>" name="adjustment<?=$i;?>"value="<?= $row->adjustment; ?>" readonly>
                                </td>
                                <td class="col-sm-1">
                                    <input style ="width:120px"type="text" class="form-control" id="retur<?=$i;?>" name="retur<?=$i;?>"value="<?= $row->retur; ?>" readonly>
                                </td>
                                <td class="col-sm-1">
                                    <input style ="width:120px"type="text" class="form-control" id="saldoakhir<?=$i;?>" name="saldoakhir<?=$i;?>"value="<?= $row->saldoakhir; ?>" readonly>
                                </td>
                                <td class="col-sm-1">
                                    <input style ="width:120px"type="text" class="form-control" id="git<?=$i;?>" name="git<?=$i;?>" value="<?= $row->git; ?>" readonly>
                                </td>
                                <td class="col-sm-1">
                                    <input style ="width:120px"type="text" class="form-control" id="so<?=$i;?>" name="so<?=$i;?>"value="<?= $row->so; ?>" readonly>
                                </td>
                                <td class="col-sm-1">
                                    <input style ="width:120px"type="text" class="form-control" id="selisih<?=$i;?>" name="selisih<?=$i;?>"value="<?= $row->selisih; ?>" readonly>
                                </td>
                                </tr>
                               <?php  } ?>
