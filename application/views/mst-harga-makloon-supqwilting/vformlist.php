    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-list"></i> <?= $title; ?>
                <?php  if(check_role($this->i_menu, 1)){ ?><a href="#" onclick="show('<?= $folder; ?>/cform/tambah/<?=$dfrom;?>','#main'); return false;" class="btn btn-info btn-sm pull-right"><i
...
<script>
    $(document).ready(function () {
        showCalendar2('.date');
        datatable('#tabledata', base_url + '<?= $folder; ?>/Cform/data/<?=$dfrom;?>');
    });

    function hapus(isupplier, kodebrg) {
        // var material = kodebrg.trim();
        swal({   
...
<!-- <script>
$(document).ready(function() {
    datatable('#table', base_url + 'index.php/ttbtolak/Cform/data/<?= $now; ?>/<?= $dudet ?>');
});
</script> -->