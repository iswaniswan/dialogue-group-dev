            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input name="ipromo" id="ipromo" type="hidden" class="form-control" value="<?php echo $isi->i_spb_program;?>">
                            <input readonly id="epromoname" name="epromoname" class="form-control" type="text" value="<?php echo $isi->e_promo_name;?>">
                        </div>
                    </div> 
                    <div class="form-group row">
                            ...
                            <?php if ($detail) {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-control" style="text-align:right;" type="text" id="eremark<?=$i;?>" name="eremark<?=$i;?>" value="<?= $row->e_remark; ?>" readonly onkeyup="hitungnilai(this.value,<?=$jmlitem;?>)">
                                            </td>
                                        </tr>
                                    <?php  } ?>
