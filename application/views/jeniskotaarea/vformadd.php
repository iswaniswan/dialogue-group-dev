            ...
            <div class="panel-body table-responsive">
                ...
                <div id="pesan"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="icitytypeperarea" class="form-control" required="" maxlength="3" onkeyup="gede(this)">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Nama Jenis Kota/Area</label>
                        <div class="col-sm-12">
                            <input type="text" name="ecitytypeperarea" class="form-control" required="" maxlength="50" onkeyup="gede(this)">
                        </div>
                    </div>
                    <div class="form-group">
