            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="hidden" id= "jreferensi" name="jreferensi" value="<?= $data->id_jenis_barang_keluar; ?>">
            ...
            <table id="tabledatax" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                ...
                <?php
                    ...
                    <tr>   
                        ...
                        <td hidden>
                            <input type="text" class="form-control input-sm text-right" id="nquantitysisa<?=$i;?>" name="nquantitysisa[]" value="<?= $row->n_sisa; ?>" readonly> 
                        </td>
                        <td>
...
<script>
        ...
        var ipengirim = $('#ipengirim').val();
            $.ajax({
                ...
                var newRow = $("<tr>");
                    ...
                    cols += '<td><input readonly class="form-control input-sm" type="text" id="iproduct'+a+'" name="iproduct[]" value="'+iproduct+'"><input readonly class="form-control input-sm" type="hidden" id="idproduct'+a+'" name="idproduct[]" value="'+idproduct+'"></td>';
                    ...
                    cols += '<td><input readonly class="form-control input-sm" type="text" id="nquantity'+a+'" name="nquantity[]" value="'+nquantity+'"></td>';
                    cols += '<td hidden><input readonly class="form-control input-sm" type="text" id="nquantitysisa'+a+'" name="nquantitysisa[]" value="'+nquantitysisa+'"></td>';
                    cols += '<td><input class="form-control input-sm inputitem" type="text" id="nquantitymasuk'+a+'" name="nquantitymasuk[]" value="'+nquantitysisa+'" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\'  onkeyup="validasi('+a+')"></td>';
    ...
    function validasi(i){            
        ...
        if(/*parseFloat(nquantitymasuk) == 0 &&*/  parseFloat($('#nquantitymasuk'+i).val()) == ''){
