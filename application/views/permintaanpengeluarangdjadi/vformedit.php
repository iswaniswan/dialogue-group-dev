            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" id="dperkiraan" name="dperkiraan" class="form-control input-sm date" value="<?= $data->d_perkiraan;?>" placeholder="Tanggal Perkiraan" readonly>
                        </div>
                        <div class="col-sm-4">
                ...
                <tbody>
                    ...
                    foreach ($datadetail as $key) {
                        ...
                        <tr>
                            ...
                            <td>
                                <select data-nourut="<?= $i ;?>" id="idproduct<?= $i ;?>" class="form-control input-sm" name="idproduct<?= $i ;?>" >
                                    <option value="<?= $key->id_product_base;?>"><?= $key->i_product_base.' - '.$key->e_product_basename.' - '.$key->e_color_name;?></option>
                                </select>
                            </td>
                            <td><input type="text" id="nquantitysaldo<?= $i ;?>" class="form-control text-right input-sm" value="0" readonly></td>
