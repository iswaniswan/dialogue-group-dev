            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" id="dmemo" name="dmemo" class="form-control" value="<?= $data->d_memo; ?>" readonly>
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div <?= $hidden;?> id="pice" class="col-sm-3">
                            <input type="text" id="epic" name="epic" class="form-control" placeholder="Nama PIC" value="<?= $data->pic_eks; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="table-responsive">
                            <table id="tabledata" class="table color-table inverse-table table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    ...
                                    <th class="text-center" style="width: 10%;">Belum Terpenuhi</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($detail as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input value="<?= $row->n_qty;?>" type="text" id="nquantity<?= $counter;?>" class="form-control text-right" name="nquantity<?= $counter;?>" readonly>
                                            </td>
                                            <td>
                                                <input value="<?= $row->sisa_now;?>" type="text" id="sisa_now<?= $counter;?>" class="form-control text-right" name="sisa_now<?= $counter;?>" readonly>
                                            </td>
                                            <td>
                                                <input value="<?= $row->e_remark;?>" type="text" id="edesc<?= $counter;?>" class="form-control" name="edesc<?=$counter;?>" readonly>
                                            </td>
                                        </td>
                                    </tr>
                                <?php } ?>
