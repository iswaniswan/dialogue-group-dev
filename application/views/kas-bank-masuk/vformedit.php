                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <select name="i_area" id="i_area" class="form-control select2" onchange="number();">
                                <?php if ($area) {
                                    foreach ($area as $row): ?>
                                        <option value="<?= $row->id; ?>" <?php if ($row->id == $data->i_area) { ?> selected <?php } ?>><?="[" . $row->i_area . "] - " . $row->e_area; ?>
                                        </option>
                                    <?php endforeach;
                                } ?>
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <select name="i_coa" id="i_coa" class="form-control select2">
                                <option value="<?= $data->i_coa; ?>"><?= $data->i_coa_id . " - " . $data->e_coa_name; ?>
                                </option>
                            </select>
                        </div>
                        <div class="col-sm-6">
                            <textarea name="e_remark" class="form-control input-sm"
                                placeholder="Note ..."><?= $data->e_remark; ?></textarea>
                        </div>
                    </div>
                    <hr class="mt-0">
                    <div class="row">
                                    ...
                                    if ($datadetail) {
                                        foreach ($datadetail as $key) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select data-nourut="<?= $i;?>" id="i_coa_item_<?= $i;?>"
                                                        class="form-control input-sm" name="i_coa_item_<?= $i;?>" required>
                                                        <option value="<?= $key->i_coa; ?>"><?= $key->i_coa_id . ' - ' . $key->e_coa_name; ?></option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <input type="text" readonly class="form-control input-sm date"
                                                        placeholder="dd-mm-yyyy" name="d_bukti_<?= $i;?>" id="d_bukti_<?= $i;?>" value="<?= formatdmY($key->d_bukti); ?>"
                                                        required>
                                                </td>
                                                <td>
                                                    <select id="i_area_item_<?= $i;?>" class="form-control input-sm"
                                                        name="i_area_item_<?= $i;?>" required>
                                                        <option value="<?= $key->i_area; ?>"><?= $key->i_area_id . ' - ' . $key->e_area; ?></option>
                                                    </select>
                                                </td>
                                                <td class="clear">
                                                    <select id="i_rv_refference_type_<?= $i;?>" class="form-control input-sm"
                                                        name="i_rv_refference_type_<?= $i;?>">
                                                        <option value="<?= $key->i_rv_refference_type; ?>"><?= $key->e_rv_refference_type_name; ?></option>
                                                    </select>
                                                </td>
                                                <td class="clear">
                                                    <select data-no="<?= $i;?>" id="i_rv_refference_<?= $i;?>"
                                                        class="form-control input-sm" name="i_rv_refference_<?= $i;?>">
                                                        <option value="<?= $key->i_rv_refference; ?>"><?= $key->i_referensi; ?></option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control input-sm"
                                                        placeholder="Keterangan Transaksi" name="e_remark_item_<?= $i;?>"
                                                        id="e_remark_item_<?= $i;?>" required value="<?= $key->e_remark; ?>">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control input-sm text-right v_rv"
                                                        placeholder="Nilai Transaksi" name="v_rv_item_<?= $i;?>" id="v_rv_item_<?= $i;?>"
                                                        required value="<?= number_format($key->v_rv); ?>" onkeyup="angkahungkul(this);hetang();reformat(this);">
                                                </td>
