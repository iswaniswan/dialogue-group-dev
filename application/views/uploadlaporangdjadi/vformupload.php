            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                   <div class="form-group row">
                            ...
                            <div class="col-sm-2"> 
                                <input type="text" name="ebulan" id="ebulan" class="form-control input-sm" value="<?php 
                                $months=array("Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember");
                                $i = ((int)$bulan) - 1;
                                echo $months[$i];
                                ?>" readonly>
                                <input type="hidden" name="bulan" id="bulan" class="form-control input-sm" value="<?= $bulan;?>" readonly>   
                            </div>
                            <div class="col-sm-2">
                    ...
                    <tbody>
                        ...
                        foreach ($datadetail as $key) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <select data-nourut="<?= $i ;?>" id="id_product_base<?= $i ;?>" class="form-control select2 input-sm" name="id_product_base<?= $i ;?>" >
                                        <option value="<?= $key['id_product_base']?>"><?= $key["i_product_base"];?> - <?= $key["e_product_basename"];?> - <?= $key["e_color_name"];?></option>
                                    </select>
                                    <input type="hidden" id="i_product_base<?= $i ;?>" class="form-control input-sm" readonly name="i_product_base<?= $i ;?>" value="<?= $key["i_product_base"];?>">
                                </td>
                ...
                <table id="tabledataxnon" class="table color-table table-bordered class" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        foreach ($datadetailnon as $keynon) {
                            ...
                            <tr>
                                <td class="text-center"><spanx id="snum<?= $i ;?>"><?= $i ;?></spanx></td>
                                <td><?= $keynon["i_product_base"];?></td>
                                <td class="text-right"><?= $keynon["n_saldo_awal"];?></td>
                            </tr>
                        <?php } 
                        ?> 
                    </tbody>
            ...
            $('#id_product_base'+ i).select2({
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#i_product_base' + nourut).val( parseInt(cek[0].iproductbase));

                        $('#i_color' + nourut).val( parseInt(cek[0].icolor));
