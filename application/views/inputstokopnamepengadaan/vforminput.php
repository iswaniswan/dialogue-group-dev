                        ...
                        <table id="tabledatax" class="table color-table success-table table-bordered class" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select data-igrade="<?= $i ;?>" id="igrade<?= $i ;?>" class="form-control select2 input-sm" name="igrade<?= $i ;?>" >
                                        </select>
                                    </td>
...
<script>
    $(document).ready(function () {
        for (var i = 1; i <= $('#jml').val(); i++) {
                ...
                $('#igrade'+ i).select2({
                    ...
                    type: "POST",
                    ajax: {
                        url: '<?= base_url($folder.'/cform/cargrade/'); ?>',
                        dataType: 'json',
                        delay: 250,
                        data: function (params) {
                            var query   = {
    ...
    $("#addrow").on("click", function () {
        ...
        cols += `<td><select data-nourut="${i}" id="idmaterial${i}" class="form-control input-sm" name="idmaterial${i}" ></select></td>`;
         cols += `<td><input type="text" id="e_satuan${i}" class="form-control text-right input-sm inputitem" autocomplete="off" name="e_satuan${i}" readonly></td>`;
        cols += `<td><select data-igrade="${i}" id="igrade${i}" class="form-control input-sm" name="igrade${i}" ></select></td>`;
