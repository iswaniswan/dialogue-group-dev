            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <label class="col-md-3">Tanggal Permintaan Dibayar</label>
                        <div class="col-sm-3">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" id="jumlah" name="jumlah" class="form-control" disabled="" value="<?php echo $data->v_total; ?>" 
                            readonly>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        <button type="button" class="btn btn-inverse btn-rounded btn-sm" onclick="show('<?= $folder;?>/cform/index/<?= $ldfrom."/".$ldto;?>','#main')"> <i class="fa fa-arrow-circle-left"></i>&nbsp;&nbsp;Kembali</button>&nbsp;
                            <button type="button" id="change" class="btn btn-warning btn-rounded btn-sm" onclick="statuschange('<?= $folder."','".$data->id;?>','1','<?= $ldfrom."','".$ldto;?>');"> <i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;Change Requested</button>&nbsp;
                            <button type="button" id="reject" class="btn btn-danger btn-rounded btn-sm"  onclick="statuschange('<?= $folder."','".$data->id;?>','4','<?= $ldfrom."','".$ldto;?>');"> <i class="fa fa-times"></i>&nbsp;&nbsp;Reject</button>&nbsp;
    ...
    function getdataedit() {
        ...
        success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><input style="width:200px" type="text" id="edesc'+ zz + '" class="form-control" readonly name="edesc' + zz + '" value="'+eremark+'"/></td>';
                    newRow.append(cols);
