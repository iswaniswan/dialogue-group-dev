                ...
                <?= $this->pquery->form_remote_tag(array('url' => site_url($folder.'/cform/simpan'), 'update' => '#pesan', 'type' => 'post', 'class' => 'form-horizontal')); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="idivisi" id="idivisi" autocomplete="off" class="form-control" placeholder="Standar 7 Digit" required="" maxlength="10" onkeyup="gede(this); clearcode(this);" value="">
                                <span class="notekode" hidden="true"><b> * Kode Sudah Ada!</b></span>
                            </div>
                            <div class="col-sm-8">
                                <input type="text" name="edivisi" id="edivisi" onkeyup="gede(this); clearname(this);" class="form-control" value="" placeholder="Nama Seri Maksimal 100 Karakter " maxlength="100">
                            </div>
                        </div>                                   
