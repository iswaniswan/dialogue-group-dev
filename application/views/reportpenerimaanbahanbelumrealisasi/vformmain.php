    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <?php /*
                <a href="#" onclick="show('<?= $folder; ?>/cform/','#main'); return false;" class="btn btn-info btn-sm pull-right">
                    <i class="fa fa-list"></i></i>&nbsp; <?= $title_list; ?>
                </a>
                */ ?>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        $('#ibagian').select2({
            ...
            allowClear: true,
            ajax: {
                url: '<?= base_url($folder . '/cform/get_list_bagian'); ?>',
                dataType: 'json',
                delay: 250,
    ...
    function print() {
        ...
        if (ibagian == "" || jnsbarang == "" || ikelompok == "" || dfrom == "" || dto == "") {
            ...
            const url = `/cform/cetak/?id_bagian=${ibagian}&dfrom=${dfrom}&dto=${dto}`;
            eval('window.open("<?php echo site_url($folder); ?>"+url,"screenX=0,screenY=0,left=0,top=0,fullscreen=yes,width="+(screen.availWidth-5)+",height="+(screen.availHeight-(55)))');
