            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" readonly id="dkk" name="dkk" class="form-control" value="<?= $tanggal;?>">
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="col-md-12">
                    <table id="tabledetail" class="display table" cellspacing="0" width="100%" hidden="true">
                        <thead>
                            <tr>
                                <th style="text-align: center; width: 25%;">Rekening</th>
                                <th style="text-align: center; width: 25%;">Bukti</th>
                                <th style="text-align: center; width: 15%;">Tanggal Bukti</th>
...
<script>
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><input type="text" id="ibukti'+xx+'" class="form-control" name="ibukti'+xx+'"></td>';
        ...
        cols += '<td><input id="vkk'+xx+'" class="form-control" name="vkk'+xx+'" onkeypress="return hanyaAngka(event);" onkeyup="reformat(this);"></td>';
