            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" id="dperkiraan" required="" name="dperkiraan" class="form-control input-sm date" value="<?= date('d-m-Y');?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="hidden" name="fpkp" id="fpkp">
                            <input type="hidden" name="ndiskon" id="ndiskon">
                        </div>
                        <div class="col-sm-3">
                            <input type="text" id="ipermintaan" name="ipermintaan" class="form-control input-sm" maxlength="18" required="" placeholder="No Permintaan Harus Diisi!">
                        </div>
                        <div class="col-sm-2">
                            <input type="text" id="dpermintaan" name="dpermintaan" class="form-control input-sm tgl" value="<?= date('d-m-Y');?>" readonly>
                        </div>
                        <div class="col-sm-4">
