            ...
            success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                   ...
                   if (lastmaterial == i_material) {
                        ...
                        cols += '<td><input type="text" id="edesc'+ counter + '" class="form-control" name="edesc[]" value="'+e_remark+'"/><input type="text" id="v_price'+ counter + '" class="form-control" name="v_price[]" value="'+v_price+'"/></td>';
                    } else {
