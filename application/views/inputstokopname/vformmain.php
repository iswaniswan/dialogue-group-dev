    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                <i class="fa fa-list fa-lg mr-2"></i><?= $title; ?> <a href="#" onclick="show('<?= $folder; ?>/cform/index/<?= $dfrom . "/" . $dto; ?>','#main'); return false;" class="btn btn-info btn-sm pull-right"><i class="fa fa-list"></i>&nbsp;<?= $title_list; ?></a>
            </div>
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" name="idocument" id="i_so_bb" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="SO-<?= date('ym'); ?>-001" maxlength="25" class="form-control input-sm" value="<?= $number; ?>" aria-label="Text input with dropdown button">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <button type="submit" id="submit" class="btn btn-info btn-block btn-sm" onclick="return validasi();"> <i class="fa fa-spin fa-spinner mr-2 fa-lg"></i>View</button>
                        </div>
                        <div class="col-sm-6">
...
<script>
    ...
    $('#ceklis').click(function(event) {
        if ($('#ceklis').is(':checked')) {
            $("#i_so_bb").attr("readonly", false);
        } else {
            $("#i_so_bb").attr("readonly", true);
        }
    });
