                        ...
                        <table id="tabledatax" class="table color-table inverse-table table-bordered class" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control input-sm inputitem" name="" value="<?= $key["i_product_base"].' - '.$key["e_product_basename"] ?>" readonly></td>
                                    <td><input readonly type="text" id="skin<?= $i ;?>" class="form-control input-sm inputitem" autocomplete="off" name="skin<?= $i ;?>" 
                                        value="<?= $key['id_material'].' - '.$key["e_material_name"] ?>"></td>
                                    <td><input type="text" class="form-control input-sm inputitem" name="" value="<?= $key["status_barang"] ?>" readonly></td>
                                    <td><input readonly type="text" id="nquantity<?= $i ;?>" class="form-control text-right input-sm inputitem" autocomplete="off" name="nquantity<?= $i ;?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="<?= $key["n_quantity"];?>" onkeyup="angkahungkul(this);"></td>
                                    <td><input readonly type="text" class="form-control input-sm" name="eremark<?= $i ;?>" id="eremark<?= $i ;?>" value="<?= $key["e_remark"];?>" placeholder="Isi keterangan jika ada!"/></td>
                                </tr>
                                <?php 
                                    }
                                } 
