                ...
                <table id="tabledatax" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-right" width="8%;">FC</th>
                            <th class="text-right" width="8%;">Stock</th>
                            <th class="text-right" width="8%;">Stock Outstanding</th>
                            <th class="text-right" width="8%;">Qty SPB</th>
                            <th class="text-right" width="8%;">Qty SJ</th>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td><input class="form-control text-right input-sm inputitem" autocomplete="off" id="nquantity' + no + '" name="nquantity[]" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\' value="' + data['detail'][a]['n_do'] + '" onkeyup="ceksaldo(' + no + '); angkahungkul(this);"></td>';
