                    ...
                    <tbody>
                                ...
                                foreach ($datadetail as $d) {
                                    ...
                                    if ($group != $d->i_product_base) {
                                        ...
                                        <tr class="tr list-item tr_first<?= $i ?>">
                                            ...
                                            <td colspan="5"></td>
                                            <td><input type="text" class="form-control text-right input-sm inputitem" id="nquantityspb<?= $i ?>" name="nquantityspb<?= $i ?>" value="<?= $d->nquantity_permintaan ?>" onkeydown="nexttab2(this, event,'inputitem')" readonly></td>
                                            <td colspan="2"></td>
                                    ...
                                    <tr class="list-item td_<?= $i ?>">
                                        ...
                                        <td><input class="form-control text-right input-sm inputitem kode_<?= $d->i_product_base ?>" autocomplete="off" id="nquantity<?= $i ?>_<?= $ii ?>" name="nquantity[]" onblur='if(this.value==""){this.value="0";}' onfocus='if(this.value=="0"){this.value="";}' value="<?= $d->n_quantity ?>" onkeydown="nexttab2(this, event,'inputitem')" onkeyup="ceksaldo2(<?= $i ?>, <?= $ii ?>, '<?= $d->i_product_base ?>'); angkahungkul(this);"></td>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control input-sm text-right inputitem" autocomplete="off" id="nquantity<?= $i; ?>" name="nquantity[]" value="<?= $row->n_quantity; ?>" onkeypress="return event.charCode >= 48 && event.charCode <= 57;" onblur='if(this.value==""){this.value="0";}' onfocus='if(this.value=="0"){this.value="";}' onkeyup="ceksaldo(<?= $i; ?>); angkahungkul(this);" onkeydown="nexttab(this, event,'inputitem')">
                                    </td>
                                    <td>
                    ...
                    if (data['detail'].length > 0) {
                        for (let a = 0; a < data['detail'].length; a++) {
                            ...
                            <tr class="list-item td_${i}">
                                ...
                                <td><input class="form-control text-right input-sm inputitem kode_${data['detail'][a]['i_product_base']}" autocomplete="off" id="nquantity${i}_${ii}" name="nquantity[]" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\' value="0" onkeydown="nexttab2(this, event,\'inputitem\')" onkeypress="return event.charCode >= 48 && event.charCode <= 57;" onkeydown="nexttab2(this, event,\'inputitem\')" onkeyup="ceksaldo2(${i}, ${ii}, '${data['detail'][a]['i_product_base']}'); angkahungkul(this);"></td>
