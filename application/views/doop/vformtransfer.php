                ...
                <table id="tabledatay" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" width="8%">Total FC</th>
                            <th class="text-center" width="8%">Stock</th>
                            <th class="text-center" width="8%">Stock <br>Outstanding</th>
                            <th class="text-center" width="8%">Qty OP <br>Kumulatif</th>
                            <th class="text-center" width="8%">Qty DO <br>Kumulatif</th>
                            <th class="text-center" width="8%">Qty OP</th>
                            <th class="text-center" width="8%">Qty DO <br> Per Warna</th>
                    ...
                    <tbody>
                        <?php $no = 0; $group = ""; foreach ($datadetail as $key) {
                            ...
                            if($group==""){ ?>
                                <tr class="pudding">
                                    <td colspan="12">Nomor Referensi : <b><?= $key->i_op;?></b> &nbsp;&nbsp;-&nbsp;&nbsp; Tanggal Referensi : <b><?= $key->d_referensi;?></b> &nbsp;&nbsp;-&nbsp;&nbsp; Area : <b><?= $key->i_area.' - '.$key->e_area;?></b></td>
                                </tr>
                                <?php 
                            }else{
                                if($group!=$key->i_op){?>
                                ...
                                <tr>
                                    ...
                                    <td><input class="form-control input-sm text-right inputitem" type="text" id="qty<?=$i;?>" name="qty<?=$i;?>" value="<?= $key->n_order_warna;?>" placeholder="0" autocomplete="off" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" onkeyup="angkahungkul(this);ngetang(<?=$i;?>)">
                                        <input readonly class="form-control input-sm text-right" type="hidden" name="harga<?=$i;?>" value="<?= number_format($key->v_price);?>">
                                    </td>
                                    <td><input class="form-control input-sm" type="text" name="eremark<?=$i;?>" value="<?= $key->e_op_remark;?>"></td>
                                     <td class="text-center"><input hidden class="text-center" onclick="cek(<?=$i;?>);" type="checkbox" id="ceklis<?=$i;?>" name="ceklis<?=$i;?>" checked></td>
                                </tr>
                                <?php $i++; 
                            } ?>
                    </tbody>
