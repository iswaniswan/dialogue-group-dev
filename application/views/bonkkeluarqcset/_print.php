            ...
            <div class="container-fluid table-responsive">
                <table id="tabledatax" class="table color-table inverse-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                    <thead style="background: #f8f9fa!important">
                        <tr>
                            <th class="text-center" rowspan="2" style="width: 25px;">No</th>
                            <th class="text-center" rowspan="2" style="width: 400px;">Kode</th>
                            <th class="text-center" rowspan="2" style="width: 350px;">Nama Barang</th>
                            <th class="text-center" colspan="2" style="width: auto;">Qty</th>
                            <th class="text-center" rowspan="2" style="width: 100px;">Keterangan</th>
                        </tr>
                        <tr>
                            <th class="text-center" style="width:40px;">Penyusun</th>
                            <th class="text-center" style="width:40px;">Akhir</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <?php if ($key['header']) { ?>
                                <td colspan="3" class="tdna">
                                    <div class="d-flex justify-content-between">
                                        <span>
                                            <b><?= $key['i_product_wip'] . ' - ' . $key['e_product_wipname'] . ' - ' . $key['e_color_name']; ?></b>
                                        </span>
                                        <span><b><?= $key['e_marker_name'] ?></b></span>
                                    </div>
                                </td>
                                <td class="text-right" colspan="2">
                                    <b><?= $key['n_quantity_product_wip']; ?></b>
                                </td>
                                <td></td>
                            <?php continue; } ?>
                            <tr class="del<?= $key['number'] ?>">
                                <td class="text-center"><?= $key['number'] ?></td>
                                <td class="text-left"><?= $key['i_panel'] ?></td>
                                <td class="text-left"><?= $key['e_material_name'] ?></td>
