                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="hidden" name="ibonkold" id="ibonkold" value="<?= $data->i_keluar_qcset; ?>">
                                <input type="text" name="ibonk" id="ibonk" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number; ?>" maxlength="17" class="form-control input-sm" value="<?= $data->i_keluar_qcset; ?>" aria-label="Text input with dropdown button">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <?php if ($data->i_status == '1' || $data->i_status == '3' || $data->i_status == '7') { ?>
                                ...
                                <button type="button" id="addrow" class="btn btn-info btn-rounded btn-sm" onclick="getproduct($('#jml').val());"> <i class="fa fa-plus"></i>&nbsp;&nbsp;Item</button>&nbsp;
                            <?php } ?>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <?php if ($group == "") { ?>
                                        <tr id="tr<?= $z; ?>">
                                            <td colspan="3">
                                                <select data-nourut="<?= $z; ?>" id="idproduct<?= $z; ?>" class="form-control input-sm" name="idproduct<?= $z; ?>" onchange="getdetail(<?= $z; ?>);">
                                                    <option value="<?= $key->id_product_wip; ?>"><?= $key->i_product_wip . ' - ' . $key->e_product_wipname . ' - ' . $key->e_color_name; ?></option>
                                                </select>
                                                <select data-nourut="<?= $z; ?>" id="idmarker<?= $z; ?>" class="form-control input-sm" name="idmarker<?= $z; ?>" onchange="getdetail(<?= $z; ?>);">
                                                    <option value="<?= $key->id_marker; ?>"><?= $key->e_marker_name; ?></option>
                                                </select>
                                            </td>
                                            <td>
                                                <input class="form-control qty input-sm text-right" autocomplete="off" type="text" name="nquantity<?= $z; ?>" id="nquantity<?= $z; ?>" onblur='if(this.value==""){this.value="0";kalikan();}' onfocus='if(this.value=="0"){this.value="";}' value="<?= $key->n_quantity_product_wip; ?>" onkeyup="angkahungkul(this); kalikan();">
                                            </td>
                                            <td colspan="4"></td>
                                    ...
                                    <tr class="del<?= $z; ?>">
                                        <td class="text-center"><?= $i; ?><input type="hidden" name="idpanel[]" value="<?= $key->id_panel_item; ?>"></td>
                                        <td>
                                            <input type="hidden" name="idproductwip[]" value="<?= $key->id_product_wip; ?>">
                                            <input type="hidden" class="idmaterial" name="idmaterial[]" value="<?= $key->id_panel_item; ?>">
                                            <input class="form-control input-sm" readonly type="text" value="<?= $key->i_panel; ?>">
                                        </td>
                                        <td>
                                            <input class="form-control input-sm" readonly type="text" value="<?= $key->i_material . ' - ' . $key->e_material_name; ?>">
                                        </td>
                                        <td></td>
                                        <td><input readonly class="form-control qty input-sm text-right inputqty_<?= $key->id_product_wip; ?> material_<?= $key->id_product_wip; ?>_<?= $i; ?>" data-noqty="<?= $i; ?>" autocomplete="off" type="text" id="npenyusun<?= $i; ?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" name="npenyusun[]" value="<?= $key->n_quantity_penyusun; ?>" onkeyup="angkahungkul(this); kalikan();"></td>
                                        <td><input readonly class="form-control qty input-sm text-right stock_<?= $key->id_product_wip; ?>_<?= $i; ?>" type="text" id="n_stock<?= $i; ?>" name="n_stock[]" value="<?= $key->n_saldo_akhir; ?>"></td>
                                        <td><input readonly class="form-control qty input-sm text-right akhir_<?= $key->id_product_wip; ?> inputitem sisa_<?= $key->id_product_wip; ?>_<?= $i; ?>" autocomplete="off" type="text" id="nqtysisa<?= $i; ?>" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" name="nqtysisa[]" value="<?= $key->n_quantity_akhir; ?>" onkeyup="angkahungkul(this);"></td>
...
<script>
    $(document).ready(function() {
        ...
        for (var i = 1; i <= $('#jml').val(); i++) {
            ...
            //                     cols1 += '<td class="text-center">'+x+'<input type="hidden" name="idpanel[]" value="'+data['detail'][xx]['id']+'"></td>';
            ...
            //                     cols1 += '<td></td>';
            //                     cols1 += '<td><input class="form-control qty input-sm text-right inputqty_'+idproduct+' material_'+idproduct+'_'+x+'" data-noqty="'+x+'"  autocomplete="off" type="text" id="npenyusun'+x+'" name="npenyusun[]" value="0" onkeyup="angkahungkul(this); kalikan();"></td>';
            //                     cols1 += '<td><input class="form-control qty input-sm text-right inputitem sisa_'+idproduct+'_'+x+'" autocomplete="off" type="text" id="nqtysisa'+x+'" name="nqtysisa[]" value="0" onkeyup="angkahungkul(this);"></td>';
                ...
                ajax: {
                    ...
                    data: function(params) {
                        var query = {
                            ...
                            ipartner: $('#ipartner').val(),
                            ddocument: $('#ddocument').val(),
                            id_product_wip: $('#idproduct' + (a - 1)).val()
                        }
                        return query;
                    },
                    processResults: function(data) {
    ...
    //                         // cols += '<td><input class="form-control qty input-sm text-right inputitem" autocomplete="off" type="hidden" name="nqty" id="nqty'+z+'" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\' value="0" onkeyup="angkahungkul(this);"></td>';
    //                         cols += '<td></td>';
    //                         cols += '<td><input class="form-control qty input-sm text-right inputqty_'+idproduct+' material_'+idproduct+'_'+x+'" data-noqty="'+x+'"  autocomplete="off" type="text" id="npenyusun'+x+'" name="npenyusun[]" value="0" onkeyup="angkahungkul(this); kalikan();"></td>';
    //                         cols += '<td><input class="form-control qty input-sm text-right inputitem sisa_'+idproduct+'_'+x+'" autocomplete="off" type="text" id="nqtysisa'+x+'" name="nqtysisa[]" value="0" onkeyup="angkahungkul(this);"></td>';
