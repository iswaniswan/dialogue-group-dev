            ...
            <div class="panel-body table-responsive">
                ...
                <div id="pesan"></div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id= "dsj "name="dsj" class="form-control date" value="<?php echo$data->d_sj;?>"  readonly>
                         </div>
                        <div class="col-sm-6">
                    ...
                    <tbody>
                       <?$i = 0;
                        ...
                        <tr>
                            ...
                            <td class="col-sm-1">
                                <input style ="width:150px" class="form-control" type="text" id="edesc<?=$i;?>" name="edesc<?=$i;?>"value="<?= $row->e_remark; ?>" >
                            </td>
                            <td>
