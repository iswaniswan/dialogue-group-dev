...
<div class="col-sm-12">
    ...
    function view_detail(a, b) {
        lebar = 1366;
        tinggi = 768;
        eval('window.open("<?php echo site_url(); ?>"+"/listtargetcollection/cform/detail/"+a+"/"+b,"","width="+lebar+"px,height="+tinggi+"px,resizable=1,scrollbars=1,top=' +
    ...
    function view_sales(a, b) {
        ...
        eval('window.open("<?php echo site_url(); ?>"+"/listtargetcollection/cform/sales/"+a+"/"+b,"","width="+lebar+"px,height="+tinggi+"px,resizable=1,scrollbars=1,top=' +
            (screen.height - tinggi) / 2 + ',left=' + (screen.width - lebar) / 2 + '")');
    }
    ...
    function view_divisi(a, b) {
        ...
        tinggi = 768;
        periode = document.getElementById("iperiode").value;
        eval('window.open("<?php echo site_url(); ?>"+"/listtargetcollection/cform/divisi/"+a+"/"+b,"","width="+lebar+"px,height="+tinggi+"px,resizable=1,scrollbars=1,top=' +
            (screen.height - tinggi) / 2 + ',left=' + (screen.width - lebar) / 2 + '")');
    }
    </script>