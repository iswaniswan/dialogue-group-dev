        ...
        <table class="table color-bordered-table info-bordered-table display nowrap" id="sitabel" cellpadding="0"
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th style="font-size: 12px;text-align: center;vertical-align: middle;">Jatuh Tempo + Toleransi</th>
            ...
            if($group==''){
              echo "<tr><td colspan=9 align=center style='font-size: 15px;'>$row->e_product_groupname</td></tr>";
              ...
              echo "<tr>
                    <td colspan='6' style='font-size: 15px;'>Sub Total</td>
