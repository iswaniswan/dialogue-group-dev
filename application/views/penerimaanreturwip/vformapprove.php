            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-warning btn-block btn-sm mr-2" onclick="statuschange('<?= $folder."','".$data->id;?>','3','<?= $dfrom."','".$dto;?>');"> <i class="fa fa-pencil-square-o mr-2"></i>Change Requested</button>
                        </div>
                        <div class="col-sm-3">
                  ...
                  <?php
                    ...
                    <tr>   
                        ...
                        <td><?= $row->e_color_name; ?>
                            ...
                            <input type="hidden" class="form-control" id="ecolorname<?=$i;?>" name="ecolorname[]"value="<?= $row->e_color_name; ?>" readonly>
                        </td>                    
                        <td class="text-right"><?= $row->n_quantity_jahit; ?>
                            <input type="hidden" class="form-control" id="nquantityjht<?=$i;?>" name="nquantityjht[]" value="<?= $row->n_quantity_jahit; ?>" readonly> 
                            <input type="hidden" class="form-control" id="nquantitysisa<?=$i;?>" name="nquantitysisa[]" value="<?= $row->n_sisa; ?>"> 
                        </td>
                        <td class="text-right"><?= $row->n_quantity_masuk; ?>
                            <input type="hidden" class="form-control" id="nquantitymsk<?=$i;?>" name="nquantitymsk[]" value="<?= $row->n_quantity_masuk; ?>" onkeyup="validasi(<?=$i;?>);" readonly> 
                        </td>
                        <td><?=$row->e_remark;?>
