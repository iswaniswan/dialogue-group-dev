                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" name="idocument" id="imasukreturwip" readonly="" autocomplete="off" onkeyup="gede(this);" class="form-control input-sm" value="" aria-label="Text input with dropdown button">
        ...
        if(idreff) {
            $.ajax({
                ...
                var newRow = $("<tr>");
                    ...
                    cols += '<td><input readonly class="form-control input-sm text-right" type="text" id="nquantity'+a+'" name="nquantity[]" value="'+nquantity+'"><input readonly class="form-control input-sm text-right" type="hidden" id="nquantitysisa'+a+'" name="nquantitysisa[]" value="'+nquantitysisa+'"></td>';
