                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input type="text" name="idocument" id="idocument" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number;?>" maxlength="25" class="form-control input-sm" value="<?= $data->i_adjustment;?>" aria-label="Text input with dropdown button">
                    ...
                    if ($datadetail) {
                        foreach ($datadetail as $row) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" value="<?= $row->n_quantity;?>" id="nquantity<?=$i;?>" class="form-control text-right input-sm" autocomplete="off" name="nquantity[]" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="0" onkeyup="angkahungkul(this);">
                                </td>
                                <td>
            ...
            success: function (data) {
                ...
                if(!ada){
                    ...
                    for (let a = 0; a < data['detail'].length; a++) {
                        ...
                        var i_material      = data['detail'][a]['i_product_base'];
                        var e_material_name = data['detail'][a]['e_product_basename'];
