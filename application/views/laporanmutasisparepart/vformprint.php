                                ...
                                <table id="tabledata" class="table table-bordered" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center">Keluar Penempatan</th>
                                    ...
                                    <tbody>
                                        ...
                                        <td style="font-size: 11px; padding: 2px 7px;vertical-align: middle;" class="text-center"><?= $row->m_keluar; ?></td>
