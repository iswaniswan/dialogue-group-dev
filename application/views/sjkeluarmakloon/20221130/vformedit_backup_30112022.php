            ...
            <table id="tabledatalistx" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" style="width: 30%;">Barang WIP</th>
                        <th class="text-center" style="width: 30%;">Barang Material</th>
                        ...
                        foreach ($datadetail as $key) {
                            ...
                            if ($group == "") { ?>
                                <tr class="table-warning xx<?= $z; ?>">
                                    ...
                                    <td>
                                        <select data-xx="<?= $z; ?>" id="id_wip<?= $z; ?>" class="form-control input-sm" name="id_wip<?= $z; ?>">
                                            <option value="<?= $key->id_product_wip; ?>"><?= '[' . $key->i_product_wip, '] - ' . $key->e_product_wipname; ?></option>
                                        </select>
                                    </td>
                                    <td>
                                    ...
                                    <td><input type="hidden" class="form-control input-sm" name="eremark<?= $z; ?>" id="eremark<?= $z; ?>" placeholder="Isi keterangan jika ada!" /><input type="hidden" id="jmldetail<?= $z; ?>" value=""></td>
                                ...
                                <tr class="tr table-info del<?= $z; ?>" id="tr<?= $z; ?>">
                                    ...
                                    <td colspan="6" class="font"><b>LIST BARANG MATERIAL</b></td>
                                </tr>
                                <?php
                            } else {
                                if ($group != $key->id_material) { ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#addrowlist").on("click", function() {
            ...
            var newRow1 = $('<tr class="tr table-info del' + iter + '" id="tr' + iter + '"><td class="text-center"><a href="#" onclick="toge(' + iter + '); return false;" class="toggler' + iter + '" data-icon-name="fa-eye" data-prod-cat="eye_' + iter + '"><i class="fa fa-eye fa-lg text-success"></i></a></td><td colspan="6" class="font"><b>LIST BARANG MATERIAL</b></td></tr>');
            ...
            $("#addlist" + iter).on("click", function() {
                ...
                col += `<td colspan="2"><select data-urutan="${u}${nox}" id="idmateriallist${u}${nox}" class="form-control input-sm" name="idmateriallist[]"></select><input type="hidden" id="idmaterialhead${u}${nox}" name="idmaterialhead[]"></td>`;
