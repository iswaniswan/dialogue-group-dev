            ...
            <div class="col-md-6">
                <div id="pesan"></div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="isuppliergroup" name="isuppliergroup" class="form-control" autocomplete="off" required="" maxlength="15" onkeyup="gede(this);clearcode(this);" value="">
                            <span id="cek" hidden="true"> 
                                    <font size="3" face="Courier New" color="red">Kode Sudah Ada!</font> 
                            </span>
                        </div>
                         <div class="col-sm-8">
                            <input type="text" name="isuppliergroupname" class="form-control" maxlength="30" onkeyup="gede(this);clearname(this);" required="" value="" >
                        </div>
                    </div>          
