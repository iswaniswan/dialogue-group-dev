                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" name="idocument" id="ireturjahit" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number;?>" maxlength="15" class="form-control input-sm" value="" aria-label="Text input with dropdown button">
...
<script>
    ...
    $('#ceklis').click(function(event) {
        if($('#ceklis').is(':checked')){
            $("#ireturjahit").attr("readonly", false);
        }else{
            $("#ireturjahit").attr("readonly", true);
            $("#ada").attr("hidden", true);
            number();
        }
    });
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (let x = data['detail'].length; x > 0 ; x--) {
                            ...
                            cols += '<td><input type="hidden" name="idproductwip[]" id="idproductwip'+x+'" value="'+data['detail'][xx]['id_product_wip']+'">';
                            cols += '<input type="hidden" class="idmaterial" name="idmaterial[]" id="idmaterial'+x+'" value="'+data['detail'][xx]['id_material']+'">';
