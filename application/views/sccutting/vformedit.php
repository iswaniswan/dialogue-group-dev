                        ...
                        foreach ($datadetail as $key) {
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-1 text-center">
                                    <input readonly value="<?= formatdmY($key->d_schedule); ?>" type="text" class="form-control tgl input-sm" name="d_schedule<?= $i; ?>" id="d_schedule<?= $i; ?>" />
                                </td>
                                <td class="col-1 text-center">
                                    <input value="<?= $key->jam; ?>" type="time" id="input-pickuptime" min="00:00" max="23:59" required class="form-control input-sm" name="jam<?= $i; ?>" id="jam<?= $i; ?>" />
                                </td>
