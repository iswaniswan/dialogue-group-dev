                        ...
                        ?>
                            <?php if ($group == "") { ?>
                                <tr id="tr<?= $z; ?>">
                                    ...
                                    <td>
                                        <input readonly data-nourut="<?= $z; ?>" id="iproduct<?= $z; ?>" type="text" class="form-control input-sm" name="iproduct<?= $z; ?>" value="<?= $key->i_product_wip; ?>">
                                    </td>
                                    <td>
                                        <input readonly data-ngurut="<?= $z; ?>" id="e_product_wipname<?= $z; ?>" type="text" class="form-control input-sm" name="e_product_wipname<?= $z; ?>" value="<?= $key->e_product_wipname . ' - ' . $key->e_color_name; ?>">
                                    ...
                                    <td hidden>
                                        <input eadonly class="form-control qty input-sm text-right" autocomplete="off" type="text" name="nquantitywipsisa<?= $z; ?>" id="nquantitywipsisa<?= $z; ?>" value="<?= $key->n_quantity_wip_sisa; ?>" readonly>
                                    </td>
                                    <td>
                                    ...
                                    <td><input class="form-control qty input-sm text-right" autocomplete="off" type="text" id="nquantitybs<?= $z; ?>" name="nquantitybs<?= $z; ?>" onblur="if(this.value=='' ){this.value='0' ;}" onfocus="if(this.value=='0' ){this.value='' ;}" value="<?= $key->qty_bs; ?>" onkeyup="validasi(<?= $z; ?>);"></td>
                                    <td><input class="form-control input-sm" placeholder="Keterangan jika ada" type="text" value="<?= $key->e_remark; ?>" onkeyup="set_text('<?= $key->i_product_wip; ?>',this.value);" id="remark<?= $z; ?>" name="remark<?= $z; ?>"></td>
                                    <td class="text-center"><input type="checkbox" checked id="check<?= $z; ?>" name="check<?= $z; ?>"></td>
                                    <!-- <td class="text-center"><?= $no; ?></td>
                                    <td>
                                        <input readonly data-nourut="<?= $z; ?>" id="iproduct<?= $z; ?>" type="text" class="form-control input-sm" name="iproduct<?= $z; ?>" value="<?= $key->i_product_wip; ?>">
                                    </td>
                                    ...
                                    <td><input class="form-control qty input-sm text-right" autocomplete="off" type="text" id="nquantitybs<?= $z; ?>" name="nquantitybs<?= $z; ?>" onblur="if(this.value=='' ){this.value='0' ;}" onfocus="if(this.value=='0' ){this.value='' ;}" value="<?= $key->qty_bs; ?>" onkeyup="validasi(<?= $z; ?>);"></td>
                                    <td><input class="form-control input-sm" placeholder="Keterangan jika ada" type="text" onkeyup="set_text('<?= $key->i_product_wip; ?>',this.value);" id="remark<?= $z; ?>" name="remark<?= $z; ?>"></td>
                                    <td class="text-center"><input type="checkbox" checked id="check<?= $z; ?>" name="check<?= $z; ?>"></td> -->
                                </tr>
                                <?php } else {
                                if ($group != $key->id_product_wip) { ?>
                            ...
                            <tr class="del<?= $i; ?>" hidden>
                                <td class="text-center"><?= $no; ?></td>
                                <td>
                                    <input type="hidden" name="id_referensi_item[]" id="id_referensi_item<?= $i; ?>" value="<?= $key->id_referensi_item; ?>">';
                                ...
                                <td colspan="2">
                                    <input type="text" class="form-control <?= $key->i_product_wip; ?> input-sm" name="edesc[]" id="edesc<?= $i; ?>" value="<?= $key->e_remark; ?>" placeholder="Isi keterangan jika ada!">
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
