            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="hidden" name="iperiodeawal" id="iperiodeawal" value="<?= $iperiodeawal; ?>">
                            <input type="hidden" name="iperiodeakhir" id="iperiodeakhir" value="<?= $iperiodeakhir; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" readonly id="dkb" name="dkb" class="form-control" value="<?= $tanggal;?>">
                        </div>
                    </div>
                    <div class="form-group row">
...
<script>
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><input id="vkb'+xx+'" class="form-control" name="vkb'+xx+'" onkeypress="return hanyaAngka(event);" onkeyup="reformat(this);"></td>';
    ...
    function cektanggal(){
        ...
        for(i=1;i<=jmls;i++){
            ...
            dkk=document.getElementById('dkb').value;
            dtmp=dbukti.split('-');
            thnbk=dtmp[2];
            blnbk=dtmp[1];
            hrbk =dtmp[0];
