            ...
            <div class="panel-body table-responsive">
                <table class="display nowrap" cellspacing="0" width="100%" id="tabledata" cellpadding="0">
                    ...
                    <tfoot>
                        ...
                        <!-- <th></th> -->
                        <th>Rp. <?= number_format($total->nota);?></th>
                        <th>Rp. <?= number_format($total->bersih);?></th>
                    </tfoot>
                </table>
                <br>
        ...
        var table = $('#tabledata').DataTable({
            ...
            "drawCallback": function ( settings ) {
                ...
                api.column(3, {page:'current'} ).data().each( function ( group, i ) {
                    ...
                    var netto  = vals[6] ? parseFloat(formatulang(vals[6])) : 0;
                ...
                for(var office in aData){
                    ...
                    $(rows).eq( idx ).after(
                        '<tr class="group">'+
                        '<td colspan="4" style="text-align: center;"><b>TOTAL '+office+' per pages</b></td>'+
                        '<td style="text-align: right"><b>Rp. '+formatcemua(sum)+'</b></td>'+
