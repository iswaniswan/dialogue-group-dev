            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                        ...
                        <div class="col-sm-12">
                            <select name="iproductstatus" class="form-control select2">
                                <?php foreach ($productstatus as $iproductstatus):?>
                                    <option value="<?php echo $iproductstatus->i_product_status;?>" <?php if ($iproductstatus->i_product_status=='2') { echo "selected";}?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <select name="iproductcategory" id="iproductcategory" class="form-control select2" required="">
                                <option value=""></option>
