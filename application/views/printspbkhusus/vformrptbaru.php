...
<!--    <td width="194" class="huruf nmper">Rp <?php echo number_format($row->v_saldo); ?></td>-->
    <td width="194" class="huruf nmper">Rp <?php echo number_format($saldopiutang); ?></td>
    <td width="185">&nbsp;</td>
...
and c.i_alokasi like '%$thnota%' and c.i_customer='$row->i_customer' group by d.v_nota_netto, d.i_nota, c.i_alokasi, c.d_alokasi, d.d_nota) as a
