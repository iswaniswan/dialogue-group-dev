            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" required="" placeholder="Pilih Tanggal" readonly id= "dalokasi" name="dalokasi" class="form-control date" value="<?= date('d-m-Y');?>">
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <label class="col-md-12">No DT</label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-offset-5 col-sm-12">
                            ...
                            <button type="button" id="addrow" class="btn btn-info btn-rounded btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Detail</button>&nbsp;&nbsp;                                
