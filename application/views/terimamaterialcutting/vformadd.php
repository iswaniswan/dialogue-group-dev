            ...
            <table id="sitabel" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                <thead>
                    <tr>
                        ...
                        <th>Keterangan</th>
                        <th class="text-center" width="3%"><input class="form-control input-sm" type="checkbox" id="cekall"></th>
                    </tr>
                </thead>
                <tbody id="formclose">
                </tbody>
...
<script>
                ...
                success: function(data) {
                    if (data['detail'] != null) {
                        ...
                        for (let x = 0; x < data['detail'].length; x++) {
                            ...
                            // cols += '<td><input readonly class="form-control input-sm" type="text" id="e_color_name' + x + '" name="e_color_name' + x + '" value="' + data['detail'][x]['e_color_name'] + '"></td>';
                            ...
                            cols += '<td><input type="checkbox" class="form-control input-sm" name="check' + x + '" id="check' + x + '"></td>';
                            newRow.append(cols);
    ...
    function ngetang(i) {
        ...
        $('#n_quantity_gelar' + i).val( (parseFloat($('#n_quantity' + i).val())/parseFloat($('#v_gelar' + i).val())).toFixed(0) );
    }
