            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" id="dbtb" name="dbtb" class="form-control date" required="" value="<?= date("d-m-Y",strtotime($data->d_btb)); ?>" readonly>
                        </div>
                        <div class="col-sm-4">
                   ...
                   <!--  <div class="form-group">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-md-4">Tanggal Dok Supp</label>
                         <div class="col-sm-8">
                            <input id="isj" name="isj" class="form-control" required="" value = "<?= $data->i_sj; ?>" readonly>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" id="eremark" name="eremark" class="form-control" required="" value = "<?= $data->e_remark; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <?if($data->e_approval =='1'){?>
                    ...
                    <!-- <input type="hidden" name="jml" id="jml"> -->
                            ...
                            $grandtotop=0;
                                    $i = 0;
                                        ...
                                        <td class="col-sm-1">
                                            <input style ="width:150px"type="text" id="nquantityeks<?=$i;?>" name="nquantityeks<?=$i;?>" value="<?=$row->n_qty_eks;?>" class="form-control">
                                        </td>
                                        <td class="col-sm-1">
                                            <input style="width:100px;" type="hidden" id="isatuaneks<?=$i;?>" class="form-control" name="isatuaneks<?=$i;?>" value="<?=$row->i_satuan_eks;?>" readonly>
                                            <input style="width:150px;" type="text" id="esatuaneks<?=$i;?>" class="form-control" name="esatuaneks<?=$i;?>" value="<?=$row->satuaneks;?>" readonly>
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:150px" class="form-control" type="text" id="nquantity<?=$i;?>" name="nquantity<?=$i;?>"value="<?= $row->n_qty; ?>"onkeyup= hitungnilai(this.value);>
                                        </td>
                                        <td class="col-sm-1">
                                            <input style ="width:150px" class="form-control" type="text" id="esatuan<?=$i;?>" name="esatuan<?=$i;?>"value="<?= $row->e_satuan; ?>" readonly >
