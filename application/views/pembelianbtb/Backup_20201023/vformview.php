             ...
             <div id="pesan"></div>
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input id="ibtb" name="ibtb" class="form-control form-control-sm" required="" value = "<?= $data->i_btb; ?>" readonly>
                        </div>
                        <div class="col-sm-3">
                            <input type="text" id="dbtb" name="dbtb" class="form-control form-control-sm date" required="" value="<?= $data->d_btb; ?>" readonly>
                        </div>
                        <div class="col-sm-4">
                            <input id="ipp" name="ipp" class="form-control form-control-sm" required="" value = "<?= $data->i_pp; ?>" readonly>
                        </div>
                    </div>
                    ...
                    <!-- <input type="hidden" name="jml" id="jml"> -->
                            ...
                            $grandtotop=0;
                                    $i = 0;
                                        ...
                                        <td class="col-sm-1">
                                            <input style ="width:80px" class="form-control" type="text" id="nquantity<?=$i;?>" name="nquantity<?=$i;?>"value="<?= $row->n_qty; ?>"onkeyup= hitungnilai(this.value); readonly>
                                        </td>
                                        <td class="col-sm-1">
