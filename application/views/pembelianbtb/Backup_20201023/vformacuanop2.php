            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-7">
                    <div class="form-group row">
                        ...
                        <label class="col-md-5">No PP</label>
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="igudang" id="igudang" class="form-control select2" onchange="getcode();">
                            ...
                            <input type="hidden" id="idepart" name="idepart" value="<?= $igudang->i_departemen; ?>" readonly >
                        </div>
                    </div>                    
                </div>              
                    <div class="panel-body table-responsive">
                       <table id="tabledata" class="table color-table success-table table-bordered" cellspacing="0" width="100%">
                            ...
                            ?>
                                ...
                                <td class="col-sm-1">
                                    <input style ="width:150px"type="text" id="nquantityeks<?=$i;?>" name="nquantityeks<?=$i;?>"value="" class="form-control">
                                </td>
                                <td class="col-sm-1">
                                    <select style="width:150px;" type="text" id="isatuaneks<?=$i;?>" class="form-control select2" name="isatuaneks<?=$i;?>" >
                                    </select>
                                </td>
                                <td class="col-sm-1">
                                    <input style ="width:150px"type="text" id="nquantity<?=$i;?>" name="nquantity<?=$i;?>"value="<?= $row->n_pemenuhan; ?>" class="form-control" onkeyup=valstock(this.value);>
                                ...
                                <td class="col-sm-1">
                                    <input style ="width:150px" type="text" id="esatuan<?=$i;?>" name="esatuan<?=$i;?>"value="<?= $row->e_satuan; ?>" class="form-control" readonly >
...
<script>
    ...
    function getcode(){
         ...
         $.ajax({
           ...
           url: '<?= base_url($folder.'/cform/getcode'); ?>',
           dataType: "json",
           success: function (data) {
               $('#idepart').val(data[0].i_departemen);
           },
           error: function () {
               alert('Error :)');
           }
