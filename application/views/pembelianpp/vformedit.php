                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="hidden" name="ippold" id="ippold" value="<?= $data->i_pp;?>">
                                <input type="hidden" name="budgeting" id="budgeting" value="<?= $data->f_budgeting;?>">
                                <input type="text" name="ipp" id="ipp" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number;?>" maxlength="15" class="form-control input-sm" value="<?= $data->i_pp;?>" aria-label="Text input with dropdown button">
                ...
                <tbody>
                    ...
                    if ($detail) {
                        foreach ($detail as $row) {
                            ...
                            $readonly = ' readonly ';
                            if($data->f_budgeting == 'f') {$readonly = '';}
                            ?>
                            <tr>
                                ...
                                <!-- <td>
                                    <select id="imaterial<?=$i;?>" class="form-control input-sm" name="imaterial[]" onchange="getmaterial(<?=$i;?>);">
                                        <option value="<?= $row->i_material;?>"><?= $row->i_material." - ".$row->e_material_name;?></option>
                                    </select>
                                </td> -->
                                <td><input type="text" id="i_material<?=$i;?>" class="form-control input-sm" name="imaterial[]" readonly value="<?= $row->i_material;?>"></td>
                                <td><input type="text" id="e_material_name<?=$i;?>" class="form-control input-sm" name="e_material_name[]" readonly value="<?= $row->e_material_name;?>"></td>
                                <td>
                                ...
                                <td>
                                    <input type="text" readonly="" value="<?= $row->n_quantity;?>" id="nquantity<?=$i;?>" class="form-control text-right inputitem input-sm" autocomplete="off" name="nquantity[]" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" value="0" onkeyup="angkahungkul(this);">
                                </td>
                               <!--  <td><select data-urut="<?=$i;?>" id="isupplier<?=$i;?>" class="form-control select2 input-sm" name="isupplier[]"><option value="<?= $row->id_supplier;?>"><?= $row->i_supplier. " - " . $row->e_supplier_name; ?></option></select></td>
                                <td><input type="text" readonly id="harga_sup<?=$i;?>" class="form-control text-right input-sm" autocomplete="off" name="harga_sup[]" value="<?= $row->v_price;?>"></td> -->
                                <td hidden><input type="text" <?= $readonly ?>id="harga_adj<?=$i;?>" class="form-control text-right input-sm" autocomplete="off" name="harga_adj[]" onblur='if(this.value==""){this.value="0";}' onfocus='if(this.value=="0"){this.value="";}' value="<?= $row->v_price_adj;?>" onkeyup="angkahungkul(this);"></td>
                                <td>
                                    <input type="text" id="eremark<?=$i;?>" class="form-control input-sm" value="<?= $row->e_remark;?>" name="eremark[]"/>
                                    <input type="hidden" value="<?= $row->i_kode_kelompok;?>" id="ikode<?=$i;?>" name="ikode[]"/>
                                </td>
                                <!-- <td>
