        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <i class="fa fa-lg fa-pencil mr-2"></i> &nbsp; <?= $title; ?> <a href="#" onclick="show('<?= $folder; ?>/cform/index/<?= $dfrom . "/" . $dto; ?>','#main'); return false;" class="btn btn-info btn-sm pull-right"><i class="fa fa-list"></i></i>&nbsp;
                        <?= $title_list; ?></a>
                </div>
                                ...
                                <select name="ibagian" id="ibagian" class="form-control select2" required="">
                                    <?php /* if ($bagian) {
                                        foreach ($bagian as $row) : */ ?>
                                            <option value="<?= $data->i_bagian."|".$data->id_company_bagian ?>" selected>
                                                <?= $data->e_bagian_name; ?>
                                            </option>
                                    <?php /* endforeach;
                                    } */ ?>
                        ...
                        <thead>
                            ...
                            if ($datadetail) {
                                foreach ($datadetail as $key) {
                                    ...
                                    $n_quantity_urai += $key->n_quantity;
                                }
                            } ?>
                            <tr>
                                ...
                                <th class="text-right"><span class="n_fc_jahit_urai text-right"><?= number_format($n_quantity_urai);?></span></th>
                                <th></th>
                            </tr>
                            <tr>
                            ...
                            foreach ($datadetail as $key) {
                                if ($group == "") { ?>
                                    <tr class="table-active">
                                        <td class="text-center"><a href="#" class="toggler" data-icon-name="fa-eye-slash" data-prod-cat="<?= $key->grup; ?>"><i class="fa fa-eye-slash fa-lg text-success"></i></a></td>
                                ...
                                <tr class="<?= $key->grup; ?>" style="display:none">
                                    ...
                                    <td>
                                        <input class="form-control input-sm text-right" type="number" id="n_uraian_jahit<?= $i; ?>" name="n_uraian_jahit<?= $i; ?>" placeholder="0" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" onkeyup="cekvalidasi(<?= $i; ?>);" onkeypress="return event.charCode >= 48 && event.charCode <= 57;" value="<?= $key->n_quantity; ?>">
                                        <input type="hidden" value="<?= count($datadetail) ?>" id="jmlrow">
                                    </td>
                                    <td>
                    ...
                    if (data['detail'].length > 0) {
                        ...
                        for (let i = 0; i < data['detail'].length; i++) {
                            ...
                            cols += `<tr class="${data['detail'][i]['grup']}" style="display:none">
                                    ...
                                    <td>
                                        <input class="form-control input-sm text-right" type="number" id="n_uraian_jahit${i}" name="n_uraian_jahit${i}" placeholder="0" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" onkeyup="cekvalidasi(${i});" onkeypress="return event.charCode >= 48 && event.charCode <= 57;" value="${data['detail'][i]['n_quantity_sisa']}">
