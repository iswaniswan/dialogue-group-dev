        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <i class="fa fa-eye fa-lg mr-3"></i><?= $title; ?> <a href="#" onclick="show('<?= $folder; ?>/cform/index/<?= $dfrom . "/" . $dto; ?>','#main'); return false;" class="btn btn-info btn-sm pull-right"><i class="fa fa-list"></i></i>&nbsp;
                        <?= $title_list; ?></a>
                </div>
                    ...
                    <table id="tabledatay" class="table color-table table-bordered inverse-table" cellpadding="8" cellspacing="1" width="100%">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="text-right"><span class="n_fc_jahit_urai text-right"><?= number_format($n_quantity_urai); ?></th>
                                <th></th>
                            </tr>
                            <tr>
