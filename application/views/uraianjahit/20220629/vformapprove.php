                    ...
                    <table id="tabledatay" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th class="text-right">Eksternal</th>
                                <th>Keterangan</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            foreach ($datadetail as $key) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" id="idproduct<?= $i; ?>" name="idproduct<?= $i; ?>" value="<?= $key->id_product_wip; ?>"><?= $key->i_product_wip; ?>
                                    </td>
                                    <td>
                                        <?= $key->e_product_name; ?>
                                    </td>
                                    ...
                                    <td class="text-right">
                                        <?= $key->n_quantity_internal; ?>
                                    </td>
                                    <td class="text-right">
                                        <?= $key->n_quantity_eksternal; ?>
                                    </td>
                                    <td>
                                        <?= $key->e_remark; ?>
                                    </td>
