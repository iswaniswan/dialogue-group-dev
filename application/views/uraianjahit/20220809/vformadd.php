                    ...
                    if (data['detail'].length > 0) {
                        ...
                        for (let i = 0; i < data['detail'].length; i++) {
                            ...
                            cols += `<tr class="${data['detail'][i]['grup']}" style="display:none">
                                    ...
                                    <td>
                                        <input class="form-control input-sm text-right" type="number" id="n_uraian_jahit${i}" name="n_uraian_jahit${i}" placeholder="0" onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}" onkeyup="cekvalidasi(${i});" value="0">
                                    </td>
                                    <td>
