    ...
    <div class="col-lg-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                onclick="show('<?= $folder; ?>/cform/index/<?= $dfrom.'/'.$dto.'/'.$status ;?>','#main'); return false;"
                class="btn btn-info btn-sm pull-right"><i class="fa fa-list"></i></i>&nbsp; <?= $title_list; ?></a>
            </div>
            <input type = "hidden" name = "dfrom" value = "<?= $dfrom ;?>" readonly>
            <input type = "hidden" name = "dto" value = "<?= $dto ;?>" readonly>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-12">
                            <button type="button" class="btn btn-inverse btn-rounded btn-sm" onclick='show("<?= $folder;?>/cform/index/<?= $dfrom."/".$dto."/".$status ;?>","#main")'><i class="fa fa-arrow-circle-left"></i>&nbsp;&nbsp;Kembali</button>
