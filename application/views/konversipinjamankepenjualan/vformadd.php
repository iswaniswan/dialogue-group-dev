            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-12">  
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" name="idocument" required="" id="ikpp" readonly="" autocomplete="off" onkeyup="gede(this);" placeholder="<?= $number;?>" maxlength="16" class="form-control input-sm" value="" aria-label="Text input with dropdown button">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="ireff[]" id="ireff" required="" multiple="multiple" class="form-control input-sm select2"></select>
                            <input type="hidden" id="dreff" readonly>
                        </div>
                        <div class="col-sm-6">
