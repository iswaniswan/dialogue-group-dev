...
<form id="cekinputan">
                ...
                <div class="panel-body table-responsive">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <input type="hidden" name="id" id="id" value="<?= $data->i_alokasimt ?>"/>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control input-sm" name="i_document" value="<?= $data->i_alokasimt_id ?>" readonly="" autocomplete="off">                                
                            </div>
                            <div class="col-md-3">
                                <input type="text" class="form-control input-sm date" name="d_alokasi" value="<?= date('d-m-Y', strtotime($data->d_alokasimt)) ?>">
                            </div>
                            <div class="col-md-3">
    ...
    <div class="white-box" id="detail">
        <div class="col-sm-6">
            <h3 class="box-title m-b-0">Detail Alokasi Meterai</h3>
        </div>
        <div class="col-sm-12">
                ...
                <table id="tabledatay" class="table color-table success-table table-bordered class" cellpadding="8" cellspacing="1" width="100%">
                    ...
                    <tbody>
                        <?php foreach ($datadetail as $item) { $i++; ?>
                            <tr id="tr<?= $i; ?>">
                                <input type="hidden" name="items[<?= $i ?>][id]" value="<?= $item->i_alokasimt_item ?>"/>
            ...
            success: function (data) {
                if(typeof data[0] != 'undefined'){
                    ...
                    if(!ada){
                        ...
                        $('#vnilai'+id).val(formatcemua(data[0].v_meterai_sisa));
                        if (parseInt(formatulang($('#vjumlahsisa').val())) > parseInt(formatulang(data[0].v_meterai_sisa))) {
                            $('#vbayar'+id).val(formatcemua(data[0].v_sisa));
                        }else if ((parseInt(formatulang($('#vjumlahsisa').val())) < parseInt(formatulang(data[0].v_meterai_sisa))) && (parseInt(formatulang($('#vjumlahsisa').val())) > 0)) {
