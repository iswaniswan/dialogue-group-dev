        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <i class="fa fa-eye fa-lg mr-2"></i><?= $title; ?> <a href="#" onclick="show('<?= $folder; ?>/cform/index/<?= $dfrom . "/" . $dto; ?>','#main'); return false;" class="btn btn-info btn-sm pull-right"><i class="fa fa-list fa-lg mr-2"></i><?= $title_list; ?> </a>
                </div>
                        ...
                        <tbody>
                            ...
                            foreach ($datadetail as $key) {
                                ...
                                <tr class="table-warning cat_eye_<?= $z; ?>">
                                    ...
                                    <td><?= htmlentities($key->e_material_name); ?></td>
