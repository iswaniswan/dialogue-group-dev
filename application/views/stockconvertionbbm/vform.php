        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label class="col-md-12">Area - No. BBM - Tanggal BBM</label>
                        <div class="col-sm-9">
...
<script>
    function getdetailbarang(kode) {
        var ibbm  = $('#irefference option:selected').text();
        var iarea = ibbm.substr(0,2);
        var dbbm  = ibbm.substr(-10);
        $("#iarea").val(iarea);
        $("#drefference").val(dbbm);
        if (kode!='') {
    ...
    $(document).ready(function () {
        ...
        showCalendar('.date');
        $('#irefference').select2({
            placeholder: 'Cari No. BBM',
            allowClear: true,
            ajax: {
                url: '<?= base_url($folder.'/cform/getbbm/'); ?>',
                dataType: 'json',
                delay: 250,
