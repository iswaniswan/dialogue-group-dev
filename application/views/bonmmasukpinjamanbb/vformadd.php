        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let a = 0; a < data['detail'].length; a++) {
                    ...
                    cols += '<td style="text-align: center"><input hidden class="form-control" readonly id="idmaterial'+no+'" name="idmaterial[]" value="'+data['detail'][a]['id_material']+'"><input class="form-control"  style="width:120px;" readonly id="imaterial'+no+'" name="imaterial'+no+'" value="'+data['detail'][a]['i_material']+'"></td>';
