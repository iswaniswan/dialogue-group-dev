            ...
            <div class="col-md-6">
                ...
                ?>                
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="ipajak" class="form-control" value="<?= $data->i_pajak;?>" >
                        </div>
                    </div>     
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="totdpp" id="totdpp" class="form-control" value="<?php echo number_format($data->v_dpp,2);?>" >
                        </div>
                    </div>  
                    <div class="form-group">
                        <label class="col-md-12">Jumlah PPN</label>
                        <div class="col-sm-12">
                            <input type="text" name="totppn" id="totppn" class="form-control" value="<?php echo number_format($data->v_ppn,2);?>" >
                        </div>
                    </div>   
                    <div class="form-group">
                        <label class="col-md-12">Jumlah Total</label>
                        <div class="col-sm-12">
                            <input type="text" name="totakhir" id="totakhir" class="form-control" value="<?php echo number_format($data->v_total,2);?>" >
                        </div>
                    </div>  
                </div>
                    <div class="form-group">
