            ...
            <div class="panel-body table-responsive">
                <div id="pesan"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="ipricegroup" class="form-control" required="" maxlength="30" onkeyup="gede(this)" value="<?= $data->i_price_group; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Nama Barang</label>
                        <div class="col-sm-12">
                            <input type="text" name="eproductname" class="form-control" maxlength="30" onkeyup="gede(this)" value="<?= $data->e_product_name; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
