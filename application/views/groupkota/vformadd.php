            ...
            <div class="panel-body table-responsive">
                ...
                <div id="pesan"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="icitygroup" class="form-control" required="" maxlength="4" onkeyup="gede(this)">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Nama Grup Kota</label>
                        <div class="col-sm-12">
                            <input type="text" name="ecitygroupname" class="form-control" required="" maxlength="50" onkeyup="gede(this)">
                        </div>
                    </div>
                    <div class="form-group">
