            ...
            <div class="panel-body table-responsive">
                ...
                <div class="form-group row">
                    <div class="col-sm-offset-5 col-sm-8">
                        <?php if(($isi->i_store =='') && ($departement == '3') && ($isi->i_approve1=='') && ($isi->i_approve2=='') && ($isi->f_spb_rekap!='t') && ($isi->f_spb_cancel!='t') && check_role($i_menu, 3)){ ?>
                        ...
                        <?php if(($isi->i_store =='') && ($departement == '3') && ($isi->i_approve1=='') && ($isi->i_approve2=='') && ($isi->f_spb_cancel!='t')&& check_role($i_menu, 3)){ ?>
                            &nbsp;&nbsp;
