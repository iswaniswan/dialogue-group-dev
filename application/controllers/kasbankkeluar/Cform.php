...
class Cform extends CI_Controller {
    ...
    function getcoa(){
        ...
        $this->db->select("*");
        $this->db->from("tr_coa a");
        //$this->db->where("UPPER(a.i_coa)", $icoa);
        $this->db->where("a.i_coa", $icoa);
        $data = $this->db->get();
    ...
    public function simpan(){
        ...
        $ikode = '';
        $fdebet='t';
        if ($iperiode != '' &&  $iarea != '' && $ibank != '' && $dbank != '' &&  $jml != '0'){
            $this->db->trans_begin();
            $tot  = 0;
            ...
            for ($a=1;$a<=$jml;$a++) {
                ...
                $this->mmaster->insert($iareax,$ikode,$iperiode,$icoa,$vbank,$ecoaname,$edescription,$fdebet,$icoabank, $dbank);
                ...
                $this->mmaster->inserttransitemdebet($accdebet,$ikode,$namadebet, $iareax,$eremark,$vbank,$dbank,$icoabank);
                $this->mmaster->updatesaldodebet($accdebet,$iperiode,$vbank);
                $this->mmaster->inserttransitemkredit($acckredit,$ikode,$namakredit,$iareax,$eremark,$vbank,$dbank,$icoabank);
                $this->mmaster->updatesaldokredit($acckredit,$iperiode,$vbank);
                $this->mmaster->insertgldebet($accdebet,$ikode,$namadebet,$iareax,$vbank,$dbank,$eremark,$icoabank);
                $this->mmaster->insertglkredit($acckredit,$ikode,$namakredit,$iareax,$vbank,$dbank,$eremark,$icoabank);
