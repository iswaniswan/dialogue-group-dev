...
class Cform extends CI_Controller {
    ...
    public function simpan()
    {
        ...
        $this->db->trans_begin();            
        $this->mmaster->insert_alokasimt($i_document, $i_rv, $i_rv_item, $d_document, $e_bank_name, $v_jumlah, $v_lebih,
        ...
        foreach ($items as $item) {
            ...
            $this->mmaster->insert_alokasimt_item($insert_id, $i_alokasi_item=null, $i_rv_item, $id_nota, $d_nota, 
    ...
    public function update()
    {
        ...
        foreach ($items as $item) {
            $id = $item['id'];
            $e_remark = $item['eremark'];
            $this->mmaster->update_alokasimt_item($id, $e_remark);
        }
