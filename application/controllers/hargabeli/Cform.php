...
class Cform extends CI_Controller {
    ...
    public function tambah(){
        ...
        $data['iproductgrade'] = $this->mmaster->bacagrade();
    ...
    public function simpan(){
        ...
        $product            = explode(' - ',$this->input->post('iproduct',true));
        $iproduct           = strtoupper($product[0]);
        $eproductname       = strtoupper($product[1]);
