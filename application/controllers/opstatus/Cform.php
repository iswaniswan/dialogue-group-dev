...
class Cform extends CI_Controller {
    ...
    public function simpan(){
        ...
        if ($iopstatus != '' && $eopstatusname != ''){
                $cekada = $this->mmaster->cek_data($iopstatus);
                if($cekada->num_rows() > 0){
                    ...
                    if ($this->db->trans_status() === FALSE){
                        ...
                        $this->Logger->write('Simpan Data '.$this->global['title'].' Kode : '.$iopstatus);
                        $data = array(
                            'sukses'    => true,
                            'kode'      => $iopstatus
                        );
        ...
        if ($iopstatus != '' && $eopstatusname != ''){
            ...
            if($cekada->num_rows() > 0){ 
                ...
                if ($this->db->trans_status() === FALSE){
                    ...
                    $this->db->trans_commit();
                    $this->Logger->write('Update Data '.$this->global['title'].' Kode : '.$iopstatus);
    ...
    public function view(){
        ...
        $data = array(
            ...
            'title_list' => 'List '.$this->global['title'],
            'data' => $this->mmaster->cek_data($iopstatus)->row()
        );
