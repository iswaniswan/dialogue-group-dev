...
class Cform extends CI_Controller {
        ...
        if ($idocument!='' && $jml>0) {
            ...
            for ($i = 1; $i <= $jml; $i++) {
                ...
                if ($nquantity > 0 && $nquantity != null) {
                    $this->mmaster->simpandetail($id, $id_document_reff, $id_product, $nquantity, $eremark);
                }
    ...
    public function edit() {
        ...
        $data = array(
            ...
            'referensi'     => $this->mmaster->datareferensi($this->uri->segment(4))->result(),
            'number'        => "SJ-".date('ym')."-000001",
        );
    ...
    public function update(){
        ...
        if ($idocument!='' && $jml>0) {
            $this->db->trans_begin();
            $this->mmaster->update($id, $idocument, $ddocument, $ibagian, $ipartner, $idocumentsup,$eremarkh);
    ...
    public function approve(){
        ...
        if ($idocument!='' && $jml>0) {
            ...
            for ($i =1; $i <= $jml; $i++) {
                ...
                $this->mmaster->updatekeluar($id_document_reff, $id_product, $nquantity);
