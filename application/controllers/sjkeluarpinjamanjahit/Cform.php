...
class Cform extends CI_Controller {
    ...
    public function detailproduct() {
        ...
        $data = $this->mmaster->detailproduct($this->input->post('id'));
    ...
    public function simpan(){
        ...
        $n_quantity     = str_replace(',','',$n_quantity);
        ...
        if ($idocument!='' && $ddocument!='' && $ibagian != '' && $jml>0) {
            ...
            foreach ($id_product as $idproduct) {
                ...
                $edesc       = $e_desc[$no];
                if($nquantity > 0 && $nquantity != null && $nquantity != ''){
                    $this->mmaster->insertdetail($id, $idproduct, $nquantity, $edesc); 
                }
                $no++;
            }
            //die();
