...
class Cform extends CI_Controller {
    ...
    public function data(){
        ...
        $area           = $this->mmaster->bacaareauser($username,$idcompany);
        $iperiode       = $this->mmaster->cekperiode();
        echo $this->mmaster->data($dfrom,$dto,$iarea,$cekdepartemen,$area,$iperiode,$this->global['folder']);
    }
