...
class Cform extends CI_Controller {
    ...
    public function view(){
        ...
        $data = array(
            ...
            'dfrom'     => $dfrom,
            'dto'       => $dto,
            'nilai'     => $this->mmaster->getnilai($dfrom, $dto)->row()
        );
    ...
    public function detail(){
        $isales = $this->uri->segment(4);
        $esales = $this->uri->segment(5);
    ...
    public function rinci(){
        $dfrom      = $this->uri->segment(4);
        $dto        = $this->uri->segment(5);
        $isales     = $this->uri->segment(6);
        echo $this->mmaster->getdetail($dfrom, $dto, $isales);
    }
}
