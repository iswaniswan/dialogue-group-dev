...
class Cform extends CI_Controller {
    ...
    public function simpan()
    {
        ...
        if ($idocument!='' && $ddocument!='' && $ibagian != '' && $jml>0) {
            ...
            $i_grade_awal   = $this->input->post('i_grade_awal[]', true);
            $i_grade_akhir  = $this->input->post('i_grade_akhir[]', true);
            ...
            foreach ($i_material as $imaterial) {
                ...
                $igradeawal = $i_grade_awal[$no];
                $igradeakhir= $i_grade_akhir[$no];
                $eremark    = $e_remark[$no];
                if (($imaterial != '' || $imaterial != null)) {
                    $this->mmaster->simpandetail($id,$imaterial,$nquantity, $igradeawal, $igradeakhir, $eremark);
                }
                $no++;
            }
            //die();
