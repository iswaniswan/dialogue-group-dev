...
class Cform extends CI_Controller {
    ...
    public function data(){
        $dfrom   = $this->uri->segment(4);
		echo $this->mmaster->data($dfrom, $this->i_menu);
    }
    ...
    public function getmaterial(){
            ...
            if($query->num_rows()>0) {
                ...
                $spb = $query->result();
                foreach($spb as $row) {
                    $c.="<option value=".$row->i_kodebrg." >".$row->i_kodebrg." - ".$row->e_namabrg."</option>";
                }
    ...
    public function delete()
    {
        ...
        if ($this->db->trans_status() === false) {
            ...
            $this->Logger->write('Cancel Harga Makloon by Supplier Embosh ' . $kodebrg);
