 ...
 */
        ...
        $this->mmaster->insertheader($id, $dok_rrkh, $ibagian, $drrkh, $kode_area, $kode_salesman);  
    //    $waktu_xx = '22-01-2022';
    ...
    // var_dump($_POST);
        ...
        for($i=1;$i<=$jml;$i++){   
            ...
            $this->mmaster->insertdetail($id, $id_customer, $waktu, $id_rencana, $real, $bukti, $eremark);
            // $i++;
        }     
