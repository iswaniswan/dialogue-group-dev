...
class Cform extends CI_Controller
{
    ...
    public function export_excel()
    {
        ...
        $query = $this->mmaster->edititembase($id);
        ...
        if ($query->num_rows()>0) {
            ...
            $spreadsheet->setActiveSheetIndex(0)
                ...
                ->setCellValue('G2', 'FC Produksi Yang Dibudgetkan')
                ->setCellValue('H2', 'Stock Pengesetan')
                ->setCellValue('I2', 'Permintaan Cutting')
                ->setCellValue('J2', 'Memo Penambahan')
                ->setCellValue('K2', 'FC Cutting')
            ...
            $spreadsheet->getActiveSheet()->getStyle('A2:l2')->getAlignment()->setWrapText(true); 
            $spreadsheet->getActiveSheet()->getStyle('G2:G2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setRGB('CCFFFF');
            $spreadsheet->getActiveSheet()->getStyle('H2:H2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setRGB('CCFFFF');
            //$spreadsheet->getActiveSheet()->getStyle('J2:J2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setRGB('FFE5CC');
            $spreadsheet->getActiveSheet()->getStyle('I2:I2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setRGB('FFE5CC');
            ...
            $spreadsheet->getActiveSheet()->getStyle('L2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setRGB('E5FFCC');
            $spreadsheet->getActiveSheet()->getStyle('K2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setRGB('404040');
            /* $spreadsheet->getActiveSheet()->getStyle('G2:J2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setRGB('99FFFF');
            $spreadsheet->getActiveSheet()->getStyle('K2:M2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setRGB('99FFFF');
            $spreadsheet->getActiveSheet()->getStyle('J2:J2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setRGB('FFCC99');
            $spreadsheet->getActiveSheet()->getStyle('N2:O2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setRGB('FFCC99');
            $spreadsheet->getActiveSheet()->getStyle('P2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setRGB('99FF99');
            $spreadsheet->getActiveSheet()->getStyle('R2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setRGB('99FF99');
            $spreadsheet->getActiveSheet()->getStyle('Q2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setRGB('202020'); */
            $spreadsheet->getActiveSheet()->getStyle('K2')->getFont()->getColor()->setRGB ('FFFFFF');
            ...
            foreach ($query->result() as $row) {
                ...
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('G' . $kolom, $row->n_fc_perhitungan)
                    ->setCellValue('H' . $kolom, $row->n_stock_pengesetan)
                    ->setCellValue('I' . $kolom, "=N$kolom+G$kolom")
                    ->setCellValue('J' . $kolom, $row->n_up_cutting)
                    ->setCellValue('K' . $kolom, "=IF(I$kolom>0,I$kolom+J$kolom,J$kolom)")
