...
class Cform extends CI_Controller {
    ...
    public function simpan(){
        ...
        if ($iproductgrade != '' && $eproductgradename != ''){
                $cekada = $this->mmaster->cek_data($iproductgrade);
                if($cekada->num_rows() > 0){
                    $data = array(
                        'sukses' => false
                    );
                }else{
                    $this->Logger->write('Simpan Data '.$this->global['title'].' Kode : '.$iproductgrade);
    ...
    public function edit(){
        ...
        $data = array(
            ...
            'title_list' => 'List '.$this->global['title'],
            //'data' => $this->mmaster->cek_data($iproductgrade)->row()
        );
    ...
    public function update(){
        ...
        if ($iproductgrade != '' && $eproductgradename != ''){
            $cekada = $this->mmaster->cek_data($iproductgrade);
            if($cekada->num_rows() > 0){ 
                $this->Logger->write('Update Data '.$this->global['title'].' Kode : '.$iproductgrade);
