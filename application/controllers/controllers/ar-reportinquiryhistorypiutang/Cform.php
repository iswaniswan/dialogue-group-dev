...
class Cform extends CI_Controller {
    ...
    public function view(){
        ...
        $data = array(
            ...
            'dto'           => $dto,
            // 'supplier'      => $supplier,
            // 'total'         => $this->mmaster->total($dfrom,$dto)->row()
        );

        $this->Logger->write('Membuka Data '.$this->global['title'].' '.$from.' Sampai '.$to);
    ...
    // }
        ...
        public function viewdetail(){
            ...
            $data = array(
                ...
                'title' => "Edit ".$this->global['title'],
                'title_list' => 'List '.$this->global['title'],
                'head' => $this->mmaster->cek_data($ifaktur)->row(),
