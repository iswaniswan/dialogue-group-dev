...
class Cform extends CI_Controller {
    ...
    public function getnota(){
        ...
        if($query->num_rows()>0) {
            ...
            $nota = $query->result();
            foreach($nota as $row) {
                $c.="<option value=".$row->id." >".$row->i_btb.' || '.$row->i_sj_supplier."</option>";
    ...
    public function getmemo(){
        ...
        $query  = array(
            ...
            'detail' => $this->mmaster->getmemodetail($isupplier, $idnota, $ibagian)->result_array()
        );
