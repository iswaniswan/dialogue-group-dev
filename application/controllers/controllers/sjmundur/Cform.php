...
class Cform extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->Logger->write('Memilih Area '.$this->global['title']);
    ...
    public function index2(){
        ...
        $data = array(
            'folder'    => $this->global['folder'],
            'title'     => $this->global['title'],
            'spb' => $this->mmaster->bacaspb($post['iarea']),
            'area' => $this->mmaster->bacaareabyid($post['iarea']),
        );

        $this->Logger->write('Membuka Menu '.$this->global['title']);

        $this->load->view($this->global['folder'].'/vformadd2', $data);
