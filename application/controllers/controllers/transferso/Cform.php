        ...
        if ((isset($dstockopname) && $dstockopname != '')){
            ...
            for ($n=2; $n<=$hrow; $n++){
                ...
                $aray = array(
                    ...
                    'i_product_grade'     => $spreadsheet->getActiveSheet()->getCell('D'.$n)->getCalculatedValue(),
                    'i_product_motif'     =>  '00',  
                    'i_area'              => $iarea,
            ...
            if(($this->db->trans_status()=== False)){
                ...
                $this->Logger->write('Transfer SO Area '.$iarea.' No:'.$istockopname);
                $data = array(
                    'sukses'    => true,
                    'kode'      => $istockopname
                );
