...
class Cform extends CI_Controller {
    ...
    public function simpan()
    {
        ...
        if ($idocument!='' && $ddocument!='' && $ibagian != '' && $itype != '' && $ipartner != '' && $jml>0) {
            ...
            $this->mmaster->simpan($id,$idocument,$ddocument,$ibagian,$itype,$ipartner,$iforecast,$dforecast,$eremarkh);
            for ($i = 1; $i <= $jml; $i++) {
    ...
    public function update()
    {
        ...
        if ($id!='' && $idocument!='' && $ddocument!='' && $ibagian != '' && $itype != '' && $ipartner != '' && $jml>0) {
            $this->db->trans_begin();
            $this->mmaster->update($id,$idocument,$ddocument,$ibagian,$itype,$ipartner,$iforecast,$dforecast,$eremarkh);
