...
class Cform extends CI_Controller {
    ...
    function getmaterialsj(){
      ...
      public function simpan(){
        ...
        $dokpartner           = $this->input->post('dokpartner', TRUE);
        ...
        //var_dump($nosjmasuk, $dsjk,$nosjkeluar,$partner, $dokpartner, $istore, $remark, $jml);
        $this->db->trans_begin();
        $this->mmaster->insertheader($nosjmasuk, $dsjk,$nosjkeluar,$partner, $dokpartner, $istore, $remark);
        for($i=1;$i<=$jml;$i++){
            $cek=$this->input->post('chk'.$i, TRUE);
                if($cek=='on'){
                    $imaterial_reff = $this->input->post('i_materialasal'.$i, TRUE);
            ...
            //var_dump($nosjmasuk, $istore,$nosjkeluar,$imaterial_reff, $imaterial, $nquantity, $isatuan, $edesc);
        }
        //die();
    ...
    public function update(){
        ...
        //var_dump($nosjmasuk, $dsjk,$nosjkeluar,$partner, $dokpartner, $istore, $remark, $jml);
        $this->db->trans_begin();
        $this->mmaster->updateheader($nosjmasuk, $dsjk,$nosjkeluar,$partner, $dokpartner, $istore, $remark);
