...
class Cform extends CI_Controller {
    ...
    public function view(){
        ...
        $dfrom   = '01-'.$bulan1.'-'.$tahun1;
        $akhirtmp = $tahun2.'-'.$bulan2.'-01';
        ...
        $data = array(
            ...
            'total'         => $this->mmaster->total($dfrom,$dto,$interval)->result()
            
        );
        // var_dump($this->mmaster->total($dfrom,$dto,$interval)->result());
        // die();
