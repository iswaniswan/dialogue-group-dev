...
class Cform extends CI_Controller {
    ...
    public function cetak(){
        ...
        $data = array(
            ...
            'saldopiutang'  => $this->mmaster->bacapiutang($id,$iarea),
            'notapiutang'   => $this->mmaster->bacanotapiutang($id,$iarea),
        );

        $this->Logger->write('Cetak '.$this->global['title'].' Area : '.$iarea.' No SPB : '.$id);
