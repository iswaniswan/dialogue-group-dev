                    ...
                    if($idproduct != "" || $idproduct != NULL){
                        foreach ($this->input->post("idproductwip[]", TRUE) as $idproductwip) {
                            if($idproduct ==  $idproductwip){
                                ...
                                $nquantitybahanmasuk  = str_replace(",",".",$this->input->post("nquantitybahansisa[]", TRUE))[$i];
                                $edesc                = $this->input->post("edesc[]", TRUE)[$i];
                                $d_schedule           = $this->input->post("d_schedule[]", TRUE)[$i];
                                //var_dump($d_schedule);
                                if($d_schedule != "" ){
                                    $this->mmaster->insertdetail($id, $ireff, $idproductwip, $idmaterial, $nquantitywipmasuk, $nquantitybahanmasuk, $edesc, $id_fccutting_item, $d_schedule);
                                }
                            }
                            $i++;
                        }
