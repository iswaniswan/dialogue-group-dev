...
class Cform extends CI_Controller {
    ...
    public function approve(){
        ...
        if( ($prog==null)||($prog=='') ){          
            if($group=='00'){            
                $folder = $this->lang->line('spbapprovesales')." Reguler";        
            }else{            
                $folder = $this->lang->line('spbapprovesales')." Baby";        
            }    
        }else{      
            if($group=='00'){        
                $folder = $this->lang->line('spbapprovesales')." Promo Reguler";    
            }else{        
                $folder = $this->lang->line('spbapprovesales')." Promo Baby";    
            }
        }*/
        $data = array(
            'folder'    => $this->global['folder'],
