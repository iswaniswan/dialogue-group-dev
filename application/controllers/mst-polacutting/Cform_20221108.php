...
class Cform extends CI_Controller
{
    ...
    public function simpan()
    {
        ...
        if ($iproductcolor != '' && $jml > 0) {
            ...
            $iproduct       = $iproductcolor[0];
            $icolor         = $iproductcolor[1];
            $this->mmaster->delete($iproduct, $icolor, $cek);
            ...
            for ($i = 1; $i <= $jml; $i++) {
                ...
                if (($imaterial != '' || $imaterial != null) && ($vgelar > 0 || $bis3 > 0)) {
                    $this->mmaster->insertdetail($imaterial, $vgelar, $vset, $iproduct, $icolor, $bagian, $bis3, $id_bisbisan, $f_cutting, $autocutter, $badan, $print, $bordir, $quilting,$id_type_makloon, $f_kain_utama, $f_budgeting);
    ...
    public function edit()
    {
        ...
        $data = array(
            ...
            'title_list' => 'List ' . $this->global['title'],
            'data'       => $this->mmaster->datawip($this->uri->segment(4), $this->uri->segment(5))->row(),
            'detail'     => $this->mmaster->detail($this->uri->segment(4), $this->uri->segment(5))->result(),
        );
    ...
    public function update()
    {
        ...
        if ($iproductcolor != '' && $jml > 0) {
            ...
            $this->mmaster->delete($iproductold, $icolorold, $cek);
            ...
            for ($i = 1; $i <= $jml; $i++) {
                ...
                if (($imaterial != '' || $imaterial != null) && ($vgelar > 0 || $bis3 > 0)) {
                    ...
                    $n_quantity = ((1 / $vset) * $vgelar) + $finalbis;
                    if ($cek != 'on') {
                        $this->mmaster->updatedetail($imaterial, $vtoset, $vgelar, $vset, $fbis, $iproduct, $icolor, $n_bagibis, $bagian, $bis3, $bis4, $id_bisbisan, $f_cutting, $autocutter, $badan, $print, $bordir, $quilting, $id_type_makloon, $f_kain_utama, $f_budgeting);
                        $this->mmaster->insertdetailwip($iproduct, $imaterial, $n_quantity, $bagian, $icolor, $f_cutting, $autocutter, $badan, $print, $bordir, $quilting, $id_type_makloon, $f_kain_utama, $f_budgeting);
                    } else {
                        $this->mmaster->updatedetailall($imaterial, $vtoset, $vgelar, $vset, $fbis, $iproduct, $icolor, $n_bagibis, $bagian, $bis3, $bis4, $id_bisbisan, $f_cutting, $autocutter, $badan, $print, $bordir, $quilting, $id_type_makloon, $f_kain_utama, $f_budgeting);
