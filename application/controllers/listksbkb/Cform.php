...
class Cform extends CI_Controller {
    ...
    public function delete(){
        ...
        if(($this->db->trans_status()=== False)){
            ...
            $this->Logger->write('Hapus Konversi Stock BKB No : '.$id.' Gudang :'.$istore);
    ...
    public function deleteitem(){
        ...
        if(($this->db->trans_status()=== False)){
            ...
            $this->db->trans_commit();
            $this->Logger->write('Menghapus Detail Item Konversi Stock BKB No : '.$iicconvertion.' Kode Barang : '.$iproduct);
            echo json_encode($data);
        }
    }
    ...
    public function update(){
        ...
        if ((isset($dicconvertion) && $dicconvertion != '') && ($iicconvertion != '')){
            ...
            if(($this->db->trans_status()=== False)){
                ...
                $this->db->trans_commit();
                $this->Logger->write('Update Konversi Stok BKB No:'.$iicconvertion);
                $data = array(
                    'sukses'    => true,
                    'kode'      => $iicconvertion
                );
