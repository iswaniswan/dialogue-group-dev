...
class Cform extends CI_Controller
{
    ...
    function view()
    {
      ...
      $iperiode   = $tahun.$bulan;
        ...
        $data = array(
         ...
         'iperiode'      => $iperiode,
         'akhir'         => $akhir,
         'isi'           => $this->mmaster->baca($iperiode, $akhir, $username)->result()
        );
   ...
   function detail()
   {
         ...
         $data = array(
            ...
            'akhir'         => $akhir,
            'iarea'         => $iarea,
            'detail'        => $this->mmaster->detail($iarea,$iperiode,$akhir)->result()
           );
         $this->Logger->write('Membuka Menu View '.$this->global['title']);
   ...
   function sales()
   {
      ...
      $data = array(
         ...
         'iarea'         => $iarea,
         'detail'        => '',
         'sales'         => $this->mmaster->detailsales($iperiode,$akhir)->result()
        );
      $this->Logger->write('Membuka Menu View '.$this->global['title']);
   ...
   function divisi()
   {
      if (
         ...
         $data['detail']       = '';
         $data['sales']     = '';
         $data['divisi']       = $this->mmaster->detaildivisi($iarea,$iperiode,$akhir);
