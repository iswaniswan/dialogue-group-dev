...
class Cform extends CI_Controller {
    ...
    public function tambah(){
        ...
        $data = array(
            ...
            'datadetail'    => $this->mmaster->datadetail($this->session->userdata('id_company'),$ibagian)->result_array(),
        );
    ...
    public function export()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)->setCellValue("A1", strtoupper($this->session->e_company_name))
            ->setCellValue("A2", "FORMAT UPLOAD STOCKOPNAME PENGADAAN");
    ...
    public function load()
    {
        ...
        if ($this->upload->do_upload("userfile")) {
            ...
            $this->Logger->write('Upload File SO Pengadaan : ' . $i_so);
