...
class Cform extends CI_Controller {
    ...
    public function cek(){
        ...
        $data = array(
            ...
            'dto'       => $dto,
            'iarea'     => $iarea,
            'isi'       => $this->mmaster->bacapl($iarea,$ialokasi,$ikn),
            'detail'    => $this->mmaster->bacadetailpl($iarea,$ialokasi,$ikn),
        );
    ...
    public function update(){
        ...
        if(($ialokasi!='') && ($iarea!='') && ($ikn!='')){
            $this->db->trans_begin();
            $this->mmaster->updatecek($ecek1,$user,$ialokasi,$ikn,$iarea);
            if(($this->db->trans_status()=== False)){
                ...
                $this->Logger->write('Cek Alokasi KN No:'.$ialokasi.' Area:'.$iarea.' KN : '.$ikn);
                $data = array(
                    'sukses'    => true,
                    'kode'      => $ialokasi
                );
