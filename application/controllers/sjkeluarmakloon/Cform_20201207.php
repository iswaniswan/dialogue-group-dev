...
class Cform extends CI_Controller {
    ...
    public function getdetailreff(){
        ...
        $dsjk         = $this->input->post('dsjk', FALSE);

        $query  = array(
            'head'   => $this->mmaster->getreff($reff)->row(),
            'detail' => $this->mmaster->getreff_detail($reff, $ipartner, $itypemakloon, $dsjk)->result_array()
    ...
    public function simpan(){
        ...
        $this->mmaster->insertheader($nosjkeluar, $datesjk, $ibagian, $partner, $remark, $dateback, $reff, $datereff, $itypemakloon, $fpkp);
            ...
            foreach ($i_material as $imaterial) {
                ...
                $pemenuh    = $this->mmaster->cekpermintaan($reff, $imaterial, $imaterial2);
                $pemenuh2   = $this->mmaster->cekpermintaan2($reff, $imaterial, $imaterial2);

                $npemenuh   = $pemenuhan_1 + $pemenuh;
                $npemenuh2  = $pemenuhan_2 + $pemenuh2;
                ...
                $this->mmaster->updatesisa($reff, $imaterial, $imaterial2, $sisa, $sisaa, $npemenuh, $npemenuh2);
    ...
    public function delete(){
        ...
        if ($this->db->trans_status() === false) {
            ...
            $this->db->trans_commit();
            $this->Logger->write('Cancel Surat Keluar Makloon Bahan Baku' . $isj);
