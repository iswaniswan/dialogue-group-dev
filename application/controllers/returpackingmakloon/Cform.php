...
class Cform extends CI_Controller {
    ...
    public function simpan(){
        ...
        // var_dump($ibagian,$idocument,$ddocument,$idpartner);
        // die();
        ...
        if($ibagian != ''  && $idocument != '' && $ddocument != '' && $idpartner != ''){
            ...
            if ($cekdata->num_rows()>0) {
                ...
                $this->mmaster->insertheader($id, $idocument, $dateretur, $ibagian, $idpartner, $eremark);
                //INSERT DETAIL
                for ($i = 1; $i <= $jml; $i++) {
                    ...
                    if ($nquantity > 0 && $nquantity != null) {
                        $this->mmaster->insertdetail($id, $id_document_reff, $id_product, $nquantity, $eremark);
                    }
                }
    ...
    public function update() {
        ...
        if ($idocument!='' && $ddocument!='' && $ibagian != '') {
            ...
            if ($cekdata->num_rows()==0) {
                ...
                $this->db->trans_begin();
                $this->mmaster->updateheader($id, $idocument, $ddocument, $ibagian, $idpartner, $eremark);
                ...
                for ($i = 1; $i <= $jml; $i++) {
                    ...
                    if ($nquantity > 0 && $nquantity != null) {
                        $this->mmaster->insertdetail($id, $id_document_reff, $id_product, $nquantity, $edesc);
                    }
                }
                if ($this->db->trans_status() === FALSE) {
                    $this->db->trans_rollback();
