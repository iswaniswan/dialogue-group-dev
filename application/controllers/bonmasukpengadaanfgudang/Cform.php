...
class Cform extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->global['folder1'] = 'bonmmasukpengadaan';
    ...
    public function simpan(){
        ...
        if($ibagian != ''  && $idocument != '' && $ipengirim != '' && $ireff != '' && $jml>0){
    ...
    public function update()
    {
        ...
        if($ibagian != ''  && $idocument != '' ){
            ...
            foreach ($i_material as $imaterial) {
                ...
                $edesc         = $e_desc[$no];    
                if($nquantity <> 0){
                    $this->mmaster->updatedetail($id, $imaterial, $nquantity, $edesc, $ireff);
                }
