...
class Cform extends CI_Controller {
    ...
    public function number(){
        ...
        if ($this->input->post('tgl', TRUE) != '') {
            $number = $this->mmaster->runningnumber(date('ym', strtotime($this->input->post('tgl', TRUE))),date('Y', strtotime($this->input->post('tgl', TRUE))),$this->input->post('ibagian', TRUE),$this->input->post('id', TRUE));
        }
    ...
    public function alasanrepair(){
        $filter = [];
        $cari = strtoupper($this->input->get('q'));
        $data = $this->mmaster->alasanrepair($cari);
        if ($data->num_rows()>0) {
            $group   = [];
            $arr     = [];
    ...
    public function simpan(){
        ...
        $alasan       = $this->input->post('ialasan[]',TRUE);
        ...
        foreach ($i_product as $iproduct) {     
            ...
            $this->mmaster->insertdetail($id, $iproduct, $icolor, $nqtyproduct, $edesc, $ialasan); 
            $no++;
        }     
    ...
    public function cetak()
    {
        ...
        $data = [ 
            ...
            'data' => $_data,
            'datadetail' => $this->mmaster->view_datadetail_print($id, $id_company)->result(),
