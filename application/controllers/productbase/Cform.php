    ...
    public function simpan(){
        ...
        if ($iproduct != '' &&  $eproductname != ''){
                ...
                if($cekada->num_rows() > 0){
                    ...
                    $this->mmaster->insert($iproduct, $iproductsupplier, $isupplier, $iproductstatus, 
    ...
    public function update(){
        ...
        if($vproductmill=='')
            ...
            if ($iproduct != '' &&  $eproductname != ''){
                $cekada = $this->mmaster->cek_data($iproduct);
                if($cekada->num_rows() > 0){
                    $this->mmaster->update($iproduct, $iproductsupplier, $isupplier, $iproductstatus, 
                    $iproducttype, $iproductcategory, $iproductclass, $iproductgroup,$eproductname,
                    $eproductsuppliername, $vproductretail, $vproductmill, $fproductpricelist,
