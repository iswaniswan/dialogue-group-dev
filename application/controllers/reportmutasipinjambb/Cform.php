...
class Cform extends CI_Controller {
    ...
    public function partner()
    {
        ...
        $data = $this->mmaster->partner(str_replace("'","",$this->input->get('q')), $dfrom1, $dto1, $periode, $this->session->userdata('id_company'), $this->input->get('ibagian'));
        if ($data->num_rows()>0) {
            $filter[]= array(
                'id'    => 'all',
                'text'  => 'Semua Partner',
    ...
    public function cetak(){
        ...
        $awal = DateTime::createFromFormat('d-m-Y', $this->uri->segment(8));
        $akhir   = DateTime::createFromFormat('d-m-Y', $this->uri->segment(9));
        ...
        $data = array(
            ...
            'kategori'      => $this->mmaster->kategoribarang($ikelompok, $id_company)->row(),
            'jenis'         => $this->mmaster->jenisbarang($jnsbarang, $id_company)->row(),
            'partner'       => $this->mmaster->bacapartner($ipartner, $id_company)->row(),
            'data2'         => $this->mmaster->cek_datadet($id_company, $i_periode, $d_jangka_awal, $d_jangka_akhir, $dfrom, $dto, $ibagian, $ikelompok, $jnsbarang, $ipartner)->result(),
        );
        $this->Logger->write('Membuka Menu Edit '.$this->global['title']);
