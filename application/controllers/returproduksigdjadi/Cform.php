...
class Cform extends CI_Controller
{
    ...
    {
        $filter = [];
        if($this->input->get('id_product_wip')) {
    ...
    public function getproduct()
    {
        ...
        $data = array(
            'data' => $this->mmaster->getproduct($this->input->post('eproduct'), $this->input->post('ibagian') )->result_array(),
            'detail' => $this->mmaster->getproduct_material($this->input->post('eproduct'))->result_array(),
        );
    ...
    public function simpan()
    {
        ...
        $id_marker    = $this->input->post('emarker[]', TRUE);
        ...
        $id_product_base = $this->input->post("id_product[]");
        $i = 0;
        foreach ($id_product_base as $id_product) {
            $id_material = $this->input->post("id_material[]")[$i];
            $n_quantity_bagus = str_replace(",", "", $this->input->post("n_quantity_bagus[]")[$i]);
            $n_quantity_rusak = str_replace(",", "", $this->input->post("n_quantity_rusak[]")[$i]);
            $this->mmaster->insert_item_detail($id, $id_product, $id_material, $n_quantity_rusak, $n_quantity_bagus);
            $i++;
        }
