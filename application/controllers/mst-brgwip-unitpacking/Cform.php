...
class Cform extends CI_Controller {
    ...
    public function edit(){
        ...
        $iunitpacking = $this->uri->segment('5');
        ...
        $data = array(
            ...
            'data2' => $this->mmaster->cek_data2($id,$iunitpacking)->result()
        );
    ...
    public function simpan(){
        ...
        $ikodeunit       = $this->input->post('ikodeunit', TRUE);
        // $ikodeunit       = $kodeunit[1];
        $ikode   = $this->input->post('ikode', TRUE);
        $ikode2           = $this->input->post('ikode2', TRUE);
        
        // $idunitjahit           = '1';
          $idunitpacking           = $this->input->post('idunitpacking', TRUE);
        ...
        for($i=1;$i<=$jml;$i++){
            ...
            $this->mmaster->insertheader($ikodeunit,$ikode,$ikode2,$idunitpacking,$iproduct,$harga,$idprod);
                            // insertheader($ikodeunit,$ikode,$ikode2,$idunitpacking,$iproduct,$harga,$idprod)
...
#              $this->db->trans_rollback();
        ...
        public function update(){
            ...
            for($i=1;$i<=$jml;$i++){
                ...
                $idprod           = $this->input->post('idprod'.$i, TRUE);
                if($jml > 0 ){
                $this->mmaster->delete($ikodeunit,$ikode,$ikode2,$idunitpacking,$iproduct,$harga,$idprod);
                $this->mmaster->insertheader($ikodeunit,$ikode,$ikode2,$idunitpacking,$iproduct,$harga,$idprod);
                }
