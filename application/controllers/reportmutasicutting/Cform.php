...
class Cform extends CI_Controller {
    ...
    public function company(){
        ...
        $search = str_replace("'", "", $this->input->get('search'));
        $data = $this->mmaster->getcompany($search);
    ...
    public function cetak(){
        ...
        $data = array(
            ...
            'bagian'        => $this->mmaster->bacabagian($ibagian)->row(),
            'i_bagian'      => $bagian,
            'company'       => $this->db->get_where('public.company', ['id' => $id_company])->row()->name,
            ...
            'saldo'         => $this->mmaster->get_saldo($id_company, $i_periode, $d_jangka_awal, $d_jangka_akhir, $dfrom, $dto, $bagian)->row(),
